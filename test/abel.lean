...
example [CommMonoid α] : a * (b * a) = a * a * b := by abel
example [CommGroup α] : (a * b) / ((b * a) * a) = a⁻¹ := by abel
example [CommGroup α] (x : α) : x / 1 = x := by abel
example [CommMonoid α] : a^(3 : ℕ) = a * a^(2 : ℕ) := by abel
example [CommGroup α] : a^(3 : ℤ) = a * a^(2 : ℤ) := by abel
example [CommGroup α] (a b : α) : a/b^2 = a * b^(-2 : ℤ) := by abel

example [CommMonoid α] (a b : α) : a * (b * a) = a * a * b := by abel1
example [CommGroup α] (a b : α) : (a * b) / ((b * a) * a) = a⁻¹ := by abel1
example [CommGroup α] (x : α) : x / 1 = x := by abel1
example [CommMonoid α] (a : α) : a^(3 : ℕ) = a * a^(2 : ℕ) := by abel1
example [CommGroup α] (a : α) : a^(3 : ℤ) = a * a^(2 : ℤ) := by abel1
example [CommGroup α] (a b : α) : a / b^2 = a / b^2 := by abel1
example [CommGroup α] (a : α) : 1 * a = a := by abel1
example [CommGroup α] (n : ℕ) (a : α) : a^n = a^n := by abel1
example [CommGroup α] (n : ℕ) (a : α) : 1 * a^n = a^n := by abel1


example [CommMonoid α] (a b c d e : α) :
  a * (b * (a * (c * (a * (d * (a * e)))))) = e * d * c * b * a^4 := by abel1
example [CommGroup α] (a b c d e : α) :
  a * (b * (a * (c * (a * (d * (a * e)))))) = e * d * c * b * a^4 := by abel1
example [CommGroup α] (a b c d : α) :
  a * b * (c * d / a) = b * c * d := by abel1
example [CommGroup α] (a b c : α) :
  a * b * c * (c / a / a) = a^(-1 : ℤ) * b * c^2 := by abel1
...
-- https://leanprover.zulipchat.com/#narrow/stream/287929-mathlib4/topic/abel.20bug.3F/near/368707560
example [CommGroup α] (a b s : α) : b⁻¹ * (s / a) = s / b / a := by abel_nf
