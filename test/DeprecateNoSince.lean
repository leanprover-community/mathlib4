...
/--
warning: After here, please add (since := "2024-06-13") or whatever date is appropriate `⟨11, 44⟩`
...
/--
warning: After here, please add (since := "2024-06-13") or whatever date is appropriate `⟨19, 22⟩`
note: this linter can be disabled with `set_option linter.deprecateNoSince false`
-/
#guard_msgs in
set_option linter.deprecateNoSince true in
...
/--
warning: After here, please add (since := "2024-06-13") or whatever date is appropriate `⟨27, 18⟩`
note: this linter can be disabled with `set_option linter.deprecateNoSince false`
-/
#guard_msgs in
set_option linter.deprecateNoSince true in
