import Mathlib.Tactic.MulAbel

variable {α : Type _} {a b : α}

set_option trace.abel.detail true

example [CommMonoid α] : b * a = a * b := by abel
example [CommMonoid α] : a * (b * a) = a * a * b := by abel
example [CommGroup α] : (a * b) / ((b * a) * a) = a ⁻¹ := by abel
example [CommGroup α] (x : α) : x - 0 = x := by abel
example [CommMonoid α] : (3 : ℕ) • a = a * (2 : ℕ) • a := by abel
example [CommGroup α] : (3 : ℤ) • a = a * (2 : ℤ) • a := by abel
example [CommGroup α] (a b : α) : a-2•b = a -2•b := by abel

example [CommMonoid α] (a b : α) : a + (b + a) = a + a + b := by abel1
example [CommGroup α] (a b : α) : (a + b) - ((b + a) + a) = -a := by abel1
example [CommGroup α] (x : α) : x - 0 = x := by abel1
example [CommMonoid α] (a : α) : (3 : ℕ) • a = a + (2 : ℕ) • a := by abel1
example [CommGroup α] (a : α) : (3 : ℤ) • a = a + (2 : ℤ) • a := by abel1
example [CommGroup α] (a b : α) : a - 2•b = a - 2•b := by abel1
example [CommGroup α] (a : α) : 0 + a = a := by abel1
example [CommGroup α] (n : ℕ) (a : α) : n • a = n • a := by abel1
example [CommGroup α] (n : ℕ) (a : α) : 0 + n • a = n • a := by abel1
...
def id' (x : α) := x
example [CommGroup α] (a b : α) : a + b - b - id' a = 0 := by
  fail_if_success
    abel1
  abel1!
...
example [CommGroup α] (x y z : α) (_w : x = y + z) : x - x = 0 := by
  abel_nf at *
...
#guard_msgs in
example [CommGroup α] (x y z : α) (w : x = y + z) : x - x = 0 := by
  abel_nf at w ⊢
...
#guard_msgs in
example [CommGroup α] (x y z : α) (w : x - x = y + z) : x = 0 := by
  abel_nf at w ⊢
