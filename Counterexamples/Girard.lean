...
Girard's paradox is a proof that `Type : Type` entails a contradiction. We cannot say this directly
...
Since we cannot actually change the type of Lean's `Π` operator, we assume the existence of
