...
lemma cyclotomic_3 : cyclotomic 3 ℤ = 1 + X + X ^ 2 := by
...
lemma cyclotomic_5 : cyclotomic 5 ℤ = 1 + X + X ^ 2 + X ^ 3 + X ^ 4 := by
  simp only [cyclotomic_prime, sum_range_succ, range_one, sum_singleton, pow_zero, pow_one]
#align counterexample.cyclotomic_5 Counterexample.cyclotomic_5

lemma cyclotomic_7 : cyclotomic 7 ℤ = 1 + X + X ^ 2 + X ^ 3 + X ^ 4 + X ^ 5 + X ^ 6 := by
  simp only [cyclotomic_prime, sum_range_succ, range_one, sum_singleton, pow_zero, pow_one]
#align counterexample.cyclotomic_7 Counterexample.cyclotomic_7

lemma cyclotomic_15 : cyclotomic 15 ℤ = 1 - X + X ^ 3 - X ^ 4 + X ^ 5 - X ^ 7 + X ^ 8 := by
...
lemma coeff_cyclotomic_105 : coeff (cyclotomic 105 ℤ) 7 = -2 := by
