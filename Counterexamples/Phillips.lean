...
lemma exists_discrete_support_nonpos (f : BoundedAdditiveMeasure α) :
...
lemma measurable_comp (Hcont : #ℝ = aleph 1) (φ : (DiscreteCopy ℝ →ᵇ ℝ) →L[ℝ] ℝ) :
...
lemma no_pettis_integral (Hcont : #ℝ = aleph 1) :
