...
class MathLibFixer:
    ...
    def add_annotation(self, file_path: Path, line_number: int, definition_name: str) -> bool:
        ...
        try:
            ...
            print(f"\n  Processing: {file_rel}:{line_number}")
            ...
            if start_index < 0 or start_index >= len(lines):
                print(f"      ERROR: Line {line_number} out of range")
                return False
            ...
            if def_index is None:
                print(f"      ERROR: Could not find 'def' keyword at or after line {line_number}")
                return False
            ...
            if def_stripped.startswith('@['):
                ...
                if closing_bracket_idx != -1:
                    ...
                    print(f"      ✓ Fixed Definition {definition_name} at Line {def_index + 1}")
                    return True
            ...
            if def_index > 0 and "@[implicit_reducible]" in lines[def_index - 1]:
                print(f"      WARNING: @[implicit_reducible] already present before line {def_index + 1}")
                return False
