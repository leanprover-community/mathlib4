...
| [`nightly-docgen.yml`](https://github.com/leanprover-community/mathlib-ci/blob/master/.github/workflows/nightly-docgen.yml) <br/> (**mathlib-ci**) | Docgen test on nightly-testing<br>[![passed/failed](https://img.shields.io/github/actions/workflow/status/leanprover-community/mathlib-ci/nightly-docgen.yml?label=status)](https://github.com/leanprover-community/mathlib-ci/actions/workflows/nightly-docgen.yml) | Medium | `schedule (daily at 01:37 UTC)` | Runs nightly-testing docgen checks and sends Zulip success/failure messages. |
| [`nightly-regression-report.yml`](https://github.com/leanprover-community/mathlib-ci/blob/master/.github/workflows/nightly-regression-report.yml) <br/> (**mathlib-ci**) | nightly-testing regression report<br>[![passed/failed](https://img.shields.io/github/actions/workflow/status/leanprover-community/mathlib-ci/nightly-regression-report.yml?label=status)](https://github.com/leanprover-community/mathlib-ci/actions/workflows/nightly-regression-report.yml) | Medium | `schedule (daily at 04:37 UTC)` | Produces nightly-testing regression/lint report output and posts summary to Zulip. |
