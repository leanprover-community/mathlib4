...
@[to_additive]
noncomputable instance (priority := 10000) [Monoid M] : Group (IsUnit.submonoid M) :=
...
@[to_additive]
noncomputable instance (priority := 10000) [CommMonoid M] : CommGroup (IsUnit.submonoid M) :=
