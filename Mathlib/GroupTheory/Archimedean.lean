...
/-- The additive subgroup generated by an element of an archimedean additive group equals the set of
...
lemma AddSubgroup.mem_closure_singleton_iff_existsUnique_zsmul {G : Type*}
    [LinearOrderedAddCommGroup G] {a b : G} (ha : a ≠ 0) :
