...
lemma AddSubgroup.cyclic_of_min {H : AddSubgroup G} {a : G}
...
lemma AddSubgroup.exists_isLeast_pos {H : AddSubgroup G} (hbot : H ≠ ⊥) {a : G} (h₀ : 0 < a)
...
lemma AddSubgroup.cyclic_of_isolated_zero {H : AddSubgroup G} {a : G} (h₀ : 0 < a)
