...
@[to_additive]
instance (priority := 10000) Quotient.group : Group (G ⧸ N) :=
...
@[to_additive]
instance (priority := 10000) Quotient.commGroup {G : Type*} [CommGroup G] (N : Subgroup G) : CommGroup (G ⧸ N) :=
...
@[to_additive]
instance (priority := 10000) map_normal : (M.map (QuotientGroup.mk' N)).Normal :=
