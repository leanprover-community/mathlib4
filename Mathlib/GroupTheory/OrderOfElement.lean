...
@[to_additive (attr := implicit_reducible) /-- Every finite left cancellative additive monoid is an additive group. -/]
...
@[to_additive (attr := implicit_reducible) /-- Every finite right cancellative additive monoid is an additive group. -/]
