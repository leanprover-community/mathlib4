    ...
    (fun ⟨a, b⟩ hab =>
      if h : f⁻¹ b < f⁻¹ a then by
        ...
        · dsimp [finPairsLT] at hab
          simp at hab says simp only [mem_sigma, mem_univ, mem_attachFin, mem_range, Fin.val_fin_lt, true_and] at hab
        ...
        · dsimp at *
          dsimp [finPairsLT] at hab
          simp at * says simp only [mem_sigma, mem_univ, mem_attachFin, mem_range, Fin.val_fin_lt, true_and,
            not_lt, apply_inv_self, not_le] at *
