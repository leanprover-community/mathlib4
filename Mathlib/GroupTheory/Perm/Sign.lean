...
lemma signBijAux_injOn {n : ℕ} {f : Perm (Fin n)} :
...
lemma signAux3_mul_and_swap [Finite α] (f g : Perm α) (s : Multiset α) (hs : ∀ x, x ∈ s) :
...
lemma signAux3_symm_trans_trans [Finite α] [DecidableEq β] [Finite β] (f : Perm α) (e : α ≃ β)
