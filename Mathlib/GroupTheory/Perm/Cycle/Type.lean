...
instance (priority := 10000) zeroUnique : Unique (vectorsProdEqOne G 0) := by
  rw [zero_eq]
...
instance (priority := 10000) oneUnique : Unique (vectorsProdEqOne G 1) := by
  rw [one_eq]
...
instance (priority := 10000) [Fintype G] : Fintype (vectorsProdEqOne G n) :=
