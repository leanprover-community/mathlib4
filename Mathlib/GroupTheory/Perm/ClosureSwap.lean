...
theorem surjective_of_isSwap_of_isPretransitive' [Finite α] (S : Set G)
    (hS1 : ∀ σ ∈ S, MonoidAction.toPermHom G α σ = 1 ∨ Perm.IsSwap (MulAction.toPermHom G α σ))
...
theorem surjective_of_isSwap_of_isPretransitive [Finite α] (S : Set G)
    ...
    [h : MonoidAction.IsPretransitive G α] : Function.Surjective (MulAction.toPermHom G α) :=
