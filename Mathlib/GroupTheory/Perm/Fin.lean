...
theorem cycleRange_succAbove {n : ℕ} (i : Fin (n + 1)) (j : Fin n) :
  ...
  · rw [Fin.succAbove_of_castSucc_lt h, Fin.cycleRange_of_lt h, Fin.coeSucc_eq_succ]
  · rw [Fin.succAbove_of_le_castSucc h, Fin.cycleRange_of_gt (Fin.le_castSucc_iff.mp h)]
