...
instance (priority := 10000) : Subgroup.Normal (commutator G) := Subgroup.commutator_normal ⊤ ⊤
...
instance (priority := 10000) commutator_characteristic : (commutator G).Characteristic :=
  Subgroup.commutator_characteristic ⊤ ⊤
#align commutator_characteristic commutator_characteristic

instance (priority := 10000) [Finite (commutatorSet G)] : Group.FG (commutator G) := by
...
instance (priority := 10000) commGroup : CommGroup (Abelianization G) :=
...
instance (priority := 10000) : Inhabited (Abelianization G) :=
  ⟨1⟩

instance (priority := 10000) [Unique G] : Unique (Abelianization G) := Quotient.instUniqueQuotient _

instance (priority := 10000) [Fintype G] [DecidablePred (· ∈ commutator G)] : Fintype (Abelianization G) :=
  QuotientGroup.fintype (commutator G)

instance (priority := 10000) [Finite G] : Finite (Abelianization G) :=
  Quotient.finite _
...
instance (priority := 10000) [Finite (commutatorSet G)] : Finite (commutatorRepresentatives G) :=
...
instance (priority := 10000) closureCommutatorRepresentatives_fg [Finite (commutatorSet G)] :
...
instance (priority := 10000) [Finite (commutatorSet G)] :
