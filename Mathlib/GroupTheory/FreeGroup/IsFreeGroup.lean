...
structure FreeAddGroupBasis (ι : Type*) (G : Type*) [AddGroup G] where
  ...
  group. -/
  ofRepr ::
    /-- `repr` is the isomorphism between the group `G` and the additive free group generated by
    `ι`. -/
...
@[to_additive
/-- If a group satisfies the universal property of an additive free group with respect to a given
type, then it admits a free group basis based on this type. Here, the universal property is
expressed as in `IsFreeAddGroup.lift` and its properties. -/]
...
@[to_additive
/-- If a group satisfies the universal property of an additive free group with respect to a given
type, then it admits a free group basis based on this type. Here
...
@[to_additive
/-- If a group satisfies the universal property of an additive free group with respect to a given
type, then it is free. Here, the universal property is expressed as in `IsFreeAddGroup.lift` and its
properties. -/]
...
@[to_additive
/-- If a group satisfies the universal property of an additive free group with respect to a given
type, then it is free. Here the universal property is expressed as in
