...
/-- An equivalence between any fiber of a `MonoidHom` and its kernel. -/
@[to_additive "An equivalence between any fiber of an `AddMonoidHom` and its kernel."]
...
/-- An equivalence between any two fibers of a `MonoidHom`. -/
@[to_additive "An equivalence between any two fibers of an `AddMonoidHom`."]
