...
-- We define a subgroup which is finitely generated by a normal closure.
...
lemma isFinitelyPresented_iff_fintype {G : Type*} [Group G] :
  ...
  Function.Surjective f ∧ IsNormalClosureFG (MonoidHom.ker f) := by
    ...
    · -- mpr
      ...
      · --exact  IsNormalClosureFG.map iso.symm.toMonoidHom iso.symm.surjective (MonoidHom.ker f) hkernel
