...
lemma inv_mem_centralizer [Group M] (ha : a ∈ centralizer S) : a⁻¹ ∈ centralizer S := fun g hg =>
...
lemma centralizer_eq_top_iff_subset {s : Set M} [Mul M] :
...
lemma centralizer_univ [Mul M] : centralizer univ = center M :=
