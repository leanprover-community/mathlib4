...
-/
@[to_additive exponent_dvd_of_addMonoidHom /-- If there exists an injective, addition-preserving
map from `G` to `H`, then the exponent of `G` divides the exponent of `H`. -/]
