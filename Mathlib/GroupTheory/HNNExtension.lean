...
theorem unitsSMul_neg (u : ℤˣ) (w : NormalWord d) :
  ...
  · have hcan2 : Cancels u w := not_not.1 (mt (unitsSMul_cancels_iff _ _ _).2 hcan)
    ...
    | cons g u' w h1 h2 ih =>
      ...
      · -- This used to `simp [this]` before https://github.com/leanprover/lean4/issues/2644
        dsimp
        conv_lhs => erw [IsComplement.equiv_mul_left]
        rw [map_mul, Submonoid.coe_mul, toSubgroupEquiv_neg_apply, this]
        simp
      · -- The next two lines were not needed before https://github.com/leanprover/lean4/issues/2644
        dsimp
        conv_lhs => erw [IsComplement.equiv_mul_left]
...
theorem prod_smul_empty (w : NormalWord d) :
  ...
  | cons g u w h1 h2 ih =>
    ...
    -- The next 3 lines were a single `simp [...]` before https://github.com/leanprover/lean4/issues/2644
    simp only [unitsSMulGroup]
    simp_rw [SetLike.coe_sort_coe]
    erw [(d.compl _).equiv_fst_eq_one_of_mem_of_one_mem (one_mem _) h1]
    ext <;> simp
    -- The next 4 were not needed before https://github.com/leanprover/lean4/issues/2644
