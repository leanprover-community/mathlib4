...
/-- A `SubMulAction` is finitely generated if it is generated by a finite set. -/
@[to_additive /-- A `SubAddAction` is finitely generated if it is generated by a finite set. -/]
