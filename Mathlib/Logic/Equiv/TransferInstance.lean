...
@[to_additive]
noncomputable instance (priority := 10000) [Small.{v} α] [One α] : One (Shrink.{v} α) :=
...
@[to_additive]
noncomputable instance (priority := 10000) [Small.{v} α] [Mul α] : Mul (Shrink.{v} α) :=
...
@[to_additive]
noncomputable instance (priority := 10000) [Small.{v} α] [Div α] : Div (Shrink.{v} α) :=
...
@[to_additive]
noncomputable instance (priority := 10000) [Small.{v} α] [Inv α] : Inv (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] (R : Type*) [SMul R α] : SMul R (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] (N : Type*) [Pow α N] : Pow (Shrink.{v} α) N :=
...
@[to_additive]
noncomputable instance (priority := 10000) [Small.{v} α] [Semigroup α] : Semigroup (Shrink.{v} α) :=
...
@[to_additive]
noncomputable instance (priority := 10000) [Small.{v} α] [SemigroupWithZero α] : SemigroupWithZero (Shrink.{v} α) :=
...
@[to_additive]
noncomputable instance (priority := 10000) [Small.{v} α] [CommSemigroup α] : CommSemigroup (Shrink.{v} α) :=
...
@[to_additive]
noncomputable instance (priority := 10000) [Small.{v} α] [MulZeroClass α] : MulZeroClass (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [MulOneClass α] : MulOneClass (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [MulZeroOneClass α] : MulZeroOneClass (Shrink.{v} α) :=
...
@[to_additive]
noncomputable instance (priority := 10000) [Small.{v} α] [Monoid α] : Monoid (Shrink.{v} α) :=
...
@[to_additive]
noncomputable instance (priority := 10000) [Small.{v} α] [CommMonoid α] : CommMonoid (Shrink.{v} α) :=
...
@[to_additive]
noncomputable instance (priority := 10000) [Small.{v} α] [Group α] : Group (Shrink.{v} α) :=
...
@[to_additive]
noncomputable instance (priority := 10000) [Small.{v} α] [CommGroup α] : CommGroup (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [NonUnitalNonAssocSemiring α] :
...
noncomputable instance (priority := 10000) [Small.{v} α] [NonUnitalSemiring α] : NonUnitalSemiring (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [AddMonoidWithOne α] : AddMonoidWithOne (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [AddGroupWithOne α] : AddGroupWithOne (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [NonAssocSemiring α] : NonAssocSemiring (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [Semiring α] : Semiring (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [NonUnitalCommSemiring α] :
...
noncomputable instance (priority := 10000) [Small.{v} α] [CommSemiring α] : CommSemiring (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [NonUnitalNonAssocRing α] :
...
noncomputable instance (priority := 10000) [Small.{v} α] [NonUnitalRing α] : NonUnitalRing (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [NonAssocRing α] : NonAssocRing (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [Ring α] : Ring (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [NonUnitalCommRing α] : NonUnitalCommRing (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [CommRing α] : CommRing (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [Nontrivial α] : Nontrivial (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [Ring α] [IsDomain α] : IsDomain (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [RatCast α] : RatCast (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [DivisionRing α] : DivisionRing (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [Field α] : Field (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [MulAction R α] : MulAction R (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [AddCommMonoid α] [DistribMulAction R α] :
...
noncomputable instance (priority := 10000) [Small.{v} α] [AddCommMonoid α] [Module R α] : Module R (Shrink.{v} α) :=
...
noncomputable instance (priority := 10000) [Small.{v} α] [Semiring α] [Algebra R α] :
