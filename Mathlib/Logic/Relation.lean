...
theorem _root_.well_founded.transGen (h : WellFounded r) : WellFounded (TransGen r) :=
  ⟨fun a => (h.apply a).TransGen⟩

#align well_founded.trans_gen well_founded.transGen
...
-- needs editing/aligning from here
