...
theorem _root_.Quot.eqvGen_exact {a b : α} (H : Quot.mk r a = Quot.mk r b) : EqvGen r a b :=
...
theorem _root_.Quot.eqvGen_sound {r : α → α → Prop} {a b : α} (H : EqvGen r a b) :
...
open Decidable in
instance _root_.Quotient.decidableEq {α : Sort*} {s : Setoid α} [d : ∀ a b : α, Decidable (a ≈ b)] :
...
@[deprecated (since := "2024-09-01")] alias _root_.EqvGen := EqvGen
@[deprecated (since := "2024-09-01")] alias _root_.EqvGen.is_equivalence := EqvGen.is_equivalence
@[deprecated (since := "2024-09-01")] alias _root_.EqvGen.Setoid := EqvGen.Setoid
@[deprecated (since := "2024-09-01")] alias _root_.EqvGen.mono := EqvGen.mono
@[deprecated (since := "2024-08-29")] alias _root_.Quot.exact := Quot.eqvGen_exact
@[deprecated (since := "2024-08-29")] alias _root_.Quot.EqvGen_sound := Quot.eqvGen_sound
