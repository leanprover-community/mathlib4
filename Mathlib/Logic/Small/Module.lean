...
instance (priority := 10000) [Semiring α] [AddCommMonoid β] [Module α β] [Small β] : Module α (Shrink β) :=
...
instance (priority := 10000) [CommSemiring α] [Semiring β] [Algebra α β] [Small β] : Algebra α (Shrink β) :=
