...
theorem pi_of_empty {α : Type*} {_ : Fintype α} [IsEmpty α] {β : α → Type*}
...
attribute [-instance] Fintype.ofIsEmpty in
theorem measurePreserving_pi_empty {ι : Type u} {α : ι → Type v} {_ : Fintype ι} [IsEmpty ι]
...
attribute [-instance] Fintype.ofIsEmpty in
theorem volume_preserving_pi_empty {ι : Type u} (α : ι → Type v) {_ : Fintype ι} [IsEmpty ι]
    [∀ i, MeasureSpace (α i)] :
