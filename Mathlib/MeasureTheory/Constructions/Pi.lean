...
theorem ae_eq_set_pi {I : Set ι} {s t : ∀ i, Set (α i)} (h : ∀ i ∈ I, s i =ᵐˢ[μ i] t i) :
    Set.pi I s =ᵐˢ[Measure.pi μ] Set.pi I t :=
