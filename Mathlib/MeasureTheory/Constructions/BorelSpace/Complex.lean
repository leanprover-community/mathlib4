...
instance (priority := 900) RCLike.measurableSpace {𝕜 : Type*} [SMul ℝ 𝕜] [RCLike 𝕜] : MeasurableSpace 𝕜 :=
  borel 𝕜
#align is_R_or_C.measurable_space RCLike.measurableSpace

instance (priority := 900) RCLike.borelSpace {𝕜 : Type*} [SMul ℝ 𝕜] [RCLike 𝕜] : BorelSpace 𝕜 :=
  ⟨rfl⟩
