...
variable {α E F F' G 𝕜 : Type*} [AddCommGroup E] [NormedAddCommGroup E] [NormedSpace ℝ E]
  ...
  [NormedAddCommGroup F'] [NormedSpace ℝ F'] [AddCommGroup G] [NormedAddCommGroup G]
...
def DominatedFinMeasAdditive {β} [AddCommGroup β] [SeminormedAddCommGroup β] {_ : MeasurableSpace α}
...
theorem eq_zero_of_measure_zero {β : Type*} [AddCommGroup β] [NormedAddCommGroup β] {T : Set α → β}
    {C : ℝ}
...
theorem eq_zero {β : Type*} [AddCommGroup β] [NormedAddCommGroup β] {T : Set α → β} {C : ℝ}
    {_ : MeasurableSpace α}
...
theorem smul [AddCommGroup 𝕜] [SeminormedAddGroup 𝕜] [DistribSMul 𝕜 β] [IsBoundedSMul 𝕜 β]
...
variable {G' G'' : Type*}
  ...
  [NormedSpace ℝ G''] [AddCommGroup G'] [NormedAddCommGroup G'] [PartialOrder G'] [NormedSpace ℝ G']
