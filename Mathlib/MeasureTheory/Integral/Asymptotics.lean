...
variable {α E F : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] {f : α → E} {g : α → F} {a : α} {l : Filter α}

namespace Asymptotics

section Basic

variable [MeasurableSpace α] [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] {μ : Measure α}
...
variable [NormedSpace ℝ E] [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F]
