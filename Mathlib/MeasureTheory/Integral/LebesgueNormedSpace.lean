...
theorem aemeasurable_withDensity_iff {E : Type*} [AddCommGroup E] [NormedAddCommGroup E]
    [NormedSpace ℝ E] [SecondCountableTopology E] [MeasurableSpace E] [BorelSpace E] {f : α → ℝ≥0}
