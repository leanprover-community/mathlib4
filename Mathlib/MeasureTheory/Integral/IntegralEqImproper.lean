...
variable {α ι E : Type*} [MeasurableSpace α] {μ : Measure α} {l : Filter ι}
...
variable {ι E : Type*} {μ : Measure ℝ} {l : Filter ι} [Filter.NeBot l] [IsCountablyGenerated l]
  [AddCommGroup E] [NormedAddGroup E] {a b : ι → ℝ} {f : ℝ → E}
...
variable {ι E : Type*} {μ : Measure ℝ} {l : Filter ι} [IsCountablyGenerated l]
  [AddCommGroup E] [NormedAddGroup E] [NormedSpace ℝ E] {a b : ι → ℝ} {f : ℝ → E}
...
variable {E : Type*} {f f' : ℝ → E} {g g' : ℝ → ℝ} {a l : ℝ} {m : E}
  [AddCommGroup E] [NormedAddGroup E] [NormedSpace ℝ E]
...
variable {E : Type*} {f f' : ℝ → E} {a : ℝ} {m : E} [AddCommGroup E] [NormedAddGroup E]
  [NormedSpace ℝ E]
...
variable {E : Type*} {f f' : ℝ → E} {m n : E} [AddCommGroup E] [NormedAddGroup E]
  [NormedSpace ℝ E]
...
variable {E F G : Type*} [AddCommGroup E] [NormedAddGroup E] [NormedSpace ℝ E]
...
variable {A : Type*} [Ring A] [NormedRing A] [NormedAlgebra ℝ A]
