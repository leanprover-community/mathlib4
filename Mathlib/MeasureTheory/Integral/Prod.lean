...
theorem Integrable.prod_smul {𝕜 : Type*} [Field 𝕜] [StrictNormedRing 𝕜] [NormedSpace 𝕜 E]
...
theorem Integrable.prod_mul {L : Type*} [Field L] [StrictNormedRing L] {f : α → L} {g : β → L}
