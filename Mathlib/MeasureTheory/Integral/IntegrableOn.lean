...
theorem integrableAtFilter_atBot_iff [Preorder α] [IsPrecodirectedOrder α] [Nonempty α] :
...
theorem integrableAtFilter_atTop_iff [Preorder α] [IsPredirectedOrder α] [Nonempty α] :
