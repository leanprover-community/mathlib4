...
protected noncomputable def ofFunction (m : Set α → ℝ≥0∞) (m_empty : m ∅ = 0) : OuterMeasure α :=
...
noncomputable def boundedBy : OuterMeasure α :=
...
noncomputable def sInfGen (m : Set (OuterMeasure α)) (s : Set α) : ℝ≥0∞ :=
