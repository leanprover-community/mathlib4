...
@[measurability, fun_prop]
theorem Set.measurable_restrict (s : Set δ) : Measurable (s.restrict (X := X)) :=
  measurable_pi_lambda _ fun _ ↦ measurable_pi_apply _

@[measurability, fun_prop]
theorem Set.measurable_restrict₂ {s t : Set δ} (hst : s ⊆ t) :
    Measurable (restrict₂ (X := X) hst) :=
  measurable_pi_lambda _ fun _ ↦ measurable_pi_apply _

@[measurability, fun_prop]
theorem Finset.measurable_restrict (s : Finset δ) : Measurable (s.restrict (X := X)) :=
  measurable_pi_lambda _ fun _ ↦ measurable_pi_apply _

@[measurability, fun_prop]
theorem Finset.measurable_restrict₂ {s t : Finset δ} (hst : s ⊆ t) :
    Measurable (Finset.restrict₂ (X := X) hst) :=
  measurable_pi_lambda _ fun _ ↦ measurable_pi_apply _
...
theorem Set.measurable_restrict₂_apply {s t : Set α} (hst : s ⊆ t)
    ...
    Measurable (restrict₂ (X := fun _ ↦ γ) hst f) := hf.comp (measurable_inclusion hst)
