...
protected theorem iUnion_of_monotone {ι : Type*} [Preorder ι] [IsPredirectedOrder ι]
...
protected theorem iInter_of_antitone {ι : Type*} [Preorder ι] [IsPredirectedOrder ι]
    [(atTop : Filter ι).IsCountablyGenerated] {s : ι → Set α}
