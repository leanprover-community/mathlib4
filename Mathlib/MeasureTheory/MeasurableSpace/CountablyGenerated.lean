...
noncomputable def countableGeneratingSet (α : Type*) [MeasurableSpace α]
...
noncomputable def natGeneratingSequence (α : Type*) [MeasurableSpace α] [CountablyGenerated α] :
    ℕ → (Set α) :=
