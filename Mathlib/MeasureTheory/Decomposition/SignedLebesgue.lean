...
theorem singularPart_add_withDensity_rnDeriv_eq [c.HaveLebesgueDecomposition μ] :
  ...
  apply Complex.ext
  · rw [Complex.add_re, withDensityᵥ_apply (c.integrable_rnDeriv μ) hi, ← ROrCLike.re_eq_complex_re,
      ← integral_re (c.integrable_rnDeriv μ).integrableOn, ROrCLike.re_eq_complex_re,
  ...
  · rw [Complex.add_im, withDensityᵥ_apply (c.integrable_rnDeriv μ) hi, ← ROrCLike.im_eq_complex_im,
      ← integral_im (c.integrable_rnDeriv μ).integrableOn, ROrCLike.im_eq_complex_im,
      ← withDensityᵥ_apply _ hi]
