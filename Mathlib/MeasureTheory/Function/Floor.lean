...
variable {α R : Type*} [MeasurableSpace α] [Ring R] [LinearOrderedRing R] [FloorRing R] [TopologicalSpace R]
...
variable {α R : Type*} [MeasurableSpace α] [Semiring R] [LinearOrderedSemiring R] [FloorSemiring R]
