...
-- XXX: clean up and minimize this pre-amble!
...
variable {α : Type u_1} {E : Type u_2} {m0 : MeasurableSpace α}
  {p : ℝ≥0∞} {μ : Measure α} [NormedAddCommGroup E] [TopologicalSpace α] [BorelSpace α]
