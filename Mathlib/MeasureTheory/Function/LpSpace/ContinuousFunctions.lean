...
variable {α E : Type*} {m m0 : MeasurableSpace α} {p : ℝ≥0∞} {μ : Measure α}
  [TopologicalSpace α] [BorelSpace α] [AddCommGroup E] [NormedAddGroup E]
...
as an element of `Lp`. -/
def toLp [Field 𝕜] [StrictNormedRing 𝕜] [NormedSpace 𝕜 E] : (α →ᵇ E) →L[𝕜] Lp E p μ :=
...
theorem coeFn_toLp [Field 𝕜] [StrictNormedRing 𝕜] [NormedSpace 𝕜 E] (f : α →ᵇ E) :
    toLp (E := E) p μ 𝕜 f =ᵐ[μ] f :=
  AEEqFun.coeFn_mk f _

variable {𝕜}

theorem range_toLp [Field 𝕜] [StrictNormedRing 𝕜] [NormedSpace 𝕜 E] :
...
theorem toLp_norm_le [Field 𝕜] [NontriviallyNormedField 𝕜] [NormedSpace 𝕜 E] :
...
theorem toLp_inj {f g : α →ᵇ E} [μ.IsOpenPosMeasure]
    [Field 𝕜] [StrictNormedRing 𝕜] [NormedSpace 𝕜 E] :
...
theorem toLp_injective [μ.IsOpenPosMeasure] [Field 𝕜] [StrictNormedRing 𝕜] [NormedSpace 𝕜 E] :
...
def toLp [Field 𝕜] [StrictNormedRing 𝕜] [NormedSpace 𝕜 E] : C(α, E) →L[𝕜] Lp E p μ :=
...
theorem coeFn_toLp [Field 𝕜] [StrictNormedRing 𝕜] [NormedSpace 𝕜 E] (f : C(α, E)) :
    toLp (E := E) p μ 𝕜 f =ᵐ[μ] f :=
  AEEqFun.coeFn_mk f _

theorem toLp_def [Field 𝕜] [StrictNormedRing 𝕜] [NormedSpace 𝕜 E] (f : C(α, E)) :
    toLp (E := E) p μ 𝕜 f =
      BoundedContinuousFunction.toLp (E := E) p μ 𝕜 (linearIsometryBoundedOfCompact α E 𝕜 f) :=
  rfl

@[simp]
theorem toLp_comp_toContinuousMap [Field 𝕜] [StrictNormedRing 𝕜] [NormedSpace 𝕜 E] (f : α →ᵇ E) :
    toLp (E := E) p μ 𝕜 f.toContinuousMap = BoundedContinuousFunction.toLp (E := E) p μ 𝕜 f :=
  rfl

@[simp]
theorem coe_toLp [Field 𝕜] [StrictNormedRing 𝕜] [NormedSpace 𝕜 E] (f : C(α, E)) :
...
variable (μ) [Field 𝕜] [NontriviallyNormedField 𝕜] [NormedSpace 𝕜 E]
