...
theorem edist_def (f g : α →₁[μ] β) : edist f g = ∫⁻ a, edist (f a) (g a) ∂μ := by
  simp only [Lp.edist_def, snorm, one_ne_zero, snorm', Pi.sub_apply, one_toReal, ENNReal.rpow_one, ne_eq,
...
theorem dist_def (f g : α →₁[μ] β) : dist f g = (∫⁻ a, edist (f a) (g a) ∂μ).toReal := by
  simp only [Lp.dist_def, snorm, one_ne_zero, snorm', Pi.sub_apply, one_toReal, ENNReal.rpow_one, ne_eq,
    not_false_eq_true, div_self, ite_false]
  simp [edist_eq_coe_nnnorm_sub]
...
theorem norm_toL1 (f : α → β) (hf : Integrable f μ) :
  ...
  simp only [toL1, Lp.norm_toLp, snorm, one_ne_zero, snorm', one_toReal, ENNReal.rpow_one, ne_eq, not_false_eq_true,
    div_self, ite_false]
...
theorem edist_toL1_toL1 (f g : α → β) (hf : Integrable f μ) (hg : Integrable g μ) :
  ...
  simp only [toL1, Lp.edist_toLp_toLp, snorm, one_ne_zero, snorm', Pi.sub_apply, one_toReal, ENNReal.rpow_one, ne_eq,
    not_false_eq_true, div_self, ite_false]
  simp [edist_eq_coe_nnnorm_sub]
...
theorem edist_toL1_zero (f : α → β) (hf : Integrable f μ) :
  ...
  simp only [toL1, Lp.edist_toLp_zero, snorm, one_ne_zero, snorm', one_toReal, ENNReal.rpow_one, ne_eq,
    not_false_eq_true, div_self, ite_false]
  simp [edist_eq_coe_nnnorm]
