...
variable {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] {μ : Measure α} {p : ℝ≥0∞}
...
variable (𝕜 : Type*) [NormMetric 𝕜] [Ring 𝕜] [IsNormedRing 𝕜] [Module 𝕜 E] [IsBoundedSMul 𝕜 E] [NormedSpace ℝ E]
