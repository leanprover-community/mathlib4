...
variable [MeasurableSpace β] [MeasurableSpace E] [AddCommGroup E] [NormedAddCommGroup E]
  [AddCommGroup F] [NormedAddCommGroup F] {q : ℝ} {p : ℝ≥0∞}
...
theorem _root_.MeasureTheory.MemLp.exists_simpleFunc_eLpNorm_sub_lt {E : Type*} [AddCommGroup E]
...
variable [MeasurableSpace α] [AddCommGroup E] [NormedAddCommGroup E] [AddCommGroup F]
  [NormedAddCommGroup F] (p : ℝ≥0∞) (μ : Measure α)
...
variable [MeasurableSpace α] [AddCommGroup E] [NormedAddCommGroup E] {f : α → E} {p : ℝ≥0∞}
  {μ : Measure α}
