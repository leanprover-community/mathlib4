...
variable {α F : Type*} {m : MeasurableSpace α} {μ : Measure α} [AddCommGroup F]
...
variable {α E F 𝕜 : Type*} [RCLike 𝕜] [MeasurableSpace α] {μ : Measure α} [AddCommGroup E]
  [NormedAddCommGroup E] [AddCommGroup F] [InnerProductSpace 𝕜 E] [NormedAddCommGroup F]
...
theorem inner_indicatorConstLp_eq_setIntegral_inner (f : Lp E 2 μ) (hs : MeasurableSet s) (c : E)
  ...
  refine integral_congr_ae ((@indicatorConstLp_coeFn _ _ _ 2 μ _ _ s hs hμs c).mono fun x hx ↦ ?_)
