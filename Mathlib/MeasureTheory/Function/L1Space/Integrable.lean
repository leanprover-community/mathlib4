...
theorem Integrable.smul_essSup {𝕜 : Type*} [NormedRing 𝕜] [MonoidActionWithZero 𝕜 β]
...
theorem _root_.IsUnit.integrable_smul_iff [NormedRing 𝕜] [MonoidActionWithZero 𝕜 β]
...
theorem integrable_smul_iff [NormedDivisionRing 𝕜] [MonoidActionWithZero 𝕜 β]
    [IsBoundedSMul 𝕜 β] {c : 𝕜} (hc : c ≠ 0) (f : α → β) :
    Integrable (c • f) μ ↔ Integrable f μ :=
  (IsUnit.mk0 _ hc).integrable_smul_iff f

theorem integrable_fun_smul_iff [NormedDivisionRing 𝕜] [MonoidActionWithZero 𝕜 β] [IsBoundedSMul 𝕜 β]
    {c : 𝕜} (hc : c ≠ 0) (f : α → β) :
    Integrable (fun x ↦ c • f x) μ ↔ Integrable f μ :=
