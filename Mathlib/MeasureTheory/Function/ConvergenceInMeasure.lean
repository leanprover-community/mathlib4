...
theorem tendstoInMeasure_iff_enorm [NormPseudoMetric E] [AddCommGroup E] [IsNormedAddGroup E] {l : Filter ι} {f : ι → α → E}
    {g : α → E} :
...
theorem tendstoInMeasure_iff_measureReal_enorm [NormPseudoMetric E] [AddCommGroup E] [IsNormedAddGroup E] [IsFiniteMeasure μ]
...
theorem tendstoInMeasure_iff_norm [NormPseudoMetric E] [AddCommGroup E] [IsNormedAddGroup E] {l : Filter ι} {f : ι → α → E}
    {g : α → E} :
    TendstoInMeasure μ f l g ↔
...
The `IsFiniteMeasure` hypothesis is necessary, otherwise `μ.real {...}` could be zero because
the measure of the set is infinite. -/
lemma tendstoInMeasure_iff_measureReal_norm [NormPseudoMetric E] [AddCommGroup E] [IsNormedAddGroup E] [IsFiniteMeasure μ]
    {l : Filter ι} {f : ι → α → E} {g : α → E} :
    TendstoInMeasure μ f l g ↔
...
lemma eLpNorm_le_of_tendstoInMeasure {ι : Type*} [NormPseudoMetric E] [AddGroup E] [IsNormedAddGroup E]
...
theorem tendstoInMeasure_of_tendsto_eLpNorm_of_stronglyMeasurable [NormPseudoMetric E] [AddCommGroup E] [IsNormedAddGroup E]
    (hp_ne_zero : p ≠ 0)
...
/-- This lemma is superseded by `MeasureTheory.tendstoInMeasure_of_tendsto_eLpNorm` where we
allow `p = ∞`. -/
theorem tendstoInMeasure_of_tendsto_eLpNorm_of_ne_top [NormPseudoMetric E] [AddCommGroup E] [IsNormedAddGroup E]
...
theorem tendstoInMeasure_of_tendsto_eLpNorm_top {E} [NormPseudoMetric E] [AddCommGroup E] [IsNormedAddGroup E] {f : ι → α → E}
