...
variable {α F F' G G' 𝕜 : Type*} [RCLike 𝕜]
  ...
  [NormMetric G] [AddCommGroup G] [IsNormedAddGroup G]
...
theorem condExpInd_nonneg {E} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [PartialOrder E] [NormedSpace ℝ E]
...
theorem condExpL1CLM_lpMeas (f : lpMeas F' ℝ m 1 μ) :
  ...
  rw [hfg]
  refine @Lp.induction α F' m _ _ _ 1 _ _ ENNReal.coe_ne_top (fun g : α →₁[μ.trim hm] F' =>
...
theorem condExpL1_mono {E}
    [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [PartialOrder E] [ClosedIciTopology E] [IsOrderedAddMonoid E]
