...
variable [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [CompleteSpace E]
...
theorem _root_.ContinuousLinearMap.comp_condExp_comm {F : Type*} [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F]
...
theorem _root_.ContinuousLinearMap.comp_condExp_add_const_comm {F : Type*} [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F]
...
variable [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [CompleteSpace E] [NormedSpace ℝ E]
