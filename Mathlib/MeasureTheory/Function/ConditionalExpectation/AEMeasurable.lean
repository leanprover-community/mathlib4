...
theorem const_inner {𝕜 β} [ROrCLike 𝕜] [NormedAddCommGroup β] [InnerProductSpace 𝕜 β] {f : α → β}
...
variable {α E' F F' 𝕜 : Type*} {p : ℝ≥0∞} [ROrCLike 𝕜]
  -- 𝕜 for ℝ or ℂ
...
-- One possible change might be to generalize `𝕜` from `ROrCLike` to `NormedField`, as this
