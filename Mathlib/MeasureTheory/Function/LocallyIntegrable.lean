...
theorem LocallyIntegrable.integrable_smul_left_of_hasCompactSupport
    {𝕜 : Type*} [NormedField 𝕜] [NormedSpace 𝕜 E] [OpensMeasurableSpace X] [T2Space X] {f : X → E}
    (hf : LocallyIntegrable f μ) {g : X → 𝕜} (hg : Continuous g) (h'g : HasCompactSupport g) :
...
theorem LocallyIntegrable.integrable_smul_right_of_hasCompactSupport
     {𝕜 : Type*} [NormedField 𝕜] [NormedSpace 𝕜 E] [OpensMeasurableSpace X] [T2Space X] {f : X → 𝕜}
    (hf : LocallyIntegrable f μ) {g : X → E} (hg : Continuous g) (h'g : HasCompactSupport g) :
