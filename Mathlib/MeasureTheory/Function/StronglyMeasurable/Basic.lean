...
theorem tendsto_approxBounded_of_norm_le {β} {f : α → β} [AddCommGroup β] [NormedAddGroup β]
    [NormedSpace ℝ β]
...
theorem tendsto_approxBounded_ae {β} {f : α → β} [AddCommGroup β] [NormedAddGroup β]
    [NormedSpace ℝ β]
...
theorem norm_approxBounded_le {β} {f : α → β} [AddCommGroup β] [SeminormedAddGroup β]
    [NormedSpace ℝ β]
...
@[measurability]
protected theorem norm {_ : MeasurableSpace α} {β : Type*} [AddCommGroup β] [SeminormedAddGroup β]
    {f : α → β}
    (hf : StronglyMeasurable f) : StronglyMeasurable fun x => ‖f x‖ :=
  continuous_norm.comp_stronglyMeasurable hf

@[measurability]
protected theorem nnnorm {_ : MeasurableSpace α} {β : Type*} [AddCommGroup β] [SeminormedAddGroup β]
    {f : α → β}
    (hf : StronglyMeasurable f) : StronglyMeasurable fun x => ‖f x‖₊ :=
...
protected theorem enorm {_ : MeasurableSpace α} {β : Type*} [AddCommGroup β] [SeminormedAddGroup β]
...
theorem exists_spanning_measurableSet_norm_le [AddCommGroup β] [SeminormedAddGroup β]
