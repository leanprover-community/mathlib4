...
protected lemma StronglyMeasurable.aestronglyMeasurable {α β} {_ : MeasurableSpace α}
...
@[simp]
lemma Subsingleton.stronglyMeasurable {α β} [MeasurableSpace α] [TopologicalSpace β]
...
lemma SimpleFunc.stronglyMeasurable {α β} {_ : MeasurableSpace α} [TopologicalSpace β]
...
lemma stronglyMeasurable_of_isEmpty [IsEmpty α] {_ : MeasurableSpace α} [TopologicalSpace β]
...
lemma stronglyMeasurable_const {α β} {_ : MeasurableSpace α} [TopologicalSpace β] {b : β} :
...
@[to_additive]
lemma stronglyMeasurable_one {α β} {_ : MeasurableSpace α} [TopologicalSpace β] [One β] :
...
lemma stronglyMeasurable_const' {α β} {m : MeasurableSpace α} [TopologicalSpace β] {f : α → β}
...
protected lemma tendsto_approx {_ : MeasurableSpace α} (hf : StronglyMeasurable f) :
    ∀ x, Tendsto (fun n => hf.approx n x) atTop (𝓝 (f x)) :=
  hf.choose_spec
...
lemma tendsto_approxBounded_of_norm_le {β} {f : α → β} [NormedAddCommGroup β] [NormedSpace ℝ β]
...
lemma tendsto_approxBounded_ae {β} {f : α → β} [NormedAddCommGroup β] [NormedSpace ℝ β]
...
lemma norm_approxBounded_le {β} {f : α → β} [SeminormedAddCommGroup β] [NormedSpace ℝ β]
...
lemma _root_.stronglyMeasurable_bot_iff [Nonempty β] [T2Space β] :
...
lemma finStronglyMeasurable_of_set_sigmaFinite [TopologicalSpace β] [Zero β]
...
protected lemma finStronglyMeasurable [TopologicalSpace β] [Zero β] {m0 : MeasurableSpace α}
...
@[aesop 5% apply (rule_sets [Measurable])]
protected lemma measurable {_ : MeasurableSpace α} [TopologicalSpace β] [PseudoMetrizableSpace β]
...
@[aesop 5% apply (rule_sets [Measurable])]
protected lemma aemeasurable {_ : MeasurableSpace α} [TopologicalSpace β]
...
lemma _root_.Continuous.comp_stronglyMeasurable {_ : MeasurableSpace α} [TopologicalSpace β]
...
@[to_additive]
nonrec lemma measurableSet_mulSupport {m : MeasurableSpace α} [One β] [TopologicalSpace β]
...
protected lemma mono {m m' : MeasurableSpace α} [TopologicalSpace β]
...
protected lemma prod_mk {m : MeasurableSpace α} [TopologicalSpace β] [TopologicalSpace γ]
...
lemma comp_measurable [TopologicalSpace β] {_ : MeasurableSpace α} {_ : MeasurableSpace γ}
...
lemma of_uncurry_left [TopologicalSpace β] {_ : MeasurableSpace α} {_ : MeasurableSpace γ}
...
lemma of_uncurry_right [TopologicalSpace β] {_ : MeasurableSpace α} {_ : MeasurableSpace γ}
...
protected lemma mul [Mul β] [ContinuousMul β] (hf : StronglyMeasurable f)
...
lemma mul_const [Mul β] [ContinuousMul β] (hf : StronglyMeasurable f) (c : β) :
...
@[to_additive (attr := measurability)]
lemma const_mul [Mul β] [ContinuousMul β] (hf : StronglyMeasurable f) (c : β) :
...
@[to_additive (attr := measurability)]
protected lemma inv [Inv β] [ContinuousInv β] (hf : StronglyMeasurable f) :
...
@[to_additive (attr := aesop safe 20 apply (rule_sets [Measurable]))]
protected lemma div [Div β] [ContinuousDiv β] (hf : StronglyMeasurable f)
    (hg : StronglyMeasurable g) : StronglyMeasurable (f / g) :=
...
@[to_additive (attr := aesop safe 20 apply (rule_sets [Measurable]))]
protected lemma smul {𝕜} [TopologicalSpace 𝕜] [SMul 𝕜 β] [ContinuousSMul 𝕜 β] {f : α → 𝕜}
...
@[measurability]
protected lemma const_smul {𝕜} [SMul 𝕜 β] [ContinuousConstSMul 𝕜 β] (hf : StronglyMeasurable f)
...
@[to_additive (attr := measurability)]
protected lemma smul_const {𝕜} [TopologicalSpace 𝕜] [SMul 𝕜 β] [ContinuousSMul 𝕜 β] {f : α → 𝕜}
...
lemma _root_.stronglyMeasurable_const_smul_iff {m : MeasurableSpace α} (c : G) :
...
nonrec lemma _root_.IsUnit.stronglyMeasurable_const_smul_iff {_ : MeasurableSpace α} {c : M}
    (hc : IsUnit c) :
    (StronglyMeasurable fun x => c • f x) ↔ StronglyMeasurable f :=
  let ⟨u, hu⟩ := hc
...
lemma _root_.stronglyMeasurable_const_smul_iff₀ {_ : MeasurableSpace α} {c : G₀} (hc : c ≠ 0) :
    (StronglyMeasurable fun x => c • f x) ↔ StronglyMeasurable f :=
...
protected lemma sup [Sup β] [ContinuousSup β] (hf : StronglyMeasurable f)
    (hg : StronglyMeasurable g) : StronglyMeasurable (f ⊔ g) :=
...
@[aesop safe 20 (rule_sets [Measurable])]
protected lemma inf [Inf β] [ContinuousInf β] (hf : StronglyMeasurable f)
    (hg : StronglyMeasurable g) : StronglyMeasurable (f ⊓ g) :=
  ⟨fun n => hf.approx n ⊓ hg.approx n, fun x =>
...
@[to_additive (attr := measurability)]
lemma _root_.Finset.stronglyMeasurable_prod' {ι : Type*} {f : ι → α → M} (s : Finset ι)
...
lemma isSeparable_range {m : MeasurableSpace α} [TopologicalSpace β] (hf : StronglyMeasurable f) :
...
lemma separableSpace_range_union_singleton {_ : MeasurableSpace α} [TopologicalSpace β]
...
lemma _root_.Measurable.stronglyMeasurable [TopologicalSpace β] [PseudoMetrizableSpace β]
...
lemma _root_.stronglyMeasurable_iff_measurable [TopologicalSpace β] [MetrizableSpace β]
...
@[measurability]
lemma _root_.stronglyMeasurable_id [TopologicalSpace α] [PseudoMetrizableSpace α]
...
range. -/
lemma _root_.stronglyMeasurable_iff_measurable_separable {m : MeasurableSpace α}
...
is second-countable. -/
lemma _root_.Continuous.stronglyMeasurable [MeasurableSpace α] [TopologicalSpace α]
...
lemma _root_.Embedding.comp_stronglyMeasurable_iff {m : MeasurableSpace α} [TopologicalSpace β]
...
lemma _root_.stronglyMeasurable_of_tendsto {ι : Type*} {m : MeasurableSpace α}
...
protected lemma piecewise {m : MeasurableSpace α} [TopologicalSpace β] {s : Set α}
...
protected lemma ite {_ : MeasurableSpace α} [TopologicalSpace β] {p : α → Prop}
...
lemma _root_.stronglyMeasurable_of_stronglyMeasurable_union_cover {m : MeasurableSpace α}
...
lemma _root_.stronglyMeasurable_of_restrict_of_restrict_compl {_ : MeasurableSpace α}
...
@[measurability]
protected lemma indicator {_ : MeasurableSpace α} [TopologicalSpace β] [Zero β]
...
protected lemma dist {_ : MeasurableSpace α} {β : Type*} [PseudoMetricSpace β] {f g : α → β}
...
@[measurability]
protected lemma norm {_ : MeasurableSpace α} {β : Type*} [SeminormedAddCommGroup β] {f : α → β}
...
@[measurability]
protected lemma nnnorm {_ : MeasurableSpace α} {β : Type*} [SeminormedAddCommGroup β] {f : α → β}
    (hf : StronglyMeasurable f) : StronglyMeasurable fun x => ‖f x‖₊ :=
...
@[measurability]
protected lemma ennnorm {_ : MeasurableSpace α} {β : Type*} [SeminormedAddCommGroup β]
...
@[measurability]
protected lemma real_toNNReal {_ : MeasurableSpace α} {f : α → ℝ} (hf : StronglyMeasurable f) :
...
@[measurability]
lemma _root_.MeasurableEmbedding.stronglyMeasurable_extend {f : α → β} {g : α → γ} {g' : γ → β}
...
lemma _root_.MeasurableEmbedding.exists_stronglyMeasurable_extend {f : α → β} {g : α → γ}
...
lemma measurableSet_eq_fun {m : MeasurableSpace α} {E} [TopologicalSpace E] [MetrizableSpace E]
...
lemma measurableSet_lt {m : MeasurableSpace α} [TopologicalSpace β] [LinearOrder β]
...
lemma measurableSet_le {m : MeasurableSpace α} [TopologicalSpace β] [Preorder β]
    [OrderClosedTopology β] [PseudoMetrizableSpace β] {f g : α → β} (hf : StronglyMeasurable f)
    (hg : StronglyMeasurable g) : MeasurableSet { a | f a ≤ g a } := by
  borelize (β × β)
...
lemma stronglyMeasurable_in_set {m : MeasurableSpace α} [TopologicalSpace β] [Zero β] {s : Set α}
...
lemma stronglyMeasurable_of_measurableSpace_le_on {α E} {m m₂ : MeasurableSpace α}
...
lemma exists_spanning_measurableSet_norm_le [SeminormedAddCommGroup β] {m m0 : MeasurableSpace α}
...
lemma finStronglyMeasurable_zero {α β} {m : MeasurableSpace α} {μ : Measure α} [Zero β]
...
lemma aefinStronglyMeasurable [Zero β] [TopologicalSpace β] (hf : FinStronglyMeasurable f μ) :
...
protected lemma fin_support_approx : ∀ n, μ (support (hf.approx n)) < ∞ :=
  hf.choose_spec.1
#align measure_theory.fin_strongly_measurable.fin_support_approx MeasureTheory.FinStronglyMeasurable.fin_support_approx

protected lemma tendsto_approx : ∀ x, Tendsto (fun n => hf.approx n x) atTop (𝓝 (f x)) :=
  hf.choose_spec.2
...
@[aesop 5% apply (rule_sets [Measurable])]
protected lemma stronglyMeasurable [Zero β] [TopologicalSpace β]
...
lemma exists_set_sigmaFinite [Zero β] [TopologicalSpace β] [T2Space β]
...
protected lemma measurable [Zero β] [TopologicalSpace β] [PseudoMetrizableSpace β]
...
@[aesop safe 20 (rule_sets [Measurable])]
protected lemma mul [MonoidWithZero β] [ContinuousMul β] (hf : FinStronglyMeasurable f μ)
...
@[aesop safe 20 (rule_sets [Measurable])]
protected lemma add [AddMonoid β] [ContinuousAdd β] (hf : FinStronglyMeasurable f μ)
...
@[measurability]
protected lemma neg [AddGroup β] [TopologicalAddGroup β] (hf : FinStronglyMeasurable f μ) :
    FinStronglyMeasurable (-f) μ := by
...
@[measurability]
protected lemma sub [AddGroup β] [ContinuousSub β] (hf : FinStronglyMeasurable f μ)
    (hg : FinStronglyMeasurable g μ) : FinStronglyMeasurable (f - g) μ :=
  ⟨fun n => hf.approx n - hg.approx n, fun n =>
...
@[measurability]
protected lemma const_smul {𝕜} [TopologicalSpace 𝕜] [AddMonoid β] [Monoid 𝕜]
...
@[aesop safe 20 (rule_sets [Measurable])]
protected lemma sup [SemilatticeSup β] [ContinuousSup β] (hf : FinStronglyMeasurable f μ)
    (hg : FinStronglyMeasurable g μ) : FinStronglyMeasurable (f ⊔ g) μ := by
  refine'
...
@[aesop safe 20 (rule_sets [Measurable])]
protected lemma inf [SemilatticeInf β] [ContinuousInf β] (hf : FinStronglyMeasurable f μ)
    (hg : FinStronglyMeasurable g μ) : FinStronglyMeasurable (f ⊓ g) μ := by
  refine'
    ⟨fun n => hf.approx n ⊓ hg.approx n, fun n => _, fun x =>
      (hf.tendsto_approx x).inf_right_nhds (hg.tendsto_approx x)⟩
...
lemma finStronglyMeasurable_iff_stronglyMeasurable_and_exists_set_sigmaFinite {α β} {f : α → β}
...
lemma aefinStronglyMeasurable_zero {α β} {_ : MeasurableSpace α} (μ : Measure α) [Zero β]
...
@[measurability]
lemma aestronglyMeasurable_const {α β} {_ : MeasurableSpace α} {μ : Measure α}
...
@[to_additive (attr := measurability)]
lemma aestronglyMeasurable_one {α β} {_ : MeasurableSpace α} {μ : Measure α} [TopologicalSpace β]
...
@[simp]
lemma Subsingleton.aestronglyMeasurable {_ : MeasurableSpace α} [TopologicalSpace β]
...
@[simp]
lemma aestronglyMeasurable_zero_measure [MeasurableSpace α] [TopologicalSpace β] (f : α → β) :
...
@[measurability]
lemma SimpleFunc.aestronglyMeasurable {_ : MeasurableSpace α} {μ : Measure α} [TopologicalSpace β]
...
lemma measurable_mk [PseudoMetrizableSpace β] [MeasurableSpace β] [BorelSpace β]
...
@[aesop 5% apply (rule_sets [Measurable])]
protected lemma aemeasurable {β} [MeasurableSpace β] [TopologicalSpace β]
...
lemma mono_measure {ν : Measure α} (hf : AEStronglyMeasurable f μ) (h : ν ≤ μ) :
...
protected lemma mono' {ν : Measure α} (h : AEStronglyMeasurable f μ) (h' : ν ≪ μ) :
    AEStronglyMeasurable f ν :=
...
lemma mono_set {s t} (h : s ⊆ t) (ht : AEStronglyMeasurable f (μ.restrict t)) :
...
lemma ae_mem_imp_eq_mk {s} (h : AEStronglyMeasurable f (μ.restrict s)) :
...
second countable. -/
lemma _root_.Continuous.aestronglyMeasurable [TopologicalSpace α] [OpensMeasurableSpace α]
...
protected lemma prod_mk {f : α → β} {g : α → γ} (hf : AEStronglyMeasurable f μ)
...
lemma _root_.Measurable.aestronglyMeasurable {_ : MeasurableSpace α} {μ : Measure α}
...
@[to_additive (attr := aesop safe 20 apply (rule_sets [Measurable]))]
protected lemma mul [Mul β] [ContinuousMul β] (hf : AEStronglyMeasurable f μ)
...
@[to_additive (attr := measurability)]
protected lemma mul_const [Mul β] [ContinuousMul β] (hf : AEStronglyMeasurable f μ) (c : β) :
...
@[to_additive (attr := measurability)]
protected lemma const_mul [Mul β] [ContinuousMul β] (hf : AEStronglyMeasurable f μ) (c : β) :
...
@[to_additive (attr := measurability)]
protected lemma inv [Inv β] [ContinuousInv β] (hf : AEStronglyMeasurable f μ) :
    AEStronglyMeasurable f⁻¹ μ :=
...
@[to_additive (attr := aesop safe 20 apply (rule_sets [Measurable]))]
protected lemma div [Group β] [TopologicalGroup β] (hf : AEStronglyMeasurable f μ)
    (hg : AEStronglyMeasurable g μ) : AEStronglyMeasurable (f / g) μ :=
...
@[measurability]
protected lemma const_smul {𝕜} [SMul 𝕜 β] [ContinuousConstSMul 𝕜 β]
...
@[aesop safe 20 apply (rule_sets [Measurable])]
protected lemma sup [SemilatticeSup β] [ContinuousSup β] (hf : AEStronglyMeasurable f μ)
    (hg : AEStronglyMeasurable g μ) : AEStronglyMeasurable (f ⊔ g) μ :=
...
@[aesop safe 20 apply (rule_sets [Measurable])]
protected lemma inf [SemilatticeInf β] [ContinuousInf β] (hf : AEStronglyMeasurable f μ)
    (hg : AEStronglyMeasurable g μ) : AEStronglyMeasurable (f ⊓ g) μ :=
...
@[to_additive (attr := measurability)]
lemma _root_.Finset.aestronglyMeasurable_prod' {ι : Type*} {f : ι → α → M} (s : Finset ι)
...
/-- In a space with second countable topology, measurable implies strongly measurable. -/
@[aesop 90% apply (rule_sets [Measurable])]
lemma _root_.AEMeasurable.aestronglyMeasurable [PseudoMetrizableSpace β] [OpensMeasurableSpace β]
...
@[measurability]
lemma _root_.aestronglyMeasurable_id {α : Type*} [TopologicalSpace α] [PseudoMetrizableSpace α]
...
/-- In a space with second countable topology, strongly measurable and measurable are equivalent. -/
lemma _root_.aestronglyMeasurable_iff_aemeasurable [PseudoMetrizableSpace β] [BorelSpace β]
...
@[aesop safe 20 apply (rule_sets [Measurable])]
protected lemma dist {β : Type*} [PseudoMetricSpace β] {f g : α → β}
...
@[measurability]
protected lemma norm {β : Type*} [SeminormedAddCommGroup β] {f : α → β}
...
@[measurability]
protected lemma nnnorm {β : Type*} [SeminormedAddCommGroup β] {f : α → β}
    (hf : AEStronglyMeasurable f μ) : AEStronglyMeasurable (fun x => ‖f x‖₊) μ :=
...
@[measurability]
protected lemma ennnorm {β : Type*} [SeminormedAddCommGroup β] {f : α → β}
...
@[aesop safe 20 apply (rule_sets [Measurable])]
protected lemma edist {β : Type*} [SeminormedAddCommGroup β] {f g : α → β}
    (hf : AEStronglyMeasurable f μ) (hg : AEStronglyMeasurable g μ) :
...
@[measurability]
protected lemma real_toNNReal {f : α → ℝ} (hf : AEStronglyMeasurable f μ) :
...
lemma _root_.aestronglyMeasurable_indicator_iff [Zero β] {s : Set α} (hs : MeasurableSet s) :
...
@[measurability]
protected lemma indicator [Zero β] (hfm : AEStronglyMeasurable f μ) {s : Set α}
...
lemma nullMeasurableSet_eq_fun {E} [TopologicalSpace E] [MetrizableSpace E] {f g : α → E}
    (hf : AEStronglyMeasurable f μ) (hg : AEStronglyMeasurable g μ) :
...
lemma nullMeasurableSet_lt [LinearOrder β] [OrderClosedTopology β] [PseudoMetrizableSpace β]
...
lemma nullMeasurableSet_le [Preorder β] [OrderClosedTopology β] [PseudoMetrizableSpace β]
    {f g : α → β} (hf : AEStronglyMeasurable f μ) (hg : AEStronglyMeasurable g μ) :
    NullMeasurableSet { a | f a ≤ g a } μ := by
  apply
...
lemma _root_.aestronglyMeasurable_of_aestronglyMeasurable_trim {α} {m m0 : MeasurableSpace α}
...
lemma comp_aemeasurable {γ : Type*} {_ : MeasurableSpace γ} {_ : MeasurableSpace α} {f : γ → α}
...
lemma comp_measurable {γ : Type*} {_ : MeasurableSpace γ} {_ : MeasurableSpace α} {f : γ → α}
...
lemma comp_quasiMeasurePreserving {γ : Type*} {_ : MeasurableSpace γ} {_ : MeasurableSpace α}
...
lemma comp_measurePreserving {γ : Type*} {_ : MeasurableSpace γ} {_ : MeasurableSpace α}
    {f : γ → α} {μ : Measure γ} {ν : Measure α} (hg : AEStronglyMeasurable g ν)
...
lemma _root_.aestronglyMeasurable_iff_aemeasurable_separable [PseudoMetrizableSpace β]
...
lemma _root_.MeasurableEmbedding.aestronglyMeasurable_map_iff {γ : Type*}
...
lemma _root_.Embedding.aestronglyMeasurable_comp_iff [PseudoMetrizableSpace β]
...
lemma _root_.MeasureTheory.MeasurePreserving.aestronglyMeasurable_comp_iff {β : Type*}
...
lemma _root_.aestronglyMeasurable_of_tendsto_ae {ι : Type*} [PseudoMetrizableSpace β]
...
lemma _root_.exists_stronglyMeasurable_limit_of_tendsto_ae [PseudoMetrizableSpace β]
...
lemma sum_measure [PseudoMetrizableSpace β] {m : MeasurableSpace α} {μ : ι → Measure α}
...
@[simp]
lemma _root_.aestronglyMeasurable_sum_measure_iff [PseudoMetrizableSpace β]
...
@[simp]
lemma _root_.aestronglyMeasurable_add_measure_iff [PseudoMetrizableSpace β] {ν : Measure α} :
...
@[measurability]
lemma add_measure [PseudoMetrizableSpace β] {ν : Measure α} {f : α → β}
...
@[measurability]
protected lemma iUnion [PseudoMetrizableSpace β] {s : ι → Set α}
...
@[simp]
lemma _root_.aestronglyMeasurable_iUnion_iff [PseudoMetrizableSpace β] {s : ι → Set α} :
    AEStronglyMeasurable f (μ.restrict (⋃ i, s i)) ↔
...
@[simp]
lemma _root_.aestronglyMeasurable_union_iff [PseudoMetrizableSpace β] {s t : Set α} :
...
lemma aestronglyMeasurable_uIoc_iff [LinearOrder α] [PseudoMetrizableSpace β] {f : α → β}
    {a b : α} :
...
@[measurability]
lemma smul_measure {R : Type*} [Monoid R] [DistribMulAction R ℝ≥0∞] [IsScalarTower R ℝ≥0∞ ℝ≥0∞]
...
lemma _root_.aestronglyMeasurable_smul_const_iff {f : α → 𝕜} {c : E} (hc : c ≠ 0) :
...
nonrec lemma _root_.IsUnit.aestronglyMeasurable_const_smul_iff {c : M} (hc : IsUnit c) :
    AEStronglyMeasurable (fun x => c • f x) μ ↔ AEStronglyMeasurable f μ :=
  let ⟨u, hu⟩ := hc
...
lemma _root_.aestronglyMeasurable_const_smul_iff₀ {c : G₀} (hc : c ≠ 0) :
    AEStronglyMeasurable (fun x => c • f x) μ ↔ AEStronglyMeasurable f μ :=
...
lemma _root_.StronglyMeasurable.apply_continuousLinearMap {_m : MeasurableSpace α}
    {φ : α → F →L[𝕜] E}
...
@[measurability]
lemma apply_continuousLinearMap {φ : α → F →L[𝕜] E} (hφ : AEStronglyMeasurable φ μ) (v : F) :
...
lemma _root_.aestronglyMeasurable_withDensity_iff {E : Type*} [NormedAddCommGroup E]
...
protected lemma aemeasurable {β} [Zero β] [MeasurableSpace β] [TopologicalSpace β]
...
@[aesop safe 20 (rule_sets [Measurable])]
protected lemma mul [MonoidWithZero β] [ContinuousMul β] (hf : AEFinStronglyMeasurable f μ)
...
@[aesop safe 20 (rule_sets [Measurable])]
protected lemma add [AddMonoid β] [ContinuousAdd β] (hf : AEFinStronglyMeasurable f μ)
    (hg : AEFinStronglyMeasurable g μ) : AEFinStronglyMeasurable (f + g) μ :=
...
@[measurability]
protected lemma neg [AddGroup β] [TopologicalAddGroup β] (hf : AEFinStronglyMeasurable f μ) :
    AEFinStronglyMeasurable (-f) μ :=
...
@[measurability]
protected lemma sub [AddGroup β] [ContinuousSub β] (hf : AEFinStronglyMeasurable f μ)
    (hg : AEFinStronglyMeasurable g μ) : AEFinStronglyMeasurable (f - g) μ :=
...
@[aesop safe 20 (rule_sets [Measurable])]
protected lemma sup [SemilatticeSup β] [ContinuousSup β] (hf : AEFinStronglyMeasurable f μ)
    (hg : AEFinStronglyMeasurable g μ) : AEFinStronglyMeasurable (f ⊔ g) μ :=
...
@[aesop safe 20 (rule_sets [Measurable])]
protected lemma inf [SemilatticeInf β] [ContinuousInf β] (hf : AEFinStronglyMeasurable f μ)
    (hg : AEFinStronglyMeasurable g μ) : AEFinStronglyMeasurable (f ⊓ g) μ :=
...
lemma finStronglyMeasurable_iff_measurable {_m0 : MeasurableSpace α} (μ : Measure α)
...
@[aesop 90% apply (rule_sets [Measurable])]
lemma finStronglyMeasurable_of_measurable {_m0 : MeasurableSpace α} (μ : Measure α)
...
lemma aefinStronglyMeasurable_iff_aemeasurable {_m0 : MeasurableSpace α} (μ : Measure α)
...
@[aesop 90% apply (rule_sets [Measurable])]
lemma aefinStronglyMeasurable_of_aemeasurable {_m0 : MeasurableSpace α} (μ : Measure α)
    [SigmaFinite μ] (hf : AEMeasurable f μ) : AEFinStronglyMeasurable f μ :=
  (aefinStronglyMeasurable_iff_aemeasurable μ).mpr hf

end SecondCountableTopology

lemma measurable_uncurry_of_continuous_of_measurable {α β ι : Type*} [TopologicalSpace ι]
...
lemma stronglyMeasurable_uncurry_of_continuous_of_stronglyMeasurable {α β ι : Type*}
