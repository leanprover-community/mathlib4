...
theorem eLpNorm_indicator_sub_le_of_dist_bdd {β : Type*} [NormMetric β] [AddCommGroup β] [IsNormedAddGroup β]
...
theorem eLpNorm_sub_le_of_dist_bdd {β : Type*} [NormMetric β] [AddCommGroup β] [IsNormedAddGroup β]
...
theorem MemLp.exists_eLpNorm_indicator_compl_lt {β : Type*} [NormMetric β] [AddCommGroup β] [IsNormedAddGroup β] (hp_top : p ≠ ∞)
