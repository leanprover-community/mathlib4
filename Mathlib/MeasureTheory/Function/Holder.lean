...
variable {α 𝕜 E F G : Type*} {m : MeasurableSpace α} {μ : Measure α}
    {p q r : ENNReal} [hpqr : HolderTriple p q r] [NontriviallyNormedField 𝕜] [AddCommGroup E]
    [NormedAddCommGroup E] [AddCommGroup F] [NormedAddCommGroup F] [AddCommGroup G]
...
variable [NormedRing 𝕜] [AddCommGroup E] [NormedAddCommGroup E] [Module 𝕜 E] [IsBoundedSMul 𝕜 E]
