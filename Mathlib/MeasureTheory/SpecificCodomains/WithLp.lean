...
variable {ι : Type*} [Fintype ι] {E : ι → Type*} [∀ i, AddCommGroup (E i)] [∀ i, NormedAddCommGroup (E i)] {f : X → PiLp q E}
...
variable {E F : Type*} [AddCommGroup E] [NormedAddCommGroup E] [AddCommGroup F] [NormedAddCommGroup F] {f : X → WithLp q (E × F)}
