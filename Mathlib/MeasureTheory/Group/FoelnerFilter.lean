...
noncomputable def MeasureTheory.mean (s : Set X) :=
...
@[to_additive]
theorem IsFoelner.tendsto_meas_smul_symmDiff_smul [SMulInvariantMeasure G X μ]
...
@[to_additive amenable_of_maxAddFoelner_ne_bot]
