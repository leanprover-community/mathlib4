...
@[to_additive]
lemma inv_def (μ : Measure G) : μ.inv = Measure.map inv μ := rfl
...
@[to_additive]
lemma regular_inv_iff : μ.inv.Regular ↔ μ.Regular :=
...
@[to_additive]
lemma innerRegular_inv_iff : μ.inv.InnerRegular ↔ μ.InnerRegular :=
