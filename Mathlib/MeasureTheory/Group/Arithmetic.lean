...
@[to_additive] -- See note [lowerInstancePriority]
...
@[to_additive DiscreteMeasurableSpace.toMeasurableAdd₂] -- See note [lowerInstancePriority]
...
@[to_additive DiscreteMeasurableSpace.toMeasurableSub₂] -- See note [lowerInstancePriority]
