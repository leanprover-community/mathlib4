...
lattice point of `L`. -/
theorem exists_ne_zero_mem_lattice_of_measure_mul_two_pow_lt_measure [AddCommGroup E] [NormedAddCommGroup E]
...
inequality. -/
theorem exists_ne_zero_mem_lattice_of_measure_mul_two_pow_le_measure [AddCommGroup E] [NormedAddCommGroup E]
