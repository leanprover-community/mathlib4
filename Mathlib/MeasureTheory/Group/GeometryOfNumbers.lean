...
lattice point of `L`. -/
theorem exists_ne_zero_mem_lattice_of_measure_mul_two_pow_lt_measure [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
...
inequality. -/
theorem exists_ne_zero_mem_lattice_of_measure_mul_two_pow_le_measure [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
