...
@[deprecated (since := "2024-10-04")] alias sFiniteSeq := sfiniteSeq
...
@[deprecated (since := "2024-10-04")] alias sum_sFiniteSeq := sum_sfiniteSeq

lemma sfiniteSeq_le (μ : Measure α) [SFinite μ] (n : ℕ) : sfiniteSeq μ n ≤ μ :=
  (le_sum _ n).trans (sum_sfiniteSeq μ).le

@[deprecated (since := "2024-10-04")] alias sFiniteSeq_le := sfiniteSeq_le
...
@[deprecated (since := "2024-10-04")] alias sFiniteSeq_zero := sfiniteSeq_zero
