...
/-- At a point of positive `ν`-mass, the Radon-Nikodym derivative is the ratio of the
singleton masses. -/
lemma rnDeriv_eq_div_measure_singleton [MeasurableSingletonClass α] [HaveLebesgueDecomposition μ ν]
