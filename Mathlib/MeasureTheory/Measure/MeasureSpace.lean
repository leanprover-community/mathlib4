...
theorem measure_iInter_eq_iInf_measure_iInter_le {α ι : Type*} [MeasurableSpace α] {μ : Measure α}
...
theorem tendsto_measure_iInter_atTop [Preorder ι] [IsDirected ι (· ≤ ·)]
...
theorem tendsto_measure_iInter_le {α ι : Type*} [MeasurableSpace α] {μ : Measure α} [Countable ι]
