...
theorem _root_.Monotone.measure_iUnion [Preorder ι] [IsDirectedLE ι]
...
theorem _root_.Antitone.measure_iUnion [Preorder ι] [IsDirectedGE ι]
...
theorem measure_iUnion_eq_iSup_accumulate [Preorder ι] [IsDirectedLE ι]
...
theorem _root_.Monotone.measure_iInter [Preorder ι] [IsDirectedGE ι]
...
is equal to the infimum of the measures. -/
theorem _root_.Antitone.measure_iInter [Preorder ι] [IsDirectedLE ι]
...
theorem measure_iInter_eq_iInf_measure_iInter_le {α ι : Type*} {_ : MeasurableSpace α}
    {μ : Measure α} [Countable ι] [Preorder ι] [IsDirectedLE ι]
