...
-- Need to specify `α := Set α` below because of diamond; see leanprover-community/mathlib#16932
...
-- Need to specify `α := Set α` above because of diamond; see leanprover-community/mathlib#16932
