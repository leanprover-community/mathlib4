...
lemma charFun_map_smul_comp {X : Type*} {mX : MeasurableSpace X} {μ : Measure X} [IsFiniteMeasure μ]
...
lemma charFun_map_mul_comp {X : Type*} {mX : MeasurableSpace X} {μ : Measure X} [IsFiniteMeasure μ]
