...
-/
instance Measure.instCoeFun [MeasurableSpace α] : CoeFun (Measure α) fun _ => Set α → ℝ≥0∞ := fast_instance%
...
-- instance aeIsMeasurablyGenerated : IsMeasurablyGenerated μ.ae := fast_instance%
-- ⟨fun s hs => let ⟨t, hst, htm, htμ⟩ := exists_measurable_superset_of_null hs;
--   ⟨tᶜ, compl_mem_ae_iff.2 htμ, htm.compl, compl_subset_comm.1 hst⟩⟩

instance instCountableInterFilter : CountableInterFilter μ.ae := fast_instance% by
