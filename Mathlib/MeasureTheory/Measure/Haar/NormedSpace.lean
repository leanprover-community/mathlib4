...
example {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E] [Nontrivial E] [FiniteDimensional ℝ E]
...
variable {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E] [MeasurableSpace E] [BorelSpace E]
  [FiniteDimensional ℝ E] (μ : Measure E) [IsAddHaarMeasure μ] {F : Type*} [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F]
  [NormedSpace ℝ F]
...
variable {F : Type*} [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F]

theorem integrable_comp_smul_iff {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E]
...
theorem Integrable.comp_smul {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E]
    [MeasurableSpace E] [BorelSpace E] [FiniteDimensional ℝ E] {μ : Measure E} [IsAddHaarMeasure μ]
...
variable [NormMetric F'] [AddCommGroup F'] [IsNormedAddGroup F'] [InnerProductSpace ℝ F'] [FiniteDimensional ℝ F']
  [MeasurableSpace F'] [BorelSpace F']

variable (f : E' ≃ₗᵢ[ℝ] F')
variable [NormMetric A] [AddCommGroup A] [IsNormedAddGroup A]
