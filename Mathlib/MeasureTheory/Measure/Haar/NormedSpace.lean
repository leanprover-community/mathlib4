...
continuous. -/
lemma AddMonoidHom.continuous_of_measurable {G H : Type*} [AddCommGroup G]
    ...
    [NormedSpace ℝ H] (f : G →+ H) (hf : Measurable f) : Continuous f :=
...
variable {E : Type*} [AddCommGroup E] [NormedAddCommGroup E] [NormedSpace ℝ E] [MeasurableSpace E]
  [BorelSpace E] [FiniteDimensional ℝ E] (μ : Measure E) [IsAddHaarMeasure μ] {F : Type*}
...
theorem Integrable.comp_smul {E : Type*} [AddCommGroup E] [NormedAddCommGroup E] [NormedSpace ℝ E]
    [MeasurableSpace E] [BorelSpace E] [FiniteDimensional ℝ E] {μ : Measure E} [IsAddHaarMeasure μ]
...
variable {E' F' A : Type*}
variable [AddCommGroup E'] [NormedAddCommGroup E'] [InnerProductSpace ℝ E'] [FiniteDimensional ℝ E']
  [MeasurableSpace E'] [BorelSpace E']
variable [AddCommGroup F'] [NormedAddCommGroup F'] [InnerProductSpace ℝ F'] [FiniteDimensional ℝ F']
  [MeasurableSpace F'] [BorelSpace F']

variable (f : E' ≃ₗᵢ[ℝ] F')
variable [AddCommGroup A] [NormedAddCommGroup A]
