...
-/
instance (priority := 100) measureSpaceOfInnerProductSpace [AddCommGroup E] [NormedAddGroup E]
    [InnerProductSpace ℝ E] [FiniteDimensional ℝ E] [MeasurableSpace E] [BorelSpace E] :
    MeasureSpace E where volume := (stdOrthonormalBasis ℝ E).toBasis.addHaar

instance [AddCommGroup E] [NormedAddGroup E] [InnerProductSpace ℝ E] [FiniteDimensional ℝ E]
