...
theorem Real.integrable_of_summable_norm_Icc {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] {f : C(ℝ, E)}
...
@[simp]
theorem integral_comp_neg_Iic {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E]
...
@[simp]
theorem integral_comp_neg_Ioi {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E]
