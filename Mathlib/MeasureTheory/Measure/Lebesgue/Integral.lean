...
theorem Real.integrable_of_summable_norm_Icc {E : Type*}
    [AddCommGroup E] [NormedAddGroup E] {f : C(ℝ, E)}
...
theorem integral_comp_neg_Iic {E : Type*} [AddCommGroup E] [NormedAddGroup E] [NormedSpace ℝ E]
...
/- @[simp] Porting note: Linter complains it does not apply to itself. Although it does apply to
itself, it does not apply when `f` is more complicated -/
theorem integral_comp_neg_Ioi {E : Type*} [AddCommGroup E] [NormedAddGroup E] [NormedSpace ℝ E]
