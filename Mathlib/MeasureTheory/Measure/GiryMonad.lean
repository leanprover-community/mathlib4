...
instance (priority := 10000) instMeasurableSpace : MeasurableSpace (Measure α) :=
...
instance (priority := 10000) instMeasurableAdd₂ {α : Type*} {m : MeasurableSpace α} : MeasurableAdd₂ (Measure α) := by
