...
theorem hausdorffMeasure_smul_right_image [AddCommGroup E] [NormedAddGroup E] [NormedSpace ℝ E]
...
variable [AddCommGroup E] [NormedAddGroup E] [NormedSpace ℝ E] [MeasurableSpace P]
variable [MetricSpace P] [NormedAddTorsor E P] [BorelSpace P]
...
/-- The measure of a segment is the distance between its endpoints. -/
@[simp]
theorem hausdorffMeasure_segment {E : Type*} [AddCommGroup E] [NormedAddGroup E] [NormedSpace ℝ E]
