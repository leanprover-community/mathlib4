...
if __name__ == '__main__':
    ...
    # Read in all #align statements, parse the names of the old and new declaration;
    # add any old declarations which were renamed.
    old_declarations = []
    for line in open('/home/michael/all_aligns.txt', 'r', encoding='utf-8'):
        ...
        if old_decl != new_decl:
            old_declarations.append(old_decl)
    ...
    for line in open('/home/michael/geo-v2.txt', 'r', encoding='utf-8'):
        s = extract_backticks(line.strip())
        if s is None:
            print(f'what, what input did we get: "{line.strip()}"')
