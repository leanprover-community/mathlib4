  ...
  { PGame.le with
    ...
    le_trans := by
      suffices
        ...
        fun x y z => this.1
      intro x y z
      induction x generalizing y z with | mk xl xr xL xR IHxl IHxr
      induction y generalizing   z with | mk yl yr yL yR IHyl IHyr
      induction z                  with | mk zl zr zL zR IHzl IHzr
      exact
