...
lemma card_lt_card_of_right_lt_aleph0 {A B : Set α} (hfin : B.Finite) (hlt : A ⊂ B) : #A < #B := by
...
lemma card_lt_card_of_left_lt_aleph0 {A B : Set α} (hfin : A.Finite) (hlt : A ⊂ B) : #A < #B := by
  rcases finite_or_infinite B with hfin | hinf
  · exact card_lt_card_of_right_lt_aleph0 hfin hlt
