...
@[deprecated] alias add_nat_le_add_nat_iff_of_lt_aleph_0 := add_nat_le_add_nat_iff
...
@[deprecated] alias add_one_le_add_one_iff_of_lt_aleph_0 := add_one_le_add_one_iff
