...
@[simp]
theorem mul_mk_eq_max {α β : Type z} [Infinite α] [Infinite β] : #α * #β = max #α #β :=
...
@[simp]
theorem add_mk_eq_max {α β : Type z} [Infinite α] : #α + #β = max #α #β :=
  add_eq_max (aleph0_le_mk α)
#align cardinal.add_mk_eq_max Cardinal.add_mk_eq_max

@[simp]
theorem add_mk_eq_max' {α β : Type z} [Infinite β] : #α + #β = max #α #β :=
