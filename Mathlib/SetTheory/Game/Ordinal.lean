...
instance (priority := 10000) isEmpty_zero_toPGame_leftMoves : IsEmpty (toPGame 0).LeftMoves := by
...
instance (priority := 10000) isEmpty_toPGame_rightMoves (o : Ordinal) : IsEmpty o.toPGame.RightMoves := by
...
noncomputable instance (priority := 10000) uniqueOneToPGameLeftMoves : Unique (toPGame 1).LeftMoves :=
