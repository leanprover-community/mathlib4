...
@[deprecated "Deprecated without replacement." (since := "2024-09-02")]
...
@[deprecated "Deprecated without replacement." (since := "2024-09-02"), refl]
...
@[deprecated "Deprecated without replacement." (since := "2024-09-02"), symm]
protected theorem Resp.Equiv.symm {n} {a b : Resp n} : Resp.Equiv a b → Resp.Equiv b a :=
  (Resp.Equiv.refl b).euc

@[deprecated "Deprecated without replacement." (since := "2024-09-02"), trans]
...
attribute [deprecated "Deprecated without replacement." (since := "2024-09-02"), instance]
  Definable.mk
...
set_option linter.deprecated false in
@[deprecated "Deprecated without replacement." (since := "2024-09-02"), simp]
