...
/--
    ZFA prelist membership. A ZFA list is in a ZFA prelist if some element of this ZFA prelist is
    equivalent as a ZFA list to this ZFA list. -/
instance : Membership (Lists α) (Lists' α b) :=
...
theorem mem_def {l : Lists' α b} : a ∈ l ↔ ∃ a' ∈ l.toList, a ~ a' := Iff.rfl
...
theorem of_list_subset {l₁ l₂ : List (Lists α)} (h : l₁ ⊆ l₂) :
  ...
  case cons _ _ t'ih =>
    refine' Subset.cons (Lists.Equiv.refl _) _ (t'ih (List.subset_of_cons_subset h))
    simp at h; simp [h]
...
theorem subset_def {l₁ l₂ : Lists' α true} : l₁ ⊆ l₂ ↔ ∀ a ∈ l₁.toList, a ∈ l₂ :=
  ⟨fun H a => mem_of_subset' H, fun H => by
    rw [← of_to_list l₁]
    revert H; induction toList l₁ <;> intro
    case nil => exact Subset.nil
    case cons h t tih H =>
      simp; apply cons_subset.2
      exact ⟨H h (by simp), tih (λ a h₀ => H a (by simp; apply Or.inr h₀))⟩⟩
...
theorem to_of_list (l : List (Lists α)) : toList (ofList l) = l := by simp [ofList, of']
#align lists.to_of_list Lists.to_of_list
...
-- Porting note: Is `noncomputable` needed here?
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
-- Porting note: sorry
theorem Equiv.antisymm_iff {l₁ l₂ : Lists' α true} :
  of' l₁ ~ of' l₂ ↔ l₁ ⊆ l₂ ∧ l₂ ⊆ l₁ := by
  admit
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.classInductive'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem equiv_atom {l : Lists α} : atom a ~ l ↔ atom a = l :=
  ⟨λ h => by cases h; rfl, λ h => h ▸ Equiv.refl _ ⟩
...
-- Porting note: Is this required?
open WellFoundedTactics

theorem sizeof_pos (l : Lists' α b) : 0 < SizeOf.sizeOf l := by
  cases l <;> simp
...
theorem lt_sizeof_cons' (a : Lists' α b) (l) :
    SizeOf.sizeOf (⟨b, a⟩ : Lists α) < SizeOf.sizeOf (Lists'.cons' a l) := by
  simp; apply sizeof_pos
