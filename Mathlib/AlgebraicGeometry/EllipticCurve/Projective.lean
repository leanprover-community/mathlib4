...
lemma equiv_of_Z_eq_zero {P Q : Fin 3 → F} (hP : W.Nonsingular P) (hQ : W.Nonsingular Q)
  ...
  simp? [nonsingular_iff, equation_iff] at hP hQ says
    simp only [Fin.isValue, nonsingular_iff, equation_iff, Matrix.cons_val_one,
      Matrix.head_cons, Matrix.cons_val_two, Matrix.tail_cons, ↓mul_zero, Matrix.cons_val_zero,
      add_zero, ne_eq, OfNat.ofNat_ne_zero, not_false_eq_true, zero_pow, zero_eq_mul,
      pow_eq_zero_iff, neg_mul, neg_zero, sub_self, not_true_eq_false, false_or] at hP hQ
