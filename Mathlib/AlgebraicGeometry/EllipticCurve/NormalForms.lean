...
theorem toCharThreeNF_spec_of_b₂_ne_zero (hb₂ : W.b₂ ≠ 0) :
  ...
  · have ha₂ : W'.a₂ ≠ 0 := W.toShortNFOfCharThree_a₂ ▸ hb₂
    field_simp [variableChange_a₄, ha₂]
...
theorem toCharTwoJEqZeroNF_spec (ha₁ : W.a₁ = 0) :
  ...
  constructor
  · simp [variableChange_a₁, toCharTwoJEqZeroNF, ha₁]
...
theorem toCharTwoJNeZeroNF_spec (ha₁ : W.a₁ ≠ 0) :
  ...
  constructor
  · simp [variableChange_a₁, toCharTwoJNeZeroNF, ha₁]
  · field_simp [variableChange_a₃, toCharTwoJNeZeroNF]
