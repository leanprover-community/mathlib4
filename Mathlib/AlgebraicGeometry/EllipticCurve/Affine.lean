...
instance (priority := 10000) : Inhabited W.Point :=
  ⟨zero⟩

instance (priority := 10000) : Zero W.Point :=
  ⟨zero⟩
...
instance (priority := 10000) : Neg W.Point :=
  ⟨neg⟩
...
instance (priority := 10000) : InvolutiveNeg W.Point :=
...
noncomputable instance (priority := 10000) instAddPoint : Add W.Point :=
  ⟨add⟩
...
noncomputable instance (priority := 10000) instAddZeroClassPoint : AddZeroClass W.Point :=
