...
instance (priority := 10000) [Nontrivial R] : Nonempty <| MaximalSpectrum R :=
...
instance (priority := 10000) zariskiTopology : TopologicalSpace <| MaximalSpectrum R :=
...
instance (priority := 10000) : T1Space <| MaximalSpectrum R :=
