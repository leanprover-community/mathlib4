...
theorem fromSpec_range :
  ...
  erw [← coe_comp, ← TopCat.epi_iff_surjective]
  infer_instance
...
theorem _root_.AlgebraicGeometry.Scheme.Hom.isAffineOpen_iff_of_isOpenImmersion
  ...
  · erw [Scheme.comp_val_base, coe_comp, Set.range_comp]
    dsimp [Opens.coe_inclusion, Scheme.restrict]
    erw [Subtype.range_coe, Subtype.range_coe]
    rfl
  · infer_instance
...
theorem fromSpec_primeIdealOf (x : U) :
  ...
  erw [← elementwise_of% Scheme.comp_val_base]
