...
instance isSeparated : IsSeparated (toSpecZero 𝒜) := by
  ...
  · simp only [Iso.trans_hom, congrHom_hom, Category.assoc, Iso.hom_inv_id, Category.comp_id,
      limit.lift_π, PullbackCone.mk_π_app, e₂, e₁, pullbackSpecIso_inv_fst, ← Spec.map_comp]
  ...
  · simp only [Iso.trans_hom, congrHom_hom, Category.assoc, Iso.hom_inv_id, Category.comp_id,
      limit.lift_π, PullbackCone.mk_π_app, pullbackSpecIso_inv_snd, ← Spec.map_comp, e₂, e₁]
