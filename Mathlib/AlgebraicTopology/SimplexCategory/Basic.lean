...
lemma δ_two_eq_mkOfSucc : δ (2 : Fin 3) = SimplexCategory.mkOfSucc (n := 2) 0 := by decide
lemma δ_zero_eq_mkOfSucc : δ (0 : Fin 3) = SimplexCategory.mkOfSucc (n := 2) 1 := by decide
lemma δ_one_δ_two_eq_const : δ (1 : Fin 2) ≫ δ (2 : Fin 3) = ⦋0⦌.const ⦋2⦌ 0 := by decide
lemma δ_zero_δ_two_eq_const : δ (0 : Fin 2) ≫ δ (2 : Fin 3) = ⦋0⦌.const ⦋2⦌ 1 := by decide
lemma δ_one_δ_zero_eq_const : δ (1 : Fin 2) ≫ δ (0 : Fin 3) = ⦋0⦌.const ⦋2⦌ 1 := by decide
lemma δ_one_δ_one_eq_const : δ (1 : Fin 2) ≫ δ (1 : Fin 3) = ⦋0⦌.const ⦋2⦌ 0 := by decide
lemma δ_zero_δ_zero_eq_const : δ (0 : Fin 2) ≫ δ (0 : Fin 3) = ⦋0⦌.const ⦋2⦌ 2 := by decide
lemma δ_zero_δ_one_eq_const : δ (0 : Fin 2) ≫ δ (1 : Fin 3) = ⦋0⦌.const ⦋2⦌ 2 := by decide
