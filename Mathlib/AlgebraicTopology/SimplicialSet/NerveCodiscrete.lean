...
In the codiscrete category on a type `X`, every homset is given by `unit`. When we take the nerve of
such a category, the `n`-simplices become equivalent to `X`-vectors of length `n + 1`.
