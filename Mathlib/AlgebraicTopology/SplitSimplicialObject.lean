...
@[reassoc]
lemma ιSummand_eq {Δ : SimplexCategoryᵒᵖ} (A : IndexSet Δ) :
...
@[reassoc]
lemma ιSummand_epi_naturality {Δ₁ Δ₂ : SimplexCategoryᵒᵖ} (A : IndexSet Δ₁) (p : Δ₁ ⟶ Δ₂)
...
lemma ιSummand_naturality_symm {S₁ S₂ : Split C} (Φ : S₁ ⟶ S₂) {Δ : SimplexCategoryᵒᵖ}
