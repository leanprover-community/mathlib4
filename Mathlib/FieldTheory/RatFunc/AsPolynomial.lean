...
noncomputable def C : K →+* K⟮X⟯ := algebraMap _ _
...
-/
noncomputable def eval (f : K →+* L) (a : L) (p : K⟮X⟯) : L :=
...
noncomputable instance valuedRatFunc : Valued K⟮X⟯ ℤᵐ⁰ := Valued.mk' ((idealX K).valuation _)
