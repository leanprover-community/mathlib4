...
instance (priority := 10000) instInhabitedEmb : Inhabited (Emb F E) := ⟨IsScalarTower.toAlgHom F E _⟩

instance (priority := 10000) instNeZeroFinSepDegree [FiniteDimensional F E] : NeZero (finSepDegree F E) :=
