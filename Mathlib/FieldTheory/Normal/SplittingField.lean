...
In this file we prove that for a finite extension, being normal is the same as being a splitting
field (`Normal.of_isSplittingField` and `Normal.exists_isSplittingField`).
...
variable {F} {E : Type*} [Field E] [Algebra F E] [Algebra K E] [IsScalarTower F K E]
