...
theorem exists_separable_and_not_isCentral (H : k ≠ (⊤ : Subring D)) :
  ...
  rw [add_pow_expChar_pow_of_commute p r (Commute.one_left _), one_pow, GroupWithZero.conj_pow₀ ha₀,
    ← hr.comm, mul_assoc, inv_mul_cancel₀ ha₀, mul_one, right_eq_add] at deq
