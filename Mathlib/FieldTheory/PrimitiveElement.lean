...
private lemma primitive_element_inf_aux_of_finite_intermediateField
...
lemma isAlgebraic_of_adjoin_eq_adjoin {α : E} {m n : ℕ} (hneq : m ≠ n)
...
lemma isAlgebraic_of_finite_intermediateField
...
lemma FiniteDimensional.of_finite_intermediateField
...
lemma exists_primitive_element_of_finite_intermediateField
...
lemma FiniteDimensional.of_exists_primitive_element (halg : Algebra.IsAlgebraic F E)
...
lemma finite_intermediateField_of_exists_primitive_element (halg : Algebra.IsAlgebraic F E)
...
@[simp]
lemma AlgHom.card (K : Type*) [Field K] [IsAlgClosed K] [Algebra F K] :
...
@[simp]
lemma AlgHom.card_of_splits (L : Type*) [Field L] [Algebra F L]
...
lemma primitive_element_iff_minpoly_natDegree_eq (α : E) :
...
lemma primitive_element_iff_minpoly_degree_eq (α : E) :
...
lemma primitive_element_iff_algHom_eq_of_eval' (α : E) :
