...
instance (priority := 10000) IsSepClosed.of_isAlgClosed [IsAlgClosed k] : IsSepClosed k :=
...
instance (priority := 10000) IsSepClosure.self_of_isSepClosed [IsSepClosed k] : IsSepClosure k k :=
...
instance (priority := 10000) isSeparable [Algebra k K] [IsSepClosure k K] : IsSeparable k K :=
