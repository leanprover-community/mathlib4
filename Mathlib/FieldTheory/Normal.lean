...
/-
[Stacks 09HN](https://stacks.math.columbia.edu/tag/09HN)
-/
...
[Stacks: 0BR3](https://stacks.math.columbia.edu/tag/0BR3)
-/
...
/-- If a set of algebraic elements in a field extension `K/F` have minimal polynomials that
  ...
  [Stacks: 0BR3, first part](https://stacks.math.columbia.edu/tag/0BR3)
-/
...
/-
[Stacks: 09HP](https://stacks.math.columbia.edu/tag/09HP)
-/
instance normal_inf
    (E E' : IntermediateField F K) [Normal F E] [Normal F E'] :
    Normal F (E ⊓ E' : IntermediateField F K) :=
