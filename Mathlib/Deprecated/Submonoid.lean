...
@[to_additive "The inductively defined `AddSubmonoid` genrated by a subset of an `AddMonoid`."]
...
@[to_additive "A subset of an `AddMonoid` is contained in the `AddSubmonoid` it generates."]
