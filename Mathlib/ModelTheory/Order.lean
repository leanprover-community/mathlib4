...
instance (priority := 10000) orderStructure [LE M] : Language.order.Structure M :=
...
instance (priority := 10000) Language.instIsRelational : IsRelational Language.order :=
...
instance (priority := 10000) Language.instSubsingleton : Subsingleton (Language.order.Relations n) :=
...
instance (priority := 10000) : IsOrdered Language.order :=
  ⟨Unit.unit⟩
...
instance (priority := 10000) sum.instIsOrdered : IsOrdered (L.sum Language.order) :=
...
instance (priority := 10000) orderedStructure_LE [LE M] : OrderedStructure Language.order M := by
...
instance (priority := 10000) model_preorder [Preorder M] : M ⊨ Language.order.preorderTheory := by
...
instance (priority := 10000) model_partialOrder [PartialOrder M] : M ⊨ Language.order.partialOrderTheory := by
...
instance (priority := 10000) model_linearOrder [LinearOrder M] : M ⊨ Language.order.linearOrderTheory := by
...
instance (priority := 10000) model_dlo [LinearOrder M] [DenselyOrdered M] [NoTopOrder M] [NoBotOrder M] :
