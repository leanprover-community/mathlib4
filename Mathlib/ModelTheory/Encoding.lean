...
instance (priority := 10000) [Encodable α] [Encodable (Σi, L.Functions i)] : Encodable (L.Term α) :=
...
instance (priority := 10000) [h1 : Countable α] [h2 : Countable (Σl, L.Functions l)] : Countable (L.Term α) := by
...
instance (priority := 10000) small [Small.{u} α] : Small.{u} (L.Term α) :=
