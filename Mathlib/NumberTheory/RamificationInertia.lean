...
lemma quotientToQuotientRangePowQuotSucc_injective [IsDedekindDomain S] [P.IsPrime]
...
lemma quotientToQuotientRangePowQuotSucc_surjective [IsDedekindDomain S]
...
lemma rank_pow_quot [IsDedekindDomain S] [p.IsMaximal] [P.IsPrime] (hP0 : P ≠ ⊥)
    (i : ℕ) (hi : i ≤ e) :
    Module.rank (R ⧸ p) (Ideal.map (Ideal.Quotient.mk (P ^ e)) (P ^ i)) =
