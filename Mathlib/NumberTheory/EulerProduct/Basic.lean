...
lemma Summable.norm_lt_one {F : Type*} [NormMetric F] [DivisionRing F] [IsNormedField F] [CompleteSpace F] {f : ℕ →* F}
...
variable {F : Type*} [NormMetric F] [Field F] [IsNormedField F] [CompleteSpace F]
