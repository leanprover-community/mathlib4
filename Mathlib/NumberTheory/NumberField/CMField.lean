...
/--
An element of `K` is fixed by the complex conjugation iff it lies in its maximal real subfield.
-/
@[simp]
...
/--
The subgroup of `(𝓞 K)ˣ` generated by the units of its maximal real subfield. These
