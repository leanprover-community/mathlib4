...
* `Number.Field.Units.regOfFamily_div_regOfFamily`: Let `u` and `v` be two family of units. Assume
  that the subgroup `U` generated by `u` and `torsion K` is included in the subgroup `V` generated
...
/--
Let `u` and `v` be two family of units. Assume that the subgroup `U` generated by `u` and
`torsion K` is included in the subgroup `V` generated by `v` and `torsion K`. Then the ratio
