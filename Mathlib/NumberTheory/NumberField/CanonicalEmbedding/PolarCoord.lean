...
/-- The polar coordinate partial homeomorph in `ℝ^r₁ × (ℝ × ℝ)^r₂` defined as the identity on
...
/-- The polar coordinate partial homeomorph between the mixed space `ℝ^r₁ × ℂ^r₂` and
