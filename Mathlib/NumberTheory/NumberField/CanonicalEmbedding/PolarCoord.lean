...
open scoped Classical in
theorem integral_comp_polarCoordReal_symm {E : Type*} [AddCommGroup E] [NormedAddCommGroup E]
    [NormedSpace ℝ E] (f : realMixedSpace K → E) :
...
open scoped Classical in
theorem integral_comp_polarSpaceCoord_symm [NumberField K] {E : Type*} [AddCommGroup E]
    [NormedAddCommGroup E] [NormedSpace ℝ E] (f : mixedSpace K → E) :
