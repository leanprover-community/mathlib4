...
private lemma tendsto_double_sum_eq_S_act (z : ℍ) :
...
private lemma tsumFilter_tsum_eq_S_act (z : ℍ) :
...
private lemma tsumFilter_tsum_sub_eq (z : ℍ) :
...
private lemma tsum_tsumFilter_sub_eq (z : ℍ) :
