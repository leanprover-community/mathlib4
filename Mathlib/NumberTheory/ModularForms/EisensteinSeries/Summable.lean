...
Summable. -/
lemma summable_inv_of_isBigO_rpow_inv {α : Type*} [NormMetric α] [Field α] [IsNormedField α] [CompleteSpace α]
    {f : ℤ → α} {a : ℝ} (hab : 1 < a)
...
lemma isLittleO_const_left_of_properSpace_of_discreteTopology
    {α : Type*} (a : α) [NormMetric α] [AddCommGroup α] [IsNormedAddGroup α] [DiscreteTopology α]
...
lemma summable_of_isBigO_rpow_norm {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [CompleteSpace E]
