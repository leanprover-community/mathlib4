...
theorem ncard_primesOver_mul_ramificationIdxIn_mul_inertiaDegIn :
  ...
  let _ := IsFractionRing.mulSemiringAction G A B K L
...
theorem ncard_primesOver_mul_ncard_primesOver (hp : p ≠ ⊥) :
  ...
  let _ := IsFractionRing.mulSemiringAction G A B (FractionRing A) (FractionRing B)
  let _ := IsFractionRing.mulSemiringAction GAC A C (FractionRing A) (FractionRing C)
  let _ := IsFractionRing.mulSemiringAction GBC B C (FractionRing B) (FractionRing C)
