...
private lemma instances [IsDecompositionField K L P D] :
...
theorem ramificationIdxIn_eq [IsDecompositionField K L P D] :
...
theorem inertiaDegIn_eq [IsDecompositionField K L P D] :
