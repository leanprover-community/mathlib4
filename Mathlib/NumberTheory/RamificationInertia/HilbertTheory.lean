...
noncomputable abbrev IsDecompositionField.ringEquiv (D' : Type*) [Field D'] [Algebra D' L]
...
noncomputable abbrev IsInertiaField.ringEquiv (E' : Type*) [Field E'] [Algebra E' L]
