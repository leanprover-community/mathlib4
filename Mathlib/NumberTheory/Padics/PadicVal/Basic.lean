...
theorem num_or_den_zero_padicVal (a : ℚ) (p : ℕ) [Fact (Nat.Prime p)] :
...
theorem num_den_even_padicVal_of_even_padicVal {a : ℚ} {p : ℕ} [Fact (Nat.Prime p)]
...
theorem isSquare_of_even_factorization {a : ℚ} (hR : 0 ≤ a)
