...
/-- Search for the AC-variable (`Entry.acVar`) with the least occurrences in the LHS. -/
def getVarWithLeastLHSOccs (ccs : CCState) (e : ACApps) : Option Expr :=
  ccs.getVarWithLeastOccs e true

/-- Search for the AC-variable (`Entry.acVar`) with the least occurrences in the RHS. -/
