...
| nil {basis_hd : _} {basis_tl : _} : isFlatZero (basis := basis_hd :: basis_tl) Seq.nil

theorem isFlatZero_cons {basis_hd : _} {basis_tl : _} {deg : ℝ} {coef : PreMS basis_tl}
    {tl : PreMS (basis_hd :: basis_tl)} :
    ¬(isFlatZero (basis := (basis_hd :: basis_tl)) (Seq.cons (deg, coef) tl)) := by
  intro h
...
| nil {basis_hd : _} {basis_tl : _} : isTrimmed (basis := basis_hd :: basis_tl) Seq.nil
| cons {basis_hd : _} {basis_tl : _} {deg : ℝ} {coef : PreMS basis_tl}
  ...
  isTrimmed (basis := basis_hd :: basis_tl) (Seq.cons (deg, coef) tl)

theorem isTrimmed_cons {basis_hd : _} {basis_tl : _} {deg : ℝ} {coef : PreMS basis_tl}
    {tl : PreMS (basis_hd :: basis_tl)}
    (h : isTrimmed (basis := basis_hd :: basis_tl) (Seq.cons (deg, coef) tl)) :
