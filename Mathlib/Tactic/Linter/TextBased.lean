...
def findBadUnicodeAux (s : String) (pos : s.Pos) (c : Char)
  ...
  if h : pos < s.endPos then
    ...
    | some cₙ =>
      ...
      else if cₙ == UnicodeVariant.emoji && !(emojis.contains c) && !(maybeEmojis.contains c) then
      ...
      else if cₙ == UnicodeVariant.text && !(nonEmojis.contains c) && !(maybeEmojis.contains c) then
