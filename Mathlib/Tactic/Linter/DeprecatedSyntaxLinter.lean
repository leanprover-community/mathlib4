...
-/
public meta register_option linter.style.refine : Bool := {
  defValue := false
...
-/
public meta register_option linter.style.cases : Bool := {
  defValue := false
...
required to be separated by case, which hinders readability.
-/
public meta register_option linter.style.induction : Bool := {
  defValue := false
...
public meta register_option linter.style.admit : Bool := {
  defValue := false
...
public meta register_option linter.style.nativeDecide : Bool := {
  defValue := false
...
-/
public meta register_option linter.style.maxHeartbeats : Bool := {
  defValue := false
