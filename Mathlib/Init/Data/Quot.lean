...
lemma EqvGen.is_equivalence : Equivalence (@EqvGen α r) :=
...
lemma Quot.exact {a b : α} (H : Quot.mk r a = Quot.mk r b) : EqvGen r a b :=
...
lemma Quot.EqvGen_sound {r : α → α → Prop} {a b : α} (H : EqvGen r a b) :
