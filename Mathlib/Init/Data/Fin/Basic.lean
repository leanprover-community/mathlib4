...
@[deprecated eq_of_val_eq (since := "2024-02-15")] theorem eq_of_veq : i.val = j.val → i = j := eq_of_val_eq
@[deprecated val_eq_of_eq (since := "2024-02-15")] theorem veq_of_eq : i = j → i.val = j.val := val_eq_of_eq
