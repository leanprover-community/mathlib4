...
@[simp]
lemma finsuppTensorLeft_apply_tmul_apply {α : Type w'} (f : α →₀ V) (w : W)
...
@[simp]
lemma finsuppTensorLeft_symm_apply_single {α : Type w'} (i : α) (v : V) (w : W) :
...
@[simp]
lemma finsuppTensorRight_apply_tmul_apply {α : Type w'} (v : V) (f : α →₀ W)
...
@[simp]
lemma finsuppTensorRight_symm_apply_single {α : Type w'} (i : α) (v : V) (w : W) :
