...
instance [IsNoetherianRing R] : PreservesFiniteLimits (forget₂ (FDRep R G) (Rep R G)) :=
  inferInstaceAs% (PreservesFiniteLimits <| (forget₂ (FGModuleCat R) (ModuleCat R)).mapAction G)

instance : PreservesFiniteColimits (forget₂ (FDRep R G) (Rep R G)) :=
  inferInstaceAs% (PreservesFiniteColimits <| (forget₂ (FGModuleCat R) (ModuleCat R)).mapAction G)
