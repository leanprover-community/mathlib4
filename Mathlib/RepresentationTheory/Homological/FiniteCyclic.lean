...
In the files `RepresentationTheory/HomologicalComplex/Group(Co)Homology/FiniteCyclic.lean`, we use
this resolution to compute the group (co)homology of representations of finite cyclic groups.
