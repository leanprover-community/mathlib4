...
noncomputable def mapIso (e : G ≃* H) (e' : A.V ≃ₗ[k] B.V)
  ...
  hom_inv_id := by
    ...
    exact groupHomology.map_congr e.ofClass_monoidHom_symm_comp_ofClass_monoidHom e'.symm_comp n
  inv_hom_id := by
    rw [← groupHomology.map_comp, ← groupHomology.map_id]
    exact groupHomology.map_congr e.ofClass_monoidHom_comp_ofClass_monoidHom_symm e'.comp_symm n
