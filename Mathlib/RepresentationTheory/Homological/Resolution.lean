...
In `RepresentationTheory.Homological.GroupCohomology.Basic`, we then use `Rep.barResolution` to
define the inhomogeneous cochains of a representation, useful for computing group cohomology.
