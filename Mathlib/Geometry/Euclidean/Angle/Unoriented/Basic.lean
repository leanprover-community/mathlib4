...
variable {V : Type*} [AddCommGroup V] [NormedAddCommGroup V] [InnerProductSpace ℝ V] {x y : V}
...
@[simp]
theorem _root_.LinearIsometry.angle_map {E F : Type*} [AddCommGroup E] [NormedAddCommGroup E] [AddCommGroup F] [NormedAddCommGroup F]
