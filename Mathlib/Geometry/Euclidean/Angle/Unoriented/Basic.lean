...
variable {V : Type*} [NormMetric V] [AddCommGroup V] [IsNormedAddGroup V] [InnerProductSpace ℝ V] {x y : V}
...
@[simp]
theorem _root_.LinearIsometry.angle_map {E F : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F]
