...
instance MeasureTheory.isAddHaarMeasure_euclideanHausdorffMeasure {E : Type*} [AddCommGroup E]
...
theorem MeasureTheory.Measure.euclideanHausdorffMeasure_smul₀ {𝕜 : Type*} {E : Type*}
    [AddCommGroup E] [NormedAddCommGroup E] [NormedDivisionRing 𝕜] [Module 𝕜 E] [NormSMulClass 𝕜 E]
...
section Homothety
variable {𝕜 V P : Type*} [NormedField 𝕜] [AddCommGroup V] [NormedAddCommGroup V] [NormedSpace 𝕜 V]
...
variable {V P : Type*}
variable [AddCommGroup V] [NormedAddCommGroup V] [InnerProductSpace ℝ V] [MeasurableSpace V]
  [BorelSpace V]
