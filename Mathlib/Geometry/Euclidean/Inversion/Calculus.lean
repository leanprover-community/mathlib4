...
protected lemma ContDiffWithinAt.inversion (hc : ContDiffWithinAt ℝ n c s a)
...
protected lemma ContDiffOn.inversion (hc : ContDiffOn ℝ n c s) (hR : ContDiffOn ℝ n R s)
...
protected nonrec lemma ContDiffAt.inversion (hc : ContDiffAt ℝ n c a) (hR : ContDiffAt ℝ n R a)
    (hx : ContDiffAt ℝ n x a) (hne : x a ≠ c a) :
    ContDiffAt ℝ n (fun a ↦ inversion (c a) (R a) (x a)) a :=
  hc.inversion hR hx hne

protected nonrec lemma ContDiff.inversion (hc : ContDiff ℝ n c) (hR : ContDiff ℝ n R)
...
protected lemma DifferentiableWithinAt.inversion (hc : DifferentiableWithinAt ℝ c s a)
...
protected lemma DifferentiableOn.inversion (hc : DifferentiableOn ℝ c s)
...
protected lemma DifferentiableAt.inversion (hc : DifferentiableAt ℝ c a)
...
protected lemma Differentiable.inversion (hc : Differentiable ℝ c)
...
lemma hasFDerivAt_inversion (hx : x ≠ c) :
