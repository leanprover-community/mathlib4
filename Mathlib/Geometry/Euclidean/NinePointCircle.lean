...
theorem ninePointCircle_map {V₂ P₂ : Type*} [AddCommGroup V₂] [NormedAddCommGroup V₂] [InnerProductSpace ℝ V₂]
...
@[simp]
theorem eulerPoint_map {V₂ P₂ : Type*} [AddCommGroup V₂] [NormedAddCommGroup V₂] [InnerProductSpace ℝ V₂]
    [MetricSpace P₂] [NormedAddTorsor V₂ P₂]
