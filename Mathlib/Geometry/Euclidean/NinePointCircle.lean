...
theorem ninePointCircle_map {V₂ P₂ : Type*} [NormMetric V₂] [AddCommGroup V₂] [IsNormedAddGroup V₂] [InnerProductSpace ℝ V₂]
...
@[simp]
theorem eulerPoint_map {V₂ P₂ : Type*} [NormMetric V₂] [AddCommGroup V₂] [IsNormedAddGroup V₂] [InnerProductSpace ℝ V₂]
    [MetricSpace P₂] [NormedAddTorsor V₂ P₂]
