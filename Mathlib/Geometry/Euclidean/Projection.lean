...
variable [NormMetric V] [AddCommGroup V] [IsNormedAddGroup V] [InnerProductSpace 𝕜 V]
variable {V₂ P₂ : Type*} [NormMetric V₂] [AddCommGroup V₂] [IsNormedAddGroup V₂] [InnerProductSpace 𝕜 V₂]
