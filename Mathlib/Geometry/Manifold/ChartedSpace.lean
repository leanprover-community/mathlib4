...
theorem ChartedSpace.locallyPathConnectedSpace [LocallyPathConnectedSpace H] : LocallyPathConnectedSpace M := by
...
@[deprecated (since := "2026-04-01")] alias ChartedSpace.locPathConnectedSpace :=
