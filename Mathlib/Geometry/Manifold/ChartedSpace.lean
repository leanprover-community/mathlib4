...
open Set OpenPartialHomeomorph Manifold  -- Porting note: Added `Manifold`
...
theorem closedUnderRestriction_iff_id_le (G : StructureGroupoid H) :
  ...
  · intro _i
    ...
    ext
    · rw [OpenPartialHomeomorph.restr_apply, OpenPartialHomeomorph.refl_apply, id, ofSet_apply,
        id_eq]
    · simp
    · simp [hs.interior_eq]
  · intro h
...
lemma StructureGroupoid.restriction_in_maximalAtlas {e : OpenPartialHomeomorph M H}
