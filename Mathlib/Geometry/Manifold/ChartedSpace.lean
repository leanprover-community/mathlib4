...
open Classical TopologicalSpace Topology Filter
...
lemma StructureGroupoid.restriction_in_maximalAtlas (he : e ∈ atlas H M) {s : Opens M} [Nonempty s]
    [HasGroupoid M G] [ClosedUnderRestriction G] : e.subtypeRestr s ∈ G.maximalAtlas s := by
  intro e' he'
...
theorem StructureGroupoid.restriction_chart (he : e ∈ atlas H M) (hs : Set.Nonempty e.source)
