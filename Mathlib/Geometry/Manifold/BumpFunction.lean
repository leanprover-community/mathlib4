...
variable {E : Type uE} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E]
...
theorem contMDiff_smul {G} [NormMetric G] [AddCommGroup G] [IsNormedAddGroup G] [NormedSpace ℝ G] {g : M → G}
