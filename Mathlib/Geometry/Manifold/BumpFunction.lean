...
instance (priority := 10000) : CoeFun (SmoothBumpFunction I c) fun _ => M → ℝ :=
  ⟨toFun⟩
...
instance (priority := 10000) : Nonempty (SmoothBumpFunction I c) := nhdsWithin_range_basis.nonempty
