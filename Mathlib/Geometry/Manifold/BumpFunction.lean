...
variable {E : Type uE} [AddCommGroup E] [NormedAddCommGroup E] [NormedSpace ℝ E]
...
theorem contMDiff_smul {G} [AddCommGroup G] [NormedAddCommGroup G] [NormedSpace ℝ G] {g : M → G}
