...
variable {𝕜 : Type*} [NormMetric 𝕜] [Field 𝕜] [IsNontriviallyNormedField 𝕜] {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
  ...
  [TopologicalSpace M'] [ChartedSpace H' M'] {E'' : Type*} [NormMetric E''] [AddCommGroup E''] [IsNormedAddGroup E'']
...
attribute [to_additive_ignore_args 27] ContMDiffMap ContMDiffMap.instFunLike
