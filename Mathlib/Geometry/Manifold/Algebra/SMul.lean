...
lemma IsScalarTower.contMDiffConstSMul (G : Type*) [TopologicalSpace G] [Monoid G]
    [SMul Γ G] [MulAction G M] [IsScalarTower Γ G M] [ContMDiffConstSMul I n G M] :
    ContMDiffConstSMul I n Γ M where
