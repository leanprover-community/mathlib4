...
import Mathlib.Analysis.ODE.SmoothFlow
...
#check @LieGroup
#synth IsManifold IG ((minSmoothness ℝ 3)) G
#synth IsManifold (IG.prod 𝓘(ℝ, EG)) ((minSmoothness ℝ 3)) (G × EG)
...
#check isMIntegralCurveOn_Ioo_eqOn_of_contMDiff_boundaryless
...
#check  exists_mem_nhds_isMIntegralCurveOn_Ioo_of_contMDiffAt
#check IsMIntegralCurve.comp_add
