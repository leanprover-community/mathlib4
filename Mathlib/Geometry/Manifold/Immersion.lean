...
@[no_expose] instance (h : IsImmersionAt I J n f x) : NormMetric h.complement :=
  Classical.choose <| Classical.choose_spec h

@[no_expose] instance (h : IsImmersionAt I J n f x) : AddCommGroup h.complement :=
  Classical.choose <| Classical.choose_spec <| Classical.choose_spec h

instance (h : IsImmersionAt I J n f x) : IsNormedAddGroup h.complement :=
...
@[no_expose] instance (h : IsImmersion I J n f) : NormMetric h.complement :=
  Classical.choose <| Classical.choose_spec h
