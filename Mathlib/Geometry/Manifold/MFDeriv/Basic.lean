...
For functions between vector spaces, we show that the usual notions and the manifold notions
coincide.

See `SpecificFunctions.lean` for results on the differential of the identity, constant functions,
