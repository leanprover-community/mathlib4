...
theorem contMDiff_toPartitionOfUnity {E : Type uE} [AddCommGroup E] [NormedAddCommGroup E]
    [NormedSpace ℝ E] {H : Type uH} [TopologicalSpace H] {I : ModelWithCorners ℝ E H} {M : Type uM}
