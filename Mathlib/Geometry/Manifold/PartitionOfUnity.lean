...
variable {ι : Type uι} {E : Type uE} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E]
  {F : Type uF} [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] [NormedSpace ℝ F] {H : Type uH}
...
theorem contMDiff_toPartitionOfUnity {E : Type uE} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E]
...
theorem exists_contMDiffSection_forall_mem_convex_of_local
    {F_fiber : Type*} [NormMetric F_fiber] [AddCommGroup F_fiber] [IsNormedAddGroup F_fiber] [NormedSpace ℝ F_fiber]
