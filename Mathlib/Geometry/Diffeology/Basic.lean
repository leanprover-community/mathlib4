...
class IsContDiffCompatible (X : Type*)
    [NormMetric X] [AddCommGroup X] [IsNormedAddGroup X] [NormedSpace ℝ X] [DiffeologicalSpace X] : Prop where
...
def _root_.NormedSpace.toDiffeology (X : Type*)
    [NormMetric X] [AddCommGroup X] [IsNormedAddGroup X] [NormedSpace ℝ X] [FiniteDimensional ℝ X] :
...
instance {X : Type*} [NormMetric X] [AddCommGroup X] [IsNormedAddGroup X] [NormedSpace ℝ X] [FiniteDimensional ℝ X] :
    IsContDiffCompatible X :=
  ⟨Iff.rfl⟩

lemma _root_.NormedSpace.isContDiffCompatible_iff_eq_toDiffeology {X : Type*}
    [NormMetric X] [AddCommGroup X] [IsNormedAddGroup X] [NormedSpace ℝ X] [FiniteDimensional ℝ X] [d : DiffeologicalSpace X] :
...
variable {Y : Type*}
  [NormMetric X] [AddCommGroup X] [IsNormedAddGroup X] [NormedSpace ℝ X] [IsContDiffCompatible X]
  [NormMetric Y] [AddCommGroup Y] [IsNormedAddGroup Y] [NormedSpace ℝ Y] [DiffeologicalSpace Y] [IsContDiffCompatible Y]
