...
lemma isColimit_exists_rep {c : Cocone F} (hc : IsColimit c) (x : c.pt) :
...
lemma imageBasicOpen_image_preimage :
...
lemma imageBasicOpen_image_open :
...
lemma isLocalRingHom_stalkMap_congr {X Y : RingedSpace} (f g : X ⟶ Y) (H : f = g) (x)
