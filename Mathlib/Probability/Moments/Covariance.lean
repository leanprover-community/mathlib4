...
lemma covariance_fst_snd_prod [IsProbabilityMeasure μ] [IsProbabilityMeasure ν]
    {X : Ω → ℝ} {Y : Ω' → ℝ} (hfμ : MemLp X 2 μ) (hgν : MemLp Y 2 ν) :
...
lemma variance_add_prod [IsProbabilityMeasure μ] [IsProbabilityMeasure ν]
    {X : Ω → ℝ} {Y : Ω' → ℝ} (hfμ : MemLp X 2 μ) (hgν : MemLp Y 2 ν) :
