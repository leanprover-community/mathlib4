...
theorem iIndepSet.indep_generateFrom_lt [Preorder ι] [IsZeroOrMarkovKernel κ] {s : ι → Set Ω}
...
theorem iIndepSet.indep_generateFrom_le [LinearOrder ι] [IsZeroOrMarkovKernel κ] {s : ι → Set Ω}
...
theorem iIndepSet.indep_generateFrom_le_nat [IsZeroOrMarkovKernel κ] {s : ℕ → Set Ω}
...
theorem iIndepFun.indepFun_finset [IsZeroOrMarkovKernel κ] (S T : Finset ι) (hST : Disjoint S T)
...
theorem iIndepFun.indepFun_prod_mk [IsZeroOrMarkovKernel κ] (hf_Indep : iIndepFun m f κ μ)
...
open Finset in
lemma iIndepFun.indepFun_prod_mk_prod_mk [IsZeroOrMarkovKernel κ] (hf_indep : iIndepFun m f κ μ)
