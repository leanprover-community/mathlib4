...
variable {α β Ω F : Type*} [MeasurableSpace Ω] [StandardBorelSpace Ω]
  [Nonempty Ω] [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] {mα : MeasurableSpace α} {μ : Measure α} [IsFiniteMeasure μ]
  {X : α → β} {Y : α → Ω}
...
theorem condExp_ae_eq_integral_condDistrib' {Ω : Type*} [NormMetric Ω] [AddCommGroup Ω] [IsNormedAddGroup Ω] [NormedSpace ℝ Ω]
