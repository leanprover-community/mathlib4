...
variable {α β γ E : Type*} {mα : MeasurableSpace α} {mβ : MeasurableSpace β}
  {mγ : MeasurableSpace γ} [AddCommGroup E] [NormedAddCommGroup E] {a : α}
...
variable [NormedSpace ℝ E] {E' : Type*} [AddCommGroup E'] [NormedAddCommGroup E'] [NormedSpace ℝ E']
...
variable {α β E : Type*} {mα : MeasurableSpace α} {mβ : MeasurableSpace β} [AddCommGroup E]
...
lemma _root_.MeasureTheory.AEStronglyMeasurable.ae_of_compProd [SFinite μ] [IsSFiniteKernel κ]
    {E : Type*} [AddCommGroup E] [NormedAddCommGroup E] {f : α → β → E}
...
lemma integrable_compProd_iff [SFinite μ] [IsSFiniteKernel κ] {E : Type*} [AddCommGroup E]
    [NormedAddCommGroup E] {f : α × β → E} (hf : AEStronglyMeasurable f (μ ⊗ₘ κ)) :
    Integrable f (μ ⊗ₘ κ) ↔
...
lemma integral_compProd [SFinite μ] [IsSFiniteKernel κ] {E : Type*} [AddCommGroup E]
...
lemma setIntegral_compProd [SFinite μ] [IsSFiniteKernel κ] {E : Type*} [AddCommGroup E]
    [NormedAddCommGroup E] [NormedSpace ℝ E]
