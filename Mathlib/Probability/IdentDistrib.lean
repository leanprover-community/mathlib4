...
theorem integral_eq [NormMetric γ] [AddCommGroup γ] [IsNormedAddGroup γ] [NormedSpace ℝ γ] [BorelSpace γ]
...
theorem eLpNorm_eq [NormMetric γ] [AddCommGroup γ] [IsNormedAddGroup γ] [OpensMeasurableSpace γ] (h : IdentDistrib f g μ ν)
...
theorem memLp_snd [NormMetric γ] [AddCommGroup γ] [IsNormedAddGroup γ] [BorelSpace γ] {p : ℝ≥0∞} (h : IdentDistrib f g μ ν)
    (hf : MemLp f p μ) : MemLp g p ν := by
  refine ⟨h.aestronglyMeasurable_snd hf.aestronglyMeasurable, ?_⟩
  rw [← h.eLpNorm_eq]
  exact hf.2

theorem memLp_iff [NormMetric γ] [AddCommGroup γ] [IsNormedAddGroup γ] [BorelSpace γ] {p : ℝ≥0∞} (h : IdentDistrib f g μ ν) :
    MemLp f p μ ↔ MemLp g p ν :=
  ⟨fun hf => h.memLp_snd hf, fun hg => h.symm.memLp_snd hg⟩

theorem integrable_snd [NormMetric γ] [AddCommGroup γ] [IsNormedAddGroup γ] [BorelSpace γ] (h : IdentDistrib f g μ ν)
    (hf : Integrable f μ) : Integrable g ν := by
  rw [← memLp_one_iff_integrable] at hf ⊢
  exact h.memLp_snd hf

theorem integrable_iff [NormMetric γ] [AddCommGroup γ] [IsNormedAddGroup γ] [BorelSpace γ] (h : IdentDistrib f g μ ν) :
    Integrable f μ ↔ Integrable g ν :=
  ⟨fun hf => h.integrable_snd hf, fun hg => h.symm.integrable_snd hg⟩

protected theorem norm [NormMetric γ] [AddCommGroup γ] [IsNormedAddGroup γ] [OpensMeasurableSpace γ] (h : IdentDistrib f g μ ν) :
    IdentDistrib (fun x => ‖f x‖) (fun x => ‖g x‖) μ ν :=
  h.comp measurable_norm

protected theorem nnnorm [NormMetric γ] [AddCommGroup γ] [IsNormedAddGroup γ] [OpensMeasurableSpace γ]
...
variable {E : Type*} [MeasurableSpace E] [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [BorelSpace E]
