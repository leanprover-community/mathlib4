...
theorem Adapted.stoppedProcess [MetrizableSpace ι] (hu : StronglyAdapted f u)
...
is adapted. -/
theorem Adapted.stoppedProcess_of_discrete [DiscreteTopology ι] (hu : StronglyAdapted f u)
    (hτ : IsStoppingTime f τ) : StronglyAdapted f (MeasureTheory.stoppedProcess u τ) :=
  (hu.progMeasurable_of_discrete.stoppedProcess hτ).stronglyAdapted

theorem Adapted.stronglyMeasurable_stoppedProcess [MetrizableSpace ι] (hu : StronglyAdapted f u)
