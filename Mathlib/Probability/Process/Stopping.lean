...
variable [PartialOrder ι] {ℱ : Filtration ι m} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
...
variable [LinearOrder ι] [TopologicalSpace ι] [OrderTopology ι] [FirstCountableTopology ι]
  {ℱ : Filtration ι m} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
...
variable [LinearOrder ι] {μ : Measure Ω} {ℱ : Filtration ι m} {τ σ : Ω → WithTop ι} {E : Type*}
  [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E] [CompleteSpace E] {f : Ω → E}
