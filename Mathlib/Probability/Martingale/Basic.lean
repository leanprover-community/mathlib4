...
variable {Ω E ι : Type*} [Preorder ι] {m0 : MeasurableSpace Ω} {μ : Measure Ω}
  [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E] [CompleteSpace E] {f g : ι → Ω → E} {ℱ : Filtration ι m0}
...
variable {F : Type*} [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] [PartialOrder F] [NormedSpace ℝ F] [CompleteSpace F]
  [IsOrderedModule ℝ F]
...
variable {F : Type*} [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] [PartialOrder F] [IsOrderedAddMonoid F]
