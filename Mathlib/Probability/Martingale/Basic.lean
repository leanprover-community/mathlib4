...
variable {Ω E ι : Type*} [Preorder ι] {m0 : MeasurableSpace Ω} {μ : Measure Ω} [AddCommGroup E]
...
variable {F : Type*} [AddCommGroup F] [NormedAddCommGroup F] [PartialOrder F] [NormedSpace ℝ F]
  [CompleteSpace F] [IsOrderedModule ℝ F]
