...
theorem Module.Finite.span_of_finite {A : Set M} (hA : Set.Finite A) :
...
instance Module.Finite.span_singleton (x : M) : Module.Finite R (R ∙ x) :=
  Module.Finite.span_of_finite R <| Set.finite_singleton _

/-- The submodule generated by a finset is `R`-finite. -/
instance Module.Finite.span_finset (s : Finset M) : Module.Finite R (span R (s : Set M)) :=
