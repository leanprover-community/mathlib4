...
variable [IsDomain R] [IsDomain S] [Module.IsTorsionFree R S] [IsIntegrallyClosed R]
...
theorem minpoly_eq [IsDomain R] [IsDomain S] [Module.IsTorsionFree R S] [IsIntegrallyClosed R]
...
theorem Algebra.adjoin.powerBasis'_minpoly_gen [IsDomain R] [IsDomain S] [Module.IsTorsionFree R S]
