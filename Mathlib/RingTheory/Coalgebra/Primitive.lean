...
* `Coalgebra.IsSkewPrimitiveElem`: Predicate for an element to be `(g, h)`-skew-primitive.
* `Coalgebra.skewPrimitiveSubmodule`: The submodule of `(g, h)`-skew-primitive elements.
