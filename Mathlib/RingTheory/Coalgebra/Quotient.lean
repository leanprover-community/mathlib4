...
* `Coalgebra.IsCoideal R I` : the submodule `I : Submodule R C` is a coideal.

## Main results

* `Coalgebra` instance on `C ⧸ I` when `[Coalgebra.IsCoideal I]`.
-/
...
noncomputable instance : Coalgebra R (C ⧸ I) where
  coassoc := by ext : 1; simp [coassoc_simps, comul_comp_mkQ]
