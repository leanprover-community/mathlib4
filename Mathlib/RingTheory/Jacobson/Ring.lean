...
private lemma aux_IH {R : Type u} {S : Type v} {T : Type w}
  ...
  have h_eq : algebraMap R (T ⧸ P) =
    ...
    ext r
    simp only [AlgHom.toRingHom_eq_coe, RingEquiv.toRingHom_eq_coe, AlgHom.comp_algebraMap_of_tower,
      coe_comp, coe_coe, AlgEquiv.coe_ringEquiv, Function.comp_apply, AlgEquiv.commutes]
  rw [h_eq]
