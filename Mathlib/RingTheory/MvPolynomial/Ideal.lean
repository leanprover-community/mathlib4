...
lemma idealOfVars_eq_restrictSupportIdeal :
  ...
  · simp only [le_iff_mem_imp_mem, restrictSupportIdeal, Submodule.mem_mk,
      Submodule.mem_toAddSubmonoid, ← Submodule.restrictScalars_mem R (idealOfVars σ R)]
    rw [← le_iff_mem_imp_mem, restrictSupport_eq_span, Submodule.span_le, Set.image_subset_iff]
    intro x hx
