...
@[simp]
theorem weightedHomogeneousComponent_zero [CanonicallyOrderedAdd M] [Module.IsTorsionFree ℕ M]
    (hw : ∀ i : σ, w i ≠ 0) :
...
theorem nonTorsionWeight_of [Module.IsTorsionFree ℕ M] (hw : ∀ i : σ, w i ≠ 0) :
    NonTorsionWeight w :=
