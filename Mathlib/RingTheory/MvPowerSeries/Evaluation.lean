...
theorem comp_eval₂ {T : Type*} [CommRing T] [UniformSpace T] [LinearTopology T] [CompleteSpace T]
...
theorem comp_aeval {T : Type*} [CommRing T] [UniformSpace T] [UniformAddGroup T] [LinearTopology T]
