...
theorem cast_eq_top {n : ℕ} (hn : n ≠ 0) : (n : Ideal R) = ⊤ :=
  cast_eq_one hn |>.trans one_eq_top

/-- `3 : Ideal R` is *not* the ideal generated by 3, it is simply 1 + 1 + 1 = ⊤. -/
theorem ofNat_eq_top {n : ℕ} [n.AtLeastTwo] : (no_index (OfNat.ofNat n : Ideal R)) = ⊤ :=
  cast_eq_top <| (NeZero.ne' n).symm
