...
/-- The equivalence between `R/Rˣ` and the principal ideals of `R` defined by sending the
class of `x` to the principal ideal generated by `x`. -/
noncomputable def equivIsPrincipal (R : Type*) [CommRing R] [IsDomain R] :
  ...
  have h_main : ∀ ⦃x : R⦄, ∀ ⦃y:R⦄,
    ...
    simp_rw [span_singleton_eq_span_singleton, MulAction.orbit, Set.mem_range, Associated,
    mul_comm x _]
    rfl
...
theorem equivIsPrincipal_apply (R : Type*) [CommRing R] [IsDomain R] (x : R) :
