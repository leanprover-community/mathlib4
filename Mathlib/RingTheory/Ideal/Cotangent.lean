...
lemma spanFinrank_le_of_surjective [IsNoetherianRing R] {R' : Type*} [CommRing R'] [IsLocalRing R']
...
lemma spanFinrank_eq_of_ringEquiv [IsNoetherianRing R] {R' : Type*} [CommRing R'] [IsLocalRing R']
