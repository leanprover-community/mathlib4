...
lemma val_h1CotangentEquivOfSurjective_symm_toCotangent (h : Surjective (algebraMap R S))
    (x : RingHom.ker (algebraMap R S)) : ((h1CotangentEquivOfSurjective h).symm
      ((RingHom.ker (algebraMap R S)).toCotangent x)).1 =
