...
Authors: Thomas Browning, Jingting Wang, Junyan Xu, Andrew Yang
-/
module
...
instance Algebra.EssFiniteType.fiber [h : EssFiniteType R S] :
  ...
  .of_surjective (Ideal.Fiber.algEquivTensor p S).symm.toAlgHom
    (Ideal.Fiber.algEquivTensor p S).symm.surjective
