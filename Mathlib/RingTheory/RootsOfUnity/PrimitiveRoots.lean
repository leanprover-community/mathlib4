...
=======
See `adjoin_pair_eq'` for a version where the root of unity of order `lcm k₁ k₂` is constructed
directly from the ones of order `k₁` and `k₂`.
>>>>>>> 30e729e63f (1st commit)
-/
...
=======
/--
The sub-algebra generated by two roots of unity can be generated by a combination of the two.
-/
>>>>>>> 1b1a5be795 (docstring)
theorem adjoin_pair_eq' (S : Type*) [CommSemiring S] [Algebra S R] {ζ₁ ζ₂ : R} {k₁ : ℕ} {k₂ : ℕ}
    (hζ₁ : IsPrimitiveRoot ζ₁ k₁) (hζ₂ : IsPrimitiveRoot ζ₂ k₂) (hk₁ : k₁ ≠ 0) (hk₂ : k₂ ≠ 0) :
    Algebra.adjoin S {ζ₁, ζ₂} =
      Algebra.adjoin S {ζ₁ ^ (k₁ / k₁.factorizationLCMLeft k₂) *
        ζ₂ ^ (k₂ / k₁.factorizationLCMRight k₂)} :=
  hζ₁.adjoin_pair_eq S hζ₂ hk₁ hk₂ <| pow_mul_pow_lcm hζ₁ hζ₂ hk₁ hk₂
