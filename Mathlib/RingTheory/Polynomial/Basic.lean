...
lemma degreeLE_eq_span_X_pow [DecidableEq R] {n : ℕ} :
...
lemma degreeLT_eq_span_X_pow [DecidableEq R] {n : ℕ} :
...
lemma degreeLT_succ_eq_degreeLE {n : ℕ} : degreeLT R (n + 1) = degreeLE R n := by
  ext x
  by_cases x_zero : x = 0
