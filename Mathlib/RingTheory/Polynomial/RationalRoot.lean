...
variable {M : Submonoid A} [SMul A S] [Algebra A S] [IsLocalization M S] [SMul A K] [Algebra A K] [IsFractionRing A K]
...
variable [SMul A K] [Algebra A K] [IsFractionRing A K]
