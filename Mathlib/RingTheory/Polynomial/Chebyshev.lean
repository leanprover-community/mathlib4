...
theorem iterate_derivative_T_eval_one_eq_div {𝔽} [Field 𝔽] [CharZero 𝔽] (n : ℤ) (k : ℕ) :
...
theorem iterate_derivative_U_eval_one_eq_div {𝔽} [Field 𝔽] [CharZero 𝔽] (n : ℤ) (k : ℕ) :
...
theorem derivative_U_eval_one_eq_div {𝔽} [Field 𝔽] [neZero3 : NeZero (3 : 𝔽)] (n : ℤ) :
