...
theorem single_zero_smul_coeff {Γ} [AddCommMonoid Γ] [PartialOrder Γ] [AddAction Γ Γ']
...
theorem smul_coeff_order_add_order {Γ}
    [AddCommMonoid Γ] [LinearOrder Γ] [IsOrderedCancelAddMonoid Γ]
    [Zero R] [SMulWithZero R V] (x : HahnSeries Γ R) (y : HahnModule Γ R V) :
...
theorem mul_coeff_order_add_order {Γ} [AddCommMonoid Γ] [LinearOrder Γ] [IsOrderedCancelAddMonoid Γ]
