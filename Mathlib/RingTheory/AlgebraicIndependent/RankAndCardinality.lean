...
theorem IsTranscendenceBasis.lift_cardinalMk_eq_max_lift
  ...
  suffices #E = #K by simp [K, this, ← (mk_liftEq.2 ⟨hx.1.aevalEquiv.toEquiv⟩).lift_eq]
...
theorem IsTranscendenceBasis.lift_rank_eq_max_lift
  ...
  have : _ = _ := mk_liftEq.2 ⟨hx.1.aevalEquivField.toEquiv⟩
  simp [K, ← (mk_liftEq.2 ⟨hx.1.aevalEquivField.toEquiv⟩).lift_eq]
