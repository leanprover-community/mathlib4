...
theorem algHom_bijective [Module.IsTorsionFree K L] [Algebra.IsAlgebraic K L] (f : L →ₐ[K] L) :
...
theorem algHom_bijective₂ [Module.IsTorsionFree K L] [DivisionRing R] [Algebra K R]
...
theorem bijective_of_isScalarTower [Module.IsTorsionFree K L] [Algebra.IsAlgebraic K L]
...
@[simps]
noncomputable def algEquivEquivAlgHom [Module.IsTorsionFree K L] [Algebra.IsAlgebraic K L] :
