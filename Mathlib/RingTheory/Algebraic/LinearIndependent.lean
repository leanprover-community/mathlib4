...
theorem Transcendental.linearIndependent_sub_inv
  ...
  simp_rw [map_zero, p, map_sum, map_mul, map_prod, map_sub, aeval_X, aeval_C,
    Algebra.algebraMap_self_apply, ← s.sum_erase_add _ hi, Finset.sum_eq_zero h2, zero_add] at hm
