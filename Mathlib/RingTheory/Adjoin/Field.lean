...
lemma IsIntegral.mem_range_algHom_of_minpoly_splits (f : K →ₐ[R] L) : x ∈ f.range :=
...
lemma IsIntegral.mem_range_algebraMap_of_minpoly_splits [Algebra K L] [IsScalarTower R K L] :
...
lemma IsIntegral.minpoly_splits_tower_top' {f : K →+* L}
...
lemma IsIntegral.minpoly_splits_tower_top [Algebra K L] [IsScalarTower R K L]
