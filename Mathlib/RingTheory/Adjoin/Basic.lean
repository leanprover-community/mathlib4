...
variable [SMul R S] [Algebra R S] [SMul R A] [Algebra R A]
variable [SMul S A] [Algebra S A] [SMul R B] [Algebra R B] [IsScalarTower R S A]
variable {s t : Set A}
...
variable [SMul R A] [Algebra R A] {s t : Set A}
variable (R s t)
...
theorem pow_smul_mem_of_smul_subset_of_mem_adjoin [CommSemiring B] [SMul R B] [Algebra R B]
    [SMul A B] [Algebra A B]
...
variable (F E : Type*) {K : Type*} [CommSemiring E] [Semiring K] [SMul F E] [SMul E K] [Algebra E K]
...
variable [CommSemiring F] [SMul F K] [Algebra F K] [IsScalarTower F E K] (L : Subalgebra F K) {F}
...
theorem Algebra.restrictScalars_adjoin (F : Type*) [CommSemiring F] {E : Type*} [CommSemiring E]
    [SMul F E] [Algebra F E] (K : Subalgebra F E) (S : Set E) :
...
theorem Algebra.restrictScalars_adjoin_of_algEquiv
    ...
    [SMul F L] [Algebra F L] [SMul L E] [Algebra L E] [SMul F L'] [Algebra F L']
    [SMul L' E] [Algebra L' E] [SMul F E] [Algebra F E]
