...
-- See https://github.com/leanprover-community/mathlib4/issues/26018 . The
-- definition `KaehlerDifferential.mvPolynomialEquiv` typechecks 200 times more slowly
-- if `σ`'s universe name is after `u` in the alphabet.
...
def KaehlerDifferential.mvPolynomialEquiv (σ : Type t) :
