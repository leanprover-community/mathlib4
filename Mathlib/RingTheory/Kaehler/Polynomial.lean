...
variable (R : Type v) [CommRing R] (σ : Type u)
...
def KaehlerDifferential.mvPolynomialEquiv :
...
def KaehlerDifferential.mvPolynomialBasis :
...
lemma KaehlerDifferential.mvPolynomialBasis_repr_D (x) :
...
@[simp]
lemma KaehlerDifferential.mvPolynomialBasis_repr_D_X (i) :
    (mvPolynomialBasis R σ).repr (D _ _ (.X i)) = Finsupp.single i 1 := by
  simp [mvPolynomialBasis_repr_D]

@[simp]
lemma KaehlerDifferential.mvPolynomialBasis_repr_apply (x) (i) :
...
lemma KaehlerDifferential.mvPolynomialBasis_repr_symm_single (i) (x) :
...
@[simp]
lemma KaehlerDifferential.mvPolynomialBasis_apply (i) :
    mvPolynomialBasis R σ i = D R (MvPolynomial σ R) (.X i) :=
  (mvPolynomialBasis_repr_symm_single R σ i 1).trans (one_smul _ _)

instance : Module.Free (MvPolynomial σ R) Ω[MvPolynomial σ R⁄R] :=
