...
lemma δ_C {r : S} (hr : MvPolynomial.C r ∈ Q.ker) :
    δ Q P ⟨Extension.Cotangent.mk ⟨MvPolynomial.C r, hr⟩,
      Extension.Cotangent.mk_C_mem_ker_cotangentComplex ..⟩ = 1 ⊗ₜ[S] D R S r := by
  rw [δ_eq_δAux, δAux_C]
