...
noncomputable def equivNum [Nontrivial P] [Module.IsTorsionFree R P]
...
@[simp]
 theorem equivNum_apply [Nontrivial P] [Module.IsTorsionFree R P] {I : FractionalIdeal S P}
    (h_nz : (I.den : R) ≠ 0) (x : I) :
...
theorem zero_of_num_eq_bot [Module.IsTorsionFree R P] (hS : 0 ∉ S) {I : FractionalIdeal S P}
    (hI : I.num = ⊥) : I = 0 := by
