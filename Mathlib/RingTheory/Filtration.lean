...
instance (priority := 10000) : Sup (I.Filtration M) :=
  ⟨fun F F' =>
...
instance (priority := 10000) : SupSet (I.Filtration M) :=
  ⟨fun S =>
...
instance (priority := 10000) : Inf (I.Filtration M) :=
  ⟨fun F F' =>
...
instance (priority := 10000) : InfSet (I.Filtration M) :=
  ⟨fun S =>
...
instance (priority := 10000) : Top (I.Filtration M) :=
  ⟨I.trivialFiltration ⊤⟩

instance (priority := 10000) : Bot (I.Filtration M) :=
  ⟨I.trivialFiltration ⊥⟩
...
instance (priority := 10000) : CompleteLattice (I.Filtration M) :=
...
instance (priority := 10000) : Inhabited (I.Filtration M) :=
  ⟨⊥⟩
