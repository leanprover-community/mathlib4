...
lemma Ideal.isRadical_iff_quotient_reduced {R : Type*} [CommRing R] (I : Ideal R) :
...
lemma Ideal.IsNilpotent.induction_on (hI : IsNilpotent I)
...
lemma IsNilpotent.isUnit_quotient_mk_iff {R : Type*} [CommRing R] {I : Ideal R}
