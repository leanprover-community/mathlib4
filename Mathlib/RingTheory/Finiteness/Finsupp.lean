...
instance moduleFinite : Module.Finite R S[ι] := .equiv <| .symm <| coeffLinearEquiv _
...
instance moduleFinite : Module.Finite R (MonoidAlgebra S ι) := .equiv <| .symm <| coeffLinearEquiv _
