...
theorem isArtinian_of_fg_of_artinian {R M} [Ring R] [AddCommMonoid M] [Module R M]
...
artinian. -/
theorem isArtinian_span_of_finite (R) {M} [Ring R] [AddCommMonoid M] [Module R M] [IsArtinianRing R]
