...
instance (priority := 10000) frobeniusFun_isPoly : IsPoly p fun R _Rcr => @frobeniusFun p R _ _Rcr :=
...
-- Porting note: replaced `@[is_poly]` with `instance`.
instance (priority := 10000) frobenius_isPoly : IsPoly p fun R _Rcr => @frobenius p R _ _Rcr :=
