...
lemma RingHom.OfLocalizationSpan.mk (hP : RingHom.RespectsIso P)
  ...
  rw [this]
  exact hP.1 _ (IsLocalization.Away.tensorRightEquiv S r (Localization.Away r)).symm.toRingEquiv
    (hf ⟨r, hr⟩)
...
lemma RingHom.OfLocalizationSpanTarget.ofIsLocalization
  ...
  rw [← RingHom.comp_assoc, RingEquiv.toRingHom_eq_coe, Localization.coe_algEquiv_symm,
