...
/-!
# Propertiers that are local properties of commutative rings
...
* `Function.Surjective` : `localizationPreserves_surjective`, `surjective_of_localizationSpan`.
...
* `IsIntegrallyClosed` : `isIntegrallyClosed_ofLocalizationMaximal`
...
-- TODO: Prove that `IsIntegrallyClosed` is preserved by localization
