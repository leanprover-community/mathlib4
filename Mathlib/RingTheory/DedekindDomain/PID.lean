...
lemma Ideal.eq_span_singleton_of_mem_of_not_mem_sq_of_not_mem_prime_ne {P : Ideal R}
...
lemma FractionalIdeal.isPrincipal_of_unit_of_comap_mul_span_singleton_eq_top {R A : Type*}
...
lemma FractionalIdeal.isPrincipal.of_finite_maximals_of_inv {A : Type*} [CommRing A]
...
lemma IsPrincipalIdealRing.of_finite_primes [IsDomain R] [IsDedekindDomain R]
...
lemma IsLocalization.OverPrime.mem_normalizedFactors_of_isPrime [DecidableEq (Ideal Sₚ)]
...
lemma IsDedekindDomain.isPrincipalIdealRing_localization_over_prime :
