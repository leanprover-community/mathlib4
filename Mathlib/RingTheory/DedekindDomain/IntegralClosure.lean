...
theorem IsIntegralClosure.isLocalization [IsDomain A] [Algebra.IsAlgebraic K L] :
  ...
  haveI : Module.IsTorsionFree A L := Module.IsTorsionFree.trans_faithfulSMul A K L
  haveI : Module.IsTorsionFree A C := IsIntegralClosure.noZeroSMulDivisors A L
...
a free `A`-module. -/
theorem IsIntegralClosure.module_free [Module.IsTorsionFree A L] [IsPrincipalIdealRing A] :
    Module.Free A C :=
  haveI : Module.IsTorsionFree A C := IsIntegralClosure.noZeroSMulDivisors A L
...
theorem IsIntegralClosure.rank [IsPrincipalIdealRing A] [Module.IsTorsionFree A L] :
...
instance [Module.Finite A C] [Module.IsTorsionFree A C] :
