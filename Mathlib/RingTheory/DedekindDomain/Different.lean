...
lemma dual_inv_le :
  ...
  convert mul_left_mono ((dual A K I)⁻¹)
    (mul_right_mono I (inv_le_dual A K I)) using 1
...
lemma dual_eq_mul_inv :
  ...
  · suffices dual A K I * I ≤ dual A K 1 by
      convert mul_left_mono I⁻¹ this using 1; simp only [mul_inv_cancel₀ hI, mul_one, mul_assoc]
