...
theorem isEquiv_tfae [LinearOrderedCommGroupWithZero Γ₀] [LinearOrderedCommGroupWithZero Γ'₀]
  ...
  tfae_have 1 ↔ 2 := by apply isEquiv_iff_val_le_one
  tfae_have 1 ↔ 3 := by apply isEquiv_iff_val_eq_one
  tfae_have 1 ↔ 4 := by apply isEquiv_iff_val_lt_one
  tfae_have 1 ↔ 5 := by apply isEquiv_iff_val_sub_one_lt_one
  tfae_finish
