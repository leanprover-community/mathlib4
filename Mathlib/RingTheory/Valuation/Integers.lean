...
variable {R : Type u} {Γ₀ : Type v} [Ring R] [CommGroupWithZero Γ₀] [LinearOrderedCommGroupWithZero Γ₀]
...
variable {F : Type u} {Γ₀ : Type v} [Field F] [CommGroupWithZero Γ₀] [LinearOrderedCommGroupWithZero Γ₀]
