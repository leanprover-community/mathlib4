...
#align_import ring_theory.localization.away.adjoin_root from "leanprover-community/mathlib"@"a7c017d750512a352b623b1824d75da5998457d0"
...
theorem IsLocalization.adjoin_inv (r : R) :
  letI : Algebra R (AdjoinRoot (C r * X - 1)) := AdjoinRoot.instAlgebra (Polynomial.C r * Polynomial.X - 1)
  IsLocalization.Away r (AdjoinRoot <| C r * X - 1):=
