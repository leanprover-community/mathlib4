...
variable [CommRing K] [SMul A K] [Algebra A K] [IsFractionRing A K]
...
/-- The canonical map from a localization of `A` at `S` to the fraction ring
  of `A`, given that `S ≤ A⁰`. -/
noncomputable def mapToFractionRing (B : Type*) [CommRing B] [SMul A B] [Algebra A B] [IsLocalization S B]
    (hS : S ≤ A⁰) : B →ₐ[A] K :=
...
@[simp]
theorem mapToFractionRing_apply {B : Type*} [CommRing B] [SMul A B] [Algebra A B] [IsLocalization S B]
    (hS : S ≤ A⁰) (b : B) :
...
theorem mem_range_mapToFractionRing_iff (B : Type*) [CommRing B] [SMul A B] [Algebra A B] [IsLocalization S B]
    (hS : S ≤ A⁰) (x : K) :
...
instance isLocalization_range_mapToFractionRing (B : Type*) [CommRing B] [SMul A B] [Algebra A B]
...
instance isFractionRing_range_mapToFractionRing (B : Type*) [CommRing B] [SMul A B] [Algebra A B]
...
variable [Field K] [SMul A K] [Algebra A K] [IsFractionRing A K]

namespace subalgebra

theorem mem_range_mapToFractionRing_iff_ofField (B : Type*) [CommRing B] [SMul A B] [Algebra A B]
