...
theorem coeffIntegerNormalization_of_notMem_support (p : S[X]) (i : ℕ) (h : coeff p i = 0) :
...
alias coeffIntegerNormalization_of_not_mem_support := coeffIntegerNormalization_of_notMem_support
