...
theorem compRingEquiv_det_mul_pow :
  ...
  · simp_rw [_root_.map_mul, det_mul, ((auxMat_blockTriangular M k).mapMatrix f).compRingEquiv
      ...
      det_reindex_self, f.mapMatrix_apply, toSquareBlock_map, auxMat_toSquareBlock_eq,
      auxMat_toSquareBlock_ne, smul_one_eq_diagonal, ← diagonal_one,
  ...
  · simp_rw [((mul_auxMat_blockTriangular M k).mapMatrix f).compRingEquiv.det_fintype,
      ...
      f.mapMatrix_apply, toSquareBlock_map, mul_auxMat_toSquareBlock_eq, smul_one_eq_diagonal,
