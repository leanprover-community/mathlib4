...
instance FormallySmooth.mvPolynomial (σ : Type*) : FormallySmooth R (MvPolynomial σ R) := by
...
@[deprecated (since := "2026-05_20")] alias mvPolynomial := FormallySmooth.mvPolynomial
