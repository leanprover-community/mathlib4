...
variable {R S T : Type*} [CommRing R] [Ring S] [SMul R S] [Algebra R S]
variable {A B : Type*} [CommRing A] [CommRing B] [IsDomain B] [SMul A B] [Algebra A B]
...
structure PowerBasis (R S : Type*) [CommRing R] [Ring S] [SMul R S] [Algebra R S] where
  gen : S
  dim : ℕ
...
theorem algHom_ext {S' : Type*} [Semiring S'] [SMul R S'] [Algebra R S'] (pb : PowerBasis R S)
...
variable [SMul A S] [Algebra A S] {S' : Type*} [Ring S'] [SMul A S'] [Algebra A S']
...
theorem linearIndependent_pow [SMul K S] [Algebra K S] (x : S) :
...
variable {S' : Type*} [CommRing S'] [SMul R S'] [Algebra R S']
...
variable [SMul A S] [Algebra A S] [SMul A S'] [Algebra A S']
