...
theorem mem_span_pow' {x y : S} {d : ℕ} :
  ...
  simp only [this, mem_span_image_iff_linearCombination, degree_lt_iff_coeff_zero,
    FinsuppWith.support, exists_iff_exists_finsupp, coeff, aeval_def, eval₂RingHom', eval₂_eq_sum,
    Polynomial.sum, mem_supported', linearCombination, Finsupp.sum, Algebra.smul_def, eval₂_zero,
    exists_prop, LinearMap.id_coe, eval₂_one, id, not_lt, Finsupp.coe_lsum, LinearMap.coe_smulRight,
