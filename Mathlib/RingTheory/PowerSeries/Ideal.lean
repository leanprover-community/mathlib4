...
* `PowerSeries.Ideal.IsPrime.FG_iff` : a prime ideal `P` of `R⟦X⟧` if finitely generated if and only
...
polynomials. On the other hand our proof has the advantage of giving explicitely the number of
