...
def quotCompMap (i : ι) : 𝒜 i →ₗ[R] quotSubmodules 𝒜 rel i where
...
def quotDecompose' : DirectSum ι (fun i ↦ quotSubmodules 𝒜 rel i) →ₗ[R] RingQuot rel :=
  toModule R ι _ (fun i => Submodule.subtype (quotSubmodules 𝒜 rel i))
