...
variable [SetLike σM M] [AddSubmonoidClass σM M]
variable  (ℳ : ιM → σM) (𝒜 : ιA → σA)

variable [DecidableEq ιA] [AddMonoid ιA] [GradedRing 𝒜]
variable [DecidableEq ιM] [Decomposition ℳ]
...
variable [Semiring A] [AddCommMonoid M] [Module A M] [SetLike σM M]
...
variable [DecidableEq ιA] [AddMonoid ιA] [SetLike σA A] [SetLike σA A]
variable (𝒜 : ιA → σA)

variable [Semiring A] [AddCommMonoid M] [Module A M] [SetLike σM M]

variable [SetLike σM M] [AddSubmonoidClass σM M] (ℳ : ιM → σM)

variable [DecidableEq ιM] [AddMonoid ιM] [Decomposition ℳ]
variable [AddSubmonoidClass σA A] [GradedRing 𝒜]
...
theorem Submodule.homogeneous_span (s : Set M) (h : ∀ x ∈ s, Homogeneous ℳ x) :
  ...
  rintro z hz1
  apply Submodule.mul_homogeneous_element_mem_of_mem 𝒜
  · exact h _ (hc hz1)
...
variable (ℳ : ιM → σM) [DecidableEq ιM] [AddSubmonoidClass σM M] [Decomposition ℳ]
variable [DecidableEq ιA] [AddMonoid ιA] [SetLike σA A] [AddSubmonoidClass σA A]
variable (𝒜 : ιA → σA) [GradedRing 𝒜] [VAdd ιA ιM] [GradedSMul 𝒜 ℳ]
...
variable [CommSemiring A] [AddCommMonoid M] [Module A M]


variable [DecidableEq ιM] [AddMonoid ιM]
variable [SetLike σM M] [AddSubmonoidClass σM M] {ℳ : ιM → σM} [Decomposition ℳ]

variable [DecidableEq ιA] [AddMonoid ιA]

variable [SetLike σA A] [AddSubmonoidClass σA A] {𝒜 : ιA → σA} [GradedRing 𝒜]
...
variable [DecidableEq ιA] [AddMonoid ιA]
variable [SetLike σA A] [AddSubmonoidClass σA A] (𝒜 : ιA → σA) [GradedRing 𝒜]
variable [DecidableEq ιM] [AddMonoid ιM] [VAdd ιA ιM]
variable [SetLike σM M] [AddSubmonoidClass σM M] (ℳ : ιM → σM) [Decomposition ℳ] [GradedSMul 𝒜 ℳ]
...
variable [Semiring A] [AddCommMonoid M] [Module A M] [DecidableEq ιA] [AddMonoid ιA]

variable (𝒜 : ιA → σA)  (ℳ : ιM → σM) [DecidableEq ιM] [SetLike σM M] [AddSubmonoidClass σM M] [Decomposition ℳ]
...
variable [SetLike σA A] [AddSubmonoidClass σA A] (𝒜 : ιA → σA) [GradedRing 𝒜]
variable (ℳ : ιM → σM) [DecidableEq ιM] [SetLike σM M] [AddSubmonoidClass σM M] [Decomposition ℳ] [VAdd ιA ιM] [GradedSMul 𝒜 ℳ]
