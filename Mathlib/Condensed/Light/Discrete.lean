...
variable (C : Type w) [Category.{u} C] [HasSheafify (coherentTopology LightProfinite) C]

example : HasSheafify (coherentTopology LightProfinite.{u}) (Type u) := inferInstance
-- example : HasSheafify (coherentTopology LightProfinite.{u}) (AddCommGroupCat.{u}) :=
--   inferInstance
