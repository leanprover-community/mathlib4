...
@[simp] lemma mul_div_eq_left₀ (a : G₀) (h : b ≠ 0) : a * b / b = a := h.isUnit.mul_div_eq_left _
...
lemma div_mul_eq_inv_left₀ (hb : b ≠ 0) (a : G₀) : b / (a * b) = a⁻¹ :=
  hb.isUnit.div_mul_eq_inv_left _

@[deprecated div_mul_eq_inv_left₀] -- 2024-03-20
...
lemma div_mul_eq_inv_right₀ (ha : a ≠ 0) (b : G₀) : a / (a * b) = b⁻¹ :=
  ha.isUnit.div_mul_eq_inv_right _
...
lemma mul_div_eq_right₀ (b : G₀) (ha : a ≠ 0) : a * b / a = b := ha.isUnit.mul_div_eq_right _
#align mul_div_cancel_left mul_div_eq_right₀
...
-- 2024-03-20
-- The names `div_mul_cancel` and `mul_div_cancel` have been reused
-- @[deprecated] alias div_mul_cancel := div_mul_cancel₀
-- @[deprecated] alias mul_div_cancel := mul_div_eq_left₀
@[deprecated] alias mul_div_cancel_left := mul_div_eq_right₀
