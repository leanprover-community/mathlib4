...
@[inherit_doc] postfix:arg "⁺ᵐ" => OneLePart.oneLePart
@[inherit_doc] postfix:arg "⁻ᵐ" => LeOnePart.leOnePart
@[inherit_doc] postfix:arg "⁺" => PosPart.posPart
@[inherit_doc] postfix:arg "⁻" => NegPart.negPart
