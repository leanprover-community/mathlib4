...
instance (priority := 10000) contravariant_lt_of_covariant_le [LinearOrder N]
...
instance (priority := 10000) covariant_lt_of_contravariant_le [LinearOrder N]
...
@[to_additive]
instance (priority := 10000) covariant_swap_mul_of_covariant_mul [CommSemigroup N]
    [CovariantClass N N (· * ·) r] : CovariantClass N N (swap (· * ·)) r where
  elim := (covariant_flip_iff N r (· * ·)).mpr CovariantClass.elim

@[to_additive]
instance (priority := 10000) contravariant_swap_mul_of_contravariant_mul [CommSemigroup N]
...
@[to_additive]
instance (priority := 10000) IsLeftCancelMul.covariant_mul_lt_of_covariant_mul_le [Mul N] [IsLeftCancelMul N]
...
@[to_additive]
instance (priority := 10000) IsRightCancelMul.covariant_swap_mul_lt_of_covariant_swap_mul_le
...
@[to_additive]
instance (priority := 10000) IsLeftCancelMul.contravariant_mul_le_of_contravariant_mul_lt [Mul N] [IsLeftCancelMul N]
...
@[to_additive]
instance (priority := 10000) IsRightCancelMul.contravariant_swap_mul_le_of_contravariant_swap_mul_lt
