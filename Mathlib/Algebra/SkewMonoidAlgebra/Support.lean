...
The following lemma is currently missing since it needs the definition of `SkewMonoidAlgebra.of`:
- `mem_span_support`
-/
...
variable [Monoid G] [Semiring k] [MulSemiringAction G k] [DecidableEq G]
