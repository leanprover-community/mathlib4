...
instance (priority := 10000) mono_v₀₁_τ₁ : Mono S.v₀₁.τ₁ := mono_of_isLimit_fork S.h₀τ₁
instance (priority := 10000) mono_v₀₁_τ₂ : Mono S.v₀₁.τ₂ := mono_of_isLimit_fork S.h₀τ₂
instance (priority := 10000) mono_v₀₁_τ₃ : Mono S.v₀₁.τ₃ := mono_of_isLimit_fork S.h₀τ₃
...
instance (priority := 10000) mono_L₀_f [Mono S.L₁.f] : Mono S.L₀.f := by
...
instance (priority := 10000) epi_v₂₃_τ₁ : Epi S.v₂₃.τ₁ := epi_of_isColimit_cofork S.h₃τ₁
instance (priority := 10000) epi_v₂₃_τ₂ : Epi S.v₂₃.τ₂ := epi_of_isColimit_cofork S.h₃τ₂
instance (priority := 10000) epi_v₂₃_τ₃ : Epi S.v₂₃.τ₃ := epi_of_isColimit_cofork S.h₃τ₃
...
instance (priority := 10000) epi_L₃_g [Epi S.L₂.g] : Epi S.L₃.g := by
...
instance (priority := 10000) : Epi S.L₀'.g := by dsimp only [L₀']; infer_instance

instance (priority := 10000) [Mono S.L₁.f] : Mono S.L₀'.f :=
...
instance (priority := 10000) : Category (SnakeInput C) where
  Hom := Hom
  id := Hom.id
  comp := Hom.comp
