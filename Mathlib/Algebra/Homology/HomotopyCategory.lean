...
@[simp]
lemma homologyFactors_hom_app (i : ι) (C : HomologicalComplex V c) :
...
@[simp]
lemma homologyFactors_inv_app (i : ι) (C : HomologicalComplex V c) :
...
lemma homologyFunctor_map_factors (i : ι) {C D : HomologicalComplex V c} (f : C ⟶ D) :
