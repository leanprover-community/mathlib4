...
def threeδ₁Toδ₀ :
    mk₂ f₁₂ f₃ ⟶ mk₂ f₂ f₃ :=
  homMk₂ f₁ (𝟙 _) (𝟙 _) (by simpa using h₁₂.symm) (by sorry)
...
def fourδ₄Toδ₃ :
    mk₃ f₁ f₂ f₃ ⟶ mk₃ f₁ f₂ f₃₄ :=
  homMk₃ (𝟙 _) (𝟙 _) (𝟙 _) f₄ (by simp) (by sorry) (by simpa using h₃₄)
...
def fourδ₂Toδ₁ :
    mk₃ f₁ f₂₃ f₄ ⟶ mk₃ f₁₂ f₃ f₄ :=
  homMk₃ (𝟙 _) f₂ (𝟙 _) (𝟙 _) (by simpa using h₁₂) (by simpa using h₂₃.symm) (by sorry)
...
def fourδ₁Toδ₀ :
    mk₃ f₁₂ f₃ f₄ ⟶ mk₃ f₂ f₃ f₄ :=
  homMk₃ f₁ (𝟙 _) (𝟙 _) (𝟙 _) (by simpa using h₁₂.symm) (by sorry) (by sorry)
