...
lemma comm₁ (j : J) :
  ...
  simp? [HomologicalComplex₂.total_d, h₁.comm i₁, dFrom, fromNext, toPrev, dTo] says
    simp only [ι_mapBifunctorMap, h₁.comm i₁, dNext_eq_dFrom_fromNext, dFrom, fromNext,
      ...
      NatTrans.app_add, NatTrans.comp_app, Preadditive.add_comp, assoc, HomologicalComplex₂.total_d,
  ...
  · by_cases h₃ : c₁.Rel i₁ (c₁.next i₁)
    · rw [HomologicalComplex₂.d₁_eq _ _ h₃ _ _ (by rw [← h, ComplexShape.next_π₁ c₂ c h₃]),
        ...
        ιMapBifunctor_hom₁ _ _ _ _ i₁ _ _ _ _ _ (c₁.prev_eq' h₃), Linear.comp_units_smul, smul_smul,
        Int.units_mul_self, one_smul, ιMapBifunctorOrZero_eq]
...
noncomputable def mapBifunctorMapHomotopy₂ :
  ...
  haveI hom₂_eq : hom₂ f₁ h₂ F c = H.hom := by
    ...
    · rw [ιMapBifunctorOrZero_eq _ _ _ _ _ _ _ hj',
      ...
      · congr 1
        nth_rw 2 [mul_comm]
        rw [← ComplexShape.σ_ε₂ c₁ c i₁ hi₂, mul_comm, ← mul_assoc, Int.units_mul_self, one_mul]
      · rw [h₂.zero _ _ hi₂, Functor.map_zero, zero_comp, comp_zero, smul_zero, smul_zero]
    · rw [ιMapBifunctorOrZero_eq_zero _ _ _ _ _ _ _ hj',
        ιMapBifunctorOrZero_eq_zero _ _ _ _ _ _ _ (by rwa [ComplexShape.π_symm c₁ c₂ c]), comp_zero,
        comp_zero, smul_zero, zero_comp, comp_zero, comp_zero, smul_zero, smul_zero]
  { hom := hom₂ f₁ h₂ F c
