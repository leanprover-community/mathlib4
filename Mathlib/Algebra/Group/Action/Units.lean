...
/-- This is not the usual `smul_eq_mul` because `mulAction'` creates a diamond. See zulip:
https://leanprover.zulipchat.com/#narrow/channel/113488-general/topic/units.2Emul_action'.20diamond/near/246400399 -/
@[simp]
