...
/-!
# Algebraic operations on `M × N`

In this file we define algebraic operations on a product type.
Instances saying that these operations are lawful go to other files.
-/

assert_not_exists MulOneClass
