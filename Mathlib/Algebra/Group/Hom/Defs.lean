...
@[to_additive (attr := deprecated) "Deprecated: use `DFunLike.congr_fun` instead."] -- 2022-12-03
...
@[to_additive (attr := deprecated) "Deprecated: use `DFunLike.congr_arg` instead."] -- 2022-12-03
...
/-- Deprecated: use `DFunLike.coe_injective` instead. -/ -- since 2022-12-03
...
@[to_additive (attr := deprecated) "Deprecated: use `DFunLike.ext_iff` instead."] -- 2022-12-03
