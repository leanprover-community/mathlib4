...
attribute [instance 75] AddLeftCancelMonoid.toAddLeftCancelSemigroup

/-- A monoid in which multiplication is left-cancellative. -/
@[to_additive]
class LeftCancelMonoid (M : Type u) extends Monoid M, LeftCancelSemigroup M

attribute [instance 75] LeftCancelMonoid.toLeftCancelSemigroup -- See note [lower cancel priority]
...
-- See note [lower cancel priority]
attribute [instance 75] AddRightCancelMonoid.toAddRightCancelSemigroup

/-- A monoid in which multiplication is right-cancellative. -/
@[to_additive]
class RightCancelMonoid (M : Type u) extends Monoid M, RightCancelSemigroup M

attribute [instance 75] RightCancelMonoid.toRightCancelSemigroup -- See note [lower cancel priority]
...
-- See note [lower cancel priority]
attribute [instance 75] AddCancelCommMonoid.toAddLeftCancelMonoid

/-- Commutative version of `CancelMonoid`. -/
@[to_additive]
class CancelCommMonoid (M : Type u) extends CommMonoid M, LeftCancelMonoid M

attribute [instance 75] CancelCommMonoid.toLeftCancelMonoid -- See note [lower cancel priority]
