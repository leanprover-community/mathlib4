...
including monoids and groups. Structures that do not require an identity are defined in
...
/-! We initialize the projections for the monoid and group structures for `@[simps]` here.
