...
@[to_additive]
instance (priority := 10000) one [One α] : One (ULift α) :=
  ⟨⟨1⟩⟩
...
@[to_additive]
instance (priority := 10000) mul [Mul α] : Mul (ULift α) :=
...
@[to_additive]
instance (priority := 10000) div [Div α] : Div (ULift α) :=
  ⟨fun f g => ⟨f.down / g.down⟩⟩
...
@[to_additive]
instance (priority := 10000) inv [Inv α] : Inv (ULift α) :=
  ⟨fun f => ⟨f.down⁻¹⟩⟩
...
@[to_additive]
instance (priority := 10000) smul [SMul α β] : SMul α (ULift β) :=
  ⟨fun n x => up (n • x.down)⟩
...
instance (priority := 10000) pow [Pow α β] : Pow (ULift α) β :=
  ⟨fun x n => up (x.down ^ n)⟩
...
--@[to_additive]
instance (priority := 10000) semigroup [Semigroup α] : Semigroup (ULift α) :=
  (MulEquiv.ulift.injective.semigroup _) fun _ _ => rfl
#align ulift.semigroup ULift.semigroup

instance (priority := 10000) addSemigroup [AddSemigroup α] : AddSemigroup (ULift α) :=
  (Equiv.ulift.injective.addSemigroup _) fun _ _ => rfl
#align ulift.add_semigroup ULift.addSemigroup


@[to_additive]
instance (priority := 10000) commSemigroup [CommSemigroup α] : CommSemigroup (ULift α) :=
...
@[to_additive]
instance (priority := 10000) mulOneClass [MulOneClass α] : MulOneClass (ULift α) :=
...
instance (priority := 10000) mulZeroOneClass [MulZeroOneClass α] : MulZeroOneClass (ULift α) :=
  Equiv.ulift.injective.mulZeroOneClass _ rfl rfl (by intros; rfl)
#align ulift.mul_zero_one_class ULift.mulZeroOneClass

@[to_additive]
instance (priority := 10000) monoid [Monoid α] : Monoid (ULift α) :=
...
@[to_additive]
instance (priority := 10000) commMonoid [CommMonoid α] : CommMonoid (ULift α) :=
...
instance (priority := 10000) natCast [NatCast α] : NatCast (ULift α) := ⟨λ a ↦ up a⟩
#align ulift.has_nat_cast ULift.natCast
instance (priority := 10000) intCast [IntCast α] : IntCast (ULift α) := ⟨λ a ↦ up a⟩
...
instance (priority := 10000) addMonoidWithOne [AddMonoidWithOne α] : AddMonoidWithOne (ULift α) :=
...
instance (priority := 10000) addCommMonoidWithOne [AddCommMonoidWithOne α] : AddCommMonoidWithOne (ULift α) :=
  { ULift.addMonoidWithOne, ULift.addCommMonoid with }
#align ulift.add_comm_monoid_with_one ULift.addCommMonoidWithOne

instance (priority := 10000) monoidWithZero [MonoidWithZero α] : MonoidWithZero (ULift α) :=
  Equiv.ulift.injective.monoidWithZero _ rfl rfl (fun _ _ => rfl) fun _ _ => rfl
#align ulift.monoid_with_zero ULift.monoidWithZero

instance (priority := 10000) commMonoidWithZero [CommMonoidWithZero α] : CommMonoidWithZero (ULift α) :=
...
@[to_additive]
instance (priority := 10000) divInvMonoid [DivInvMonoid α] : DivInvMonoid (ULift α) :=
...
@[to_additive]
instance (priority := 10000) group [Group α] : Group (ULift α) :=
...
@[to_additive]
instance (priority := 10000) commGroup [CommGroup α] : CommGroup (ULift α) :=
...
instance (priority := 10000) addGroupWithOne [AddGroupWithOne α] : AddGroupWithOne (ULift α) :=
...
instance (priority := 10000) addCommGroupWithOne [AddCommGroupWithOne α] : AddCommGroupWithOne (ULift α) :=
  { ULift.addGroupWithOne, ULift.addCommGroup with }
#align ulift.add_comm_group_with_one ULift.addCommGroupWithOne

instance (priority := 10000) groupWithZero [GroupWithZero α] : GroupWithZero (ULift α) :=
...
instance (priority := 10000) commGroupWithZero [CommGroupWithZero α] : CommGroupWithZero (ULift α) :=
...
@[to_additive]
instance (priority := 10000) leftCancelSemigroup [LeftCancelSemigroup α] : LeftCancelSemigroup (ULift α) :=
...
@[to_additive]
instance (priority := 10000) rightCancelSemigroup [RightCancelSemigroup α] : RightCancelSemigroup (ULift α) :=
...
@[to_additive]
instance (priority := 10000) leftCancelMonoid [LeftCancelMonoid α] : LeftCancelMonoid (ULift α) :=
...
@[to_additive]
instance (priority := 10000) rightCancelMonoid [RightCancelMonoid α] : RightCancelMonoid (ULift α) :=
...
@[to_additive]
instance (priority := 10000) cancelMonoid [CancelMonoid α] : CancelMonoid (ULift α) :=
...
@[to_additive]
instance (priority := 10000) cancelCommMonoid [CancelCommMonoid α] : CancelCommMonoid (ULift α) :=
...
instance (priority := 10000) nontrivial [Nontrivial α] : Nontrivial (ULift α) :=
