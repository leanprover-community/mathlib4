...
lemma Monoid.ext {M : Type u} ⦃m₁ m₂ : Monoid M⦄ (h_mul : m₁.mul = m₂.mul) : m₁ = m₂ := by
...
@[to_additive]
lemma CommMonoid.toMonoid_injective {M : Type u} :
...
@[to_additive (attr := ext)]
lemma CommMonoid.ext {M : Type*} ⦃m₁ m₂ : CommMonoid M⦄ (h_mul : m₁.mul = m₂.mul) : m₁ = m₂ :=
...
@[to_additive]
lemma LeftCancelMonoid.toMonoid_injective {M : Type u} :
...
@[to_additive (attr := ext)]
lemma LeftCancelMonoid.ext {M : Type u} ⦃m₁ m₂ : LeftCancelMonoid M⦄ (h_mul : m₁.mul = m₂.mul) :
    m₁ = m₂ :=
...
@[to_additive]
lemma RightCancelMonoid.toMonoid_injective {M : Type u} :
...
@[to_additive (attr := ext)]
lemma RightCancelMonoid.ext {M : Type u} ⦃m₁ m₂ : RightCancelMonoid M⦄ (h_mul : m₁.mul = m₂.mul) :
    m₁ = m₂ :=
...
@[to_additive]
lemma CancelMonoid.toLeftCancelMonoid_injective {M : Type u} :
...
@[to_additive (attr := ext)]
lemma CancelMonoid.ext {M : Type*} ⦃m₁ m₂ : CancelMonoid M⦄ (h_mul : m₁.mul = m₂.mul) :
    m₁ = m₂ :=
...
@[to_additive]
lemma CancelCommMonoid.toCommMonoid_injective {M : Type u} :
...
@[to_additive (attr := ext)]
lemma CancelCommMonoid.ext {M : Type*} ⦃m₁ m₂ : CancelCommMonoid M⦄ (h_mul : m₁.mul = m₂.mul) :
    m₁ = m₂ :=
...
@[to_additive (attr := ext)]
lemma DivInvMonoid.ext {M : Type*} ⦃m₁ m₂ : DivInvMonoid M⦄ (h_mul : m₁.mul = m₂.mul)
...
@[to_additive (attr := ext)]
lemma Group.ext {G : Type*} ⦃g₁ g₂ : Group G⦄ (h_mul : g₁.mul = g₂.mul) : g₁ = g₂ := by
...
@[to_additive (attr := ext)]
lemma CommGroup.ext {G : Type*} ⦃g₁ g₂ : CommGroup G⦄ (h_mul : g₁.mul = g₂.mul) : g₁ = g₂ :=
