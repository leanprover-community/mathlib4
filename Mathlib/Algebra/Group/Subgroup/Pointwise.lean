...
@[to_additive]
theorem InvMemClass.isMulSymmetric [InvolutiveInv G] [SetLike S G] [InvMemClass S G] (H : S) :
    (H : Set G).IsMulSymmetric :=
  Set.isMulSymmetric_iff_inv_eq_self.mpr inv_coe_set
