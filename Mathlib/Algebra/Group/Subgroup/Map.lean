...
theorem map_symm_eq_iff_map_eq {H : Subgroup N} {e : G ≃* N} :
  ...
  · rw [map_map, ← MulEquiv.ofClass_monoidHom_trans, MulEquiv.symm_trans_self,
      MulEquiv.ofClass_monoidHom_refl, map_id]
  · rw [map_map, ← MulEquiv.ofClass_monoidHom_trans, MulEquiv.self_trans_symm,
      MulEquiv.ofClass_monoidHom_refl, map_id]
