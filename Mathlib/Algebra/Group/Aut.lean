...
This file is kept separate from `Mathlib/Algebra/Group/Equiv/*` so that `GroupTheory.Perm` is free
to use equivalences (and other files that use them) before the group structure is defined.
