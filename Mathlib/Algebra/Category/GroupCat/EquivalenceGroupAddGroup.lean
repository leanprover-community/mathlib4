...
private instance (X : GroupCat) : MulOneClass X.α := fast_instance% X.str.toMulOneClass
private instance (X : CommGroupCat) : MulOneClass X.α := fast_instance% X.str.toMulOneClass
private instance (X : AddGroupCat) : AddZeroClass X.α := fast_instance% X.str.toAddZeroClass
private instance (X : AddCommGroupCat) : AddZeroClass X.α := fast_instance% X.str.toAddZeroClass
