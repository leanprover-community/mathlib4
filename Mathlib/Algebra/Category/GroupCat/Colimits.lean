...
instance (priority := 10000) : Inhabited (Prequotient.{w} F) :=
  ⟨Prequotient.zero⟩
...
instance (priority := 10000) : AddCommGroup (ColimitType.{w} F) where
...
instance (priority := 10000) ColimitTypeInhabited : Inhabited (ColimitType.{w} F) := ⟨0⟩
...
instance (priority := 10000) hasColimits : HasColimits AddCommGroupCat.{w} := hasColimitsOfSize.{w}
#align AddCommGroup.colimits.has_colimits_AddCommGroup AddCommGroupCat.hasColimits

instance (priority := 10000) : HasColimitsOfSize.{v, v} (AddCommGroupCatMax.{u, v}) := hasColimitsOfSize.{u}
instance (priority := 10000) : HasColimitsOfSize.{u, u} (AddCommGroupCatMax.{u, v}) := hasColimitsOfSize.{v}
instance (priority := 10000) : HasColimitsOfSize.{u, v} (AddCommGroupCatMax.{u, v}) := hasColimitsOfSize.{u}
instance (priority := 10000) : HasColimitsOfSize.{v, u} (AddCommGroupCatMax.{u, v}) := hasColimitsOfSize.{u}
instance (priority := 10000) : HasColimitsOfSize.{0, 0} (AddCommGroupCat.{u}) := hasColimitsOfSize.{u, 0, 0}
