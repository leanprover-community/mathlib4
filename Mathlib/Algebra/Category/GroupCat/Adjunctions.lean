...
instance (priority := 10000) : IsRightAdjoint (forget AddCommGroupCat.{u}) :=
  ⟨_, adj⟩
...
instance (priority := 10000) : IsRightAdjoint (forget GroupCat.{u}) :=
  ⟨_, adj⟩
...
instance (priority := 10000) : IsRightAdjoint MonCat.units.{u} :=
...
instance (priority := 10000) : IsRightAdjoint CommMonCat.units.{u} :=
