...
noncomputable def MonoidalCategory.inducingFunctorData :
    Monoidal.InducingFunctorData (forget₂ (BialgCat R) (Alg R)) where
  μIso _ _ := Iso.refl _
...
/-- `forget₂ (BialgCat R) (Alg R)` as a monoidal functor. -/
noncomputable instance : (forget₂ (BialgCat R) (Alg R)).Monoidal where
