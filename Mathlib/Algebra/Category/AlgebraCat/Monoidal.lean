...
--     -- (forget₂ (AlgebraCat.{u} R) (ModuleCat.{u} R)).map (α_ X Y Z).hom = sorry := sorry
--       sorry = (α_
--         (forget₂ (AlgebraCat R) (ModuleCat R) |>.obj X)
--         (forget₂ (AlgebraCat R) (ModuleCat R) |>.obj Y)
--         (forget₂ (AlgebraCat R) (ModuleCat R) |>.obj Z)).hom := by sorry
--   -- rfl
--
