...
instance : MonoidalPreadditive (ModuleCat.{u} R) := by
  ...
  · intros
    ...
    simp only [LinearMap.compr₂ₛₗ_apply, TensorProduct.mk_apply, hom_zero, zero_apply]
  ...
  · intros
    ext : 1
    refine TensorProduct.ext (LinearMap.ext fun x => LinearMap.ext fun y => ?_)
    simp only [LinearMap.compr₂ₛₗ_apply, TensorProduct.mk_apply, hom_add, add_apply]
    -- This used to be `rw`, but we need `erw` after https://github.com/leanprover/lean4/pull/2644
...
instance : MonoidalLinear R (ModuleCat.{u} R) := by
  ...
  · intros
    ext : 1
    refine TensorProduct.ext (LinearMap.ext fun x => LinearMap.ext fun y => ?_)
    simp only [LinearMap.compr₂ₛₗ_apply, TensorProduct.mk_apply, hom_smul, smul_apply]
    -- This used to be `rw`, but we need `erw` after https://github.com/leanprover/lean4/pull/2644
    erw [MonoidalCategory.whiskerLeft_apply, MonoidalCategory.whiskerLeft_apply]
    simp
  · intros
