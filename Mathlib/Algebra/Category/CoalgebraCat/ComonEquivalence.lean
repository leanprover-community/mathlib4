...
constructed in `Mathlib/Algebra/Category/CoalgebraCat/Monoidal.lean` to have better
...
instance we make in `Mathlib/Algebra/Category/CoalgebraCat/Monoidal.lean` has better
definitional equalities. -/
