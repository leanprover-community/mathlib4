...
--@[simp] theorem trailingDegree_le_trailingDegre' (h : coeff q (natTrailingDegree p) ≠ 0) :
...
theorem trailingDegree_ne_of_natTrailingDegree_ne {n : ℕ} :
  ...
  mt natTrailingDegree_eq_of_trailingDegree_eq_some
...
--  rw [natTrailingDegree, trailingDegree_monomial _ ha]
--  rfl
