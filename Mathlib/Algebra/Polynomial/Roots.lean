...
alias roots_C_mul_X_sub_C_of_IsUnit := roots_C_mul_X_sub_C_of_isUnit
...
@[deprecated (since := "2025-01-03")]
alias roots_C_mul_X_add_C_of_IsUnit := roots_C_mul_X_add_C_of_isUnit
...
theorem map_mem_nthRootsFinset {S F : Type*} [CommRing S] [IsDomain S] [FunLike F R S]
    [MonoidHomClass F R S] {x : R} (hx : x ∈ nthRootsFinset n R) (f : F) :
