...
theorem isTorsion_of_aeval_eq_zero [CommSemiring R] [NoZeroDivisors R] [Semiring A] [SMul R A] [Algebra R A]
...
theorem isTorsion_of_finiteDimensional [Field K] [Ring A] [SMul K A] [Algebra K A]
