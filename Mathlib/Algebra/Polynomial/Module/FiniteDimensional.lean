...
lemma isTorsion_of_aeval_eq_zero [CommSemiring R] [NoZeroDivisors R] [Semiring A] [Algebra R A]
...
lemma isTorsion_of_finiteDimensional [Field K] [Ring A] [Algebra K A]
