...
/-- Any set `S` inside a sharp monoid contains the irreducible elements of the submonoid it
generates. -/
@[to_additive /-- Any set `S` inside a sharp monoid contains the irreducible elements of the
...
/-- Irreducible elements lie in all sets generating a sharp monoid. -/
@[to_additive /-- Irreducible elements lie in all sets generating a sharp monoid. -/]
...
/-- A finitely generated submonoid of a sharp monoid has finitely many irreducible elements. -/
@[to_additive
/-- A finitely generated salient submonoid of a sharp monoid has finitely many irreducible
elements. -/]
...
/-- A finitely generated sharp monoid has finitely many irreducible elements. -/
@[to_additive /-- A finitely generated sharp monoid has finitely many irreducible elements. -/]
...
/-- A finitely generated cancellative sharp monoid is generated by its (finitely many) irreducible
elements. -/
