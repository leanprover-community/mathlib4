...
3. Translation lemmas for the sequence: these lemmas show how the sequences of the involved
   structures (`IntFractPair.stream`, `IntFractPair.seq1`, and `GCF.of`) are connected, i.e. how the
   values are moved along the structures and the termination of one sequence implies the termination
   of another sequence.
...
theorem stream_zero (v : K) : IntFractPair.stream v 0 = some (IntFractPair.of v) :=
  rfl
#align generalized_continued_fraction.int_fract_pair.stream_zero GCF.IntFractPair.stream_zero
...
#align generalized_continued_fraction.int_fract_pair.stream_eq_none_of_fr_eq_zero GCF.IntFractPair.stream_eq_none_of_fr_eq_zero
...
#align generalized_continued_fraction.int_fract_pair.succ_nth_stream_eq_none_iff GCF.IntFractPair.succ_nth_stream_eq_none_iff
...
#align generalized_continued_fraction.int_fract_pair.succ_nth_stream_eq_some_iff GCF.IntFractPair.succ_nth_stream_eq_some_iff

/-- An easier to use version of one direction of `GCF.IntFractPair.succ_nth_stream_eq_some_iff`. -/
...
#align generalized_continued_fraction.int_fract_pair.stream_succ_of_some GCF.IntFractPair.stream_succ_of_some
...
#align generalized_continued_fraction.int_fract_pair.stream_succ_of_int GCF.IntFractPair.stream_succ_of_int
...
#align generalized_continued_fraction.int_fract_pair.exists_succ_nth_stream_of_fr_zero GCF.IntFractPair.exists_succ_nth_stream_of_fr_zero
...
#align generalized_continued_fraction.int_fract_pair.stream_succ GCF.IntFractPair.stream_succ
...
theorem IntFractPair.seq1_fst_eq_of : (IntFractPair.seq1 v).fst = IntFractPair.of v :=
  rfl
#align generalized_continued_fraction.int_fract_pair.seq1_fst_eq_of GCF.IntFractPair.seq1_fst_eq_of

theorem of_h_eq_intFractPair_seq1_fst_b : (of v).h = (IntFractPair.seq1 v).fst.b := by
  cases aux_seq_eq : IntFractPair.seq1 v
  simp [of, aux_seq_eq]
#align generalized_continued_fraction.of_h_eq_int_fract_pair_seq1_fst_b GCF.of_h_eq_intFractPair_seq1_fst_b

/-- The head term of the gcf of `v` is `⌊v⌋`. -/
@[simp]
theorem of_h_eq_floor : (of v).h = ⌊v⌋ := by
  simp [of_h_eq_intFractPair_seq1_fst_b, IntFractPair.of]
#align generalized_continued_fraction.of_h_eq_floor GCF.of_h_eq_floor
...
(`IntFractPair.stream`, `IntFractPair.seq1`, and `GCF.of`) are connected, i.e. how the values are
moved along the structures and how the termination of one sequence implies the termination of
another sequence.
-/
...
theorem IntFractPair.get?_seq1_eq_succ_get?_stream :
  ...
  rfl
#align generalized_continued_fraction.int_fract_pair.nth_seq1_eq_succ_nth_stream GCF.IntFractPair.get?_seq1_eq_succ_get?_stream
...
theorem of_terminatedAt_iff_intFractPair_seq1_terminatedAt :
  ...
  Option.map_eq_none
#align generalized_continued_fraction.of_terminated_at_iff_int_fract_pair_seq1_terminated_at GCF.of_terminatedAt_iff_intFractPair_seq1_terminatedAt
...
#align generalized_continued_fraction.of_terminated_at_n_iff_succ_nth_int_fract_pair_stream_eq_none GCF.of_terminatedAt_n_iff_succ_nth_intFractPair_stream_eq_none
...
#align generalized_continued_fraction.int_fract_pair.exists_succ_nth_stream_of_gcf_of_nth_eq_some GCF.IntFractPair.exists_succ_get?_stream_of_gcf_of_get?_eq_some
...
#align generalized_continued_fraction.nth_of_eq_some_of_succ_nth_int_fract_pair_stream GCF.get?_of_eq_some_of_succ_get?_intFractPair_stream
...
#align generalized_continued_fraction.nth_of_eq_some_of_nth_int_fract_pair_stream_fr_ne_zero GCF.get?_of_eq_some_of_get?_intFractPair_stream_fr_ne_zero
...
#align generalized_continued_fraction.of_s_head_aux GCF.of_s_head_aux
...
theorem of_s_head (h : fract v ≠ 0) : (of v).s.head = some ⟨1, ⌊(fract v)⁻¹⌋⟩ := by
  ...
  rfl
#align generalized_continued_fraction.of_s_head GCF.of_s_head
...
#align generalized_continued_fraction.of_s_of_int GCF.of_s_of_int

variable {K} (v)

/-- Recurrence for the `GCF.of` an element `v` of `K` in terms of that of the inverse of the
...
#align generalized_continued_fraction.of_s_succ GCF.of_s_succ

/-- This expresses the tail of the coefficient sequence of the `GCF.of` an element `v` of `K` as the
coefficient sequence of that of the inverse of the fractional part of `v`.
-/
theorem of_s_tail : (of v).s.tail = (of (fract v)⁻¹).s :=
  Stream'.Seq.ext fun n => Stream'.Seq.get?_tail (of v).s n ▸ of_s_succ v n
#align generalized_continued_fraction.of_s_tail GCF.of_s_tail
...
#align generalized_continued_fraction.convergents'_of_int GCF.convs'_of_int
...
#align generalized_continued_fraction.convergents'_succ GCF.convs'_succ
