...
- `GCF.coe_of_rat_eq` shows that
  `GCF.of v = GCF.of q` for `v : α` given that `↑v = q` and `q : ℚ`.
- `GCF.terminates_iff_rat` shows that
  `GCF.of v` terminates if and only if `↑v = q` for some `q : ℚ`.
...
We want to show that the computation of a continued fraction `GCF.of v`
...
#align generalized_continued_fraction.exists_gcf_pair_rat_eq_nth_conts GCF.exists_gcf_pair_rat_eq_nth_conts
...
theorem exists_rat_eq_of_terminates (terminates : (of v).Terminates) : ∃ q : ℚ, v = ↑q := by
  ...
  use q, this
#align generalized_continued_fraction.exists_rat_eq_of_terminates GCF.exists_rat_eq_of_terminates
...
```lean
    (↑(GCF.of q : GCF ℚ) : GCF K) = GCF.of v`
```
in `GCF.coe_of_rat_eq`.
...
#align generalized_continued_fraction.int_fract_pair.coe_of_rat_eq GCF.IntFractPair.coe_of_rat_eq
...
#align generalized_continued_fraction.int_fract_pair.coe_stream_nth_rat_eq GCF.IntFractPair.coe_stream_nth_rat_eq
...
theorem coe_of_h_rat_eq : (↑((of q).h : ℚ) : K) = (of v).h := by
  ...
  simp
#align generalized_continued_fraction.coe_of_h_rat_eq GCF.coe_of_h_rat_eq
...
#align generalized_continued_fraction.coe_of_s_nth_rat_eq GCF.coe_of_s_get?_rat_eq

theorem coe_of_s_rat_eq : ((of q).s.map (Pair.map ((↑))) : Stream'.Seq <| Pair K) = (of v).s := by
  ext n; rw [← coe_of_s_get?_rat_eq v_eq_q]; rfl
#align generalized_continued_fraction.coe_of_s_rat_eq GCF.coe_of_s_rat_eq

/-- Given `(v : K), (q : ℚ), and v = q`, we have that `of q = of v` -/
theorem coe_of_rat_eq :
    (⟨(of q).h, (of q).s.map (Pair.map (↑))⟩ : GCF K) = of v := by
...
#align generalized_continued_fraction.coe_of_rat_eq GCF.coe_of_rat_eq
...
theorem of_terminates_iff_of_rat_terminates {v : K} {q : ℚ} (v_eq_q : v = (q : K)) :
  ...
  constructor <;> intro h <;> cases' h with n h <;> use n <;>
    ...
    trivial
#align generalized_continued_fraction.of_terminates_iff_of_rat_terminates GCF.of_terminates_iff_of_rat_terminates
...
#align generalized_continued_fraction.int_fract_pair.of_inv_fr_num_lt_num_of_pos GCF.IntFractPair.of_inv_fr_num_lt_num_of_pos
...
#align generalized_continued_fraction.int_fract_pair.stream_succ_nth_fr_num_lt_nth_fr_num_rat GCF.IntFractPair.stream_succ_nth_fr_num_lt_nth_fr_num_rat
...
#align generalized_continued_fraction.int_fract_pair.stream_nth_fr_num_le_fr_num_sub_n_rat GCF.IntFractPair.stream_nth_fr_num_le_fr_num_sub_n_rat
...
theorem exists_nth_stream_eq_none_of_rat (q : ℚ) : ∃ n : ℕ, IntFractPair.stream q n = none := by
  ...
  · -- arrive at a contradiction since the numerator decreased num + 1 times but every fractional
    ...
    omega
#align generalized_continued_fraction.int_fract_pair.exists_nth_stream_eq_none_of_rat GCF.IntFractPair.exists_nth_stream_eq_none_of_rat
...
#align generalized_continued_fraction.terminates_of_rat GCF.terminates_of_rat
...
#align generalized_continued_fraction.terminates_iff_rat GCF.terminates_iff_rat
