...
def Units.posSubgroup (R : Type*) [Semiring R] [LinearOrderedSemiring R] : Subgroup Rˣ :=
...
@[simp]
theorem Units.mem_posSubgroup {R : Type*} [Semiring R] [LinearOrderedSemiring R] (u : Rˣ) :
