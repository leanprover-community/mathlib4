...
instance toOrderedSemiring [Semiring R] [OrderedSemiring R] [SubsemiringClass S R] :
    OrderedSemiring s :=
...
instance toStrictOrderedSemiring [Semiring R] [StrictOrderedSemiring R]
...
instance toOrderedCommSemiring [CommSemiring R] [OrderedCommSemiring R] [SubsemiringClass S R] :
...
instance toStrictOrderedCommSemiring [CommSemiring R] [StrictOrderedCommSemiring R]
...
instance toLinearOrderedSemiring [Semiring R] [LinearOrderedSemiring R]
...
instance toLinearOrderedCommSemiring [CommSemiring R] [LinearOrderedCommSemiring R]
...
/-- A subsemiring of an `OrderedSemiring` is an `OrderedSemiring`. -/
instance toOrderedSemiring [Semiring R] [OrderedSemiring R] (s : Subsemiring R) : OrderedSemiring s :=
  Subtype.coe_injective.orderedSemiring (↑) rfl rfl (fun _ _ => rfl) (fun _ _ => rfl)
    (fun _ _ => rfl) (fun _ _ => rfl) fun _ => rfl
#align subsemiring.to_ordered_semiring Subsemiring.toOrderedSemiring

/-- A subsemiring of a `StrictOrderedSemiring` is a `StrictOrderedSemiring`. -/
instance toStrictOrderedSemiring [Semiring R] [StrictOrderedSemiring R] (s : Subsemiring R) :
...
/-- A subsemiring of an `OrderedCommSemiring` is an `OrderedCommSemiring`. -/
instance toOrderedCommSemiring [CommSemiring R] [OrderedCommSemiring R] (s : Subsemiring R) :
    OrderedCommSemiring s :=
  Subtype.coe_injective.orderedCommSemiring (↑) rfl rfl (fun _ _ => rfl) (fun _ _ => rfl)
    (fun _ _ => rfl) (fun _ _ => rfl) fun _ => rfl
...
/-- A subsemiring of a `LinearOrderedSemiring` is a `LinearOrderedSemiring`. -/
instance toLinearOrderedSemiring [Semiring R] [LinearOrderedSemiring R] (s : Subsemiring R) :
...
@[simps]
def nonneg (R : Type*) [Semiring R] [OrderedSemiring R] : Subsemiring R where
  carrier := Set.Ici 0
  mul_mem' := mul_nonneg
  one_mem' := zero_le_one
  add_mem' := add_nonneg
