...
@[simp]
lemma fst_imI_dualNumberEquiv_symm (d : DualNumber (Quaternion R)) :
...
@[simp]
lemma fst_imJ_dualNumberEquiv_symm (d : DualNumber (Quaternion R)) :
...
@[simp]
lemma fst_imK_dualNumberEquiv_symm (d : DualNumber (Quaternion R)) :
...
@[simp]
lemma snd_re_dualNumberEquiv_symm (d : DualNumber (Quaternion R)) :
...
@[simp]
lemma snd_imI_dualNumberEquiv_symm (d : DualNumber (Quaternion R)) :
...
@[simp]
lemma snd_imJ_dualNumberEquiv_symm (d : DualNumber (Quaternion R)) :
...
@[simp]
lemma snd_imK_dualNumberEquiv_symm (d : DualNumber (Quaternion R)) :
