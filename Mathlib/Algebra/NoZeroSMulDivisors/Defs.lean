...
instance IsAddTorsionFree.to_noZeroSMulDivisors_nat [AddMonoid M] [AddMonoidNSMul M]
    [IsAddTorsionFree M] :
...
instance IsAddTorsionFree.to_noZeroSMulDivisors_int [AddGroup G] [AddMonoidNSMul G]
    [IsAddTorsionFree G] :
...
@[simp]
lemma noZeroSMulDivisors_nat_iff_isAddTorsionFree [AddCommGroup G] [AddMonoidNSMul G] :
...
@[simp]
lemma noZeroSMulDivisors_int_iff_isAddTorsionFree [AddCommGroup G] [AddMonoidNSMul G] :
