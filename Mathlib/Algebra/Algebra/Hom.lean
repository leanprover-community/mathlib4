...
theorem ofClass_monoidHom_injective : Function.Injective ((↑) : (A →ₐ[R] B) → A →* B) :=
  RingHom.ofClass_monoidHom_injective.comp coe_ringHom_injective

theorem ofClass_addMonoidHom_injective : Function.Injective ((↑) : (A →ₐ[R] B) → A →+ B) :=
  RingHom.ofClass_addMonoidHom_injective.comp coe_ringHom_injective
