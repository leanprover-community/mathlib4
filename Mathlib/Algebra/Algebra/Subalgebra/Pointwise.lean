...
@[simp]
theorem isIdempotentElem_subalgebra (S : Subalgebra R A) :
    IsIdempotentElem (Subalgebra.toSubmodule S) := by
  apply le_antisymm
...
@[deprecated (since := "2025-01-12")] alias mul_self := isIdempotentElem_subalgebra
