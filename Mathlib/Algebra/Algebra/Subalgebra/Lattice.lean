...
scoped syntax:max (name := subalgebra_adjoin) term "[" term,* (ppSpace ":" ppSpace term)? "]" : term
...
set_option linter.style.whitespace false in -- TODO: fix notation to pretty-print correctly!
@[simp]
