...
See issuehttps://github.com/leanprover-community/mathlib4/issues/18110.
-/
...
def span.ringHom : SetSemiring A →+* Submodule R A where
  -- Note: the hint `(α := A)` is new inhttps://github.com/leanprover-community/mathlib4/issues/8386
