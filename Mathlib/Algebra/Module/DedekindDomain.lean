...
lemma isInternal_prime_power_torsion_of_is_torsion_by_ideal {I : Ideal R} (hI : I ≠ ⊥)
...
lemma isInternal_prime_power_torsion [Module.Finite R M] (hM : Module.IsTorsion R M) :
...
lemma exists_isInternal_prime_power_torsion [Module.Finite R M] (hM : Module.IsTorsion R M) :
