...
instance toOrderedAddCommMonoid [OrderedAddCommMonoid M] [Module R M] (S : Submodule R M) :
  ...
  Subtype.coe_injective.orderedAddCommMonoid Subtype.val (by rfl) (fun _ _ => rfl) fun _ _ => by rfl
...
instance toLinearOrderedAddCommMonoid [LinearOrderedAddCommMonoid M] [Module R M]
  ...
  Subtype.coe_injective.linearOrderedAddCommMonoid Subtype.val
    (by rfl) (fun _ _ => rfl) (fun _ _ => by rfl) (fun _ _ => rfl) fun _ _ => rfl
...
instance toOrderedCancelAddCommMonoid [OrderedCancelAddCommMonoid M] [Module R M]
  ...
  Subtype.coe_injective.orderedCancelAddCommMonoid Subtype.val (by rfl) (fun _ _ => rfl) fun _ _ => by rfl
...
instance toLinearOrderedCancelAddCommMonoid [LinearOrderedCancelAddCommMonoid M] [Module R M]
  ...
  Subtype.coe_injective.linearOrderedCancelAddCommMonoid Subtype.val (by rfl) (fun _ _ => rfl)
    (fun _ _ => by rfl) (fun _ _ => rfl) fun _ _ => rfl
...
instance toOrderedAddCommGroup [OrderedAddCommGroup M] [Module R M] (S : Submodule R M) :
  ...
  Subtype.coe_injective.orderedAddCommGroup Subtype.val (by rfl) (fun _ _ => rfl)
    (fun _ => by rfl) (fun _ _ => by rfl) (fun _ _ => by rfl) fun _ _ => by rfl
...
instance toLinearOrderedAddCommGroup [LinearOrderedAddCommGroup M] [Module R M]
  ...
  Subtype.coe_injective.linearOrderedAddCommGroup Subtype.val (by rfl) (fun _ _ => rfl)
    (fun _ => by rfl) (fun _ _ => by rfl) (fun _ _ => by rfl) (fun _ _ => by rfl)
