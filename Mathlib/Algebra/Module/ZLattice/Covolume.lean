...
variable {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [MeasurableSpace E] (L : Submodule ℤ E)
...
set_option backward.privateInPublic true in
theorem covolume_comap {F : Type*} [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] [NormedSpace ℝ F] [FiniteDimensional ℝ F]
...
-/
theorem covolume_div_covolume_eq_relIndex' {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
...
see the `Naming conventions` section in the introduction. -/
theorem volume_image_eq_volume_div_covolume' {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
    [InnerProductSpace ℝ E] [FiniteDimensional ℝ E] [MeasurableSpace E] [BorelSpace E]
