...
theorem map_fundamentalDomain {F : Type*} [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] [NormedSpace K F] (f : E ≃ₗ[K] F) :
...
variable [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E] (b : Basis ι ℝ E)
...
instance instIsZLatticeRealSpan {E ι : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E]
...
instance instModuleFinite_of_discrete_submodule {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
...
instance instModuleFree_of_discrete_submodule {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
    [NormedSpace ℝ E] [FiniteDimensional ℝ E] (L : Submodule ℤ E) [DiscreteTopology L] :
    Module.Free ℤ L := by
...
theorem ZLattice.isAddFundamentalDomain {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E]
...
instance instCountable_of_discrete_submodule {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E]
...
-/
theorem Real.finrank_eq_int_finrank_of_discrete {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E]
...
theorem ZLattice.comap_comp {G : Type*} [NormMetric G] [AddCommGroup G] [IsNormedAddGroup G] [NormedSpace K G]
    (e : F →ₗ[K] E) (e' : G →ₗ[K] F) :
...
variable {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace K E] [FiniteDimensional K E]
  [ProperSpace E]
variable {F : Type*} [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] [NormedSpace K F] [FiniteDimensional K F]
  [ProperSpace F]
...
lemma IsZLattice.isCompact_range_of_periodic
    {E F : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E] [FiniteDimensional ℝ E]
    [TopologicalSpace F]
