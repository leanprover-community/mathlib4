...
lemma localizedMap_surjective_iff_subsingleton_localized_coker {R : Type*} [CommRing R]
    {M N : Type*} [AddCommGroup M] [Module R M] [AddCommGroup N] [Module R N] (S : Submonoid R)
  ...
  dsimp [LocalizedModule.map, mapExtendScalars]
  with_reducible rfl
