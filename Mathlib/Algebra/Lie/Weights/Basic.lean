...
lemma apply_eq_zero_of_isNilpotent [Module.IsTorsionFree R M] [IsReduced R]
...
lemma disjoint_genWeightSpaceOf [Module.IsTorsionFree R M] {x : L} {φ₁ φ₂ : R} (h : φ₁ ≠ φ₂) :
...
lemma disjoint_genWeightSpace [Module.IsTorsionFree R M] {χ₁ χ₂ : L → R} (h : χ₁ ≠ χ₂) :
...
lemma injOn_genWeightSpace [Module.IsTorsionFree R M] :
...
lemma iSupIndep_genWeightSpace [Module.IsTorsionFree R M] :
...
lemma iSupIndep_genWeightSpaceOf [Module.IsTorsionFree R M] (x : L) :
...
lemma finite_genWeightSpaceOf_ne_bot [Module.IsTorsionFree R M] [IsNoetherian R M] (x : L) :
    {χ : R | genWeightSpaceOf M χ x ≠ ⊥}.Finite :=
  WellFoundedGT.finite_ne_bot_of_iSupIndep (iSupIndep_genWeightSpaceOf R L M x)

lemma finite_genWeightSpace_ne_bot [Module.IsTorsionFree R M] [IsNoetherian R M] :
    {χ : L → R | genWeightSpace M χ ≠ ⊥}.Finite :=
  WellFoundedGT.finite_ne_bot_of_iSupIndep (iSupIndep_genWeightSpace R L M)

instance Weight.instFinite [Module.IsTorsionFree R M] [IsNoetherian R M] :
...
noncomputable instance Weight.instFintype [Module.IsTorsionFree R M] [IsNoetherian R M] :
