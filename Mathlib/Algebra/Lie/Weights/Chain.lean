...
variable [Module.IsTorsionFree ℤ R] [Module.IsTorsionFree R M] [IsNoetherian R M] (hχ₁ : χ₁ ≠ 0)
include hχ₁
...
variable [Module.IsTorsionFree ℤ R] [Module.IsTorsionFree R M] [IsNoetherian R M]
