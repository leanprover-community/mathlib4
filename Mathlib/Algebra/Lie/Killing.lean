...
@[simp]
lemma trace_toEndomorphism_weightSpace [IsDomain R] [IsPrincipalIdealRing R] [IsReduced R]
...
@[simp]
lemma traceForm_weightSpace_eq [IsDomain R] [IsPrincipalIdealRing R] [IsReduced R]
