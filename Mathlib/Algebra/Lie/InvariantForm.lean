...
lemma orthogonal_disjoint
  ...
  suffices ¬I ≤ orthogonal Φ hΦ_inv I by
...
lemma orthogonal_isCompl (I : LieIdeal K L) (hI : IsAtom I) :
  ...
  have := orthogonal_isCompl_submodule Φ hΦ_nondeg hΦ_inv hΦ_refl hL I hI
  apply IsCompl.of_eq
  · rw [eq_bot_iff]
...
lemma restrict_nondegenerate (I : LieIdeal K L) (hI : IsAtom I) :
  ...
  exact orthogonal_isCompl_submodule Φ hΦ_nondeg hΦ_inv hΦ_refl hL I hI
...
lemma restrict_orthogonal_nondegenerate (I : LieIdeal K L) (hI : IsAtom I) :
  ...
  exact (orthogonal_isCompl_submodule Φ hΦ_nondeg hΦ_inv hΦ_refl hL I hI).symm
