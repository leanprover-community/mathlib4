...
class AddConstMonoMapClass (F : Type _) (G H : outParam (Type _))
    [Add G] [Add H] [Preorder G] [Preorder H] (a : outParam G) (b : outParam H)
    extends AddConstMapClass F G H a b, RelHomClass F (@LE.le G _) (@LE.le H _)

instance (G H : Type _) [Add G] [Add H] [Preorder G] [Preorder H] (a : G) (b : H) :
    AddConstMonoMapClass (G →o+c[a, b] H) G H a b where
