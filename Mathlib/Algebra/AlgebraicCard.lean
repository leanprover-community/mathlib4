...
lemma infinite_of_charZero (R A : Type*) [CommRing R] [IsDomain R] [Ring A] [Algebra R A]
...
lemma aleph0_le_cardinal_mk_of_charZero (R A : Type*) [CommRing R] [IsDomain R] [Ring A]
...
@[simp]
lemma cardinal_mk_lift_of_infinite [Infinite R] :
...
@[simp]
protected lemma countable : Set.Countable { x : A | IsAlgebraic R x } := by
...
@[simp]
lemma cardinal_mk_of_countable_of_charZero [CharZero A] [IsDomain R] :
