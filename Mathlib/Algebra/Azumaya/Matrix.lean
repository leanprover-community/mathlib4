...
lemma AlgHom.mulLeftRightMatrix.comp_inv :
  ...
  intro ⟨i, j⟩
  simp only [LinearMap.coe_comp, coe_toLinearMap, LinearMap.coe_mk, AddHom.coe_mk,
    Function.comp_apply, map_sum, _root_.map_smul, stdBasis_eq_stdBasisMatrix, LinearMap.coeFn_sum,
    Finset.sum_apply, LinearMap.smul_apply, mulLeftRight_apply, unop_op, LinearMap.id_coe, id_eq]
  ext k l
