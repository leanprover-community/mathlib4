...
@[to_additive] instance inhabited : Inhabited R[M] := fast_instance% coeffEquiv.inhabited
@[to_additive] instance nontrivial [Nontrivial R] [Nonempty M] : Nontrivial R[M] :=
  coeffEquiv.nontrivial
@[to_additive] instance unique [Subsingleton R] : Unique R[M] := fast_instance% coeffEquiv.unique
