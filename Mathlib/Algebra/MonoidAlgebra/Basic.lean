...
instance faithfulSMul [Monoid R] [Semiring k] [SMulZeroClass R k] [FaithfulSMul R k]
...
instance smulCommClass [Monoid R] [Monoid S] [Semiring k] [SMulZeroClass R k]
...
instance isCentralScalar [Monoid R] [Semiring k] [SMulZeroClass R k] [SMulZeroClass Rᵐᵒᵖ k]
