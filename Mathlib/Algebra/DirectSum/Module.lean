...
lemma coe_toModule_eq_coe_toAddMonoid :
...
lemma IsInternal.isCompl {A : ι → Submodule R M} {i j : ι} (hij : i ≠ j)
...
lemma isInternal_submodule_of_independent_of_iSup_eq_top {A : ι → Submodule R M}
