...
instance (priority := 10000) : One (⨁ i, A i) where one := DirectSum.of A 0 GradedMonoid.GOne.one
...
instance (priority := 10000) : NonUnitalNonAssocSemiring (⨁ i, A i) :=
...
instance (priority := 10000) semiring : Semiring (⨁ i, A i) :=
...
instance (priority := 10000) commSemiring : CommSemiring (⨁ i, A i) :=
...
instance (priority := 10000) nonAssocRing : NonUnitalNonAssocRing (⨁ i, A i) :=
...
/-- The `Ring` derived from `GSemiring A`. -/
instance (priority := 10000) ring : Ring (⨁ i, A i) :=
...
instance (priority := 10000) commRing : CommRing (⨁ i, A i) :=
  { DirectSum.ring A,
...
instance (priority := 10000) GradeZero.nonUnitalNonAssocSemiring : NonUnitalNonAssocSemiring (A 0) :=
...
instance (priority := 10000) GradeZero.smulWithZero (i : ι) : SMulWithZero (A 0) (A i) := by
...
instance (priority := 10000) : NatCast (A 0) :=
  ⟨GSemiring.natCast⟩
...
/-- The `Semiring` structure derived from `GSemiring A`. -/
instance (priority := 10000) GradeZero.semiring : Semiring (A 0) :=
...
-/
instance (priority := 10000) GradeZero.module {i} : Module (A 0) (A i) :=
...
/-- The `CommSemiring` structure derived from `GCommSemiring A`. -/
instance (priority := 10000) GradeZero.commSemiring : CommSemiring (A 0) :=
...
instance (priority := 10000) GradeZero.nonUnitalNonAssocRing : NonUnitalNonAssocRing (A 0) :=
...
instance (priority := 10000) : IntCast (A 0) :=
  ⟨GRing.intCast⟩
...
/-- The `Ring` derived from `GSemiring A`. -/
instance (priority := 10000) GradeZero.ring : Ring (A 0) :=
...
/-- The `CommRing` derived from `GCommSemiring A`. -/
instance (priority := 10000) GradeZero.commRing : CommRing (A 0) :=
...
instance (priority := 10000) NonUnitalNonAssocSemiring.directSumGNonUnitalNonAssocSemiring {R : Type*} [AddMonoid ι]
...
/-- A direct sum of copies of a `Semiring` inherits the multiplication structure. -/
instance (priority := 10000) Semiring.directSumGSemiring {R : Type*} [AddMonoid ι] [Semiring R] :
...
-/
instance (priority := 10000) CommSemiring.directSumGCommSemiring {R : Type*} [AddCommMonoid ι] [CommSemiring R] :
