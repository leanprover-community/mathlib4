...
theorem val_inclusion {S T : NonUnitalStarSubalgebra R A} (h : S ≤ T) (s : S) :
    (inclusion h s : A) = s :=
  rfl
#align non_unital_star_subalgebra.coe_inclusion NonUnitalStarSubalgebra.val_inclusion
section Prod
...
theorem iSupLift_inclusion {i : ι} (x : K i) (h : K i ≤ T) :
  ...
  exact h
#align non_unital_star_subalgebra.supr_lift_inclusion NonUnitalStarSubalgebra.iSupLift_inclusion

@[simp]
theorem iSupLift_comp_inclusion {i : ι} (h : K i ≤ T) :
    (iSupLift K dir f hf T hT).comp (inclusion h) = f i := by ext; simp
#align non_unital_star_subalgebra.supr_lift_comp_inclusion NonUnitalStarSubalgebra.iSupLift_comp_inclusion
...
#align non_unital_star_subalgebra.supr_lift_mk NonUnitalStarSubalgebra.iSupLift_mk
...
#align non_unital_star_subalgebra.supr_lift_of_mem NonUnitalStarSubalgebra.iSupLift_of_mem
