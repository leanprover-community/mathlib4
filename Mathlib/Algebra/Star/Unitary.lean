...
theorem IsStarProjection.two_mul_sub_one_mem_unitary {R : Type*} [Ring R] [StarRing R] {p : R}
  ...
  simp only [two_mul, unitary.mem_iff, star_sub, star_add, hp.star_eq, star_one, mul_sub, mul_add,
    sub_mul, add_mul, hp.mul_self, one_mul, add_sub_cancel_right, mul_one, sub_sub_cancel, and_self]
