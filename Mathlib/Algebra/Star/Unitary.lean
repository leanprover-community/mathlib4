...
theorem IsStarProjection.two_mul_sub_one_mem_unitary {R : Type*} [Ring R] [StarRing R] {p : R}
  ...
  simp only [two_mul, Unitary.mem_iff, star_sub, star_add, hp.isSelfAdjoint.star_eq, star_one,
    mul_sub, mul_add, sub_mul, add_mul, hp.isIdempotentElem.eq, one_mul, add_sub_cancel_right,
