...
theorem CHSH_inequality_of_comm
    [CommRing R] [OrderedCommRing R] [StarRing R] [StarOrderedRing R] [Algebra ℝ R]
...
-/
theorem tsirelson_inequality [Ring R] [OrderedRing R] [StarRing R] [StarOrderedRing R] [Algebra ℝ R]
