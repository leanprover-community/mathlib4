...
-/
theorem CHSH_inequality_of_comm [OrderedCommRing R] [StarRing R] [StarOrderedRing R] [SMul ℝ R] [Algebra ℝ R]
...
-/
theorem tsirelson_inequality [OrderedRing R] [StarRing R] [StarOrderedRing R] [SMul ℝ R] [Algebra ℝ R]
