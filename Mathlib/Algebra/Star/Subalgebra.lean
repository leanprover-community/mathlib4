...
structure StarSubalgebra (R : Type u) (A : Type v) [CommSemiring R] [StarRing R] [Semiring A]
  [StarRing A] [SMul R A] [Algebra R A] [StarModule R A] extends Subalgebra R A : Type v where
...
variable [Semiring A] [StarRing A] [SMul R A] [Algebra R A] [StarModule R A]
variable [Semiring B] [StarRing B] [SMul R B] [Algebra R B] [StarModule R B]
variable [Semiring C] [StarRing C] [SMul R C] [Algebra R C] [StarModule R C]
...
instance subringClass {R A} [CommRing R] [StarRing R] [Ring A] [StarRing A] [SMul R A] [Algebra R A]
...
variable [Semiring A] [SMul R A] [Algebra R A] [StarRing A] [StarModule R A]
variable [Semiring B] [SMul R B] [Algebra R B] [StarRing B] [StarModule R B]
...
abbrev adjoinCommRingOfComm (R : Type u) {A : Type v} [CommRing R] [StarRing R] [Ring A]
    [SMul R A] [Algebra R A] [StarRing A] [StarModule R A] {s : Set A}
    (hcomm : ∀ a : A, a ∈ s → ∀ b : A, b ∈ s → a * b = b * a)
    (hcomm_star : ∀ a : A, a ∈ s → ∀ b : A, b ∈ s → a * star b = star b * a) :
    CommRing (adjoin R s) :=
...
instance adjoinCommRingOfIsStarNormal (R : Type u) {A : Type v} [CommRing R] [StarRing R] [Ring A]
    [SMul R A] [Algebra R A] [StarRing A] [StarModule R A] (x : A) [IsStarNormal x] :
...
variable (R : Type*) {S A B : Type*} [CommSemiring R]
  [CommSemiring S] [Semiring A] [Semiring B] [SMul R S] [Algebra R S]
  [SMul S A] [Algebra S A] [SMul S B] [Algebra S B] [SMul R A] [Algebra R A]
  [SMul R B] [Algebra R B] [IsScalarTower R S A] [IsScalarTower R S B] [Star A] [Star B]
