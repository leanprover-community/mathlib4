...
/-- A special case of one four lemma such that the left-most term is zero in terms of
...
lemma surjective_of_surjective_of_injective_of_left_exact (hi₂ : Function.Surjective i₂)
  ...
  refine surjective_of_surjective_of_surjective_of_injective (1 : Unit →* M₁) f₁ f₂ (1 : Unit →* N₁)
    g₁ g₂ 1 i₁ i₂ i₃ (by simp) hc₁ hc₂ hf₁ (fun y ↦ ?_) hg₁ (fun | .unit => ⟨1, rfl⟩) hi₂ hi₃
...
attribute [-instance] PUnit.commRing in
attribute [-instance] PUnit.cancelCommMonoidWithZero in
/-- A special case of one four lemma such that the right-most term is zero in terms of
groups. For a diagram explaining the variables, see the module docstring. -/
...
variable (hc₁ : g₁.comp i₁ = i₂.comp f₁) (hc₂ : g₂.comp i₂ = i₃.comp f₂)
  (hc₃ : g₃.comp i₃ = i₄.comp f₃) (hc₄ : g₄.comp i₄ = i₅.comp f₄)
variable (hf₁ : Function.AddExact f₁ f₂) (hf₂ : Function.AddExact f₂ f₃)
  (hf₃ : Function.AddExact f₃ f₄) (hg₁ : Function.AddExact g₁ g₂)
  (hg₂ : Function.AddExact g₂ g₃) (hg₃ : Function.AddExact g₃ g₄)
...
For a diagram explaining the variables, see the module docstring. -/
lemma surjective_of_surjective_of_injective_of_left_addExact (hi₂ : Function.Surjective i₂)
    (hi₃ : Function.Injective i₃) (hg₀ : Function.Injective g₁) : Function.Surjective i₁ := by
...
alias surjective_of_surjective_of_injective_of_left_exact :=
  surjective_of_surjective_of_injective_of_left_addExact
...
@[deprecated (since := "2026-01-05")]
alias injective_of_surjective_of_injective_of_right_exact :=
  injective_of_surjective_of_injective_of_right_addExact
...
see the module docstring. -/
lemma bijective_of_bijective_of_injective_of_left_addExact (hi₂ : Function.Bijective i₂)
    (hi₃ : Function.Injective i₃) (hf₀ : Function.Injective f₁) (hg₀ : Function.Injective g₁) :
    Function.Bijective i₁ :=
  ⟨fun {x y} h ↦ (hf₀ (hi₂.1 (congr($hc₁ x).symm.trans (congr(g₁ $h).trans congr($hc₁ y))))),
    surjective_of_surjective_of_injective_of_left_addExact f₁ f₂ g₁ g₂ i₁ i₂ i₃
      hc₁ hc₂ hf₁ hg₁ hi₂.2 hi₃ hg₀⟩

@[deprecated (since := "2026-01-05")]
alias bijective_of_bijective_of_injective_of_left_exact :=
  bijective_of_bijective_of_injective_of_left_addExact

include hf₁ hg₁ hc₁ hc₂ in
/-- A special case of the five lemma in terms of modules. For a diagram explaining the variables,
see the module docstring. -/
lemma bijective_of_surjective_of_bijective_of_right_addExact (hi₁ : Function.Surjective i₁)
    (hi₂ : Function.Bijective i₂) (hf₂ : Function.Surjective f₂) (hg₂ : Function.Surjective g₂) :
    Function.Bijective i₃ := by
  refine ⟨injective_of_surjective_of_injective_of_right_addExact f₁ f₂ g₁ g₂ i₁ i₂ i₃
    hc₁ hc₂ hf₁ hg₁ hi₁ hi₂.1 hf₂, fun y ↦ ?_⟩
  obtain ⟨y, rfl⟩ := hg₂ y
  obtain ⟨y, rfl⟩ := hi₂.2 y
  exact ⟨f₂ y, congr($hc₂ y).symm⟩
...
@[deprecated (since := "2026-01-05")]
alias bijective_of_surjective_of_bijective_of_right_exact :=
  bijective_of_surjective_of_bijective_of_right_addExact
