...
lemma charP_of_injective_algebraMap {R A : Type*} [CommSemiring R] [Semiring A] [Algebra R A]
...
lemma charZero_of_injective_algebraMap {R A : Type*} [CommSemiring R] [Semiring A] [Algebra R A]
...
-/
lemma algebraRat.charP_zero [Semiring R] [Algebra ℚ R] : CharP R 0 :=
...
automatically receive an `Algebra ℚ R` instance.
-/
lemma algebraRat.charZero [Ring R] [Algebra ℚ R] : CharZero R :=
...
lemma charP_of_isFractionRing [CharP R p] : CharP K p :=
...
lemma charZero_of_isFractionRing [CharZero R] : CharZero K :=
