...
noncomputable instance Cauchy.divisionRing : DivisionRing (Cauchy abv) where
  ...
  nnqsmul_def _ x := Quotient.inductionOn x fun _ ↦ congr_arg mkQ <| ext fun _ ↦ NNRat.smul_def _ _
  qsmul_def _ x := Quotient.inductionOn x fun _ ↦ congr_arg mkQ <| ext fun _ ↦ Rat.smul_def _ _
