...
lemma pairwise_disjoint_Ioc_add_intCast :
...
lemma pairwise_disjoint_Ico_add_intCast :
...
lemma pairwise_disjoint_Ioo_add_intCast :
...
lemma pairwise_disjoint_Ico_intCast : Pairwise (Disjoint on fun n : ℤ => Ico (n : α) (n + 1)) :=
...
lemma pairwise_disjoint_Ioo_intCast : Pairwise (Disjoint on fun n : ℤ => Ioo (n : α) (n + 1)) :=
...
lemma pairwise_disjoint_Ioc_intCast : Pairwise (Disjoint on fun n : ℤ => Ioc (n : α) (n + 1)) :=
