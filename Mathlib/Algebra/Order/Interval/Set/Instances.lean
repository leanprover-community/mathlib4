...
instance instMul : Mul (Icc (0 : R) 1) where
  mul p q := ⟨p * q, ⟨mul_nonneg p.2.1 q.2.1, (mul_le_of_le_one_left q.2.1 p.2.2).trans q.2.2⟩⟩
...
instance instMul : Mul (Ico (0 : R) 1) where
  mul p q :=
    ⟨p * q, ⟨mul_nonneg p.2.1 q.2.1, (mul_le_of_le_one_left q.2.1 p.2.2.le).trans_lt q.2.2⟩⟩
...
instance instMul : Mul (Ioc (0 : R) 1) where
  mul p q := ⟨p.1 * q.1, ⟨mul_pos p.2.1 q.2.1, (mul_le_of_le_one_left q.2.1.le p.2.2).trans q.2.2⟩⟩
...
instance instMul : Mul (Ioo (0 : R) 1) where
  mul p q :=
    ⟨p.1 * q.1, ⟨mul_pos p.2.1 q.2.1, (mul_le_of_le_one_left q.2.1.le p.2.2.le).trans_lt q.2.2⟩⟩
