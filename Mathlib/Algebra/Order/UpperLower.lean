...
@[to_additive]
lemma IsUpperSet.smul_subset (hs : IsUpperSet s) (hx : 1 ≤ x) : x • s ⊆ s :=
...
@[to_additive]
lemma IsLowerSet.smul_subset (hs : IsLowerSet s) (hx : x ≤ 1) : x • s ⊆ s :=
...
@[to_additive]
lemma IsUpperSet.smul (hs : IsUpperSet s) : IsUpperSet (a • s) := hs.image <| OrderIso.mulLeft _
#align is_upper_set.smul IsUpperSet.smul
#align is_upper_set.vadd IsUpperSet.vadd

@[to_additive]
lemma IsLowerSet.smul (hs : IsLowerSet s) : IsLowerSet (a • s) := hs.image <| OrderIso.mulLeft _
#align is_lower_set.smul IsLowerSet.smul
#align is_lower_set.vadd IsLowerSet.vadd

@[to_additive]
lemma Set.OrdConnected.smul (hs : s.OrdConnected) : (a • s).OrdConnected := by
...
@[to_additive]
lemma IsUpperSet.mul_left (ht : IsUpperSet t) : IsUpperSet (s * t) := by
...
@[to_additive]
lemma IsUpperSet.mul_right (hs : IsUpperSet s) : IsUpperSet (s * t) := by
  rw [mul_comm]
  exact hs.mul_left
...
@[to_additive]
lemma IsLowerSet.mul_left (ht : IsLowerSet t) : IsLowerSet (s * t) := ht.toDual.mul_left
#align is_lower_set.mul_left IsLowerSet.mul_left
#align is_lower_set.add_left IsLowerSet.add_left

@[to_additive]
lemma IsLowerSet.mul_right (hs : IsLowerSet s) : IsLowerSet (s * t) := hs.toDual.mul_right
#align is_lower_set.mul_right IsLowerSet.mul_right
#align is_lower_set.add_right IsLowerSet.add_right

@[to_additive]
lemma IsUpperSet.inv (hs : IsUpperSet s) : IsLowerSet s⁻¹ := fun _ _ h ↦ hs <| inv_le_inv' h
#align is_upper_set.inv IsUpperSet.inv
#align is_upper_set.neg IsUpperSet.neg

@[to_additive]
lemma IsLowerSet.inv (hs : IsLowerSet s) : IsUpperSet s⁻¹ := fun _ _ h ↦ hs <| inv_le_inv' h
#align is_lower_set.inv IsLowerSet.inv
#align is_lower_set.neg IsLowerSet.neg

@[to_additive]
lemma IsUpperSet.div_left (ht : IsUpperSet t) : IsLowerSet (s / t) := by
  rw [div_eq_mul_inv]
...
@[to_additive]
lemma IsUpperSet.div_right (hs : IsUpperSet s) : IsUpperSet (s / t) := by
  rw [div_eq_mul_inv]
  exact hs.mul_right
...
@[to_additive]
lemma IsLowerSet.div_left (ht : IsLowerSet t) : IsUpperSet (s / t) := ht.toDual.div_left
#align is_lower_set.div_left IsLowerSet.div_left
#align is_lower_set.sub_left IsLowerSet.sub_left

@[to_additive]
lemma IsLowerSet.div_right (hs : IsLowerSet s) : IsLowerSet (s / t) := hs.toDual.div_right
...
@[to_additive]
private lemma one_mul (s : UpperSet α) : 1 * s = s :=
...
@[to_additive]
private lemma one_mul (s : LowerSet α) : 1 * s = s :=
  SetLike.coe_injective <|
...
@[to_additive (attr := simp)]
lemma lowerClosure_smul : lowerClosure (a • s) = a • lowerClosure s :=
...
@[to_additive]
lemma mul_upperClosure : s * upperClosure t = upperClosure (s * t) := by
...
@[to_additive]
lemma mul_lowerClosure : s * lowerClosure t = lowerClosure (s * t) := by
...
@[to_additive]
lemma upperClosure_mul : ↑(upperClosure s) * t = upperClosure (s * t) := by
...
@[to_additive]
lemma lowerClosure_mul : ↑(lowerClosure s) * t = lowerClosure (s * t) := by
  simp_rw [mul_comm _ t]
...
@[to_additive (attr := simp)]
lemma upperClosure_mul_distrib : upperClosure (s * t) = upperClosure s * upperClosure t :=
...
@[to_additive (attr := simp)]
lemma lowerClosure_mul_distrib : lowerClosure (s * t) = lowerClosure s * lowerClosure t :=
  SetLike.coe_injective <| by
