...
@[to_additive]
instance (priority := 10000) : One (UpperSet α) :=
  ⟨Ici 1⟩

@[to_additive]
instance (priority := 10000) : Mul (UpperSet α) :=
  ⟨fun s t ↦ ⟨image2 (· * ·) s t, s.2.mul_right⟩⟩

@[to_additive]
instance (priority := 10000) : Div (UpperSet α) :=
  ⟨fun s t ↦ ⟨image2 (· / ·) s t, s.2.div_right⟩⟩

@[to_additive]
instance (priority := 10000) : SMul α (UpperSet α) :=
...
@[to_additive]
instance (priority := 10000) : MulAction α (UpperSet α) :=
  SetLike.coe_injective.mulAction _ (λ _ _ => rfl)

@[to_additive]
instance (priority := 10000) commSemigroup : CommSemigroup (UpperSet α) :=
...
@[to_additive]
instance (priority := 10000) : CommMonoid (UpperSet α) :=
...
@[to_additive]
instance (priority := 10000) : One (LowerSet α) :=
  ⟨Iic 1⟩

@[to_additive]
instance (priority := 10000) : Mul (LowerSet α) :=
  ⟨fun s t ↦ ⟨image2 (· * ·) s t, s.2.mul_right⟩⟩

@[to_additive]
instance (priority := 10000) : Div (LowerSet α) :=
  ⟨fun s t ↦ ⟨image2 (· / ·) s t, s.2.div_right⟩⟩

@[to_additive]
instance (priority := 10000) : SMul α (LowerSet α) :=
  ⟨fun a s ↦ ⟨(a • ·) '' s, s.2.smul⟩⟩
...
@[to_additive]
instance (priority := 10000) : MulAction α (LowerSet α) :=
  SetLike.coe_injective.mulAction _ (λ _ _ => rfl)

@[to_additive]
instance (priority := 10000) commSemigroup : CommSemigroup (LowerSet α) :=
...
@[to_additive]
instance (priority := 10000) : CommMonoid (LowerSet α) :=
