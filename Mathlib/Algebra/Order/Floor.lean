...
-- 2024-02-14
@[deprecated (since := "2024-06-12")] alias Nat.cast_floor_eq_int_floor := Int.ofNat_floor_eq_floor
@[deprecated (since := "2024-06-12")] alias Nat.cast_ceil_eq_int_ceil := Int.ofNat_ceil_eq_ceil
@[deprecated (since := "2024-06-12")] alias Nat.cast_floor_eq_cast_int_floor := natCast_floor_eq_intCast_floor
@[deprecated (since := "2024-06-12")] alias Nat.cast_ceil_eq_cast_int_ceil := natCast_ceil_eq_intCast_ceil
