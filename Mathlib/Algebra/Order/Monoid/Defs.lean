...
@[to_additive]
instance (priority := 10000) OrderedCommMonoid.toCovariantClassLeft : CovariantClass α α (· * ·) (· ≤ ·) where
...
@[to_additive]
instance (priority := 10000) OrderedCommMonoid.toCovariantClassRight (M : Type*) [OrderedCommMonoid M] :
...
@[to_additive]
instance (priority := 10000) OrderedCancelCommMonoid.toContravariantClassLeft :
...
instance (priority := 10000) `OrderedCancelCommMonoid.to_covariantClass_right` above, I imagine that without
this instance, some Type would not have a `ContravariantClass M M (function.swap (*)) (<)`
instance. -/
@[to_additive]
instance (priority := 10000) OrderedCancelCommMonoid.toContravariantClassRight :
