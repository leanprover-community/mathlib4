...
variable [CommMonoid α] [LE α] [IsOrderedMonoid α]
...
class IsOrderedCancelAddMonoid (α : Type*) [AddCommMonoid α] [LE α] extends
...
class IsOrderedCancelMonoid (α : Type*) [CommMonoid α] [LE α] extends
...
instance (priority := 200) IsOrderedCancelMonoid.toMulLeftReflectLE
  {α : Type*} [CommMonoid α] [LE α] [IsOrderedCancelMonoid α] :
    MulLeftReflectLE α :=
