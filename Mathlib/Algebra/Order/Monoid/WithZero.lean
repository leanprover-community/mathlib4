...
instance instLinearOrderedCommMonoidWithZeroMultiplicativeOrderDual
  ...
  { Multiplicative.orderedCommMonoid, Multiplicative.linearOrder with
    ...
    -- Porting note:  Here and elsewhere in the file, just `MulZeroClass.zero_mul` worked in Lean 3.
    -- See https://leanprover.zulipchat.com/#narrow/stream/287929-mathlib4/topic/Type.20synonyms
