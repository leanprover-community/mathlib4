...
theorem mul_le_mul_left' [CovariantClass α α (*) LE.le] {b c : α} (bc : b ≤ c) (a : α) :
    a * b ≤ a * c :=
...
theorem le_of_mul_le_mul_left' [ContravariantClass α α (*) LE.le] {a b c : α}
    (bc : a * b ≤ a * c) :
    b ≤ c :=
...
theorem mul_le_mul_right' [i : CovariantClass α α (swap (*)) LE.le] {b c : α} (bc : b ≤ c)
    (a : α) :
    b * a ≤ c * a :=
  i.elim a bc
...
theorem le_of_mul_le_mul_right' [i : ContravariantClass α α (swap (*)) LE.le] {a b c : α}
    (bc : b * a ≤ c * a) :
    b ≤ c :=
  i.elim a bc
...
theorem mul_le_mul_iff_left [CovariantClass α α (*) LE.le]
    [ContravariantClass α α (*) LE.le] (a : α) {b c : α} :
    a * b ≤ a * c ↔ b ≤ c :=
  rel_iff_cov α α (· * ·) (· ≤ ·) a
...
@[to_additive (attr := simp)]
theorem mul_le_mul_iff_right [CovariantClass α α (swap (*)) LE.le]
    [ContravariantClass α α (swap (*)) LE.le] (a : α) {b c : α} :
    b * a ≤ c * a ↔ b ≤ c :=
...
@[to_additive (attr := simp)]
theorem mul_lt_mul_iff_left [CovariantClass α α (*) LT.lt]
    [ContravariantClass α α (*) LT.lt] (a : α) {b c : α} :
    a * b < a * c ↔ b < c :=
  rel_iff_cov α α (· * ·) (· < ·) a
...
@[to_additive (attr := simp)]
theorem mul_lt_mul_iff_right [CovariantClass α α (swap (*)) LT.lt]
    [ContravariantClass α α (swap (*)) LT.lt] (a : α) {b c : α} :
    b * a < c * a ↔ b < c :=
  rel_iff_cov α α (swap (· * ·)) (· < ·) a
...
theorem mul_lt_mul_left' [CovariantClass α α (*) LT.lt] {b c : α} (bc : b < c) (a : α) :
    a * b < a * c :=
  CovariantClass.elim _ bc
...
theorem lt_of_mul_lt_mul_left' [ContravariantClass α α (*) LT.lt] {a b c : α}
    (bc : a * b < a * c) :
    b < c :=
  ContravariantClass.elim _ bc
...
theorem mul_lt_mul_right' [i : CovariantClass α α (swap (*)) LT.lt] {b c : α} (bc : b < c)
    (a : α) :
    b * a < c * a :=
  i.elim a bc
...
theorem lt_of_mul_lt_mul_right' [i : ContravariantClass α α (swap (*)) LT.lt] {a b c : α}
    (bc : b * a < c * a) :
    b < c :=
  i.elim a bc
...
@[to_additive]
theorem mul_lt_mul_of_lt_of_lt [CovariantClass α α (*) LT.lt]
    [CovariantClass α α (swap (*)) LT.lt]
...
@[to_additive]
theorem mul_lt_mul_of_le_of_lt [CovariantClass α α (*) LT.lt]
    [CovariantClass α α (swap (*)) LE.le] {a b c d : α} (h₁ : a ≤ b) (h₂ : c < d) :
    a * c < b * d :=
...
@[to_additive]
theorem mul_lt_mul_of_lt_of_le [CovariantClass α α (*) LE.le]
    [CovariantClass α α (swap (*)) LT.lt] {a b c d : α} (h₁ : a < b) (h₂ : c ≤ d) :
    a * c < b * d :=
...
theorem Left.mul_lt_mul [CovariantClass α α (*) LT.lt]
    [CovariantClass α α (swap (*)) LE.le] {a b c d : α} (h₁ : a < b) (h₂ : c < d) :
    a * c < b * d :=
...
theorem Right.mul_lt_mul [CovariantClass α α (*) LE.le]
    [CovariantClass α α (swap (*)) LT.lt] {a b c d : α}
    (h₁ : a < b) (h₂ : c < d) :
    a * c < b * d :=
...
theorem mul_le_mul' [CovariantClass α α (*) LE.le] [CovariantClass α α (swap (*)) LE.le]
...
@[to_additive]
theorem mul_le_mul_three [CovariantClass α α (*) LE.le]
    [CovariantClass α α (swap (*)) LE.le] {a b c d e f : α} (h₁ : a ≤ d) (h₂ : b ≤ e)
    (h₃ : c ≤ f) :
    a * b * c ≤ d * e * f :=
...
@[to_additive]
theorem mul_lt_of_mul_lt_left [CovariantClass α α (*) LE.le] {a b c d : α} (h : a * b < c)
    (hle : d ≤ b) :
    a * d < c :=
...
@[to_additive]
theorem mul_le_of_mul_le_left [CovariantClass α α (*) LE.le] {a b c d : α} (h : a * b ≤ c)
    (hle : d ≤ b) :
    a * d ≤ c :=
...
@[to_additive]
theorem mul_lt_of_mul_lt_right [CovariantClass α α (swap (*)) LE.le] {a b c d : α}
    (h : a * b < c) (hle : d ≤ a) :
    d * b < c :=
...
@[to_additive]
theorem mul_le_of_mul_le_right [CovariantClass α α (swap (*)) LE.le] {a b c d : α}
    (h : a * b ≤ c) (hle : d ≤ a) :
    d * b ≤ c :=
...
@[to_additive]
theorem lt_mul_of_lt_mul_left [CovariantClass α α (*) LE.le] {a b c d : α} (h : a < b * c)
    (hle : c ≤ d) :
    a < b * d :=
...
@[to_additive]
theorem le_mul_of_le_mul_left [CovariantClass α α (*) LE.le] {a b c d : α} (h : a ≤ b * c)
    (hle : c ≤ d) :
    a ≤ b * d :=
...
@[to_additive]
theorem lt_mul_of_lt_mul_right [CovariantClass α α (swap (*)) LE.le] {a b c d : α}
    (h : a < b * c) (hle : b ≤ d) :
    a < d * c :=
...
@[to_additive]
theorem le_mul_of_le_mul_right [CovariantClass α α (swap (*)) LE.le] {a b c d : α}
    (h : a ≤ b * c) (hle : b ≤ d) :
    a ≤ d * c :=
...
@[to_additive]
theorem mul_left_cancel'' [ContravariantClass α α (*) LE.le] {a b c : α} (h : a * b = a * c) :
    b = c :=
...
@[to_additive]
theorem mul_right_cancel'' [ContravariantClass α α (swap (*)) LE.le] {a b c : α}
    (h : a * b = c * b) :
    a = c :=
...
@[to_additive] lemma mul_le_mul_iff_of_ge [CovariantClass α α (*) LT.lt]
    [CovariantClass α α (swap (*)) LT.lt] {a₁ a₂ b₁ b₂ : α} (ha : a₁ ≤ a₂) (hb : b₁ ≤ b₂) :
    a₂ * b₂ ≤ a₁ * b₁ ↔ a₁ = a₂ ∧ b₁ = b₂ := by
...
@[to_additive] theorem mul_eq_mul_iff_eq_and_eq [CovariantClass α α (*) LT.lt]
    [CovariantClass α α (swap (*)) LT.lt] {a b c d : α} (hac : a ≤ c) (hbd : b ≤ d) :
    a * b = c * d ↔ a = c ∧ b = d := by
  haveI := covariantClass_le_of_lt α α (· * ·)
  haveI := covariantClass_le_of_lt α α (swap (· * ·))
...
@[to_additive] lemma min_lt_max_of_mul_lt_mul
    [CovariantClass α α (*) LE.le] [CovariantClass α α (swap (*)) LE.le]
...
@[to_additive] lemma Left.min_le_max_of_mul_le_mul
    [CovariantClass α α (*) LT.lt] [CovariantClass α α (swap (*)) LE.le]
    (h : a * b ≤ c * d) : min a b ≤ max c d := by
...
@[to_additive] lemma Right.min_le_max_of_mul_le_mul
    [CovariantClass α α (*) LE.le] [CovariantClass α α (swap (*)) LT.lt]
    (h : a * b ≤ c * d) : min a b ≤ max c d := by
...
@[to_additive] lemma min_le_max_of_mul_le_mul
    [CovariantClass α α (*) LT.lt] [CovariantClass α α (swap (*)) LT.lt]
...
theorem le_mul_of_one_le_right' [CovariantClass α α (*) LE.le] {a b : α} (h : 1 ≤ b) :
    a ≤ a * b :=
  calc
...
theorem mul_le_of_le_one_right' [CovariantClass α α (*) LE.le] {a b : α} (h : b ≤ 1) :
    a * b ≤ a :=
  calc
...
theorem le_mul_of_one_le_left' [CovariantClass α α (swap (*)) LE.le] {a b : α} (h : 1 ≤ b) :
    a ≤ b * a :=
  calc
...
theorem mul_le_of_le_one_left' [CovariantClass α α (swap (*)) LE.le] {a b : α} (h : b ≤ 1) :
    b * a ≤ a :=
  calc
...
@[to_additive]
theorem one_le_of_le_mul_right [ContravariantClass α α (*) LE.le] {a b : α} (h : a ≤ a * b) :
    1 ≤ b :=
...
@[to_additive]
theorem le_one_of_mul_le_right [ContravariantClass α α (*) LE.le] {a b : α} (h : a * b ≤ a) :
    b ≤ 1 :=
  le_of_mul_le_mul_left' <| by simpa only [mul_one]
...
@[to_additive]
theorem one_le_of_le_mul_left [ContravariantClass α α (swap (*)) LE.le] {a b : α}
    (h : b ≤ a * b) :
    1 ≤ a :=
...
@[to_additive]
theorem le_one_of_mul_le_left [ContravariantClass α α (swap (*)) LE.le] {a b : α}
    (h : a * b ≤ b) :
    a ≤ 1 :=
  le_of_mul_le_mul_right' <| by simpa only [one_mul]
...
theorem le_mul_iff_one_le_right' [CovariantClass α α (*) LE.le]
    [ContravariantClass α α (*) LE.le] (a : α) {b : α} :
    a ≤ a * b ↔ 1 ≤ b :=
...
theorem le_mul_iff_one_le_left' [CovariantClass α α (swap (*)) LE.le]
    [ContravariantClass α α (swap (*)) LE.le] (a : α) {b : α} :
    a ≤ b * a ↔ 1 ≤ b :=
...
theorem mul_le_iff_le_one_right' [CovariantClass α α (*) LE.le]
    [ContravariantClass α α (*) LE.le] (a : α) {b : α} :
    a * b ≤ a ↔ b ≤ 1 :=
  Iff.trans (by rw [mul_one]) (mul_le_mul_iff_left a)
...
theorem mul_le_iff_le_one_left' [CovariantClass α α (swap (*)) LE.le]
    [ContravariantClass α α (swap (*)) LE.le] {a b : α} :
    a * b ≤ b ↔ a ≤ 1 :=
...
theorem lt_mul_of_one_lt_right' [CovariantClass α α (*) LT.lt] (a : α) {b : α} (h : 1 < b) :
    a < a * b :=
  calc
    a = a * 1 := (mul_one a).symm
...
theorem mul_lt_of_lt_one_right' [CovariantClass α α (*) LT.lt] (a : α) {b : α} (h : b < 1) :
    a * b < a :=
  calc
...
theorem lt_mul_of_one_lt_left' [CovariantClass α α (swap (*)) LT.lt] (a : α) {b : α}
    (h : 1 < b) :
    a < b * a :=
  calc
    a = 1 * a := (one_mul a).symm
...
theorem mul_lt_of_lt_one_left' [CovariantClass α α (swap (*)) LT.lt] (a : α) {b : α}
    (h : b < 1) :
    b * a < a :=
  calc
...
@[to_additive]
theorem one_lt_of_lt_mul_right [ContravariantClass α α (*) LT.lt] {a b : α} (h : a < a * b) :
    1 < b :=
...
@[to_additive]
theorem lt_one_of_mul_lt_right [ContravariantClass α α (*) LT.lt] {a b : α} (h : a * b < a) :
    b < 1 :=
  lt_of_mul_lt_mul_left' <| by simpa only [mul_one]
...
@[to_additive]
theorem one_lt_of_lt_mul_left [ContravariantClass α α (swap (*)) LT.lt] {a b : α}
    (h : b < a * b) :
    1 < a :=
...
@[to_additive]
theorem lt_one_of_mul_lt_left [ContravariantClass α α (swap (*)) LT.lt] {a b : α}
    (h : a * b < b) :
    a < 1 :=
  lt_of_mul_lt_mul_right' <| by simpa only [one_mul]
...
theorem lt_mul_iff_one_lt_right' [CovariantClass α α (*) LT.lt]
    [ContravariantClass α α (*) LT.lt] (a : α) {b : α} :
    a < a * b ↔ 1 < b :=
...
theorem lt_mul_iff_one_lt_left' [CovariantClass α α (swap (*)) LT.lt]
    [ContravariantClass α α (swap (*)) LT.lt] (a : α) {b : α} : a < b * a ↔ 1 < b :=
...
theorem mul_lt_iff_lt_one_left' [CovariantClass α α (*) LT.lt]
    [ContravariantClass α α (*) LT.lt] {a b : α} :
    a * b < a ↔ b < 1 :=
  Iff.trans (by rw [mul_one]) (mul_lt_mul_iff_left a)
...
theorem mul_lt_iff_lt_one_right' [CovariantClass α α (swap (*)) LT.lt]
    [ContravariantClass α α (swap (*)) LT.lt] {a : α} (b : α) : a * b < b ↔ a < 1 :=
...
@[to_additive]
theorem mul_le_of_le_of_le_one [CovariantClass α α (*) LE.le] {a b c : α} (hbc : b ≤ c)
    (ha : a ≤ 1) :
    b * a ≤ c :=
  calc
...
@[to_additive]
theorem mul_lt_of_le_of_lt_one [CovariantClass α α (*) LT.lt] {a b c : α} (hbc : b ≤ c)
    (ha : a < 1) :
    b * a < c :=
  calc
...
@[to_additive]
theorem mul_lt_of_lt_of_le_one [CovariantClass α α (*) LE.le] {a b c : α} (hbc : b < c)
    (ha : a ≤ 1) :
    b * a < c :=
  calc
    b * a ≤ b * 1 := mul_le_mul_left' ha b
...
@[to_additive]
theorem mul_lt_of_lt_of_lt_one [CovariantClass α α (*) LT.lt] {a b c : α} (hbc : b < c)
    (ha : a < 1) :
    b * a < c :=
  calc
    b * a < b * 1 := mul_lt_mul_left' ha b
...
@[to_additive]
theorem mul_lt_of_lt_of_lt_one' [CovariantClass α α (*) LE.le] {a b c : α} (hbc : b < c)
    (ha : a < 1) :
    b * a < c :=
...
theorem Left.mul_le_one [CovariantClass α α (*) LE.le] {a b : α} (ha : a ≤ 1) (hb : b ≤ 1) :
    a * b ≤ 1 :=
...
theorem Left.mul_lt_one_of_le_of_lt [CovariantClass α α (*) LT.lt] {a b : α} (ha : a ≤ 1)
    (hb : b < 1) :
    a * b < 1 :=
...
theorem Left.mul_lt_one_of_lt_of_le [CovariantClass α α (*) LE.le] {a b : α} (ha : a < 1)
    (hb : b ≤ 1) :
    a * b < 1 :=
...
theorem Left.mul_lt_one [CovariantClass α α (*) LT.lt] {a b : α} (ha : a < 1) (hb : b < 1) :
    a * b < 1 :=
...
@[to_additive "Assumes left covariance.
The lemma assuming right covariance is `Right.add_neg'`."]
theorem Left.mul_lt_one' [CovariantClass α α (*) LE.le] {a b : α} (ha : a < 1) (hb : b < 1) :
    a * b < 1 :=
  mul_lt_of_lt_of_lt_one' ha hb
#align left.mul_lt_one' Left.mul_lt_one'
#align left.add_neg' Left.add_neg'
...
@[to_additive]
theorem le_mul_of_le_of_one_le [CovariantClass α α (*) LE.le] {a b c : α} (hbc : b ≤ c)
    (ha : 1 ≤ a) :
    b ≤ c * a :=
  calc
    b ≤ c := hbc
...
@[to_additive]
theorem lt_mul_of_le_of_one_lt [CovariantClass α α (*) LT.lt] {a b c : α} (hbc : b ≤ c)
    (ha : 1 < a) :
    b < c * a :=
  calc
    b ≤ c := hbc
...
@[to_additive]
theorem lt_mul_of_lt_of_one_le [CovariantClass α α (*) LE.le] {a b c : α} (hbc : b < c)
    (ha : 1 ≤ a) :
    b < c * a :=
  calc
    b < c := hbc
...
@[to_additive]
theorem lt_mul_of_lt_of_one_lt [CovariantClass α α (*) LT.lt] {a b c : α} (hbc : b < c)
    (ha : 1 < a) :
    b < c * a :=
  calc
    b < c := hbc
...
@[to_additive]
theorem lt_mul_of_lt_of_one_lt' [CovariantClass α α (*) LE.le] {a b c : α} (hbc : b < c)
    (ha : 1 < a) :
    b < c * a :=
...
theorem Left.one_le_mul [CovariantClass α α (*) LE.le] {a b : α} (ha : 1 ≤ a) (hb : 1 ≤ b) :
    1 ≤ a * b :=
...
theorem Left.one_lt_mul_of_le_of_lt [CovariantClass α α (*) LT.lt] {a b : α} (ha : 1 ≤ a)
    (hb : 1 < b) :
    1 < a * b :=
...
theorem Left.one_lt_mul_of_lt_of_le [CovariantClass α α (*) LE.le] {a b : α} (ha : 1 < a)
    (hb : 1 ≤ b) :
    1 < a * b :=
...
theorem Left.one_lt_mul [CovariantClass α α (*) LT.lt] {a b : α} (ha : 1 < a) (hb : 1 < b) :
    1 < a * b :=
...
@[to_additive Left.add_pos' "Assumes left covariance.
The lemma assuming right covariance is `Right.add_pos'`."]
theorem Left.one_lt_mul' [CovariantClass α α (*) LE.le] {a b : α} (ha : 1 < a) (hb : 1 < b) :
    1 < a * b :=
  lt_mul_of_lt_of_one_lt' ha hb
#align left.one_lt_mul' Left.one_lt_mul'
#align left.add_pos' Left.add_pos'
...
@[to_additive]
theorem mul_le_of_le_one_of_le [CovariantClass α α (swap (*)) LE.le] {a b c : α} (ha : a ≤ 1)
    (hbc : b ≤ c) :
    a * b ≤ c :=
  calc
...
@[to_additive]
theorem mul_lt_of_lt_one_of_le [CovariantClass α α (swap (*)) LT.lt] {a b c : α} (ha : a < 1)
    (hbc : b ≤ c) :
    a * b < c :=
  calc
...
@[to_additive]
theorem mul_lt_of_le_one_of_lt [CovariantClass α α (swap (*)) LE.le] {a b c : α} (ha : a ≤ 1)
    (hb : b < c) :
    a * b < c :=
  calc
    a * b ≤ 1 * b := mul_le_mul_right' ha b
...
@[to_additive]
theorem mul_lt_of_lt_one_of_lt [CovariantClass α α (swap (*)) LT.lt] {a b c : α} (ha : a < 1)
    (hb : b < c) :
    a * b < c :=
  calc
    a * b < 1 * b := mul_lt_mul_right' ha b
...
@[to_additive]
theorem mul_lt_of_lt_one_of_lt' [CovariantClass α α (swap (*)) LE.le] {a b c : α} (ha : a < 1)
    (hbc : b < c) :
    a * b < c :=
...
theorem Right.mul_le_one [CovariantClass α α (swap (*)) LE.le] {a b : α} (ha : a ≤ 1)
    (hb : b ≤ 1) :
    a * b ≤ 1 :=
...
theorem Right.mul_lt_one_of_lt_of_le [CovariantClass α α (swap (*)) LT.lt] {a b : α}
    (ha : a < 1) (hb : b ≤ 1) :
    a * b < 1 :=
...
theorem Right.mul_lt_one_of_le_of_lt [CovariantClass α α (swap (*)) LE.le] {a b : α}
    (ha : a ≤ 1) (hb : b < 1) :
    a * b < 1 :=
...
theorem Right.mul_lt_one [CovariantClass α α (swap (*)) LT.lt] {a b : α} (ha : a < 1)
    (hb : b < 1) :
    a * b < 1 :=
...
@[to_additive "Assumes right covariance.
The lemma assuming left covariance is `Left.add_neg'`."]
theorem Right.mul_lt_one' [CovariantClass α α (swap (*)) LE.le] {a b : α} (ha : a < 1)
    (hb : b < 1) :
    a * b < 1 :=
  mul_lt_of_lt_one_of_lt' ha hb
#align right.mul_lt_one' Right.mul_lt_one'
...
@[to_additive]
theorem le_mul_of_one_le_of_le [CovariantClass α α (swap (*)) LE.le] {a b c : α} (ha : 1 ≤ a)
    (hbc : b ≤ c) :
    b ≤ a * c :=
  calc
    b ≤ c := hbc
...
@[to_additive]
theorem lt_mul_of_one_lt_of_le [CovariantClass α α (swap (*)) LT.lt] {a b c : α} (ha : 1 < a)
    (hbc : b ≤ c) :
    b < a * c :=
  calc
    b ≤ c := hbc
...
@[to_additive]
theorem lt_mul_of_one_le_of_lt [CovariantClass α α (swap (*)) LE.le] {a b c : α} (ha : 1 ≤ a)
    (hbc : b < c) :
    b < a * c :=
  calc
    b < c := hbc
...
@[to_additive]
theorem lt_mul_of_one_lt_of_lt [CovariantClass α α (swap (*)) LT.lt] {a b c : α} (ha : 1 < a)
    (hbc : b < c) :
    b < a * c :=
  calc
    b < c := hbc
...
@[to_additive]
theorem lt_mul_of_one_lt_of_lt' [CovariantClass α α (swap (*)) LE.le] {a b c : α} (ha : 1 < a)
    (hbc : b < c) :
    b < a * c :=
...
theorem Right.one_le_mul [CovariantClass α α (swap (*)) LE.le] {a b : α} (ha : 1 ≤ a)
    (hb : 1 ≤ b) :
    1 ≤ a * b :=
...
theorem Right.one_lt_mul_of_lt_of_le [CovariantClass α α (swap (*)) LT.lt] {a b : α}
    (ha : 1 < a) (hb : 1 ≤ b) :
    1 < a * b :=
...
theorem Right.one_lt_mul_of_le_of_lt [CovariantClass α α (swap (*)) LE.le] {a b : α}
    (ha : 1 ≤ a) (hb : 1 < b) :
    1 < a * b :=
...
theorem Right.one_lt_mul [CovariantClass α α (swap (*)) LT.lt] {a b : α} (ha : 1 < a)
    (hb : 1 < b) :
    1 < a * b :=
...
@[to_additive Right.add_pos' "Assumes right covariance.
The lemma assuming left covariance is `Left.add_pos'`."]
theorem Right.one_lt_mul' [CovariantClass α α (swap (*)) LE.le] {a b : α} (ha : 1 < a)
    (hb : 1 < b) :
    1 < a * b :=
  lt_mul_of_one_lt_of_lt' ha hb
#align right.one_lt_mul' Right.one_lt_mul'
...
@[to_additive]
theorem lt_of_mul_lt_of_one_le_left [CovariantClass α α (*) LE.le] {a b c : α} (h : a * b < c)
    (hle : 1 ≤ b) :
    a < c :=
...
@[to_additive]
theorem le_of_mul_le_of_one_le_left [CovariantClass α α (*) LE.le] {a b c : α} (h : a * b ≤ c)
    (hle : 1 ≤ b) :
    a ≤ c :=
...
@[to_additive]
theorem lt_of_lt_mul_of_le_one_left [CovariantClass α α (*) LE.le] {a b c : α} (h : a < b * c)
    (hle : c ≤ 1) :
    a < b :=
...
@[to_additive]
theorem le_of_le_mul_of_le_one_left [CovariantClass α α (*) LE.le] {a b c : α} (h : a ≤ b * c)
    (hle : c ≤ 1) :
    a ≤ b :=
...
@[to_additive]
theorem lt_of_mul_lt_of_one_le_right [CovariantClass α α (swap (*)) LE.le] {a b c : α}
    (h : a * b < c) (hle : 1 ≤ a) :
    b < c :=
...
@[to_additive]
theorem le_of_mul_le_of_one_le_right [CovariantClass α α (swap (*)) LE.le] {a b c : α}
    (h : a * b ≤ c) (hle : 1 ≤ a) :
    b ≤ c :=
...
@[to_additive]
theorem lt_of_lt_mul_of_le_one_right [CovariantClass α α (swap (*)) LE.le] {a b c : α}
    (h : a < b * c) (hle : b ≤ 1) :
    a < c :=
...
@[to_additive]
theorem le_of_le_mul_of_le_one_right [CovariantClass α α (swap (*)) LE.le] {a b c : α}
    (h : a ≤ b * c) (hle : b ≤ 1) :
    a ≤ c :=
...
@[to_additive]
theorem mul_eq_one_iff' [CovariantClass α α (*) LE.le]
    [CovariantClass α α (swap (*)) LE.le] {a b : α} (ha : 1 ≤ a) (hb : 1 ≤ b) :
    a * b = 1 ↔ a = 1 ∧ b = 1 :=
  Iff.intro
    (fun hab : a * b = 1 =>
...
variable [CovariantClass α α (*) LE.le] {a b : α}
...
variable [CovariantClass α α (swap (*)) LE.le] {a b : α}
...
theorem exists_square_le [CovariantClass α α (*) LT.lt] (a : α) : ∃ b : α, b * b ≤ a := by
  by_cases h : a < 1
  · use a
...
def Contravariant.toLeftCancelSemigroup [ContravariantClass α α (*) LE.le] :
...
def Contravariant.toRightCancelSemigroup [ContravariantClass α α (swap (*)) LE.le] :
...
theorem Monotone.const_mul' [CovariantClass α α (*) LE.le] (hf : Monotone f) (a : α) :
...
@[to_additive const_add]
theorem MonotoneOn.const_mul' [CovariantClass α α (*) LE.le] (hf : MonotoneOn f s) (a : α) :
...
@[to_additive const_add]
theorem Antitone.const_mul' [CovariantClass α α (*) LE.le] (hf : Antitone f) (a : α) :
...
@[to_additive const_add]
theorem AntitoneOn.const_mul' [CovariantClass α α (*) LE.le] (hf : AntitoneOn f s) (a : α) :
...
theorem Monotone.mul_const' [CovariantClass α α (swap (*)) LE.le] (hf : Monotone f) (a : α) :
...
@[to_additive add_const]
theorem MonotoneOn.mul_const' [CovariantClass α α (swap (*)) LE.le] (hf : MonotoneOn f s)
    (a : α) :
...
@[to_additive add_const]
theorem Antitone.mul_const' [CovariantClass α α (swap (*)) LE.le] (hf : Antitone f) (a : α) :
...
@[to_additive add_const]
theorem AntitoneOn.mul_const' [CovariantClass α α (swap (*)) LE.le] (hf : AntitoneOn f s)
    (a : α) :
...
theorem Monotone.mul' [CovariantClass α α (*) LE.le]
    [CovariantClass α α (swap (*)) LE.le] (hf : Monotone f) (hg : Monotone g) :
...
/-- The product of two monotone functions is monotone. -/
@[to_additive add "The sum of two monotone functions is monotone."]
theorem MonotoneOn.mul' [CovariantClass α α (*) LE.le]
    [CovariantClass α α (swap (*)) LE.le] (hf : MonotoneOn f s) (hg : MonotoneOn g s) :
...
theorem Antitone.mul' [CovariantClass α α (*) LE.le]
    [CovariantClass α α (swap (*)) LE.le] (hf : Antitone f) (hg : Antitone g) :
...
/-- The product of two antitone functions is antitone. -/
@[to_additive add "The sum of two antitone functions is antitone."]
theorem AntitoneOn.mul' [CovariantClass α α (*) LE.le]
    [CovariantClass α α (swap (*)) LE.le] (hf : AntitoneOn f s) (hg : AntitoneOn g s) :
...
variable [CovariantClass α α (*) LT.lt]
...
variable [CovariantClass α α (swap (*)) LT.lt]
...
theorem StrictMono.mul' [CovariantClass α α (*) LT.lt]
    [CovariantClass α α (swap (*)) LT.lt] (hf : StrictMono f) (hg : StrictMono g) :
...
/-- The product of two strictly monotone functions is strictly monotone. -/
@[to_additive add "The sum of two strictly monotone functions is strictly monotone."]
theorem StrictMonoOn.mul' [CovariantClass α α (*) LT.lt]
    [CovariantClass α α (swap (*)) LT.lt] (hf : StrictMonoOn f s) (hg : StrictMonoOn g s) :
...
theorem StrictAnti.mul' [CovariantClass α α (*) LT.lt]
    [CovariantClass α α (swap (*)) LT.lt] (hf : StrictAnti f) (hg : StrictAnti g) :
...
/-- The product of two strictly antitone functions is strictly antitone. -/
@[to_additive add "The sum of two strictly antitone functions is strictly antitone."]
theorem StrictAntiOn.mul' [CovariantClass α α (*) LT.lt]
    [CovariantClass α α (swap (*)) LT.lt] (hf : StrictAntiOn f s) (hg : StrictAntiOn g s) :
...
strictly monotone."]
theorem Monotone.mul_strictMono' [CovariantClass α α (*) LT.lt]
    [CovariantClass α α (swap (*)) LE.le] {f g : β → α} (hf : Monotone f)
    (hg : StrictMono g) :
...
@[to_additive add_strictMono "The sum of a monotone function and a strictly monotone function is
strictly monotone."]
theorem MonotoneOn.mul_strictMono' [CovariantClass α α (*) LT.lt]
    [CovariantClass α α (swap (*)) LE.le] {f g : β → α} (hf : MonotoneOn f s)
...
strictly antitone."]
theorem Antitone.mul_strictAnti' [CovariantClass α α (*) LT.lt]
    [CovariantClass α α (swap (*)) LE.le] {f g : β → α} (hf : Antitone f)
    (hg : StrictAnti g) :
    StrictAnti fun x => f x * g x :=
  fun _ _ h => mul_lt_mul_of_le_of_lt (hf h.le) (hg h)
...
@[to_additive add_strictAnti "The sum of an antitone function and a strictly antitone function is
strictly antitone."]
theorem AntitoneOn.mul_strictAnti' [CovariantClass α α (*) LT.lt]
    [CovariantClass α α (swap (*)) LE.le] {f g : β → α} (hf : AntitoneOn f s)
    (hg : StrictAntiOn g s) :
    StrictAntiOn (fun x => f x * g x) s :=
  fun _ hx _ hy h => mul_lt_mul_of_le_of_lt (hf hx hy h.le) (hg hx hy h)
...
variable [CovariantClass α α (*) LE.le] [CovariantClass α α (swap (*)) LT.lt]
...
theorem cmp_mul_left' {α : Type*} [Mul α] [LinearOrder α] [CovariantClass α α (*) LT.lt]
    (a b c : α) :
    cmp (a * b) (a * c) = cmp b c :=
...
theorem cmp_mul_right' {α : Type*} [Mul α] [LinearOrder α]
    [CovariantClass α α (swap (*)) LT.lt] (a b c : α) :
    cmp (a * c) (b * c) = cmp a b :=
...
@[to_additive]
theorem Contravariant.MulLECancellable [Mul α] [LE α] [ContravariantClass α α (*) LE.le]
    {a : α} :
    MulLECancellable a :=
...
@[to_additive]
protected theorem mul_le_mul_iff_left [Mul α] [CovariantClass α α (*) LE.le] {a b c : α}
...
protected theorem mul_le_mul_iff_right [Mul α] [i : IsSymmOp α α (· * ·)]
    [CovariantClass α α (*) LE.le] {a b c : α} (ha : MulLECancellable a) :
...
@[to_additive]
protected theorem le_mul_iff_one_le_right [MulOneClass α] [CovariantClass α α (*) LE.le]
...
@[to_additive]
protected theorem mul_le_iff_le_one_right [MulOneClass α] [CovariantClass α α (*) LE.le]
    {a b : α} (ha : MulLECancellable a) :
    a * b ≤ a ↔ b ≤ 1 :=
  Iff.trans (by rw [mul_one]) ha.mul_le_mul_iff_left
...
protected theorem le_mul_iff_one_le_left [MulOneClass α] [i : IsSymmOp α α (· * ·)]
    [CovariantClass α α (*) LE.le] {a b : α} (ha : MulLECancellable a) :
...
@[deprecated]
theorem bit0_strictMono [CovariantClass α α (+) LT.lt]
    [CovariantClass α α (swap (+)) LT.lt] :
