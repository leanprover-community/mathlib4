...
instance Multiplicative.isOrderedMonoid [AddCommSemigroup α] [Preorder α] [IsOrderedAddMonoid α] :
    IsOrderedMonoid (Multiplicative α) :=
  { mul_le_mul_left := @IsOrderedAddMonoid.add_le_add_left α _ _ _ }

instance Additive.isOrderedAddMonoid [CommSemigroup α] [Preorder α] [IsOrderedMonoid α] :
...
instance Multiplicative.isOrderedCancelMonoid
    [AddCommSemigroup α] [Preorder α] [IsOrderedCancelAddMonoid α] :
...
instance Multiplicative.canonicallyOrderedMul
    [AddSemigroup α] [Preorder α] [CanonicallyOrderedAdd α] :
...
instance Additive.canonicallyOrderedAdd
    [Semigroup α] [Preorder α] [CanonicallyOrderedMul α] :
