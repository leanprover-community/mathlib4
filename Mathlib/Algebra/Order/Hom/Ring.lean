...
you should parametrize over `(F : Type*) [OrderHomClass F α β] [RingHomClass F α β] (f : F)`.
...
you should parametrize over `(F : Type*) [OrderHomClass F α β] [RingIsoClass F α β] (f : F)`.
