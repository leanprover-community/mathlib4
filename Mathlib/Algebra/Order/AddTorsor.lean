...
@[to_additive]
instance [CommSemigroup G] [Preorder G] [IsOrderedMonoid G] : IsOrderedSMul G G where
...
@[to_additive]
instance [CommSemigroup G] [Preorder G] [IsOrderedCancelMonoid G] : IsOrderedCancelSMul G G where
