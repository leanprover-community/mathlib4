...
variable [CommGroup α] [OrderedCommGroup α] [CommGroup β] [OrderedCommGroup β]
...
variable [CommGroup α] [OrderedCommGroup α] [CommGroup β] [LinearOrderedCommGroup β]
  {s : Set ι} {f f₁ f₂ : ι → α} {g g₁ g₂ : ι → β}
...
variable [Semiring α] [OrderedSemiring α] [Semiring β] [OrderedSemiring β]
  {s : Set ι} {f f₁ f₂ : ι → α} {g g₁ g₂ : ι → β}
...
variable [Semiring α] [LinearOrderedSemiring α] [Semiring β] [LinearOrderedSemiring β]
  {s : Set ι} {f f₁ f₂ : ι → α} {g g₁ g₂ : ι → β}
...
variable [Semifield α] [LinearOrderedSemifield α] [Semifield β] [LinearOrderedSemifield β]
  {s : Set ι} {f f₁ f₂ : ι → α} {g g₁ g₂ : ι → β}
...
variable [Ring α] [LinearOrderedRing α] [AddCommGroup β] [LinearOrderedAddCommGroup β] [Module α β]
...
variable [Ring α] [LinearOrderedRing α] {f g : ι → α} {s : Set ι} {a b c d : α}
