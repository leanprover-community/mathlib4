...
section
variable {α β : Type*} [Monoid α] [CommMonoid β] [Preorder β] [MulLeftMono β]
...
@[to_additive sum_pos]
lemma one_lt_prod_of_one_lt [CommMonoid M] [Preorder M] [MulLeftMono M] :
...
lemma single_le_prod [CommMonoid M] [Preorder M] [MulLeftMono M]
