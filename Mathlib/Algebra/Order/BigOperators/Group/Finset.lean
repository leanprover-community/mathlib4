...
@[deprecated (since := "2026-09-01")] alias one_le_prod' := one_le_prod
...
@[deprecated (since := "2026-09-01")] alias prod_le_one' := prod_le_one
...
@[deprecated (since := "2026-09-01")] alias prod_mono_set_of_one_le' := prod_mono_set_of_one_le
...
@[deprecated (since := "2026-09-01")] alias prod_anti_set_of_le_one' := prod_anti_set_of_le_one

@[deprecated (since := "2026-09-01")] alias sum_anti_set_of_nonpos' := sum_anti_set_of_nonpos
...
@[deprecated (since := "2026-09-01")] alias single_le_prod' := single_le_prod
...
@[deprecated (since := "2026-09-01")] alias prod_le_prod_of_subset' := prod_le_prod_of_subset
...
@[deprecated (since := "2026-09-01")] alias prod_mono_set' := prod_mono_set
...
@[deprecated (since := "2026-09-01")] alias prod_lt_prod_of_subset' := prod_lt_prod_of_subset
...
@[deprecated (since := "2026-09-01")] alias single_lt_prod' := single_lt_prod
...
@[deprecated (since := "2026-09-01")] alias prod_mono' := prod_mono
...
@[deprecated (since := "2026-09-01")] alias prod_strictMono' := prod_strictMono
