...
* `[CommGroup α]`
* `[CovariantClass α α (*) (≤)]`
* `[CovariantClass α α (swap HMul.hMul) LE.le]`
...
-- c + (a ⊔ b) = (c + a) ⊔ (c + b)
@[to_additive]
theorem mul_sup [CovariantClass α α HMul.hMul LE.le] (a b c : α) : c * (a ⊔ b) = c * a ⊔ c * b :=
  (OrderIso.mulLeft _).map_sup _ _
#align mul_sup mul_sup
#align add_sup add_sup

@[to_additive]
theorem sup_mul [CovariantClass α α (swap HMul.hMul) LE.le] (a b c : α) :
    (a ⊔ b) * c = a * c ⊔ b * c :=
...
@[to_additive]
theorem mul_inf [CovariantClass α α HMul.hMul LE.le] (a b c : α) : c * (a ⊓ b) = c * a ⊓ c * b :=
  (OrderIso.mulLeft _).map_inf _ _
#align mul_inf mul_inf
#align add_inf add_inf

@[to_additive]
theorem inf_mul [CovariantClass α α (swap HMul.hMul) LE.le] (a b c : α) :
    (a ⊓ b) * c = a * c ⊓ b * c :=
...
theorem inv_sup_eq_inv_inf_inv
    [CovariantClass α α HMul.hMul LE.le] [CovariantClass α α (swap HMul.hMul) LE.le] (a b : α) :
    (a ⊔ b)⁻¹ = a⁻¹ ⊓ b⁻¹ :=
...
theorem neg_eq_inv_inf_one
    [CovariantClass α α HMul.hMul LE.le] [CovariantClass α α (swap HMul.hMul) LE.le] (a : α) :
    a⁻ = (a ⊓ 1)⁻¹ := by
...
-- c + (a ⊓ b) = (c + a) ⊓ (c + b)
@[to_additive]
theorem mul_inf_eq_mul_inf_mul [CovariantClass α α HMul.hMul LE.le] (a b c : α) :
    c * (a ⊓ b) = c * a ⊓ c * b := by
...
-- a = a⁺ - a⁻
@[to_additive (attr := simp)]
theorem pos_div_neg [CovariantClass α α HMul.hMul LE.le] (a : α) : a⁺ / a⁻ = a := by
  symm
  rw [div_eq_mul_inv]
...
-- neg_of_nonpos
@[to_additive]
theorem neg_of_le_one [CovariantClass α α HMul.hMul LE.le] (a : α) (h : a ≤ 1) : a⁻ = a⁻¹ :=
...
-- neg_of_nonneg'
@[to_additive]
theorem neg_of_one_le [CovariantClass α α HMul.hMul LE.le] (a : α) (h : 1 ≤ a) : a⁻ = 1 :=
  neg_eq_one_iff.mpr h
...
theorem mabs_of_one_le [CovariantClass α α HMul.hMul LE.le] (a : α) (h : 1 ≤ a) : |a| = a :=
...
@[to_additive pos_abs]
theorem m_pos_abs [CovariantClass α α HMul.hMul LE.le] [CovariantClass α α (swap HMul.hMul) LE.le]
    (a : α) : |a|⁺ = |a| := by
  rw [m_pos_part_def]
...
@[to_additive neg_abs]
theorem m_neg_abs [CovariantClass α α HMul.hMul LE.le] [CovariantClass α α (swap HMul.hMul) LE.le]
    (a : α) : |a|⁻ = 1 := by
  rw [m_neg_part_def]
...
@[to_additive (attr := simp) abs_abs
  "The unary operation of taking the absolute value is idempotent."]
theorem mabs_mabs [CovariantClass α α HMul.hMul LE.le] [CovariantClass α α (swap HMul.hMul) LE.le]
    (a : α) : |(|a|)| = |a| :=
...
-- a ⊓ b + (a ⊔ b) = a + b
@[to_additive]
theorem inf_mul_sup [CovariantClass α α HMul.hMul LE.le] (a b : α) : (a ⊓ b) * (a ⊔ b) = a * b :=
  calc
...
-- a⊔b = b + (a - b)⁺
@[to_additive]
theorem sup_eq_mul_pos_div [CovariantClass α α HMul.hMul LE.le] (a b : α) : a ⊔ b = b * (a / b)⁺ :=
  calc
    a ⊔ b = b * (a / b) ⊔ b * 1 :=
...
-- a⊓b = a - (a - b)⁺
@[to_additive]
theorem inf_eq_div_pos_div [CovariantClass α α HMul.hMul LE.le] (a b : α) : a ⊓ b = a / (a / b)⁺ :=
  calc
    a ⊓ b = a * 1 ⊓ a * (b / a) :=
...
theorem m_le_iff_pos_le_neg_ge [CovariantClass α α HMul.hMul LE.le] (a b : α) :
    a ≤ b ↔ a⁺ ≤ b⁺ ∧ b⁻ ≤ a⁻ := by
  constructor <;> intro h
  · constructor
...
theorem sup_sq_eq_mul_mul_abs_div [CovariantClass α α HMul.hMul LE.le] (a b : α) :
    (a ⊔ b) ^ 2 = a * b * |b / a| := by
...
theorem inf_sq_eq_mul_div_abs_div [CovariantClass α α HMul.hMul LE.le] (a b : α) :
    (a ⊓ b) ^ 2 = a * b / |b / a| := by
...
def latticeOrderedCommGroupToDistribLattice (α : Type u) [s : Lattice α] [CommGroup α]
    [CovariantClass α α HMul.hMul LE.le] : DistribLattice α :=
  { s with
    le_sup_inf := by
      intros x y z
...
-- |a ⊔ c - (b ⊔ c)| + |a ⊓ c-b ⊓ c| = |a - b|
@[to_additive]
theorem abs_div_sup_mul_abs_div_inf [CovariantClass α α HMul.hMul LE.le] (a b c : α) :
...
theorem mabs_sup_div_sup_le_mabs [CovariantClass α α HMul.hMul LE.le] (a b c : α) :
    |(a ⊔ c) / (b ⊔ c)| ≤ |a / b| := by
...
theorem mabs_inf_div_inf_le_mabs [CovariantClass α α HMul.hMul LE.le] (a b c : α) :
    |(a ⊓ c) / (b ⊓ c)| ≤ |a / b| := by
...
theorem m_Birkhoff_inequalities [CovariantClass α α HMul.hMul LE.le] (a b c : α) :
    |(a ⊔ c) / (b ⊔ c)| ⊔ |(a ⊓ c) / (b ⊓ c)| ≤ |a / b| :=
...
theorem mabs_mul_le [CovariantClass α α HMul.hMul LE.le] (a b : α) : |a * b| ≤ |a| * |b| := by
  apply sup_le
...
-- | |a| - |b| | ≤ |a - b|
@[to_additive]
theorem abs_abs_div_abs_le [CovariantClass α α HMul.hMul LE.le] (a b : α) :
    |(|a| / |b|)| ≤ |a / b| := by
...
variable [Semiring α] [Invertible (2 : α)] [Lattice β] [AddCommGroup β] [Module α β]
  [CovariantClass β β HAdd.hAdd LE.le]
