...
variable [MonoidWithZero α] [Preorder α] [PosMulMono α] [ZeroLEOneClass α] {a : α}
...
variable [MulPosMono α]

lemma pow_le_pow_of_le_one {a : α} (ha₀ : 0 ≤ a) (ha₁ : a ≤ 1) :
    ∀ {m n : ℕ}, m ≤ n → a ^ n ≤ a ^ m
...
theorem one_le_mul_of_one_le_of_one_le {b : α} (ha : 1 ≤ a) (hb : 1 ≤ b) : (1 : α) ≤ a * b :=
...
theorem add_le_mul_two_add {b : α} (a2 : 2 ≤ a) (b0 : 0 ≤ b) : a + (2 + b) ≤ a * (2 + b) :=
  calc
    a + (2 + b) ≤ a + (a + a * b) :=
...
variable [Mul α] [Zero α] [Preorder α] [PosMulMono α] [MulPosMono α] {a : α}

theorem monotone_mul_left_of_nonneg (ha : 0 ≤ a) : Monotone fun x => a * x := fun _ _ h => mul_le_mul_of_nonneg_left h ha
...
variable [MulZeroClass α] [Preorder α] [PosMulMono α] [MulPosMono α]
...
variable [MulZeroOneClass α] [Preorder α] [PosMulMono α] [MulPosMono α] [ZeroLEOneClass α] {a b : α}
...
section NonUntialNonAssocSemiring

variable [NonUnitalNonAssocSemiring α] [Preorder α] [ExistsAddOfLE α] [PosMulMono α] [MulPosMono α]
...
end NonUntialNonAssocSemiring

section NonAssocSemiring

variable [NonAssocSemiring α] [Preorder α] [ExistsAddOfLE α] [PosMulMono α] [MulPosMono α]
    [CovariantClass α α (swap (· + ·)) (· ≤ ·)]  [ContravariantClass α α (swap (· + ·)) (· ≤ ·)]
    {a b c d : α}
...
variable [NonUnitalNonAssocSemiring α] [Preorder α] [PosMulMono α] [MulPosMono α] [ExistsAddOfLE α]
  [ContravariantClass α α (swap (· + ·)) (· ≤ ·)] [CovariantClass α α (swap (· + ·)) (· ≤ ·)]
variable [Preorder β] {f g : β → α} {a : α}
...
variable [AddZeroClass α] [LE α] [ExistsAddOfLE α]
...
variable [MulPosStrictMono α] [PosMulMono α] in
...
variable [MulPosMono α] [PosMulStrictMono α] in
theorem mul_lt_mul' (hac : a ≤ c) (hbd : b < d) (hb : 0 ≤ b) (hc : 0 < c) : a * b < c * d :=
...
variable [MonoidWithZero α] [PartialOrder α] [ZeroLEOneClass α] [NeZero (R := α) 1]
  [PosMulStrictMono α] {a : α}

@[simp]
theorem pow_pos (H : 0 < a) : ∀ n : ℕ, 0 < a ^ n
  | 0 => by
    rw [pow_zero]
    exact zero_lt_one (α := α)
  | n + 1 => by
    rw [pow_succ]
...
variable [Mul α] [Zero α] [Preorder α] [MulPosMono α] [PosMulStrictMono α] {a b : α}
...
theorem neg_of_mul_neg_left [PosMulStrictMono α]
    (h : a * b < 0) (hb : 0 ≤ b) : a < 0 :=
  lt_of_not_ge fun ha => (mul_nonneg ha hb).not_lt h
#align neg_of_mul_neg_left neg_of_mul_neg_left

theorem neg_of_mul_neg_right [PosMulStrictMono α]
    (h : a * b < 0) (ha : 0 ≤ a) : b < 0 :=
...
variable [CommSemiring α] [LinearOrder α] [PosMulMono α] [MulPosMono α] {a d : α}
