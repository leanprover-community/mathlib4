...
protected abbrev orderedSemiring [Semiring α] [OrderedSemiring α] (zero : f 0 = 0) (one : f 1 = 1)
    (add : ∀ x y, f (x + y) = f x + f y) (mul : ∀ x y, f (x * y) = f x * f y)
    (nsmul : ∀ (n : ℕ) (x), f (n • x) = n • f x) (npow : ∀ (x) (n : ℕ), f (x ^ n) = f x ^ n)
    (natCast : ∀ n : ℕ, f n = n) :
    letI := hf.semiring f zero one add mul nsmul npow natCast
    OrderedSemiring β where
...
-- See note [reducible non-instances]
protected abbrev orderedCommSemiring [CommSemiring α] [OrderedCommSemiring α]
    (zero : f 0 = 0) (one : f 1 = 1)
    (add : ∀ x y, f (x + y) = f x + f y) (mul : ∀ x y, f (x * y) = f x * f y)
    (nsmul : ∀ (n : ℕ) (x), f (n • x) = n • f x) (npow : ∀ (x) (n : ℕ), f (x ^ n) = f x ^ n)
    (natCast : ∀ n : ℕ, f n = n) :
    letI := hf.commSemiring f zero one add mul nsmul npow natCast
    OrderedCommSemiring β where
...
-- See note [reducible non-instances]
protected abbrev orderedRing [Ring α] [OrderedRing α] (zero : f 0 = 0) (one : f 1 = 1)
    ...
    letI := hf.ring f zero one add mul neg sub nsmul zsmul npow natCast intCast
    OrderedRing β where
  __ := hf.ring f zero one add mul neg sub nsmul zsmul npow natCast intCast
...
-- See note [reducible non-instances]
protected abbrev orderedCommRing [CommRing α] [OrderedCommRing α]
    (zero : f 0 = 0) (one : f 1 = 1) (add : ∀ x y, f (x + y) = f x + f y)
    (mul : ∀ x y, f (x * y) = f x * f y) (neg : ∀ x, f (-x) = -f x)
    (sub : ∀ x y, f (x - y) = f x - f y) (nsmul : ∀ (n : ℕ) (x), f (n • x) = n • f x)
    (zsmul : ∀ (n : ℤ) (x), f (n • x) = n • f x) (npow : ∀ (x) (n : ℕ), f (x ^ n) = f x ^ n)
    (natCast : ∀ n : ℕ, f n = n) (intCast : ∀ n : ℤ, f n = n) :
    letI := hf.commRing f zero one add mul neg sub nsmul zsmul npow natCast intCast
    OrderedCommRing β where
...
-- See note [reducible non-instances]
protected abbrev strictOrderedSemiring [Semiring α] [StrictOrderedSemiring α]
    (zero : f 0 = 0) (one : f 1 = 1)
    (add : ∀ x y, f (x + y) = f x + f y) (mul : ∀ x y, f (x * y) = f x * f y)
    (nsmul : ∀ (n : ℕ) (x), f (n • x) = n • f x) (npow : ∀ (x) (n : ℕ), f (x ^ n) = f x ^ n)
    (natCast : ∀ n : ℕ, f n = n) :
    letI := hf.semiring f zero one add mul nsmul npow natCast
    StrictOrderedSemiring β where
  __ := hf.semiring f zero one add mul nsmul npow natCast
...
-- See note [reducible non-instances]
protected abbrev strictOrderedCommSemiring [CommSemiring α] [StrictOrderedCommSemiring α]
    (zero : f 0 = 0) (one : f 1 = 1)
    (add : ∀ x y, f (x + y) = f x + f y) (mul : ∀ x y, f (x * y) = f x * f y)
    (nsmul : ∀ (n : ℕ) (x), f (n • x) = n • f x) (npow : ∀ (x) (n : ℕ), f (x ^ n) = f x ^ n)
    (natCast : ∀ n : ℕ, f n = n) :
...
-- See note [reducible non-instances]
protected abbrev strictOrderedRing [Ring α] [StrictOrderedRing α] (zero : f 0 = 0) (one : f 1 = 1)
    (add : ∀ x y, f (x + y) = f x + f y) (mul : ∀ x y, f (x * y) = f x * f y)
...
-- See note [reducible non-instances]
protected abbrev strictOrderedCommRing [CommRing α] [StrictOrderedCommRing α]
    (zero : f 0 = 0) (one : f 1 = 1) (add : ∀ x y, f (x + y) = f x + f y)
    (mul : ∀ x y, f (x * y) = f x * f y) (neg : ∀ x, f (-x) = -f x)
    (sub : ∀ x y, f (x - y) = f x - f y) (nsmul : ∀ (n : ℕ) (x), f (n • x) = n • f x)
    (zsmul : ∀ (n : ℤ) (x), f (n • x) = n • f x) (npow : ∀ (x) (n : ℕ), f (x ^ n) = f x ^ n)
...
-- See note [reducible non-instances]
protected abbrev linearOrderedSemiring [Semiring α] [LinearOrderedSemiring α]
    (zero : f 0 = 0) (one : f 1 = 1)
    (add : ∀ x y, f (x + y) = f x + f y) (mul : ∀ x y, f (x * y) = f x * f y)
...
-- Move this
instance [CommSemiring α] [LinearOrderedCommSemiring α]: LinearOrderedSemiring α where
  __ := ‹LinearOrderedCommSemiring α›

/-- Pullback a `LinearOrderedSemiring` under an injective map. -/
-- -- See note [reducible non-instances]
protected abbrev linearOrderedCommSemiring [CommSemiring α] [LinearOrderedCommSemiring α]
    (zero : f 0 = 0) (one : f 1 = 1) (add : ∀ x y, f (x + y) = f x + f y)
...
-- See note [reducible non-instances]
abbrev linearOrderedRing [Ring α] [LinearOrderedRing α] (zero : f 0 = 0) (one : f 1 = 1)
    (add : ∀ x y, f (x + y) = f x + f y) (mul : ∀ x y, f (x * y) = f x * f y)
    (neg : ∀ x, f (-x) = -f x) (sub : ∀ x y, f (x - y) = f x - f y)
    (nsmul : ∀ (n : ℕ) (x), f (n • x) = n • f x) (zsmul : ∀ (n : ℤ) (x), f (n • x) = n • f x)
    (npow : ∀ (x) (n : ℕ), f (x ^ n) = f x ^ n)
...
-- See note [reducible non-instances]
protected abbrev linearOrderedCommRing [CommRing α] [LinearOrderedCommRing α]
    (zero : f 0 = 0) (one : f 1 = 1)
    (add : ∀ x y, f (x + y) = f x + f y) (mul : ∀ x y, f (x * y) = f x * f y)
    (neg : ∀ x, f (-x) = -f x) (sub : ∀ x y, f (x - y) = f x - f y)
    (nsmul : ∀ (n : ℕ) (x), f (n • x) = n • f x) (zsmul : ∀ (n : ℤ) (x), f (n • x) = n • f x)
