...
structure AbsoluteValue (R S : Type*) [Semiring R] [Semiring S] [OrderedSemiring S]
    extends R →ₙ* S where
...
variable {R S : Type*} [Semiring R] [Semiring S] [OrderedSemiring S] (abv : AbsoluteValue R S)
...
variable {R S : Type*} [Ring R] [Semiring S] [OrderedSemiring S] (abv : AbsoluteValue R S)
...
variable {R S : Type*} [Semiring R] [Ring S] [OrderedRing S] (abv : AbsoluteValue R S)
...
variable {R S : Type*} [Ring R] [Ring S] [OrderedRing S] (abv : AbsoluteValue R S)
...
variable [CommRing S] [OrderedCommRing S] [Ring R] (abv : AbsoluteValue R S)
...
variable {R S : Type*} [Semiring R] [Ring S] [LinearOrderedRing S] (abv : AbsoluteValue R S)
...
variable {R S : Type*} [Ring R] [CommRing S] [LinearOrderedCommRing S] (abv : AbsoluteValue R S)
...
-/
class IsAbsoluteValue {S} [Semiring S] [OrderedSemiring S] {R} [Semiring R] (f : R → S) : Prop where
  /-- The absolute value is nonnegative -/
  abv_nonneg' : ∀ x, 0 ≤ f x
  /-- The absolute value is positive definitive -/
...
variable {S : Type*} [Semiring S] [OrderedSemiring S]
...
variable {S : Type*} [Ring S] [LinearOrderedRing S]
...
variable {S : Type*} [Ring S] [OrderedRing S]
...
section OrderedCommRing
variable [CommRing S] [OrderedCommRing S] [NoZeroDivisors S] [Ring R]
...
variable {S : Type*} [CommRing S] [LinearOrderedCommRing S]
...
variable {S : Type*} [Semifield S] [LinearOrderedSemifield S]
