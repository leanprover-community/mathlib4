...
variable {𝕜 : Type*} [RCLike 𝕜] {μ : Measure ℝ} {E : Type*} [AddCommGroup E] [NormedAddCommGroup E]
  [NormedSpace ℝ E] [NormedSpace 𝕜 E] {H : Type*} [AddCommGroup H] [NormedAddCommGroup H]
