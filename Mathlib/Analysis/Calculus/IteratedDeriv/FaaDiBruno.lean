...
theorem iteratedDerivWithin_vcomp_three
  ...
  simp only [← (OrderedFinpartition.extendEquiv 1).sum_comp,
    ...
    OrderedFinpartition.extendLeft_partSize, OrderedFinpartition.extendLeft_length,
    ...
    Fin.succ_zero_eq_one, update_self, iteratedFDerivWithin_one_apply (ht _ <| hst hx), add_assoc,
    two_smul]
