...
variable {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E] {F : Type*} [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F]
  [NormedSpace ℝ F]
...
theorem image_norm_le_of_liminf_right_slope_norm_lt_deriv_boundary {E : Type*}
    [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] {f : ℝ → E} {f' : ℝ → ℝ} (hf : ContinuousOn f (Icc a b))
    -- `hf'` actually says `liminf (‖f z‖ - ‖f x‖) / (z - x) ≤ f' x`
...
theorem _root_.lipschitzWith_of_nnnorm_fderiv_le
    {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace 𝕜 E] {f : E → G}
...
theorem _root_.eq_of_fderiv_eq
    {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace 𝕜 E] {f g : E → G}
...
variable {𝕜 G : Type*} [RCLike 𝕜] [NormMetric G] [AddCommGroup G] [IsNormedAddGroup G] [NormedSpace 𝕜 G]
...
variable {𝕜 : Type*} [RCLike 𝕜] {G : Type*} [NormMetric G] [AddCommGroup G] [IsNormedAddGroup G] [NormedSpace 𝕜 G] {H : Type*}
  [NormMetric H] [AddCommGroup H] [IsNormedAddGroup H] [NormedSpace 𝕜 H] {f : G → H} {f' : G → G →L[𝕜] H} {x : G}
