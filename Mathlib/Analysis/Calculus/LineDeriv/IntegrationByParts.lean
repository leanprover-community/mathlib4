...
variable {E F G W : Type*} [AddCommGroup E] [NormedAddCommGroup E] [NormedSpace ℝ E]
    [AddCommGroup F] [NormedAddCommGroup F]
  [NormedSpace ℝ F] [AddCommGroup G] [NormedAddCommGroup G] [NormedSpace ℝ G] [AddCommGroup W]
