...
theorem smul {𝕜' : Type*} [NontriviallyNormedField 𝕜'] [SMul 𝕜 𝕜'] [NormedAlgebra 𝕜 𝕜'] [NormedSpace 𝕜' F]
...
theorem smul_const {𝕜' : Type*} [NontriviallyNormedField 𝕜'] [SMul 𝕜 𝕜'] [NormedAlgebra 𝕜 𝕜']
