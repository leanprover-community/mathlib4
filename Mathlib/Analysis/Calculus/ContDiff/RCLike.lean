...
variable {n : WithTop ℕ∞} {𝕂 : Type*} [RCLike 𝕂] {E' : Type*} [NormMetric E'] [AddCommGroup E'] [IsNormedAddGroup E']
  [NormedSpace 𝕂 E'] {F' : Type*} [NormMetric F'] [AddCommGroup F'] [IsNormedAddGroup F'] [NormedSpace 𝕂 F']
...
variable {E F : Type*}
    [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E] [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] [NormedSpace ℝ F] {f : E → F}
