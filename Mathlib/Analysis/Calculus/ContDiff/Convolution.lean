...
variable [NormMetric G] [AddCommGroup G] [IsNormedAddGroup G] [BorelSpace G]
...
variable [RCLike 𝕜] [NormedSpace 𝕜 E] [NormedSpace 𝕜 E'] [NormedSpace 𝕜 E''] [NormedSpace ℝ F]
  [NormedSpace 𝕜 F] [MeasurableSpace G] [NormMetric G] [AddCommGroup G] [IsNormedAddGroup G] [BorelSpace G]
  [NormedSpace 𝕜 G] [NormMetric P] [AddCommGroup P] [IsNormedAddGroup P] [NormedSpace 𝕜 P] {μ : Measure G}
  (L : E →L[𝕜] E' →L[𝕜] F)
...
theorem contDiffOn_convolution_right_with_param_aux {G : Type uP} {E' : Type uP} {F : Type uP}
    {P : Type uP} [NormMetric E'] [AddCommGroup E'] [IsNormedAddGroup E'] [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] [NormedSpace 𝕜 E']
    [NormedSpace ℝ F] [NormedSpace 𝕜 F] [MeasurableSpace G]
    {μ : Measure G}
    [NormMetric G] [AddCommGroup G] [IsNormedAddGroup G] [BorelSpace G] [NormedSpace 𝕜 G] [NormMetric P] [AddCommGroup P] [IsNormedAddGroup P] [NormedSpace 𝕜 P]
