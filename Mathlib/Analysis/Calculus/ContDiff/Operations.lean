...
variable {𝕜 : Type*} [NontriviallyNormedField 𝕜]
  ...
  [NormedAddCommGroup G] [NormedSpace 𝕜 G] {X : Type*} [AddCommGroup X] [NormedAddCommGroup X]
  [NormedSpace 𝕜 X] {s t : Set E} {f : E → F}
...
@[fun_prop]
theorem ContDiffOn.prodMap {s : Set E} {t : Set E'} {f : E → F} {g : E' → F'}
