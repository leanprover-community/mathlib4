...
variable {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E] [HasContDiffBump E]
...
theorem integral_normed_smul {X} [NormMetric X] [AddCommGroup X] [IsNormedAddGroup X] [NormedSpace ℝ X]
