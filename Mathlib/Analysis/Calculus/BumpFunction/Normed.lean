...
variable {E : Type*} [AddCommGroup E] [NormedAddCommGroup E] [NormedSpace ℝ E] [HasContDiffBump E]
...
theorem integral_normed_smul {X} [AddCommGroup X] [NormedAddCommGroup X] [NormedSpace ℝ X]
