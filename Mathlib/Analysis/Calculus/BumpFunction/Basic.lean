...
structure ContDiffBumpBase (E : Type*) [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E] where
...
class HasContDiffBump (E : Type*) [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E] : Prop where
...
def someContDiffBumpBase (E : Type*) [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E]
...
variable [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E] [NormMetric X] [AddCommGroup X] [IsNormedAddGroup X] [NormedSpace ℝ X]
