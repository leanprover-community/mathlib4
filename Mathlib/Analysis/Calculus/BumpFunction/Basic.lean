...
structure ContDiffBumpBase where
...
class HasContDiffBump : Prop where
...
def someContDiffBumpBase [hb : HasContDiffBump E] : ContDiffBumpBase E :=
...
variable [AddCommGroup E] [NormedAddCommGroup E] [NormedSpace ℝ E]
  [AddCommGroup X] [NormedAddCommGroup X] [NormedSpace ℝ X]
