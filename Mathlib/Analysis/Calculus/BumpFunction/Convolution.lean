...
variable {G : Type uG} {E' : Type uE'} [AddCommGroup E'] [NormedAddGroup E']
  {g : G → E'} [MeasurableSpace G] {μ : MeasureTheory.Measure G}
  [NormedSpace ℝ E'] [AddCommGroup G] [NormedAddGroup G] [NormedSpace ℝ G]
