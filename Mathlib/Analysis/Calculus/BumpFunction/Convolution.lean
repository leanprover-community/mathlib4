...
variable {G : Type uG} {E' : Type uE'} [AddCommGroup E'] [NormedAddCommGroup E'] {g : G → E'} [MeasurableSpace G]
  {μ : MeasureTheory.Measure G} [NormedSpace ℝ E'] [AddCommGroup G] [NormedAddCommGroup G] [NormedSpace ℝ G]
