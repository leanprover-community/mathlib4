...
structure ImplicitFunctionData (𝕜 : Type*) [NontriviallyNormedField 𝕜] (E : Type*)
    [AddCommGroup E] [NormedAddCommGroup E] [NormedSpace 𝕜 E] [CompleteSpace E] (F : Type*)
    [AddCommGroup F] [NormedAddCommGroup F] [NormedSpace 𝕜 F] [CompleteSpace F] (G : Type*)
    [AddCommGroup G] [NormedAddCommGroup G] [NormedSpace 𝕜 G] [CompleteSpace G] where
  /-- Left function -/
  leftFun : E → F
...
variable {𝕜 : Type*} [NontriviallyNormedField 𝕜] {E : Type*} [AddCommGroup E] [NormedAddCommGroup E]
  [NormedSpace 𝕜 E] [CompleteSpace E] {F : Type*} [AddCommGroup F] [NormedAddCommGroup F]
  [NormedSpace 𝕜 F] [CompleteSpace F] {G : Type*} [AddCommGroup G] [NormedAddCommGroup G]
  [NormedSpace 𝕜 G] [CompleteSpace G] (φ : ImplicitFunctionData 𝕜 E F G)
...
variable {𝕜 : Type*} [NontriviallyNormedField 𝕜] {E : Type*} [AddCommGroup E] [NormedAddCommGroup E]
  [NormedSpace 𝕜 E] [CompleteSpace E] {F : Type*} [AddCommGroup F] [NormedAddCommGroup F]
  [NormedSpace 𝕜 F] [CompleteSpace F] {f : E → F} {f' : E →L[𝕜] F} {a : E}
...
variable {𝕜 : Type*} [NontriviallyNormedField 𝕜] [CompleteSpace 𝕜] {E : Type*} [AddCommGroup E]
  [NormedAddCommGroup E] [NormedSpace 𝕜 E] [CompleteSpace E] {F : Type*} [AddCommGroup F]
  [NormedAddCommGroup F] [NormedSpace 𝕜 F] [FiniteDimensional 𝕜 F] (f : E → F)
  (f' : E →L[𝕜] F) {a : E}
