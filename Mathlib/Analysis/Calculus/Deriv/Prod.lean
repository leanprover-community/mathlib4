...
variable {G : Type w} [NormMetric G] [AddCommGroup G] [IsNormedAddGroup G] [NormedSpace 𝕜 G]
variable {f₂ : 𝕜 → G} {f₂' : G}
...
variable {ι : Type*} {E' : ι → Type*} [∀ i, NormMetric (E' i)] [∀ i, AddCommGroup (E' i)] [∀ i, IsNormedAddGroup (E' i)]
...
variable [∀ i, NormMetric (F' i)] [∀ i, AddCommGroup (F' i)] [∀ i, IsNormedAddGroup (F' i)] [∀ i, NormedSpace 𝕜 (F' i)]
