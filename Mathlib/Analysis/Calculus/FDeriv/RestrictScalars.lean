...
@[fun_prop]
nonrec theorem HasStrictFDerivAt.restrictScalars (h : HasStrictFDerivAt f f' x) :
    HasStrictFDerivAt f (f'.restrictScalars 𝕜) x :=
  h.restrictScalars _

@[fun_prop]
nonrec theorem HasFDerivAt.restrictScalars (h : HasFDerivAt f f' x) :
    HasFDerivAt f (f'.restrictScalars 𝕜) x :=
  h.restrictScalars _

@[fun_prop]
nonrec theorem HasFDerivWithinAt.restrictScalars (h : HasFDerivWithinAt f f' s x) :
