...
@[fun_prop]
lemma HasStrictFDerivAt.clm_comp (hc : HasStrictFDerivAt c c' x) (hd : HasStrictFDerivAt d d' x) :
...
@[fun_prop]
lemma HasFDerivWithinAt.clm_comp (hc : HasFDerivWithinAt c c' s x)
...
@[fun_prop]
lemma HasFDerivAt.clm_comp (hc : HasFDerivAt c c' x) (hd : HasFDerivAt d d' x) :
...
@[fun_prop]
lemma DifferentiableWithinAt.clm_comp (hc : DifferentiableWithinAt 𝕜 c s x)
...
@[fun_prop]
lemma DifferentiableAt.clm_comp (hc : DifferentiableAt 𝕜 c x) (hd : DifferentiableAt 𝕜 d x) :
...
@[fun_prop]
lemma DifferentiableOn.clm_comp (hc : DifferentiableOn 𝕜 c s) (hd : DifferentiableOn 𝕜 d s) :
...
lemma fderivWithin_clm_comp (hxs : UniqueDiffWithinAt 𝕜 s x) (hc : DifferentiableWithinAt 𝕜 c s x)
    (hd : DifferentiableWithinAt 𝕜 d s x) :
...
lemma fderiv_clm_comp (hc : DifferentiableAt 𝕜 c x) (hd : DifferentiableAt 𝕜 d x) :
...
@[fun_prop]
lemma HasStrictFDerivAt.clm_apply (hc : HasStrictFDerivAt c c' x)
...
@[fun_prop]
lemma HasFDerivWithinAt.clm_apply (hc : HasFDerivWithinAt c c' s x)
...
@[fun_prop]
lemma HasFDerivAt.clm_apply (hc : HasFDerivAt c c' x) (hu : HasFDerivAt u u' x) :
...
@[fun_prop]
lemma DifferentiableWithinAt.clm_apply (hc : DifferentiableWithinAt 𝕜 c s x)
...
@[fun_prop]
lemma DifferentiableAt.clm_apply (hc : DifferentiableAt 𝕜 c x) (hu : DifferentiableAt 𝕜 u x) :
...
@[fun_prop]
lemma DifferentiableOn.clm_apply (hc : DifferentiableOn 𝕜 c s) (hu : DifferentiableOn 𝕜 u s) :
...
lemma fderivWithin_clm_apply (hxs : UniqueDiffWithinAt 𝕜 s x)
...
lemma fderiv_clm_apply (hc : DifferentiableAt 𝕜 c x) (hu : DifferentiableAt 𝕜 u x) :
...
@[fun_prop]
lemma HasStrictFDerivAt.continuousMultilinear_apply_const (hc : HasStrictFDerivAt c c' x)
...
@[fun_prop]
lemma HasFDerivWithinAt.continuousMultilinear_apply_const (hc : HasFDerivWithinAt c c' s x)
    (u : ∀ i, M i) :
...
@[fun_prop]
lemma HasFDerivAt.continuousMultilinear_apply_const (hc : HasFDerivAt c c' x) (u : ∀ i, M i) :
    HasFDerivAt (fun y ↦ (c y) u) (c'.flipMultilinear u) x :=
  (ContinuousMultilinearMap.apply 𝕜 M H u).hasFDerivAt.comp x hc

@[fun_prop]
lemma DifferentiableWithinAt.continuousMultilinear_apply_const
...
@[fun_prop]
lemma DifferentiableAt.continuousMultilinear_apply_const (hc : DifferentiableAt 𝕜 c x)
    (u : ∀ i, M i) :
    DifferentiableAt 𝕜 (fun y ↦ (c y) u) x :=
  (hc.hasFDerivAt.continuousMultilinear_apply_const u).differentiableAt

@[fun_prop]
lemma DifferentiableOn.continuousMultilinear_apply_const (hc : DifferentiableOn 𝕜 c s)
    (u : ∀ i, M i) : DifferentiableOn 𝕜 (fun y ↦ (c y) u) s :=
  fun x hx ↦ (hc x hx).continuousMultilinear_apply_const u

@[fun_prop]
lemma Differentiable.continuousMultilinear_apply_const (hc : Differentiable 𝕜 c) (u : ∀ i, M i) :
    Differentiable 𝕜 fun y ↦ (c y) u := fun x ↦ (hc x).continuousMultilinear_apply_const u

lemma fderivWithin_continuousMultilinear_apply_const (hxs : UniqueDiffWithinAt 𝕜 s x)
    (hc : DifferentiableWithinAt 𝕜 c s x) (u : ∀ i, M i) :
...
lemma fderiv_continuousMultilinear_apply_const (hc : DifferentiableAt 𝕜 c x) (u : ∀ i, M i) :
...
@[fun_prop]
lemma HasStrictFDerivAt.smul (hc : HasStrictFDerivAt c c' x) (hf : HasStrictFDerivAt f f' x) :
...
@[fun_prop]
lemma HasFDerivWithinAt.smul (hc : HasFDerivWithinAt c c' s x) (hf : HasFDerivWithinAt f f' s x) :
...
@[fun_prop]
lemma HasFDerivAt.smul (hc : HasFDerivAt c c' x) (hf : HasFDerivAt f f' x) :
...
@[fun_prop]
lemma DifferentiableWithinAt.smul (hc : DifferentiableWithinAt 𝕜 c s x)
...
@[simp, fun_prop]
lemma DifferentiableAt.smul (hc : DifferentiableAt 𝕜 c x) (hf : DifferentiableAt 𝕜 f x) :
...
@[fun_prop]
lemma DifferentiableOn.smul (hc : DifferentiableOn 𝕜 c s) (hf : DifferentiableOn 𝕜 f s) :
...
lemma fderivWithin_smul (hxs : UniqueDiffWithinAt 𝕜 s x) (hc : DifferentiableWithinAt 𝕜 c s x)
...
lemma fderiv_smul (hc : DifferentiableAt 𝕜 c x) (hf : DifferentiableAt 𝕜 f x) :
...
@[fun_prop]
lemma HasStrictFDerivAt.smul_const (hc : HasStrictFDerivAt c c' x) (f : F) :
...
@[fun_prop]
lemma HasFDerivWithinAt.smul_const (hc : HasFDerivWithinAt c c' s x) (f : F) :
...
@[fun_prop]
lemma HasFDerivAt.smul_const (hc : HasFDerivAt c c' x) (f : F) :
...
@[fun_prop]
lemma DifferentiableWithinAt.smul_const (hc : DifferentiableWithinAt 𝕜 c s x) (f : F) :
...
@[fun_prop]
lemma DifferentiableAt.smul_const (hc : DifferentiableAt 𝕜 c x) (f : F) :
...
@[fun_prop]
lemma DifferentiableOn.smul_const (hc : DifferentiableOn 𝕜 c s) (f : F) :
...
lemma fderivWithin_smul_const (hxs : UniqueDiffWithinAt 𝕜 s x)
...
lemma fderiv_smul_const (hc : DifferentiableAt 𝕜 c x) (f : F) :
...
@[fun_prop]
lemma HasStrictFDerivAt.mul (hc : HasStrictFDerivAt c c' x) (hd : HasStrictFDerivAt d d' x) :
...
@[fun_prop]
lemma HasFDerivWithinAt.mul' (ha : HasFDerivWithinAt a a' s x) (hb : HasFDerivWithinAt b b' s x) :
...
@[fun_prop]
lemma HasFDerivWithinAt.mul (hc : HasFDerivWithinAt c c' s x) (hd : HasFDerivWithinAt d d' s x) :
...
@[fun_prop]
lemma HasFDerivAt.mul' (ha : HasFDerivAt a a' x) (hb : HasFDerivAt b b' x) :
...
@[fun_prop]
lemma HasFDerivAt.mul (hc : HasFDerivAt c c' x) (hd : HasFDerivAt d d' x) :
...
@[fun_prop]
lemma DifferentiableWithinAt.mul (ha : DifferentiableWithinAt 𝕜 a s x)
...
@[simp, fun_prop]
lemma DifferentiableAt.mul (ha : DifferentiableAt 𝕜 a x) (hb : DifferentiableAt 𝕜 b x) :
...
@[fun_prop]
lemma DifferentiableOn.mul (ha : DifferentiableOn 𝕜 a s) (hb : DifferentiableOn 𝕜 b s) :
    DifferentiableOn 𝕜 (fun y => a y * b y) s := fun x hx => (ha x hx).mul (hb x hx)
#align differentiable_on.mul DifferentiableOn.mul

@[simp, fun_prop]
lemma Differentiable.mul (ha : Differentiable 𝕜 a) (hb : Differentiable 𝕜 b) :
    Differentiable 𝕜 fun y => a y * b y := fun x => (ha x).mul (hb x)
#align differentiable.mul Differentiable.mul

@[fun_prop]
lemma DifferentiableWithinAt.pow (ha : DifferentiableWithinAt 𝕜 a s x) :
...
@[simp, fun_prop]
lemma DifferentiableAt.pow (ha : DifferentiableAt 𝕜 a x) (n : ℕ) :
...
@[fun_prop]
lemma DifferentiableOn.pow (ha : DifferentiableOn 𝕜 a s) (n : ℕ) :
    DifferentiableOn 𝕜 (fun x => a x ^ n) s := fun x h => (ha x h).pow n
#align differentiable_on.pow DifferentiableOn.pow

@[simp, fun_prop]
lemma Differentiable.pow (ha : Differentiable 𝕜 a) (n : ℕ) : Differentiable 𝕜 fun x => a x ^ n :=
  fun x => (ha x).pow n
#align differentiable.pow Differentiable.pow

lemma fderivWithin_mul' (hxs : UniqueDiffWithinAt 𝕜 s x) (ha : DifferentiableWithinAt 𝕜 a s x)
...
lemma fderivWithin_mul (hxs : UniqueDiffWithinAt 𝕜 s x) (hc : DifferentiableWithinAt 𝕜 c s x)
    (hd : DifferentiableWithinAt 𝕜 d s x) :
...
lemma fderiv_mul' (ha : DifferentiableAt 𝕜 a x) (hb : DifferentiableAt 𝕜 b x) :
...
lemma fderiv_mul (hc : DifferentiableAt 𝕜 c x) (hd : DifferentiableAt 𝕜 d x) :
    fderiv 𝕜 (fun y => c y * d y) x = c x • fderiv 𝕜 d x + d x • fderiv 𝕜 c x :=
  (hc.hasFDerivAt.mul hd.hasFDerivAt).fderiv
#align fderiv_mul fderiv_mul

@[fun_prop]
lemma HasStrictFDerivAt.mul_const' (ha : HasStrictFDerivAt a a' x) (b : 𝔸) :
...
@[fun_prop]
lemma HasStrictFDerivAt.mul_const (hc : HasStrictFDerivAt c c' x) (d : 𝔸') :
...
@[fun_prop]
lemma HasFDerivWithinAt.mul_const' (ha : HasFDerivWithinAt a a' s x) (b : 𝔸) :
...
@[fun_prop]
lemma HasFDerivWithinAt.mul_const (hc : HasFDerivWithinAt c c' s x) (d : 𝔸') :
...
@[fun_prop]
lemma HasFDerivAt.mul_const' (ha : HasFDerivAt a a' x) (b : 𝔸) :
...
@[fun_prop]
lemma HasFDerivAt.mul_const (hc : HasFDerivAt c c' x) (d : 𝔸') :
...
@[fun_prop]
lemma DifferentiableWithinAt.mul_const (ha : DifferentiableWithinAt 𝕜 a s x) (b : 𝔸) :
...
@[fun_prop]
lemma DifferentiableAt.mul_const (ha : DifferentiableAt 𝕜 a x) (b : 𝔸) :
...
@[fun_prop]
lemma DifferentiableOn.mul_const (ha : DifferentiableOn 𝕜 a s) (b : 𝔸) :
...
lemma fderivWithin_mul_const' (hxs : UniqueDiffWithinAt 𝕜 s x)
...
@[fun_prop]
lemma HasFDerivWithinAt.const_mul (ha : HasFDerivWithinAt a a' s x) (b : 𝔸) :
...
@[fun_prop]
lemma HasFDerivAt.const_mul (ha : HasFDerivAt a a' x) (b : 𝔸) :
...
@[fun_prop]
lemma DifferentiableWithinAt.const_mul (ha : DifferentiableWithinAt 𝕜 a s x) (b : 𝔸) :
...
@[fun_prop]
lemma DifferentiableAt.const_mul (ha : DifferentiableAt 𝕜 a x) (b : 𝔸) :
...
@[fun_prop]
lemma DifferentiableOn.const_mul (ha : DifferentiableOn 𝕜 a s) (b : 𝔸) :
...
lemma fderivWithin_const_mul (hxs : UniqueDiffWithinAt 𝕜 s x)
    (ha : DifferentiableWithinAt 𝕜 a s x) (b : 𝔸) :
...
lemma fderiv_const_mul (ha : DifferentiableAt 𝕜 a x) (b : 𝔸) :
...
@[fun_prop]
lemma hasStrictFDerivAt_list_prod' [Fintype ι] {l : List ι} {x : ι → 𝔸} :
...
@[fun_prop]
lemma hasStrictFDerivAt_list_prod_finRange' {n : ℕ} {x : Fin n → 𝔸} :
...
@[fun_prop]
lemma hasStrictFDerivAt_list_prod_attach' [DecidableEq ι] {l : List ι} {x : {i // i ∈ l} → 𝔸} :
...
@[fun_prop]
lemma hasFDerivAt_list_prod' [Fintype ι] {l : List ι} {x : ι → 𝔸'} :
...
@[fun_prop]
lemma hasFDerivAt_list_prod_finRange' {n : ℕ} {x : Fin n → 𝔸} :
...
@[fun_prop]
lemma hasFDerivAt_list_prod_attach' [DecidableEq ι] {l : List ι} {x : {i // i ∈ l} → 𝔸} :
...
@[fun_prop]
lemma hasStrictFDerivAt_multiset_prod [DecidableEq ι] [Fintype ι] {u : Multiset ι} {x : ι → 𝔸'} :
...
@[fun_prop]
lemma hasFDerivAt_multiset_prod [DecidableEq ι] [Fintype ι] {u : Multiset ι} {x : ι → 𝔸'} :
...
lemma hasStrictFDerivAt_finset_prod [DecidableEq ι] [Fintype ι] {x : ι → 𝔸'} :
...
lemma hasFDerivAt_finset_prod [DecidableEq ι] [Fintype ι] {x : ι → 𝔸'} :
...
@[fun_prop]
lemma HasStrictFDerivAt.list_prod' {l : List ι} {x : E}
...
@[fun_prop]
lemma HasFDerivWithinAt.list_prod' {l : List ι} {x : E}
...
lemma fderiv_list_prod' {l : List ι} {x : E}
...
lemma fderivWithin_list_prod' {l : List ι} {x : E}
...
@[fun_prop]
lemma HasStrictFDerivAt.multiset_prod [DecidableEq ι] {u : Multiset ι} {x : E}
...
@[fun_prop]
lemma HasFDerivWithinAt.multiset_prod [DecidableEq ι] {u : Multiset ι} {x : E}
...
lemma fderiv_multiset_prod [DecidableEq ι] {u : Multiset ι} {x : E}
...
lemma fderivWithin_multiset_prod [DecidableEq ι] {u : Multiset ι} {x : E}
...
lemma HasStrictFDerivAt.finset_prod [DecidableEq ι] {x : E}
...
lemma HasFDerivAt.finset_prod [DecidableEq ι] {x : E}
...
lemma HasFDerivWithinAt.finset_prod [DecidableEq ι] {x : E}
...
lemma fderiv_finset_prod [DecidableEq ι] {x : E} (hg : ∀ i ∈ u, DifferentiableAt 𝕜 (g i) x) :
...
lemma fderivWithin_finset_prod [DecidableEq ι] {x : E} (hxs : UniqueDiffWithinAt 𝕜 s x)
...
lemma fderiv_inverse (x : Rˣ) : fderiv 𝕜 (@Ring.inverse R _) x = -mulLeftRight 𝕜 R ↑x⁻¹ ↑x⁻¹ :=
...
@[fun_prop]
lemma DifferentiableWithinAt.inverse (hf : DifferentiableWithinAt 𝕜 h S z) (hz : IsUnit (h z)) :
...
@[simp, fun_prop]
lemma DifferentiableAt.inverse (hf : DifferentiableAt 𝕜 h z) (hz : IsUnit (h z)) :
...
@[fun_prop]
lemma DifferentiableOn.inverse (hf : DifferentiableOn 𝕜 h S) (hz : ∀ x ∈ S, IsUnit (h x)) :
...
@[simp, fun_prop]
lemma Differentiable.inverse (hf : Differentiable 𝕜 h) (hz : ∀ x, IsUnit (h x)) :
...
@[fun_prop]
lemma DifferentiableWithinAt.inv' (hf : DifferentiableWithinAt 𝕜 h S z) (hz : h z ≠ 0) :
