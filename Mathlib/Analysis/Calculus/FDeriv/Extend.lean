...
with derivative `f'`. -/
lemma has_fderiv_at_boundary_of_tendsto_fderiv {f : E → F} {s : Set E} {x : E} {f' : E →L[ℝ] F}
...
lemma has_deriv_at_interval_right_endpoint_of_tendsto_deriv {s : Set ℝ} {e : E} {a : ℝ}
...
lemma hasDerivAt_of_hasDerivAt_of_ne {f g : ℝ → E} {x : ℝ}
