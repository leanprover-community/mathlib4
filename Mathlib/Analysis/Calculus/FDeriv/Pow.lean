...
section NormedRing
variable [NontriviallyNormedField 𝕜] [NormedRing 𝔸] [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
...
variable [NontriviallyNormedField 𝕜] [NormedCommRing 𝔸] [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
variable [NormedAlgebra 𝕜 𝔸] [NormedSpace 𝕜 E] {f : E → 𝔸} {f' : E →L[𝕜] 𝔸} {x : E} {s : Set E}
