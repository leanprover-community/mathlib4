...
theorem mem_adjoint_iff (g : Submodule 𝕜 (E × F)) (x : F × E) :
  ...
  simp only [Submodule.adjoint, mem_map, mem_orthogonal, LinearEquiv.trans_apply,
    LinearEquiv.skewSwap_symm_apply, linearEquiv_symm_apply, AddEquiv.toEquiv_eq_coe,
    Equiv.invFun_as_coe, AddEquiv.coe_toEquiv_symm, addEquiv_symm_apply, Prod.exists,
    prod_inner_apply, ofLp_fst, ofLp_snd, forall_exists_index, and_imp, linearEquiv_apply,
