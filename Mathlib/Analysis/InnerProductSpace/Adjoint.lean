...
lemma _root_.InnerProductSpace.rankOne_comp {E G : Type*} [AddCommGroup E]
    [SeminormedAddCommGroup E] [NormedSpace 𝕜 E] [AddCommGroup G] [NormedAddCommGroup G]
    [InnerProductSpace 𝕜 G] [CompleteSpace G] (x : E) (y : F) (f : G →L[𝕜] F) :
...
theorem conjStarAlgEquiv_trans {G : Type*} [AddCommGroup G] [NormedAddCommGroup G]
    [InnerProductSpace 𝕜 G] [CompleteSpace G] (e : H ≃ₗᵢ[𝕜] K) (f : K ≃ₗᵢ[𝕜] G) :
...
@[simp]
theorem LinearIsometry.adjoint_comp_self {E E' : Type*} [AddCommGroup E]
    [NormedAddCommGroup E] [InnerProductSpace 𝕜 E] [CompleteSpace E] [AddCommGroup E']
...
@[simp]
theorem LinearIsometry.adjoint_comp_self' {E E' : Type*} [AddCommGroup E]
    [NormedAddCommGroup E] [InnerProductSpace 𝕜 E] [FiniteDimensional 𝕜 E] [AddCommGroup E']
...
theorem LinearIsometryEquiv.toMatrix_mem_unitaryGroup {ι E E' : Type*} [Fintype ι] [DecidableEq ι]
    [AddCommGroup E] [NormedAddCommGroup E] [InnerProductSpace 𝕜 E] [AddCommGroup E']
