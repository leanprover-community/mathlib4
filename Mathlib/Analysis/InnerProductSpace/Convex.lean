...
variable {𝕜 E F : Type*} [RCLike 𝕜] [AddCommGroup E] [SeminormedAddCommGroup E]
  [InnerProductSpace 𝕜 E] [AddCommGroup F] [SeminormedAddCommGroup F] [InnerProductSpace ℝ F]
