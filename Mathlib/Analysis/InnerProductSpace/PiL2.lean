...
open Module Set Filter RCLike Submodule Function Uniformity Topology NNReal ENNReal
...
theorem EuclideanSpace.ball_zero_eq {n : Type*} [Fintype n] (r : ℝ) (hr : 0 ≤ r) :
  ...
  simp_rw [mem_setOf, mem_ball_zero_iff, norm_eq, Real.norm_eq_abs, sq_abs, Real.sqrt_lt this hr]
...
theorem EuclideanSpace.closedBall_zero_eq {n : Type*} [Fintype n] (r : ℝ) (hr : 0 ≤ r) :
  ...
  ext
  simp_rw [mem_setOf, mem_closedBall_zero_iff, norm_eq, Real.norm_eq_abs, sq_abs,
    Real.sqrt_le_left hr]

theorem EuclideanSpace.sphere_zero_eq {n : Type*} [Fintype n] (r : ℝ) (hr : 0 ≤ r) :
    Metric.sphere (0 : EuclideanSpace ℝ n) r = {x | ∑ i, x i ^ 2 = r ^ 2} := by
  ext x
  have : (0 : ℝ) ≤ ∑ i, x i ^ 2 := Finset.sum_nonneg fun _ _ => sq_nonneg _
  simp_rw [mem_setOf, mem_sphere_zero_iff_norm, norm_eq, Real.norm_eq_abs, sq_abs,
