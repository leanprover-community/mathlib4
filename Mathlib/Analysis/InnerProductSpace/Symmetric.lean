...
theorem IsSymmetric.restrictScalars [InnerProductSpace ℝ E] [IsScalarTower ℝ 𝕜 E]
    {T : E →ₗ[𝕜] E} (hT : T.IsSymmetric) :
    @LinearMap.IsSymmetric _ _ _ _ (InnerProductSpace.rclikeToReal 𝕜 E) (T.restrictScalars ℝ) :=
