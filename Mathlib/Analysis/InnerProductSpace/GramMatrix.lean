...
theorem posSemidef_opNorm_smul_gram_sub_gram {F} [AddCommGroup F] [NormedAddCommGroup F]
    [InnerProductSpace 𝕜 F] (v : n → E) (f : E →L[𝕜] F) :
    (‖f‖ ^ 2 • gram 𝕜 v - gram 𝕜 (f ∘ v)).PosSemidef := by
