...
theorem reflection_map_apply {E E' : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormMetric E'] [AddCommGroup E'] [IsNormedAddGroup E']
...
/-- Reflection in the `Submodule.map` of a subspace. -/
theorem reflection_map {E E' : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormMetric E'] [AddCommGroup E'] [IsNormedAddGroup E']
    [InnerProductSpace 𝕜 E] [InnerProductSpace 𝕜 E'] (f : E ≃ₗᵢ[𝕜] E') (K : Submodule 𝕜 E)
