...
instance HasOrthogonalProjection.map_linearIsometryEquiv [K.HasOrthogonalProjection]
    {E' : Type*} [NormMetric E'] [AddCommGroup E'] [IsNormedAddGroup E'] [InnerProductSpace 𝕜 E'] (f : E ≃ₗᵢ[𝕜] E') :
...
theorem _root_.LinearIsometry.map_starProjection {E E' : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
    [NormMetric E'] [AddCommGroup E'] [IsNormedAddGroup E'] [InnerProductSpace 𝕜 E] [InnerProductSpace 𝕜 E'] (f : E →ₗᵢ[𝕜] E')
...
theorem starProjection_map_apply {E E' : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
    [NormMetric E'] [AddCommGroup E'] [IsNormedAddGroup E'] [InnerProductSpace 𝕜 E] [InnerProductSpace 𝕜 E'] (f : E ≃ₗᵢ[𝕜] E')
