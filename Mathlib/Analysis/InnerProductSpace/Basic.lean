...
theorem inner_smul_add_smul_left_eq_smul
    (x y z : E) (r s : 𝕜) : ⟪r • x + s • y, z⟫ = r† * ⟪x, z⟫ + s† * ⟪y, z⟫ :=
  inner_smul_add_smul_left_eq_star_smul ..
...
theorem inner_smul_add_smul_right
    (x y z : E) (r s : 𝕜) : ⟪x, r • y + s • z⟫ = r * ⟪x, y⟫ + s * ⟪x, z⟫ :=
  inner_smul_add_smul_right_eq_smul ..
...
/-- Nonnegativity of `r * ‖a‖` when `r > 0`. -/
lemma zero_leq_pos_mul_norm (r : ℝ) (hr : 0 < r) (a : E) : 0 ≤ r * ‖a‖ := by
