...
variable {E' : Type*} [NormMetric E'] [AddCommGroup E'] [IsNormedAddGroup E'] [InnerProductSpace ℂ E']
...
lemma antilipschitz_of_forall_le_inner_map {H : Type*} [NormMetric H] [AddCommGroup H] [IsNormedAddGroup H]
