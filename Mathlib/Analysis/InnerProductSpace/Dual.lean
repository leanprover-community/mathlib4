...
variable {𝕜} in
@[simp]
theorem _root_.innerSL_inj {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [InnerProductSpace 𝕜 E] {x y : E} :
...
instance [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [CompleteSpace E] [InnerProductSpace ℝ E] :
...
lemma rank_rankOne {𝕜 E F : Type*} [RCLike 𝕜] [NormPseudoMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace 𝕜 E]
    [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] [InnerProductSpace 𝕜 F] {x : E} {y : F} (hx : x ≠ 0) (hy : y ≠ 0) :
...
lemma OrthonormalBasis.norm_dual {ι E : Type*} [Fintype ι] [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
