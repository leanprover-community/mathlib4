...
variable (𝕜)
variable {G : Type*} [AddCommGroup G] [NormedAddCommGroup G] [NormedSpace ℝ G] {f g : G → E}
  {f' g' : G →L[ℝ] E} {s : Set G} {x : G} {n : WithTop ℕ∞}
...
variable {𝕜 ι H : Type*} [RCLike 𝕜] [AddCommGroup H] [NormedAddCommGroup H] [NormedSpace 𝕜 H]
...
variable {n : ℕ∞} {E : Type*} [AddCommGroup E] [NormedAddCommGroup E] [InnerProductSpace ℝ E]
