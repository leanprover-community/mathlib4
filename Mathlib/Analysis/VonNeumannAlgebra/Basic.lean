...
-/
structure VonNeumannAlgebra (H : Type u) [NormMetric H] [AddCommGroup H] [IsNormedAddGroup H] [InnerProductSpace ℂ H]
...
variable {H : Type u} [NormMetric H] [AddCommGroup H] [IsNormedAddGroup H] [InnerProductSpace ℂ H] [CompleteSpace H]
