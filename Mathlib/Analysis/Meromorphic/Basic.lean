...
variable {𝕜 𝕜' : Type*} [NontriviallyNormedField 𝕜] [NontriviallyNormedField 𝕜']
  [NormedAlgebra 𝕜 𝕜'] {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace 𝕜 E]
...
theorem eventually_analyticAt [CompleteSpace E] {f : 𝕜 → E}
  ...
  · rw [eventually_nhdsWithin_iff]
    ...
    have := ((analyticAt_id (𝕜 := 𝕜).sub analyticAt_const).pow n).inv (E := 𝕜)
...
variable
  {F : Type*} [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] [NormedSpace 𝕜 F] [NormedSpace 𝕜' F] [IsScalarTower 𝕜 𝕜' F]
  {x : 𝕜}
