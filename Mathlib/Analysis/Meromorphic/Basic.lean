...
-/
theorem meromorphic_measurable [MeasurableSpace 𝕜] [SecondCountableTopology 𝕜] [BorelSpace 𝕜]
  ...
  intro x a
  simp_all only [mem_setOf_eq, mem_inter_iff, mem_preimage, inter_mem_iff, and_true, s]
