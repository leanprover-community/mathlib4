...
structure ProperCone (𝕜 : Type*) (E : Type*) [Semiring 𝕜] [OrderedSemiring 𝕜] [AddCommMonoid E]
...
variable (𝕜 E)
variable [Semiring 𝕜] [OrderedSemiring 𝕜] [AddCommGroup E] [OrderedAddCommGroup E]
  [Module 𝕜 E] [OrderedSMul 𝕜 E] [TopologicalSpace E] [OrderClosedTopology E]
...
theorem hyperplane_separation (K : ProperCone ℝ E) {f : E →L[ℝ] F} {b : F} :
  ...
  Iff.intro
    ...
    (by
      ...
      let C := @PointedCone.toConvexCone ℝ F _ _ _ _ (K.map f)
      obtain ⟨y, hxy, hyb⟩ :=
