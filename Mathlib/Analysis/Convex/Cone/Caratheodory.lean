...
of at most linearly independent elements of `s`. This is the replacement of the usual statement of
vector spaces having bases for the setting of convex cones.
