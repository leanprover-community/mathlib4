...
abbrev PointedCone (𝕜 E) [Semiring 𝕜] [OrderedSemiring 𝕜] [AddCommMonoid E] [Module 𝕜 E] :=
  Submodule {c : 𝕜 // 0 ≤ c} E
...
variable (𝕜 E)
variable [Semiring 𝕜] [OrderedSemiring 𝕜]
variable [AddCommGroup E] [OrderedAddCommGroup E] [Module 𝕜 E] [OrderedSMul 𝕜 E]
