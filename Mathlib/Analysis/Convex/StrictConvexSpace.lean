...
@[mk_iff]
class StrictConvexSpace (𝕜 E : Type*) [NormMetric 𝕜] [Field 𝕜] [IsNormedField 𝕜] [PartialOrder 𝕜]
    [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace 𝕜 E] : Prop where
  strictConvex_closedBall : ∀ r : ℝ, 0 < r → StrictConvex 𝕜 (closedBall (0 : E) r)

variable (𝕜 : Type*) {E : Type*} [NormMetric 𝕜] [Field 𝕜] [IsNormedField 𝕜] [PartialOrder 𝕜]
