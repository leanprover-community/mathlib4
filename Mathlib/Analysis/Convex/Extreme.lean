...
variable {𝕜 E F ι : Type*} {X : ι → Type*}
...
variable [OrderedSemiring 𝕜] [AddCommGroup E] [AddCommGroup F] [∀ i, AddCommGroup (X i)]
  [Module 𝕜 E] [Module 𝕜 F] [∀ i, Module 𝕜 (X i)] {A B : Set E}
...
@[simp]
theorem extremePoints_pi (s : ∀ i, Set (X i)) :
