...
@[deprecated StdSimplex (since := "2026-07-29")]
def stdSimplex : Set (ι → 𝕜) :=
  { f | (∀ x, 0 ≤ f x) ∧ ∑ x, f x = 1 }

@[deprecated StdSimplex.range_toFun_comp_weights (since := "2026-07-29")]
...
@[deprecated StdSimplex.instConvexSpace (since := "2026-07-29")]
...
@[nontriviality, deprecated "no replacement" (since := "2026-07-29")]
...
@[deprecated StdSimplex.single (since := "2026-07-29")]
...
@[simps -fullyApplied, deprecated StdSimplex.equivIcc (since := "2026-07-29")]
...
@[simp, deprecated StdSimplex.equivIcc_single_zero (since := "2026-07-29")]
lemma stdSimplexEquivIcc_zero :
    stdSimplexEquivIcc 𝕜 ⟨_, single_mem_stdSimplex 𝕜 0⟩ = 0 := rfl

@[simp, deprecated StdSimplex.equivIcc_single_one (since := "2026-07-29")]
...
@[deprecated StdSimplex.isClosedEmbedding_toFun_comp_weights (since := "2026-07-29")]
...
@[deprecated StdSimplex.compactSpace (since := "2026-07-29")]
...
@[deprecated StdSimplex.range_toFun_comp_weights_subset_closedBall (since := "2026-07-29")]
...
@[deprecated StdSimplex.isBounded_range_toFun_comp_weights (since := "2026-07-29")]
...
@[deprecated StdSimplex.pathConnectedSpace (since := "2026-07-29")]
...
@[simps! -fullyApplied, deprecated StdSimplex.homeomorphI (since := "2026-07-29")]
...
@[simp, deprecated StdSimplex.homeomorphI_single_zero (since := "2026-07-29")]
lemma stdSimplexHomeomorphUnitInterval_zero :
    stdSimplexHomeomorphUnitInterval ⟨_, single_mem_stdSimplex _ 0⟩ = 0 := rfl

@[simp, deprecated StdSimplex.homeomorphI_single_one (since := "2026-07-29")]
...
@[deprecated StdSimplex.diam_range_toFun_comp_weights_subset_closedBall (since := "2026-07-29")]
...
@[ext high, deprecated StdSimplex.ext (since := "2026-07-29")]
lemma ext {s t : stdSimplex S X} (h : (s : X → S) = t) : s = t := by
  ext : 1
  assumption

@[simp, deprecated StdSimplex.weights_nonneg (since := "2026-07-29")]
lemma zero_le (s : stdSimplex S X) (x : X) : 0 ≤ s x := s.2.1 x

@[simp, deprecated StdSimplex.total (since := "2026-07-29")]
lemma sum_eq_one (s : stdSimplex S X) : ∑ x, s x = 1 := s.2.2

@[simp, deprecated StdSimplex.total_fin_two (since := "2026-07-29")]
...
@[simp, deprecated StdSimplex.weights_apply_le_one (since := "2026-07-29")]
lemma le_one (s : stdSimplex S X) (x : X) : s x ≤ 1 := by
  rw [← sum_eq_one s]
  exact Finset.single_le_sum (by simp) (by simp)

@[deprecated StdSimplex.map (since := "2026-07-29")]
...
@[simp, deprecated "no replacement" (since := "2026-07-29")]
lemma map_coe (f : X → Y) (s : stdSimplex S X) :
    ⇑(map f s) = FunOnFinite.linearMap S S f s := rfl

@[simp, deprecated StdSimplex.map_id (since := "2026-07-29")]
...
@[simp, deprecated StdSimplex.map_single (since := "2026-07-29")]
lemma map_vertex [DecidableEq X] [DecidableEq Y] (f : X → Y) (x : X) :
    map (S := S) f (vertex x) = vertex (f x) := by
  aesop

@[deprecated StdSimplex.continuous_map (since := "2026-07-29")]
...
@[deprecated StdSimplex.single_injective (since := "2026-07-29")]
