...
variable {𝕜 : Type*} [DivisionRing 𝕜] [StrictNormedRing 𝕜] {E : Type*} [AddCommGroup E] [Module 𝕜 E]
    {c : 𝕜} {s : Set E} {x : E}
...
variable [DivisionRing 𝕜] [StrictNormedRing 𝕜] [∀ i, AddCommGroup (E i)] [∀ i, Module 𝕜 (E i)]
