...
variable {V P : Type*} [NormMetric V] [AddCommGroup V] [IsNormedAddGroup V] [NormedSpace ℝ V]
...
variable {E F PE PF : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] [NormedSpace ℝ E]
