...
omit [OrderedAddCommGroup β] in
private lemma piecewise_Ici_eq_piecewise_Iic_of_eq (h_eq : f e = g e) :
    (Set.Ici e).piecewise f g = (Set.Iic e).piecewise g f := by
  ext x; by_cases hx : x = e
  all_goals simp [Set.piecewise, @le_iff_lt_or_eq _ _ _ e, ← @ite_not _ (e ≤ _), hx, h_eq]
...
theorem convexOn_univ_piecewise_Ici_of_monotoneOn_Ici_antitoneOn_Iic
  ...
  rw [piecewise_Ici_eq_piecewise_Iic_of_eq h_eq]
