...
variable {𝕜 : Type*} {E : Type*} [TopologicalSpace 𝕜] [Ring 𝕜] [OrderedRing 𝕜] [AddCommMonoid E]
...
variable {𝕜 : Type*} {E : Type*} [TopologicalSpace 𝕜] [Ring 𝕜] [LinearOrderedRing 𝕜] [AddCommMonoid E]
