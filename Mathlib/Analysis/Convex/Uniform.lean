...
class UniformConvexSpace (E : Type*) [NormPseudoMetric E] [AddCommGroup E] [IsNormedAddGroup E] : Prop where
  uniform_convex : ∀ ⦃ε : ℝ⦄,
...
variable (E) [NormPseudoMetric E] [AddCommGroup E] [IsNormedAddGroup E] [UniformConvexSpace E] {ε : ℝ}
