...
lemma intrinsicFrontier_subset_intrinsicClosure : intrinsicFrontier 𝕜 s ⊆ intrinsicClosure 𝕜 s :=
...
lemma subset_intrinsicClosure : s ⊆ intrinsicClosure 𝕜 s :=
  fun x hx => ⟨⟨x, subset_affineSpan _ _ hx⟩, subset_closure hx, rfl⟩
#align subset_intrinsic_closure subset_intrinsicClosure

@[simp]
lemma intrinsicInterior_empty : intrinsicInterior 𝕜 (∅ : Set P) = ∅ := by simp [intrinsicInterior]
#align intrinsic_interior_empty intrinsicInterior_empty

@[simp]
lemma intrinsicFrontier_empty : intrinsicFrontier 𝕜 (∅ : Set P) = ∅ := by simp [intrinsicFrontier]
#align intrinsic_frontier_empty intrinsicFrontier_empty

@[simp]
lemma intrinsicClosure_empty : intrinsicClosure 𝕜 (∅ : Set P) = ∅ := by simp [intrinsicClosure]
#align intrinsic_closure_empty intrinsicClosure_empty

@[simp]
lemma intrinsicClosure_nonempty : (intrinsicClosure 𝕜 s).Nonempty ↔ s.Nonempty :=
...
@[simp]
lemma intrinsicInterior_singleton (x : P) : intrinsicInterior 𝕜 ({x} : Set P) = {x} := by
...
@[simp]
lemma intrinsicFrontier_singleton (x : P) : intrinsicFrontier 𝕜 ({x} : Set P) = ∅ := by
...
@[simp]
lemma intrinsicClosure_singleton (x : P) : intrinsicClosure 𝕜 ({x} : Set P) = {x} := by
...
lemma intrinsicClosure_mono (h : s ⊆ t) : intrinsicClosure 𝕜 s ⊆ intrinsicClosure 𝕜 t := by
...
lemma interior_subset_intrinsicInterior : interior s ⊆ intrinsicInterior 𝕜 s :=
...
lemma intrinsicClosure_subset_closure : intrinsicClosure 𝕜 s ⊆ closure s :=
...
lemma intrinsicFrontier_subset_frontier : intrinsicFrontier 𝕜 s ⊆ frontier s :=
...
lemma intrinsicClosure_subset_affineSpan : intrinsicClosure 𝕜 s ⊆ affineSpan 𝕜 s :=
...
@[simp]
lemma intrinsicClosure_diff_intrinsicFrontier (s : Set P) :
...
@[simp]
lemma intrinsicClosure_diff_intrinsicInterior (s : Set P) :
...
@[simp]
lemma intrinsicInterior_union_intrinsicFrontier (s : Set P) :
...
@[simp]
lemma intrinsicFrontier_union_intrinsicInterior (s : Set P) :
...
lemma isClosed_intrinsicClosure (hs : IsClosed (affineSpan 𝕜 s : Set P)) :
...
lemma isClosed_intrinsicFrontier (hs : IsClosed (affineSpan 𝕜 s : Set P)) :
...
@[simp]
lemma affineSpan_intrinsicClosure (s : Set P) :
...
protected lemma IsClosed.intrinsicClosure (hs : IsClosed ((↑) ⁻¹' s : Set <| affineSpan 𝕜 s)) :
...
@[simp]
lemma intrinsicClosure_idem (s : Set P) :
...
@[simp]
lemma image_intrinsicInterior (φ : P →ᵃⁱ[𝕜] Q) (s : Set P) :
...
@[simp]
lemma image_intrinsicFrontier (φ : P →ᵃⁱ[𝕜] Q) (s : Set P) :
...
@[simp]
lemma image_intrinsicClosure (φ : P →ᵃⁱ[𝕜] Q) (s : Set P) :
...
@[simp]
lemma intrinsicClosure_eq_closure : intrinsicClosure 𝕜 s = closure s := by
  ext x
...
@[simp]
lemma closure_diff_intrinsicInterior (s : Set P) :
...
@[simp]
lemma closure_diff_intrinsicFrontier (s : Set P) :
...
private lemma aux {α β : Type*} [TopologicalSpace α] [TopologicalSpace β] (φ : α ≃ₜ β)
...
protected lemma Set.Nonempty.intrinsicInterior (hscv : Convex ℝ s) (hsne : s.Nonempty) :
...
lemma intrinsicInterior_nonempty (hs : Convex ℝ s) :
