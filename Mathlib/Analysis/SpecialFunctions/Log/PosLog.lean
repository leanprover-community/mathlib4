...
-/
lemma posLog_norm_sum_le {E : Type*} [AddCommGroup E] [SeminormedAddCommGroup E] {α : Type*}
    (s : Finset α) (f : α → E) :
    log⁺ ‖∑ t ∈ s, f t‖ ≤ log s.card + ∑ t ∈ s, log⁺ ‖f t‖ := by
...
-/
lemma posLog_norm_add_le {E : Type*} [AddCommGroup E] [SeminormedAddCommGroup E] (a b : E) :
