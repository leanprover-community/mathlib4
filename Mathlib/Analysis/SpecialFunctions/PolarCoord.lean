...
theorem integral_comp_polarCoord_symm {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E]
    (f : ℝ × ℝ → E) :
...
protected theorem integral_comp_polarCoord_symm {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
...
theorem integral_comp_pi_polarCoord_symm {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E]
    (f : (ι → ℝ × ℝ) → E) :
...
protected theorem Complex.integral_comp_pi_polarCoord_symm {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
