...
theorem integral_comp_polarCoord_symm {E : Type*} [AddCommGroup E] [NormedAddCommGroup E] [NormedSpace ℝ E]
    (f : ℝ × ℝ → E) :
...
theorem integral_comp_pi_polarCoord_symm {E : Type*} [AddCommGroup E] [NormedAddCommGroup E] [NormedSpace ℝ E]
    (f : (ι → ℝ × ℝ) → E) :
...
set_option backward.isDefEq.respectTransparency false in
protected theorem Complex.integral_comp_pi_polarCoord_symm {E : Type*} [AddCommGroup E] [NormedAddCommGroup E]
