...
theorem sin_add_int_mul_pi (x : ℝ) (n : ℤ) : sin (x + n * π) = (-1) ^ n * sin x :=
  @Int.coe_negOnePow ℝ _ n ▸ sin_antiperiodic.add_int_mul_eq n
...
theorem sin_sub_int_mul_pi (x : ℝ) (n : ℤ) : sin (x - n * π) = (-1) ^ n * sin x :=
  @Int.coe_negOnePow ℝ _ n ▸ sin_antiperiodic.sub_int_mul_eq n
...
theorem cos_add_int_mul_pi (x : ℝ) (n : ℤ) : cos (x + n * π) = (-1) ^ n * cos x :=
  @Int.coe_negOnePow ℝ _ n ▸ cos_antiperiodic.add_int_mul_eq n
...
theorem cos_sub_int_mul_pi (x : ℝ) (n : ℤ) : cos (x - n * π) = (-1) ^ n * cos x :=
  @Int.coe_negOnePow ℝ _ n ▸ cos_antiperiodic.sub_int_mul_eq n
...
theorem cos_int_mul_pi_sub (x : ℝ) (n : ℤ) : cos (n * π - x) = (-1) ^ n * cos x :=
  @Int.coe_negOnePow ℝ _ n ▸ cos_neg x ▸ cos_antiperiodic.int_mul_sub_eq n
