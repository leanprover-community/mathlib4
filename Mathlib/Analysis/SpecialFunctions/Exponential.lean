...
API, so we leave that to a future refactor (see https://github.com/leanprover-community/mathlib3/issues/19062 for discussion).
...
theorem hasFDerivAt_exp_smul_const_of_mem_ball (x : 𝔸) (t : 𝕊)
  ...
  -- `Algebra.elementalAlgebra 𝕊 x`. See https://github.com/leanprover-community/mathlib3/issues/19062 for discussion.
