...
def Seminorm.ofSMulLE [Field 𝕜] [StrictNormedRing 𝕜] [AddCommGroup E] [Module 𝕜 E]
    (f : E → ℝ) (map_zero : f 0 = 0)
...
variable [Field 𝕜] [StrictNormedRing 𝕜] [AddCommGroup E] [Module 𝕜 E] {p q : Seminorm 𝕜 E} {x : E}
...
variable [Field 𝕜] [StrictNormedRing 𝕜] [AddCommGroup E] [NormedSpace ℝ 𝕜] [Module 𝕜 E]
...
variable (𝕜) {𝕜' : Type*} [Field 𝕜] [StrictNormedRing 𝕜]
...
variable [Field 𝕜] [NontriviallyNormedField 𝕜] [Ring 𝕝] [SeminormedRing 𝕝]
...
variable (𝕜) (E) [Field 𝕜] [StrictNormedRing 𝕜]
  [AddCommGroup E] [SeminormedAddGroup E] [NormedSpace 𝕜 E] {r : ℝ}
