...
structure IsPicardLindelof {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
...
structure FunSpace {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
