...
theorem contraction_of_isPowMul {α β : Type*}
    [Ring α] [SeminormedRing α] [Ring β] [SeminormedRing β]
...
variable {R S : Type*} [CommRing R] [NormedRing R] [CommRing S] [Algebra R S]
