...
variable {𝕜 : Type*} {V₁ V₂ : Type*} {P₁ P₂ : Type*} [NormedField 𝕜] [AddCommGroup V₁]
  ...
  [AddCommGroup V₂] [SeminormedAddCommGroup V₂] [NormedSpace 𝕜 V₁] [NormedSpace 𝕜 V₂]
    [MetricSpace P₁]
...
variable {𝕜 : Type u} [NontriviallyNormedField 𝕜] {E : Type v} [AddCommGroup E]
    [NormedAddCommGroup E]
  [NormedSpace 𝕜 E] {F : Type w} [AddCommGroup F] [NormedAddCommGroup F] [NormedSpace 𝕜 F]
    [CompleteSpace 𝕜]
...
lemma ProperSpace.of_locallyCompactSpace (𝕜 : Type*) [NontriviallyNormedField 𝕜]
    {E : Type*} [AddCommGroup E] [SeminormedAddCommGroup E] [NormedSpace 𝕜 E]
...
instance {𝕜 E : Type*} [NontriviallyNormedField 𝕜] [CompleteSpace 𝕜]
    [AddCommGroup E] [NormedAddCommGroup E] [NormedSpace 𝕜 E] [LocallyCompactSpace E]
      (S : Submodule 𝕜 E) :
    ProperSpace S := by
  nontriviality E
...
nonrec theorem IsCompact.exists_mem_frontier_infDist_compl_eq_dist {E : Type*}
    [AddCommGroup E] [NormedAddCommGroup E] [NormedSpace ℝ E] [Nontrivial E]
      {x : E} {K : Set E} (hK : IsCompact K)
    (hx : x ∈ K) :
...
theorem summable_of_isBigO' {ι E F : Type*} [AddCommGroup E] [NormedAddCommGroup E]
    [CompleteSpace E]
    [AddCommGroup F] [NormedAddCommGroup F] [NormedSpace ℝ F] [FiniteDimensional ℝ F]
      {f : ι → E} {g : ι → F}
...
theorem IsEquivalent.summable_iff {ι E : Type*} [AddCommGroup E] [NormedAddCommGroup E]
    [NormedSpace ℝ E]
...
theorem IsEquivalent.summable_iff_nat {E : Type*} [AddCommGroup E] [NormedAddCommGroup E]
    [NormedSpace ℝ E]
