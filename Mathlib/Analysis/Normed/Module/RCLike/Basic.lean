...
variable {𝕜 : Type*} [RCLike 𝕜] {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
...
lemma antilipschitz_of_bound_of_norm_one {𝓕 E F : Type*}
    [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] [NormedSpace 𝕜 E] [NormedSpace 𝕜 F]
