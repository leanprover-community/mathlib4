...
def Module.RestrictScalars.normedSpaceOrig {𝕜 𝕜' E : Type*} [NormedField 𝕜']
    [SeminormedAddCommGroup E] [NormedSpace 𝕜' E] : NormedSpace 𝕜' (RestrictScalars 𝕜 𝕜' E) :=
  ‹_›
