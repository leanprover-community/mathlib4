...
@[simps]
noncomputable def liftNormedAddGroupHomEquiv {N : Type*} [NormPseudoMetric N] [AddCommGroup N] [IsNormedAddGroup N] :
...
theorem norm_liftNormedAddGroupHom_le {N : Type*} [NormPseudoMetric N] [AddCommGroup N] [IsNormedAddGroup N]
...
theorem liftNormedAddGroupHom_norm_le {N : Type*} [NormPseudoMetric N] [AddCommGroup N] [IsNormedAddGroup N]
...
theorem liftNormedAddGroupHom_normNoninc {N : Type*} [NormPseudoMetric N] [AddCommGroup N] [IsNormedAddGroup N]
