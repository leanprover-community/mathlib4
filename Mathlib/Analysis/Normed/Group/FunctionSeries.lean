...
variable {α β F : Type*} [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] [CompleteSpace F] {u : α → ℝ}
...
theorem tendstoUniformlyOn_tsum_nat_eventually {α F : Type*} [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F]
