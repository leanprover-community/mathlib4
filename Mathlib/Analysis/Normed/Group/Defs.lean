...
attribute [instance 100] ESeminormedAddMonoid.toAddMonoid
...
-- see Note [lower instance priority]
attribute [instance 100] ESeminormedMonoid.toMonoid
...
-- see Note [lower instance priority]
attribute [instance 100] ESeminormedAddCommMonoid.toAddCommMonoid
...
-- see Note [lower instance priority]
attribute [instance 100] ESeminormedCommMonoid.toCommMonoid
...
-- see Note [lower instance priority]
attribute [instance 100] SeminormedAddGroup.toAddGroup
...
-- see Note [lower instance priority]
attribute [instance 100] SeminormedGroup.toGroup
...
-- see Note [lower instance priority]
attribute [instance 100] NormedAddGroup.toAddGroup
...
-- see Note [lower instance priority]
attribute [instance 100] NormedGroup.toGroup
...
-- see Note [lower instance priority]
attribute [instance 100] SeminormedAddCommGroup.toAddCommGroup
...
-- see Note [lower instance priority]
attribute [instance 100] SeminormedCommGroup.toCommGroup
...
-- see Note [lower instance priority]
attribute [instance 100] NormedAddCommGroup.toAddCommGroup
...
-- see Note [lower instance priority]
attribute [instance 100] NormedCommGroup.toCommGroup
