...
noncomputable instance instSeminormedCommGroup : WithSeminormedGroup (M ⧸ S) where
...
example [IsClosed (S : Set M)] :
    (instSeminormedCommGroup S) = WithNormedGroup.toWithSeminormedGroup := rfl
...
instance Submodule.Quotient.seminormedAddCommGroup : WithSeminormedAddGroup (M ⧸ S) :=
...
instance Ideal.Quotient.semiNormedCommRing : WithSeminormedRing (R ⧸ I) where
...
instance Ideal.Quotient.normedCommRing [IsClosed (I : Set R)] : WithNormedRing (R ⧸ I) :=
