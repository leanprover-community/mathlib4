...
variable {G : Type*} [AddCommGroup G] [SeminormedAddCommGroup G] {H : Type*} [AddCommGroup H]
  [SeminormedAddCommGroup H] {K : Type*} [AddCommGroup K] [SeminormedAddCommGroup K]
...
variable {G : Type*} [AddCommGroup G] [SeminormedAddCommGroup G]
variable {H : Type*} [AddCommGroup H] [SeminormedAddCommGroup H] [T0Space H] [CompleteSpace H]
