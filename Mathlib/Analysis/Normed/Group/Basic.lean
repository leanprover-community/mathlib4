...
@[deprecated "Use `[AddCommMonoid E] [ESeminormedAddMonoid E]` instead." (since := "2025-08-23")]
...
is not an `EMetricSpace`. This is because `ℝ≥0∞` carries the order topology, which is distinct from
the topology coming from `edist`. -/
@[deprecated "Use `[AddCommMonoid E] [ENormedAddMonoid E]` instead." (since := "2025-08-23")]
...
@[to_additive,
  deprecated "Use `[CommMonoid E] [ESeminormedMonoid E]` instead." (since := "2025-08-23")]
...
instance : ENormedAddMonoid ℝ≥0∞ where
