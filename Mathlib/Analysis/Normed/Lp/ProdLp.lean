...
instance instProdPseudoEMetricSpace [PseudoEMetricSpace α] [PseudoEMetricSpace β] :
  ...
  (prodPseudoEMetricAux p α β).replaceUniformity (private_decl% (prod_uniformity_aux p α β)).symm
...
instance instProdPseudoMetricSpace [PseudoMetricSpace α] [PseudoMetricSpace β] :
  ...
  ((prodPseudoMetricAux p α β).replaceUniformity
    (private_decl% (prod_uniformity_aux p α β)).symm).replaceBornology
    fun s => Filter.ext_iff.1 (private_decl% (prod_cobounded_aux p α β)).symm sᶜ
