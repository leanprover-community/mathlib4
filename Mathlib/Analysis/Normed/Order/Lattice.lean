...
-/
class HasSolidNorm (α : Type*) [NormMetric α] [AddCommGroup α] [IsNormedAddGroup α] [Lattice α] : Prop where
  solid : ∀ ⦃x y : α⦄, |x| ≤ |y| → ‖x‖ ≤ ‖y‖

variable {α : Type*} [NormMetric α] [AddCommGroup α] [IsNormedAddGroup α] [Lattice α] [HasSolidNorm α]
...
variable {α : Type*} [NormMetric α] [AddCommGroup α] [IsNormedAddGroup α] [Lattice α] [HasSolidNorm α] [IsOrderedAddMonoid α]
...
instance (priority := 100) HasSolidNorm.continuousSup {α : Type*}
    [NormMetric α] [AddCommGroup α] [IsNormedAddGroup α] [Lattice α] [HasSolidNorm α] [IsOrderedAddMonoid α] : ContinuousSup α :=
...
instance (priority := 100) HasSolidNorm.orderClosedTopology {E}
    [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [Lattice E] [HasSolidNorm E] [IsOrderedAddMonoid E] :
