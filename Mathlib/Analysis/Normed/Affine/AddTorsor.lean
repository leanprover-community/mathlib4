...
variable {V P W Q : Type*} [AddCommGroup V] [SeminormedAddCommGroup V] [PseudoMetricSpace P] [NormedAddTorsor V P]
...
variable {𝕜 E : Type*} [NormedDivisionRing 𝕜] [AddCommGroup E] [SeminormedAddCommGroup E]
