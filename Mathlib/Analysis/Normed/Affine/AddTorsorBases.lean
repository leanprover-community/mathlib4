...
variable {ι 𝕜 E P : Type*} [NormMetric 𝕜] [Field 𝕜] [IsNontriviallyNormedField 𝕜] [CompleteSpace 𝕜]
...
theorem AffineBasis.interior_convexHull {ι E : Type*} [Finite ι] [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
...
variable {V P : Type*} [NormMetric V] [AddCommGroup V] [IsNormedAddGroup V] [NormedSpace ℝ V] [MetricSpace P]
  [NormedAddTorsor V P]
