...
variable [AddCommGroup E] [SeminormedAddCommGroup E] [AddCommGroup Eₗ] [SeminormedAddCommGroup Eₗ]
  [AddCommGroup F] [SeminormedAddCommGroup F] [AddCommGroup Fₗ] [SeminormedAddCommGroup Fₗ]
   [AddCommGroup G] [SeminormedAddCommGroup G] [AddCommGroup Gₗ] [SeminormedAddCommGroup Gₗ]
...
theorem _root_.Continuous.clm_comp_const {X} [TopologicalSpace X] {g : X → F →SL[σ₂₃] G}
  ...
  (@ContinuousLinearMap.flip _ _ _ _ _ (E →SL[σ₁₃] G) _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _
...
variable {E' F' : Type*} [AddCommGroup E'] [SeminormedAddCommGroup E']
