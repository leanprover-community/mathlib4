...
variable (M₁ M₂ M₃ M₄ : Type*)
  [AddCommGroup M₁] [SeminormedAddCommGroup M₁] [NormedSpace 𝕜 M₁]
  [AddCommGroup M₂] [SeminormedAddCommGroup M₂] [NormedSpace 𝕜 M₂]
  [AddCommGroup M₃] [SeminormedAddCommGroup M₃] [NormedSpace 𝕜 M₃]
  [AddCommGroup M₄] [SeminormedAddCommGroup M₄] [NormedSpace 𝕜 M₄]
...
@[simp] lemma norm_fst [AddCommGroup E] [NormedAddCommGroup E] [NormedSpace 𝕜 E]
    [AddCommGroup F] [SeminormedAddCommGroup F] [NormedSpace 𝕜 F] [Nontrivial E] :
    ‖fst 𝕜 E F‖ = 1 := by
