...
def IsConformalMap {R : Type*} {X Y : Type*} [NormedField R] [AddCommGroup X]
    [SeminormedAddCommGroup X] [AddCommGroup Y]
...
variable {R M N G M' : Type*} [NormedField R] [AddCommGroup M] [SeminormedAddCommGroup M]
  [AddCommGroup N] [SeminormedAddCommGroup N] [AddCommGroup G]
  [SeminormedAddCommGroup G] [NormedSpace R M] [NormedSpace R N] [NormedSpace R G]
  [AddCommGroup M'] [NormedAddCommGroup M'] [NormedSpace R M'] {f : M →L[R] N} {g : N →L[R] G}
  {c : R}
