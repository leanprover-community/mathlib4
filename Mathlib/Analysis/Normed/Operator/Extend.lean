...
variable [DivisionRing 𝕜] [DivisionRing 𝕜₂] {σ₁₂ : 𝕜 →+* 𝕜₂}
  [AddCommGroup E] [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] [NormPseudoMetric Eₗ] [AddCommGroup Eₗ] [IsNormedAddGroup Eₗ]
...
variable [NormMetric 𝕜] [Field 𝕜] [IsNormedField 𝕜] [NormMetric 𝕜₂] [Field 𝕜₂] [IsNormedField 𝕜₂]
  ...
  [NormMetric Fₗ] [AddCommGroup Fₗ] [IsNormedAddGroup Fₗ] [NormedSpace 𝕜₂ Fₗ] [CompleteSpace Fₗ]
