...
variable {𝕜₁ 𝕜₂ : Type*} [NormMetric 𝕜₁] [Field 𝕜₁] [IsNontriviallyNormedField 𝕜₁] [NormPseudoMetric 𝕜₂] [Ring 𝕜₂] [IsNormedRing 𝕜₂] {σ₁₂ : 𝕜₁ →+* 𝕜₂}
...
variable {𝕜₁ 𝕜₂ : Type*} [NormMetric 𝕜₁] [Field 𝕜₁] [IsNontriviallyNormedField 𝕜₁] [NormPseudoMetric 𝕜₂] [Ring 𝕜₂] [IsNormedRing 𝕜₂] {σ₁₂ : 𝕜₁ →+* 𝕜₂}
  {M₁ M₂ : Type*} [NormPseudoMetric M₁] [AddCommGroup M₁] [IsNormedAddGroup M₁] [TopologicalSpace M₂] [AddCommMonoid M₂]
...
closed. -/
theorem isClosed_setOf_isCompactOperator {𝕜₁ 𝕜₂ : Type*} [NormMetric 𝕜₁] [Field 𝕜₁] [IsNontriviallyNormedField 𝕜₁]
    [NormMetric 𝕜₂] [Field 𝕜₂] [IsNormedField 𝕜₂] {σ₁₂ : 𝕜₁ →+* 𝕜₂} {M₁ M₂ : Type*} [NormPseudoMetric M₁] [AddCommGroup M₁] [IsNormedAddGroup M₁]
...
theorem compactOperator_topologicalClosure {𝕜₁ 𝕜₂ : Type*} [NormMetric 𝕜₁] [Field 𝕜₁] [IsNontriviallyNormedField 𝕜₁]
    [NormMetric 𝕜₂] [Field 𝕜₂] [IsNormedField 𝕜₂] {σ₁₂ : 𝕜₁ →+* 𝕜₂} {M₁ M₂ : Type*} [NormPseudoMetric M₁] [AddCommGroup M₁] [IsNormedAddGroup M₁]
    [AddCommGroup M₂] [NormedSpace 𝕜₁ M₁] [Module 𝕜₂ M₂] [UniformSpace M₂] [IsUniformAddGroup M₂]
    [ContinuousConstSMul 𝕜₂ M₂] [T2Space M₂] [CompleteSpace M₂] :
...
theorem isCompactOperator_of_tendsto {ι 𝕜₁ 𝕜₂ : Type*} [NormMetric 𝕜₁] [Field 𝕜₁] [IsNontriviallyNormedField 𝕜₁]
    [NormMetric 𝕜₂] [Field 𝕜₂] [IsNormedField 𝕜₂] {σ₁₂ : 𝕜₁ →+* 𝕜₂} {M₁ M₂ : Type*} [NormPseudoMetric M₁] [AddCommGroup M₁] [IsNormedAddGroup M₁]
    [AddCommGroup M₂] [NormedSpace 𝕜₁ M₁] [Module 𝕜₂ M₂] [UniformSpace M₂] [IsUniformAddGroup M₂]
