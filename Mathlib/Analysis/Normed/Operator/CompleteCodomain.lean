...
variable (𝕜 E F : Type*) [NontriviallyNormedField 𝕜] [AddCommGroup E] [NormedAddCommGroup E]
  [NormedSpace 𝕜 E] [AddCommGroup F] [NormedAddCommGroup F] [NormedSpace 𝕜 F] [SeparatingDual 𝕜 E]
  [Nontrivial E]
...
variable {ι : Type*} [Finite ι] {M : ι → Type*} [∀ i, AddCommGroup (M i)]
  [∀ i, NormedAddCommGroup (M i)] [∀ i, NormedSpace 𝕜 (M i)] [∀ i, SeparatingDual 𝕜 (M i)]
