...
variable [AddCommGroup E] [NormedAddCommGroup E] [AddCommGroup F] [NormedAddCommGroup F]
  [AddCommGroup G] [NormedAddCommGroup G] [AddCommGroup Fₗ] [NormedAddCommGroup Fₗ]
...
variable {𝕜₂' : Type*} [NontriviallyNormedField 𝕜₂'] {F' : Type*} [AddCommGroup F']
...
-/
def IsCoercive [AddCommGroup E] [SeminormedAddCommGroup E] [NormedSpace ℝ E]
...
variable {ι : Type*} [NontriviallyNormedField 𝕜] [NontriviallyNormedField 𝕜₂] {σ₁₂ : 𝕜 →+* 𝕜₂}
  [RingHomIsometric σ₁₂] [AddCommGroup E] [SeminormedAddCommGroup E] [AddCommGroup F]
  [SeminormedAddCommGroup F] [NormedSpace 𝕜 E] [NormedSpace 𝕜₂ F] (f : ι → E →SL[σ₁₂] F)
...
lemma ContinuousLinearMap.norm_inl [NontrivialTopology E] :
    ‖ContinuousLinearMap.inl 𝕜 E F‖ = 1 :=
  (LinearIsometry.inl 𝕜 E F).norm_toContinuousLinearMap

lemma ContinuousLinearMap.norm_inr [NontrivialTopology E] [NontrivialTopology F] :
    ‖ContinuousLinearMap.inr 𝕜 E F‖ = 1 :=
