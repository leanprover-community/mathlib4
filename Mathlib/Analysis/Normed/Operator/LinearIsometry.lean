...
structure LinearIsometry (σ₁₂ : R →+* R₂) (E E₂ : Type*) [AddCommGroup E] [SeminormedAddCommGroup E]
    [AddCommGroup E₂] [SeminormedAddCommGroup E₂] [Module R E] [Module R₂ E₂]
    extends E →ₛₗ[σ₁₂] E₂ where
...
-/
abbrev LinearIsometryClass (𝓕 : Type*) (R E E₂ : outParam Type*) [Semiring R] [AddCommGroup E]
    [SeminormedAddCommGroup E] [AddCommGroup E₂] [SeminormedAddCommGroup E₂] [Module R E]
    [Module R E₂] [FunLike 𝓕 E E₂] :=
...
def Simps.apply (σ₁₂ : R →+* R₂) (E E₂ : Type*) [AddCommGroup E] [SeminormedAddCommGroup E]
    [AddCommGroup E₂] [SeminormedAddCommGroup E₂] [Module R E] [Module R₂ E₂] (h : E →ₛₗᵢ[σ₁₂] E₂) :
    E → E₂ :=
  h
...
abbrev LinearIsometryEquivClass (𝓕 : Type*) (R E E₂ : outParam Type*) [Semiring R]
    [AddCommGroup E] [SeminormedAddCommGroup E] [AddCommGroup E₂] [SeminormedAddCommGroup E₂]
    [Module R E] [Module R E₂] [EquivLike 𝓕 E E₂] :=
...
def Simps.apply (σ₁₂ : R →+* R₂) {σ₂₁ : R₂ →+* R} [RingHomInvPair σ₁₂ σ₂₁] [RingHomInvPair σ₂₁ σ₁₂]
    (E E₂ : Type*) [AddCommGroup E] [SeminormedAddCommGroup E]
    [AddCommGroup E₂] [SeminormedAddCommGroup E₂] [Module R E]
...
variable {R R₁ R₂ M M₂ : Type*}
variable [Ring R] [Ring R₂] [AddCommGroup M] [SeminormedAddCommGroup M]
variable [AddCommGroup M₂] [SeminormedAddCommGroup M₂]
...
variable {R H : Type*} [Semiring R] [AddCommGroup H] [SeminormedAddCommGroup H] [Module R H]
