...
variable {R R₂ R₃ R₄ E E₂ E₃ E₄ F 𝓕 : Type*} [Semiring R] [Semiring R₂] [Semiring R₃] [Semiring R₄]
  ...
  [RingHomCompTriple σ₄₂ σ₂₁ σ₄₁] [RingHomCompTriple σ₄₃ σ₃₂ σ₄₂] [RingHomCompTriple σ₄₃ σ₃₁ σ₄₁]
  [AddCommGroup E] [SeminormedAddGroup E] [AddCommGroup E₂] [SeminormedAddGroup E₂]
  [AddCommGroup E₃] [SeminormedAddGroup E₃] [AddCommGroup E₄] [SeminormedAddGroup E₄]
  [Module R E] [Module R₂ E₂] [Module R₃ E₃] [Module R₄ E₄]
  [AddCommGroup F] [NormedAddGroup F] [Module R F]

/-- A `σ₁₂`-semilinear isometric embedding of a normed `R`-module into an `R₂`-module,
denoted as `f : E →ₛₗᵢ[σ₁₂] E₂`. -/
structure LinearIsometry (σ₁₂ : R →+* R₂) (E E₂ : Type*) [AddCommGroup E] [SeminormedAddGroup E]
  [AddCommGroup E₂] [SeminormedAddGroup E₂] [Module R E] [Module R₂ E₂] extends E →ₛₗ[σ₁₂] E₂ where
...
class SemilinearIsometryClass (𝓕 : Type*) {R R₂ : outParam Type*} [Semiring R] [Semiring R₂]
    (σ₁₂ : outParam <| R →+* R₂) (E E₂ : outParam Type*) [AddCommGroup E] [SeminormedAddGroup E]
    [AddCommGroup E₂] [SeminormedAddGroup E₂] [Module R E] [Module R₂ E₂] [FunLike 𝓕 E E₂] : Prop
...
def Simps.apply (σ₁₂ : R →+* R₂) (E E₂ : Type*) [AddCommGroup E] [SeminormedAddGroup E]
    [AddCommGroup E₂] [SeminormedAddGroup E₂] [Module R E] [Module R₂ E₂] (h : E →ₛₗᵢ[σ₁₂] E₂) :
    E → E₂ :=
  h
...
structure LinearIsometryEquiv (σ₁₂ : R →+* R₂) {σ₂₁ : R₂ →+* R} [RingHomInvPair σ₁₂ σ₂₁]
  [RingHomInvPair σ₂₁ σ₁₂] (E E₂ : Type*) [AddCommGroup E] [SeminormedAddGroup E]
...
class SemilinearIsometryEquivClass (𝓕 : Type*) {R R₂ : outParam Type*} [Semiring R]
  ...
  [RingHomInvPair σ₂₁ σ₁₂] (E E₂ : outParam Type*) [AddCommGroup E] [SeminormedAddGroup E]
  [AddCommGroup E₂] [SeminormedAddGroup E₂] [Module R E] [Module R₂ E₂] [EquivLike 𝓕 E E₂] : Prop
...
def Simps.apply (σ₁₂ : R →+* R₂) {σ₂₁ : R₂ →+* R} [RingHomInvPair σ₁₂ σ₂₁] [RingHomInvPair σ₂₁ σ₁₂]
    (E E₂ : Type*) [AddCommGroup E] [SeminormedAddGroup E] [AddCommGroup E₂] [SeminormedAddGroup E₂]
