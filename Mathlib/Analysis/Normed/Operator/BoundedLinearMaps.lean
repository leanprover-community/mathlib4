...
theorem isBoundedBilinearMap_smul {E : Type*} [AddCommGroup E] [SeminormedAddCommGroup E]
    [Module 𝕜 E] [Module A E] [IsBoundedSMul A E] [IsScalarTower 𝕜 A E] :
...
variable {𝕜 : Type*} [NontriviallyNormedField 𝕜] {E : Type*} [AddCommGroup E]
  [SeminormedAddCommGroup E] [NormedSpace 𝕜 E] {F : Type*} [AddCommGroup F]
  [SeminormedAddCommGroup F] [NormedSpace 𝕜 F] {G : Type*} [AddCommGroup G]
