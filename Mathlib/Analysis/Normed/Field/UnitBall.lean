...
instance Metric.unitBall.instHasDistribNeg [NonUnitalSeminormedRing 𝕜] :
  ...
  fast_instance% Subtype.coe_injective.hasDistribNeg ((↑) : ball (0 : 𝕜) 1 → 𝕜) (fun _ => rfl)
    fun _ _ => rfl
...
instance Metric.unitClosedBall.instHasDistribNeg [NonUnitalSeminormedRing 𝕜] :
  ...
  fast_instance% Subtype.coe_injective.hasDistribNeg ((↑) : closedBall (0 : 𝕜) 1 → 𝕜) (fun _ => rfl)
    fun _ _ => rfl
...
instance Metric.sphere.instHasDistribNeg [SeminormedRing 𝕜] [NormMulClass 𝕜] [NormOneClass 𝕜] :
  ...
  fast_instance% Subtype.coe_injective.hasDistribNeg ((↑) : sphere (0 : 𝕜) 1 → 𝕜) (fun _ => rfl)
    fun _ _ => rfl
