...
variable {ι : Type*} {Em : ι → Type*} [∀ i, AddCommGroup (Em i)] [∀ i, NormedAddCommGroup (Em i)] [∀ i, NormedSpace 𝕜 (Em i)]
...
variable {ι : Type*} {Em Fm : ι → Type*}
  [∀ i, AddCommGroup (Em i)] [∀ i, NormedAddCommGroup (Em i)] [∀ i, NormedSpace 𝕜 (Em i)]
