...
variable {ι : Type*} {Em : ι → Type*} [∀ i, AddCommGroup (Em i)] [∀ i, NormedAddCommGroup (Em i)]
  [∀ i, NormedSpace 𝕜 (Em i)] [Fintype ι] (f : ContinuousMultilinearMap 𝕜 Em F) {x : Π i, Em i}
  {s : Set (Π i, Em i)}
...
variable {ι : Type*} {Em : ι → Type*} [∀ i, AddCommGroup (Em i)] [∀ i, NormedAddCommGroup (Em i)]
  [∀ i, NormedSpace 𝕜 (Em i)] [Fintype ι] (f : G →L[𝕜] ContinuousMultilinearMap 𝕜 Em F)
...
variable {ι : Type*} {Em Fm : ι → Type*} [∀ i, AddCommGroup (Em i)]
