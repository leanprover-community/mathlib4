...
variable [NontriviallyNormedField 𝕜] [AddCommGroup E] [NormedAddCommGroup E] [AddCommGroup F₁]
  [NormedAddCommGroup F₁] [AddCommGroup F₂] [NormedAddCommGroup F₂] [AddCommGroup F₃]
...
variable [RCLike 𝕜] [AddCommGroup E]
  [NormedAddCommGroup E] [InnerProductSpace ℝ E] [FiniteDimensional ℝ E] [MeasurableSpace E]
  [BorelSpace E]
  [AddCommGroup F₁] [NormedAddCommGroup F₁] [NormedSpace ℂ F₁] [NormedSpace 𝕜 F₁]
  [SMulCommClass ℂ 𝕜 F₁]
  [AddCommGroup F₂] [NormedAddCommGroup F₂] [NormedSpace ℂ F₂] [NormedSpace 𝕜 F₂]
  [SMulCommClass ℂ 𝕜 F₂]
  [AddCommGroup F₃] [NormedAddCommGroup F₃] [NormedSpace ℂ F₃] [NormedSpace 𝕜 F₃]
