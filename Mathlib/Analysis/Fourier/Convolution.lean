...
variable [NontriviallyNormedField 𝕜] [AddCommGroup E] [NormedAddCommGroup E]
  [AddCommGroup F₁] [NormedAddCommGroup F₁] [AddCommGroup F₂] [NormedAddCommGroup F₂]
...
variable [RCLike 𝕜]
  [AddCommGroup E] [NormedAddCommGroup E] [InnerProductSpace ℝ E] [FiniteDimensional ℝ E]
    [MeasurableSpace E]
  [BorelSpace E]
