...
variable {E V : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℂ E] {f : V → E}

section InnerProductSpace

variable [NormMetric V] [AddCommGroup V] [IsNormedAddGroup V] [MeasurableSpace V] [BorelSpace V] [InnerProductSpace ℝ V]
