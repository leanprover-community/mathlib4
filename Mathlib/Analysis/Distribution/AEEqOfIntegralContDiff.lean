...
variable {E : Type*} [AddCommGroup E] [NormedAddGroup E] [NormedSpace ℝ E] [FiniteDimensional ℝ E]
  {F : Type*} [AddCommGroup F] [NormedAddGroup F] [NormedSpace ℝ F] [CompleteSpace F]
