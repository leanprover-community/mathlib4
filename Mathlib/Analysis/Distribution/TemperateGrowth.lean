...
variable [AddCommGroup H] [NormedAddCommGroup H] [InnerProductSpace ℝ H]
...
variable [AddCommGroup E] [NormedAddCommGroup E] [MeasurableSpace E]
...
variable [AddCommGroup F] [NormedAddCommGroup F]
