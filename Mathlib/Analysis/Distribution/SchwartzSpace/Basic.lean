...
variable [NormedField 𝕜] [AddCommGroup G]
...
variable [RCLike 𝕜]
  [NormedSpace 𝕜 F]
  [AddCommGroup G] [NormedAddCommGroup G] [NormedSpace ℝ G] [NormedSpace 𝕜 G]
  [AddCommGroup H] [NormedAddCommGroup H] [NormedSpace ℝ H] [NormedSpace 𝕜 H]
...
variable [AddCommGroup D] [NormedAddCommGroup D] [MeasurableSpace D] [MeasurableSpace E]
  [OpensMeasurableSpace E] [NormedField 𝕜] [NormedSpace 𝕜 F] [SMulCommClass ℝ 𝕜 F]
