...
theorem Bornology.IsVonNBounded.image_multilinear' [Nonempty ι] {s : Set (∀ i, E i)}
  ...
  if h₁ : ∀ c : 𝕜, ‖c‖ ≤ 1 then
    ...
    calc
      ...
      _ ∈ V := hft fun i hi ↦ by
        ...
        · simp_rw [update_same, I.piecewise_eq_of_mem _ _ hi, smul_smul]
          ...
          calc
            ...
            _ = ‖c i‖ := one_mul _
        · simp_rw [update_noteq hne, I.piecewise_eq_of_mem _ _ hi]
