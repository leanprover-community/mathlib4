...
variable (𝕜 E) in
theorem PolynormableSpace.topologicalAddGroup [PolynormableSpace 𝕜 E] :
    IsTopologicalAddGroup E :=
  PolynormableSpace.withSeminorms 𝕜 E |>.topologicalAddGroup
...
@[elab_as_elim]
lemma induction_of_continuous [TopologicalSpace E] (hp : WithSeminorms p)
