...
@[deprecated (since := "2026-03-09")]
alias _root_.Seminorm.continuous_from_bounded := continuous_from_bounded

theorem continuous_to_normedSpace (F) [SeminormedAddCommGroup F] [NormedSpace 𝕝₂ F]
...
@[deprecated (since := "2026-03-09")]
alias _root_.cont_withSeminorms_normedSpace := continuous_to_normedSpace

theorem continuous_from_normedSpace (E) [SeminormedAddCommGroup E] [NormedSpace 𝕝 E]
...
@[deprecated (since := "2026-03-09")]
alias _root_.Seminorm.cont_normedSpace_to_withSeminorms := continuous_from_normedSpace
