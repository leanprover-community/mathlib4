...
class BarrelledSpace (𝕜 E : Type*) [Ring 𝕜] [SeminormedRing 𝕜] [AddGroup E] [SMul 𝕜 E]
...
theorem Seminorm.continuous_of_lowerSemicontinuous {𝕜 E : Type*} [AddGroup E] [SMul 𝕜 E]
    [Ring 𝕜] [SeminormedRing 𝕜] [TopologicalSpace E] [BarrelledSpace 𝕜 E] (p : Seminorm 𝕜 E)
...
theorem Seminorm.continuous_iSup
    {ι : Sort*} {𝕜 E : Type*} [Field 𝕜] [StrictNormedRing 𝕜] [AddCommGroup E] [Module 𝕜 E]
...
variable {α ι κ 𝕜₁ 𝕜₂ E F : Type*} [Nonempty κ] [Field 𝕜₁] [NontriviallyNormedField 𝕜₁]
    [Field 𝕜₂] [NontriviallyNormedField 𝕜₂] {σ₁₂ : 𝕜₁ →+* 𝕜₂} [RingHomIsometric σ₁₂]
