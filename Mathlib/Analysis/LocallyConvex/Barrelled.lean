...
class BarrelledSpace (𝕜 E : Type*) [NormPseudoMetric 𝕜] [Ring 𝕜] [IsNormedRing 𝕜] [AddGroup E] [SMul 𝕜 E]
...
theorem Seminorm.continuous_of_lowerSemicontinuous {𝕜 E : Type*} [AddGroup E] [SMul 𝕜 E]
    [NormPseudoMetric 𝕜] [Ring 𝕜] [IsNormedRing 𝕜] [TopologicalSpace E] [BarrelledSpace 𝕜 E] (p : Seminorm 𝕜 E)
