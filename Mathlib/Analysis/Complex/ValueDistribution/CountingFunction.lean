...
-/
theorem logCounting_zero_sub_logCounting_top {f : 𝕜 → E} :
...
/--
Adding an analytic function does not change the logarithmic counting function counting poles.
-/
...
/--
For `1 ≤ r`, the logarithmic counting function of `f + g` at `⊤` is less than or equal to the sum of
the logarithmic counting functions of `f` and `g`, respectively.
-/
...
/--
For `1 ≤ r`, the logarithmic counting function counting zeros of `f * g` is less than or equal to
the sum of the logarithmic counting functions counting zeros of `f` and `g`, respectively.
...
/--
Asymptotically, the logarithmic counting function counting zeros of `f * g` is less than or equal to
the sum of the logarithmic counting functions counting zeros of `f` and `g`, respectively.
-/
...
/--
For `1 ≤ r`, the logarithmic counting function counting poles of `f * g` is less than or equal to
the sum of the logarithmic counting functions counting poles of `f` and `g`, respectively.
-/
...
/--
For natural numbers `n`, the logarithmic counting function counting zeros of `f ^ n` equals `n`
times the logarithmic counting function counting zeros of `f`.
-/
...
/--
For natural numbers `n`, the logarithmic counting function counting poles of `f ^ n` equals `n`
times the logarithmic counting function counting poles of `f`.
-/
