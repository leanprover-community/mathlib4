...
/--
For `1 ≤ r`, the characteristic function of `f * g` at zero is less than or equal to the sum of the
...
/--
Asymptotically, the characteristic function of `f * g` at zero is less than or equal to the sum of
