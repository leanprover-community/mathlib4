...
lemma toClosedBall_support_subset_closedBall {r : ℝ} (f : locallyFinsupp E ℤ) :
...
-/
noncomputable def logCounting [ProperSpace E] :
...
-/
@[simp] lemma logCounting_eval_zero [ProperSpace E] (D : locallyFinsupp E ℤ) :
...
-/
theorem logCounting_nonneg [ProperSpace E]
...
-/
theorem logCounting_le [ProperSpace E]
...
-/
theorem logCounting_eventuallyLE [ProperSpace E]
