...
lemma toClosedBall_support_subset_closedBall {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] {r : ℝ}
...
-/
noncomputable def logCounting {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [ProperSpace E] :
...
-/
@[simp] lemma logCounting_eval_zero {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [ProperSpace E]
...
-/
theorem logCounting_nonneg {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [ProperSpace E]
...
-/
theorem logCounting_le {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [ProperSpace E]
...
-/
theorem logCounting_eventuallyLE {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [ProperSpace E]
