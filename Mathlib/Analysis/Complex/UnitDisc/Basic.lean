...
instance (priority := 10000) instCommSemigroup : CommSemigroup UnitDisc := by unfold UnitDisc; infer_instance
instance (priority := 10000) instHasDistribNeg : HasDistribNeg UnitDisc := by unfold UnitDisc; infer_instance
instance (priority := 10000) instCoe : Coe UnitDisc ℂ := ⟨Subtype.val⟩
...
instance (priority := 10000) : SemigroupWithZero 𝔻 :=
...
instance (priority := 10000) : Inhabited 𝔻 :=
  ⟨0⟩

instance (priority := 10000) circleAction : MulAction circle 𝔻 :=
  mulActionSphereBall
#align complex.unit_disc.circle_action Complex.UnitDisc.circleAction

instance (priority := 10000) isScalarTower_circle_circle : IsScalarTower circle circle 𝔻 :=
...
instance (priority := 10000) isScalarTower_circle : IsScalarTower circle 𝔻 𝔻 :=
  isScalarTower_sphere_ball_ball
#align complex.unit_disc.is_scalar_tower_circle Complex.UnitDisc.isScalarTower_circle

instance (priority := 10000) instSMulCommClass_circle : SMulCommClass circle 𝔻 𝔻 :=
...
instance (priority := 10000) instSMulCommClass_circle' : SMulCommClass 𝔻 circle 𝔻 :=
...
instance (priority := 10000) closedBallAction : MulAction (closedBall (0 : ℂ) 1) 𝔻 :=
  mulActionClosedBallBall
#align complex.unit_disc.closed_ball_action Complex.UnitDisc.closedBallAction

instance (priority := 10000) isScalarTower_closedBall_closedBall :
...
instance (priority := 10000) isScalarTower_closedBall : IsScalarTower (closedBall (0 : ℂ) 1) 𝔻 𝔻 :=
...
instance (priority := 10000) instSMulCommClass_closedBall : SMulCommClass (closedBall (0 : ℂ) 1) 𝔻 𝔻 :=
...
instance (priority := 10000) instSMulCommClass_closedBall' : SMulCommClass 𝔻 (closedBall (0 : ℂ) 1) 𝔻 :=
  SMulCommClass.symm _ _ _
#align complex.unit_disc.smul_comm_class_closed_ball' Complex.UnitDisc.instSMulCommClass_closedBall'

instance (priority := 10000) instSMulCommClass_circle_closedBall : SMulCommClass circle (closedBall (0 : ℂ) 1) 𝔻 :=
...
instance (priority := 10000) instSMulCommClass_closedBall_circle : SMulCommClass (closedBall (0 : ℂ) 1) circle 𝔻 :=
  SMulCommClass.symm _ _ _
