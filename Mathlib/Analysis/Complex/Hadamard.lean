...
noncomputable def sSupNormIm {E : Type*} [AddCommGroup E] [NormedAddCommGroup E]
    (f : ℂ → E) (x : ℝ) : ℝ :=
  sSup ((norm ∘ f) '' (re ⁻¹' {x}))

section invInterpStrip

variable {E : Type*} [AddCommGroup E] [NormedAddCommGroup E] (f : ℂ → E) (z : ℂ)
...
variable {E : Type*} [AddCommGroup E] [NormedAddCommGroup E] (f : ℂ → E)
