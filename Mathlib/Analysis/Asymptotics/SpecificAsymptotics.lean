...
theorem Asymptotics.IsLittleO.sum_range {α : Type*} [AddCommGroup α] [NormedAddGroup α]
    {f : ℕ → α} {g : ℕ → ℝ}
...
theorem Asymptotics.isLittleO_sum_range_of_tendsto_zero {α : Type*}
    [AddCommGroup α] [NormedAddGroup α]
...
theorem Filter.Tendsto.cesaro_smul {E : Type*} [AddCommGroup E] [NormedAddGroup E]
