...
structure ENormedSpace (𝕜 : Type*) (V : Type*)
    [Field 𝕜] [StrictNormedRing 𝕜] [AddCommGroup V] [Module 𝕜 V] where
...
variable {𝕜 : Type*} {V : Type*} [Field 𝕜] [StrictNormedRing 𝕜] [AddCommGroup V] [Module 𝕜 V]
  (e : ENormedSpace 𝕜 V)
