...
with sperating dual is trivial. -/
protected theorem _root_.ContinuousLinearMap.center [ContinuousSMul R V] :
    Subalgebra.center R (V →L[R] V) = ⊥ := Subalgebra.ext fun T => by
