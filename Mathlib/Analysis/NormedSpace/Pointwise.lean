...
theorem smul_unit_closedBall (c : 𝕜) : c • closedBall (0 : E) (1 : ℝ) = closedBall (0 : E) ‖c‖ :=
  by rw [smul_closedBall _ _ zero_le_one, smul_zero, mul_one]
#align smul_closed_unit_ball smul_unit_closedBall
...
theorem smul_unit_closedBall_of_nonneg {r : ℝ} (hr : 0 ≤ r) :
    r • closedBall (0 : E) 1 = closedBall (0 : E) r := by
  rw [smul_unit_closedBall, Real.norm_of_nonneg hr]
#align smul_closed_unit_ball_of_nonneg smul_unit_closedBall_of_nonneg
