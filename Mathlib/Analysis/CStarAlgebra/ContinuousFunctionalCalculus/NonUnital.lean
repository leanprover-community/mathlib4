...
class NonUnitalContinuousFunctionalCalculus.IsClosedEmbedding (R A : Type*)
...
set_option backward.isDefEq.respectTransparency false in
lemma isClosedEmbedding_cfcₙHom_of_cfcHom [ContinuousFunctionalCalculus.IsClosedEmbedding R A p]
...
instance ContinuousFunctionalCalculus.IsClosedEmbedding.toNonUnital
    [ContinuousFunctionalCalculus.IsClosedEmbedding R A p] [ContinuousMapZero.UniqueHom R A]
    [CompleteSpace R] : NonUnitalContinuousFunctionalCalculus.IsClosedEmbedding R A p where
