...
`Mathlib/Analysis/SpecialFunctions/ContinuousFunctionalCalculus.lean`. If this import is needed, then
the appropriate location is `Mathlib/Analysis/CStarAlgebra/SpecialFunctions.lean`. If, as is often the
