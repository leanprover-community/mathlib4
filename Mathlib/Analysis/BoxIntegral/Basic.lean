...
variable {ι : Type u} {E : Type v} {F : Type w} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E]
  [NormMetric F] [AddCommGroup F] [IsNormedAddGroup F] [NormedSpace ℝ F] {I J : Box ι} {π : TaggedPrepartition I}
