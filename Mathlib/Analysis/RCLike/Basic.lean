...
--- Is this good place for the following two lemmas?
@[simp]
theorem re_ofReal_pow_eq_pow (a : ℝ) (n : ℕ) : re ((a : K) ^ n) = a ^ n := by
  rw [← ofReal_pow, @ofReal_re]

@[simp]
theorem im_ofReal_pow_eq_zero (a : ℝ) (n : ℕ) : im ((a : K) ^ n) = 0 := by
