...
the unit sphere. -/
theorem extremePoints_closedUnitBall_subset_unitSphere [Nontrivial H] :
    extremePoints ℝ (closedBall (0 : H) 1) ⊆ sphere 0 1 := fun x hx ↦ by
  have h : x ≠ 0 := fun h ↦
...
theorem StrictConvexSpace.extremePoints_closedUnitBall_eq_unitSphere [Nontrivial H]
    [StrictConvexSpace ℝ H] : extremePoints ℝ (closedBall (0 : H) 1) = sphere 0 1 :=
