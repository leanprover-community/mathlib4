...
instance instSMul {R A M} [CommSemiring R] [AddCommMonoid M] [CommSemiring A]
    [SMul R A] [Algebra R A] [Module R M] [Module A M]
    [IsScalarTower R A M] :
...
instance {R S A M} [CommSemiring R] [CommSemiring S] [AddCommMonoid M] [CommSemiring A]
    [SMul R A] [Algebra R A] [SMul S A] [Algebra S A] [Module R M] [Module S M] [Module A M]
...
-/
@[simps symm_apply]
def lift {A : Type*} [Semiring A] [SMul R A] [Algebra R A] : (M →ₗ[R] A) ≃ (TensorAlgebra R M →ₐ[R] A) :=
  { toFun :=
...
@[simp]
theorem ι_comp_lift {A : Type*} [Semiring A] [SMul R A] [Algebra R A] (f : M →ₗ[R] A) :
...
@[simp]
theorem lift_ι_apply {A : Type*} [Semiring A] [SMul R A] [Algebra R A] (f : M →ₗ[R] A) (x) :
...
@[simp]
theorem lift_unique {A : Type*} [Semiring A] [SMul R A] [Algebra R A] (f : M →ₗ[R] A)
...
@[simp]
theorem lift_comp_ι {A : Type*} [Semiring A] [SMul R A] [Algebra R A] (g : TensorAlgebra R M →ₐ[R] A) :
...
@[ext]
theorem hom_ext {A : Type*} [Semiring A] [SMul R A] [Algebra R A] {f g : TensorAlgebra R M →ₐ[R] A}
