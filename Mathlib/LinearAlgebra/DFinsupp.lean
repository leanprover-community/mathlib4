...
theorem iSupIndep.linearIndependent [IsDomain R] [Module.IsTorsionFree R N] {ι : Type*}
...
theorem iSupIndep_iff_linearIndependent_of_ne_zero [IsDomain R] [Module.IsTorsionFree R N]
