...
lemma HasUnifEigenvalue.isNilpotent_of_isNilpotent [IsDomain R] [Module.IsTorsionFree R M]
    {f : End R M} (hfn : IsNilpotent f) {μ : R} (hf : f.HasUnifEigenvalue μ 1) :
    IsNilpotent μ := by
...
See also `LinearMap.isNilpotent_trace_of_isNilpotent`. -/
nonrec
lemma HasEigenvalue.isNilpotent_of_isNilpotent [IsDomain R] [Module.IsTorsionFree R M] {f : End R M}
...
lemma disjoint_genEigenspace [IsDomain R] [Module.IsTorsionFree R M]
...
lemma injOn_genEigenspace [IsDomain R] [Module.IsTorsionFree R M] (f : End R M) (k : ℕ∞) :
...
lemma injOn_maxGenEigenspace [IsDomain R] [Module.IsTorsionFree R M] (f : End R M) :
    InjOn (f.maxGenEigenspace ·) {μ | f.maxGenEigenspace μ ≠ ⊥} :=
  injOn_genEigenspace f ⊤

theorem independent_genEigenspace [IsDomain R] [Module.IsTorsionFree R M] (f : End R M) (k : ℕ∞) :
...
theorem independent_maxGenEigenspace [IsDomain R] [Module.IsTorsionFree R M] (f : End R M) :
...
theorem eigenspaces_iSupIndep [IsDomain R] [Module.IsTorsionFree R M] (f : End R M) :
    iSupIndep f.eigenspace :=
  f.independent_genEigenspace 1

/-- Eigenvectors corresponding to distinct eigenvalues of a linear operator are linearly
independent. -/
theorem eigenvectors_linearIndependent' {ι : Type*} [IsDomain R] [Module.IsTorsionFree R M]
...
theorem eigenvectors_linearIndependent [IsDomain R] [Module.IsTorsionFree R M]
...
lemma map_smul_of_iInf_genEigenspace_ne_bot [IsDomain R] [Module.IsTorsionFree R M]
...
lemma map_add_of_iInf_genEigenspace_ne_bot_of_commute [IsDomain R] [Module.IsTorsionFree R M]
