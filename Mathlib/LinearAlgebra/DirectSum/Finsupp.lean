...
/-- The tensor product of `ι →₀ M` and `κ →₀ N` is linearly equivalent to `(ι × κ) →₀ (M ⊗ N)`. -/
def finsuppTensorFinsupp (R M N ι κ : Sort*) [CommRing R] [AddCommGroup M] [Module R M]
...
@[simp]
theorem finsuppTensorFinsupp_single (R M N ι κ : Sort*) [CommRing R] [AddCommGroup M] [Module R M]
...
@[simp]
theorem finsuppTensorFinsupp_apply (R M N ι κ : Sort*) [CommRing R] [AddCommGroup M] [Module R M]
...
@[simp]
theorem finsuppTensorFinsupp_symm_single (R M N ι κ : Sort*) [CommRing R] [AddCommGroup M]
