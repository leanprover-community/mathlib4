...
variable
    ...
    {A B : Type*} [Semiring A] [Semiring B] [SMul R A] [Algebra R A] [SMul R B] [Algebra R B]
...
variable {R : Type*} [CommRing R]
  ...
  [SMul R A] [Algebra R A] [SMul R B] [Algebra R B] [SMul R C] [Algebra R C] [SMul R D] [Algebra R D]
  (f : A →ₐ[R] B) (g : C →ₐ[R] D)
