...
@[simp]
lemma gradedCommAux_lof_tmul (i j : ι) (a : 𝒜 i) (b : ℬ j) :
...
@[simp]
lemma gradedCommAux_comp_gradedCommAux :
...
lemma gradedComm_of_tmul_of (i j : ι) (a : 𝒜 i) (b : ℬ j) :
...
lemma gradedComm_tmul_of_zero (a : ⨁ i, 𝒜 i) (b : ℬ 0) :
...
lemma gradedComm_of_zero_tmul (a : 𝒜 0) (b : ⨁ i, ℬ i) :
...
lemma gradedComm_tmul_one (a : ⨁ i, 𝒜 i) : gradedComm R 𝒜 ℬ (a ⊗ₜ 1) = 1 ⊗ₜ a :=
  gradedComm_tmul_of_zero _ _ _ _ _

lemma gradedComm_one_tmul (b : ⨁ i, ℬ i) : gradedComm R 𝒜 ℬ (1 ⊗ₜ b) = b ⊗ₜ 1 :=
  gradedComm_of_zero_tmul _ _ _ _ _

@[simp, nolint simpNF] -- linter times out
lemma gradedComm_one : gradedComm R 𝒜 ℬ 1 = 1 :=
  gradedComm_one_tmul _ _ _ _

lemma gradedComm_tmul_algebraMap (a : ⨁ i, 𝒜 i) (r : R) :
    gradedComm R 𝒜 ℬ (a ⊗ₜ algebraMap R _ r) = algebraMap R _ r ⊗ₜ a :=
  gradedComm_tmul_of_zero _ _ _ _ _

lemma gradedComm_algebraMap_tmul (r : R) (b : ⨁ i, ℬ i) :
    gradedComm R 𝒜 ℬ (algebraMap R _ r ⊗ₜ b) = b ⊗ₜ algebraMap R _ r :=
  gradedComm_of_zero_tmul _ _ _ _ _

lemma gradedComm_algebraMap (r : R) :
...
lemma tmul_of_gradedMul_of_tmul (j₁ i₂ : ι)
...
lemma algebraMap_gradedMul (r : R) (x : (⨁ i, 𝒜 i) ⊗[R] (⨁ i, ℬ i)) :
...
lemma one_gradedMul (x : (⨁ i, 𝒜 i) ⊗[R] (⨁ i, ℬ i)) :
...
lemma gradedMul_algebraMap (x : (⨁ i, 𝒜 i) ⊗[R] (⨁ i, ℬ i)) (r : R) :
...
lemma gradedComm_gradedMul (x y : DirectSum _ 𝒜 ⊗[R] DirectSum _ ℬ) :
