...
theorem gradedComm_of_tmul_of (i j : ι) (a : 𝒜 i) (b : ℬ j) :
  ...
  rw [TensorProduct.directSum_lof_tmul_lof, gradedCommAux_lof_tmul, Units.smul_def,
    -- Note:https://github.com/leanprover-community/mathlib4/issues/8386 specialized `map_smul` to `LinearEquiv.map_smul` to avoid timeouts.
...
theorem tmul_of_gradedMul_of_tmul (j₁ i₂ : ι)
  ...
  -- Note:https://github.com/leanprover-community/mathlib4/issues/8386 had to specialize `map_smul` to avoid timeouts.
...
theorem one_gradedMul (x : (⨁ i, 𝒜 i) ⊗[R] (⨁ i, ℬ i)) :
  ...
  -- Note:https://github.com/leanprover-community/mathlib4/issues/8386 had to specialize `map_one` to avoid timeouts.
