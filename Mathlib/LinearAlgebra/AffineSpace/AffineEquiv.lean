...
theorem pointReflection_fixed_iff_of_injective_bit0 {x y : P₁} (h : Injective (fun v ↦ v + v : V₁ → V₁)) :
...
set_option linter.deprecated false in
theorem injective_pointReflection_left_of_injective_bit0 (h : Injective (fun v ↦ v + v : V₁ → V₁)) (y : P₁) :
