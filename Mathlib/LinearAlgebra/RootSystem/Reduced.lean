...
lemma nsmul_notMem_range_root [CharZero R] [Module.IsTorsionFree ℤ M] [P.IsReduced]
...
lemma linearIndependent_of_add_mem_range_root
    [CharZero R] [Module.IsTorsionFree ℤ M] [P.IsReduced] {i j : ι}
...
lemma infinite_of_linearIndependent_coxeterWeight_four [NeZero (2 : R)] [Module.IsTorsionFree ℤ M]
...
lemma pairing_smul_root_eq_of_not_linearIndependent [NeZero (2 : R)] [Module.IsTorsionFree R M]
...
lemma coxeterWeight_ne_four_of_linearIndependent [NeZero (2 : R)] [Module.IsTorsionFree ℤ M]
...
variable [CharZero R] [Module.IsTorsionFree R M]
...
lemma pairing_one_four_iff' (h2 : IsSMulRegular R (2 : R)) :
  ...
  have _i : Module.IsTorsionFree ℤ M := Module.IsTorsionFree.int_of_charZero R M
  have _i : Module.IsTorsionFree ℤ N := Module.IsTorsionFree.int_of_charZero R N
