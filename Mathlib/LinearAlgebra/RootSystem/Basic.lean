...
lemma injOn_dualMap_subtype_span_root_coroot [Module.IsTorsionFree ℤ M] :
...
protected lemma ext [CharZero R] [Module.IsTorsionFree R M]
  ...
  have := Module.IsTorsionFree.int_of_charZero R M
  ext i
...
private lemma coroot_eq_coreflection_of_root_eq' [CharZero R] [Module.IsTorsionFree R M]
  ...
  have _i : Module.IsTorsionFree ℤ M := Module.IsTorsionFree.int_of_charZero R M
