...
instance (priority := 10000) finiteDimensional_pi {ι : Type*} [Finite ι] : FiniteDimensional K (ι → K) :=
  Finite.pi
#align finite_dimensional.finite_dimensional_pi FiniteDimensional.finiteDimensional_pi

instance (priority := 10000) finiteDimensional_pi' {ι : Type*} [Finite ι] (M : ι → Type*) [∀ i, AddCommGroup (M i)]
...
/-- If a vector space is `FiniteDimensional`, `Basis.ofVectorSpace` is indexed by
  a finite type.-/
noncomputable instance (priority := 10000) [FiniteDimensional K V] : Fintype (Basis.ofVectorSpaceIndex K V) := by
...
instance (priority := 10000) finiteDimensional_submodule [FiniteDimensional K V] (S : Submodule K V) :
...
instance (priority := 10000) finiteDimensional_quotient [FiniteDimensional K V] (S : Submodule K V) :
...
instance (priority := 10000) finiteDimensional_self : FiniteDimensional K K := inferInstance
...
instance (priority := 10000) span_singleton (x : V) : FiniteDimensional K (K ∙ x) :=
...
instance (priority := 10000) span_finset (s : Finset V) : FiniteDimensional K (span K (s : Set V)) :=
...
instance (priority := 10000) (f : V →ₗ[K] V₂) (p : Submodule K V) [FiniteDimensional K p] :
...
instance (priority := 10000) finiteDimensional_bot : FiniteDimensional K (⊥ : Submodule K V) :=
...
finite-dimensional. -/
instance (priority := 10000) finiteDimensional_inf_left (S₁ S₂ : Submodule K V) [FiniteDimensional K S₁] :
...
finite-dimensional. -/
instance (priority := 10000) finiteDimensional_inf_right (S₁ S₂ : Submodule K V) [FiniteDimensional K S₂] :
    FiniteDimensional K (S₁ ⊓ S₂ : Submodule K V) :=
...
finite-dimensional. -/
instance (priority := 10000) finiteDimensional_sup (S₁ S₂ : Submodule K V) [h₁ : FiniteDimensional K S₁]
...
instance (priority := 10000) finiteDimensional_finset_sup {ι : Type*} (s : Finset ι) (S : ι → Submodule K V)
...
instance (priority := 10000) finiteDimensional_iSup {ι : Sort*} [Finite ι] (S : ι → Submodule K V)
...
instance (priority := 10000) finiteDimensional_finsupp {ι : Type*} [Finite ι] [FiniteDimensional K V] :
...
instance (priority := 10000) finiteDimensional_range [FiniteDimensional K V] (f : V →ₗ[K] V₂) :
...
```lean4
instance (priority := 10000) (S : Subalgebra F E) : AddCommMonoid { x // x ∈ S } := inferInstance
instance (priority := 10000) (S : Subalgebra F E) : AddCommGroup { x // x ∈ S } := inferInstance
```
...
instance (priority := 10000) FiniteDimensional.finiteDimensional_subalgebra [FiniteDimensional F E]
...
instance (priority := 10000) Subalgebra.finiteDimensional_bot : FiniteDimensional F (⊥ : Subalgebra F E) := by
  nontriviality E
