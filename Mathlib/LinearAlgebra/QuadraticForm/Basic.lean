...
theorem PosDef.smul {R} [OrderedCommSemiring R] [Module R M] [Module R N] [PosSMulStrictMono R N]
...
theorem linMulLinSelfPosDef {R} [CommSemiring R] [Module R M] [LinearOrderedSemiring A]
