...
@[simps]
noncomputable
def dualSubmoduleToDual [IsDomain R] [Module.IsTorsionFree R S] (N : Submodule R M) :
...
lemma dualSubmoduleToDual_injective [IsDomain R] (hB : B.Nondegenerate) [Module.IsTorsionFree R S]
