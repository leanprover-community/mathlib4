...
lemma _root_.Submodule.mem_invtSubmodule_reflection_iff [NeZero (2 : R)] [Module.IsTorsionFree R M]
...
lemma Dual.eq_of_preReflection_mapsTo [CharZero R] [Module.IsTorsionFree R M]
