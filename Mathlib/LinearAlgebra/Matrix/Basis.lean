...
lemma coePiBasisFun.toMatrix_eq_transpose [Finite ι] :
...
lemma toMatrix_smul {R₁ S : Type*} [CommRing R₁] [Ring S] [Algebra R₁ S] [Fintype ι]
...
@[simp]
lemma toLin_toMatrix [Finite ι] [Fintype ι'] [DecidableEq ι'] (v : Basis ι' R M) :
...
@[simp]
lemma basis_toMatrix_mul_linearMap_toMatrix [Finite κ] [Fintype κ'] [DecidableEq ι'] :
...
lemma basis_toMatrix_mul [Fintype κ] [Finite ι] [DecidableEq κ]
...
@[simp]
lemma linearMap_toMatrix_mul_basis_toMatrix [Finite κ'] [DecidableEq ι] [DecidableEq ι'] :
...
lemma basis_toMatrix_mul_linearMap_toMatrix_mul_basis_toMatrix
