...
theorem listTransvecCol_mul_last_col (hM : M (inr unit) (inr unit) ≠ 0) (i : Fin r) :
  ...
  | of_succ n hn IH =>
    ...
    have A :
      ...
      simp +zetaDelta [listTransvecCol]
...
theorem mul_listTransvecRow_last_col_take (i : Fin r ⊕ Unit) {k : ℕ} (hk : k ≤ r) :
  ...
  · have hkr : k < r := hk
    ...
    have :
      ...
      simp +zetaDelta only [listTransvecRow, List.ofFnNthVal, hkr, dif_pos, List.getElem?_ofFn]
...
theorem mul_listTransvecRow_last_row (hM : M (inr unit) (inr unit) ≠ 0) (i : Fin r) :
  ...
  · have hnr : n < r := hk
    ...
    have A :
      ...
      simp +zetaDelta only [listTransvecRow, List.ofFnNthVal, hnr, dif_pos, List.getElem?_ofFn]
