...
lemma det_ne_zero_of_sum_col_pos [DecidableEq n] {S : Type*} [CommRing S] [LinearOrderedCommRing S]
...
lemma det_ne_zero_of_sum_row_pos [DecidableEq n] {S : Type*} [CommRing S] [LinearOrderedCommRing S]
