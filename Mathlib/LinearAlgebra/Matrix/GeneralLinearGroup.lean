...
variable {n : Type u} {R : Type v} [DecidableEq n] [Fintype n] [CommRing R] [LinearOrderedCommRing R]
...
variable {n : Type u} [DecidableEq n] [Fintype n] {R : Type v} [CommRing R] [LinearOrderedCommRing R]
