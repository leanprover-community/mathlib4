...
theorem Module.finrank_div_finrank (F K A : Type*) [Semiring F] [Ring K] [AddCommGroup A]
  ...
  (Nat.eq_div_of_mul_eq_left ((finrank_pos_iff_of_free ..).mpr ‹_›).ne' (finrank_mul_finrank ..)).symm
...
theorem Module.finrank_div_finrank_left (F K A : Type*) [Ring F] [Ring K] [AddCommMonoid A]
  ...
  (Nat.eq_div_of_mul_eq_right ((finrank_pos_iff_of_free ..).mpr ‹_›).ne' (finrank_mul_finrank ..)).symm
