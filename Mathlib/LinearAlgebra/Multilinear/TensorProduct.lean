...
@[simp]
theorem domCoprod'_apply (a : (fun _ : ι₁ ↦ N) →ₗₘ[R] N₁) (b : (fun _ : ι₂ ↦ N) →ₗₘ[R] N₂) :
...
theorem domCoprod_domDomCongr_sumCongr (a : (fun _ : ι₁ ↦ N) →ₗₘ[R] N₁)
    (b : (fun _ : ι₂ ↦ N) →ₗₘ[R] N₂) (σa : ι₁ ≃ ι₃) (σb : ι₂ ≃ ι₄) :
