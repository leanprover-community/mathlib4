...
lemma adjMatrix_mulVec_const_apply [NonAssocSemiring α] {a : α} {v : V} :
...
lemma adjMatrix_mulVec_const_apply_of_regular [NonAssocSemiring α] {d : ℕ} {a : α}
...
lemma dotProduct_mulVec_adjMatrix [NonAssocSemiring α] (vec : V → α) :
