...
instance [Subsingleton (V → W)] : Subsingleton (G →g H) := fast_instance% DFunLike.coe_injective.subsingleton
...
instance [Finite V] [Finite W] : Finite (G →g H) := fast_instance% DFunLike.finite _
