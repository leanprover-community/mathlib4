...
@[simp]
lemma edgeFinset_sup [Fintype (edgeSet (G₁ ⊔ G₂))] [DecidableEq V] :
...
@[simp]
lemma edgeFinset_top [DecidableEq V] :
...
lemma edgeFinset_deleteEdges [DecidableEq V] [Fintype G.edgeSet] (s : Finset (Sym2 V))
