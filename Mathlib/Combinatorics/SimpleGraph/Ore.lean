...
lemma ore_adjacent {G : SimpleGraph V} (hG : G.Connected) [Fintype V] [G.LocallyFinite]
  (h_ore : ∀ u v : V, u ≠ v → ¬ G.Adj u v → G.degree u + G.degree v ≥ Fintype.card V) {h_order : Fintype.card V ≥ 3} {a b : V} {h_ne : a ≠ b} {p : G.Walk a b} {hp : Walk.IsMaxlongPath p} {h_ab : ¬ G.Adj a b}:
