...
instance : DecidableRel (G.replaceVertex s t).Adj := fast_instance% by unfold replaceVertex; infer_instance
...
instance : Fintype (edge s t).edgeSet := fast_instance% by rw [edge]; infer_instance
