...
theorem posSemidef_lapMatrix [Field R] [LinearOrderedField R] [StarRing R] [StarOrderedRing R]
...
theorem lapMatrix_toLinearMap₂'_apply'_eq_zero_iff_forall_adj [Field R] [LinearOrderedField R] (x : V → R) :
