...
@[simp]
lemma interedges_empty_left (t : Finset β) : interedges r ∅ t = ∅ := by
...
lemma interedges_biUnion_left (s : Finset ι) (t : Finset β) (f : ι → Finset α) :
...
lemma interedges_biUnion_right (s : Finset α) (t : Finset ι) (f : ι → Finset β) :
...
lemma interedges_biUnion (s : Finset ι) (t : Finset κ) (f : ι → Finset α) (g : κ → Finset β) :
...
lemma edgeDensity_nonneg (s : Finset α) (t : Finset β) : 0 ≤ edgeDensity r s t := by
  apply div_nonneg <;> exact_mod_cast Nat.zero_le _
#align rel.edge_density_nonneg Rel.edgeDensity_nonneg

lemma edgeDensity_le_one (s : Finset α) (t : Finset β) : edgeDensity r s t ≤ 1 := by
  apply div_le_one_of_le
  · exact_mod_cast card_interedges_le_mul r s t
  · exact_mod_cast Nat.zero_le _
#align rel.edge_density_le_one Rel.edgeDensity_le_one

lemma edgeDensity_add_edgeDensity_compl (hs : s.Nonempty) (ht : t.Nonempty) :
...
@[simp]
lemma edgeDensity_empty_left (t : Finset β) : edgeDensity r ∅ t = 0 := by
...
@[simp]
lemma edgeDensity_empty_right (s : Finset α) : edgeDensity r s ∅ = 0 := by
...
lemma mul_edgeDensity_le_edgeDensity (hs : s₂ ⊆ s₁) (ht : t₂ ⊆ t₁) (hs₂ : s₂.Nonempty)
    (ht₂ : t₂.Nonempty) :
...
lemma edgeDensity_sub_edgeDensity_le_one_sub_mul (hs : s₂ ⊆ s₁) (ht : t₂ ⊆ t₁) (hs₂ : s₂.Nonempty)
    (ht₂ : t₂.Nonempty) :
...
lemma abs_edgeDensity_sub_edgeDensity_le_one_sub_mul (hs : s₂ ⊆ s₁) (ht : t₂ ⊆ t₁)
...
lemma abs_edgeDensity_sub_edgeDensity_le_two_mul_sub_sq (hs : s₂ ⊆ s₁) (ht : t₂ ⊆ t₁)
...
lemma abs_edgeDensity_sub_edgeDensity_le_two_mul (hs : s₂ ⊆ s₁) (ht : t₂ ⊆ t₁) (hδ : 0 ≤ δ)
...
lemma edgeDensity_comm (s t : Finset α) : edgeDensity r s t = edgeDensity r t s := by
...
@[simp]
lemma interedges_empty_left (t : Finset α) : G.interedges ∅ t = ∅ :=
...
lemma interedges_biUnion_left (s : Finset ι) (t : Finset α) (f : ι → Finset α) :
...
lemma interedges_biUnion_right (s : Finset α) (t : Finset ι) (f : ι → Finset α) :
...
lemma interedges_biUnion (s : Finset ι) (t : Finset κ) (f : ι → Finset α) (g : κ → Finset α) :
...
lemma edgeDensity_add_edgeDensity_compl (hs : s.Nonempty) (ht : t.Nonempty) (h : Disjoint s t) :
...
lemma edgeDensity_comm (s t : Finset α) : G.edgeDensity s t = G.edgeDensity t s :=
