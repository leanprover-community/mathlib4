...
instance Dart.fintype [Fintype V] [DecidableRel G.Adj] : Fintype G.Dart := fast_instance%
...
instance nonempty_dart_top [Nontrivial V] : Nonempty (⊤ : SimpleGraph V).Dart := fast_instance% by
