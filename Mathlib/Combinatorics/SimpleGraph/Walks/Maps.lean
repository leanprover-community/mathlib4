...
open GraphLike SimpleGraph DartLike SymmDartLike
...
@[simp] lemma mapStep_induceOfLE {u u' : s} (huu' : step G u.val u') (hs : s ⊆ s') :
  ...
  simp only [RelEmbedding.coe_toRelHom, induceHomOfLE_apply, Hom.mapStep, fst_eq, snd_eq,
    induceHomOfLE_toHom, step_val_eq, Prod.map_apply, step.ext_iff, Prod.mk.injEq]
