...
theorem adj_of_mem_incidenceSet (h : a ≠ b) (ha : e ∈ G.incidenceSet a)
  ...
  rwa [← mk'_mem_incidenceSet_left_iff, ←
    Set.mem_singleton.1 <| G.incidenceSet_inter_incidenceSet_subset h ⟨ha, hb⟩]
...
theorem adj_incidenceSet_inter {v : V} {e : Sym2 V} (he : e ∈ G.edgeSet) (h : v ∈ e) :
  ...
  ext e'
  simp only [incidenceSet, Set.mem_sep_iff, Set.mem_inter_iff, Set.mem_singleton]
  refine ⟨fun h' => ?_, ?_⟩
...
theorem neighborSet_union_compl_neighborSet_eq (G : SimpleGraph V) (v : V) :
  ...
  simp_rw [Set.mem_union, mem_neighborSet, compl_adj, Set.mem_compl_iff, Set.mem_singleton]
  tauto
