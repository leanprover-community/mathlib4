...
def ofPathGraphBetween : ∀ {n} i j, (pathGraph n).Walk i j
  | n, ⟨0, _⟩, ⟨0, _⟩ => nil
  | n, ⟨0, h₀⟩, ⟨j + 1, _⟩ =>
    ofPathGraphBetween ⟨0, h₀⟩ ⟨j, by lia⟩ |>.concat <| by simp [pathGraph_adj]
  | n, ⟨i + 1, _⟩, ⟨0, h₀⟩ =>
    ofPathGraphBetween ⟨i, by lia⟩ ⟨0, h₀⟩ |>.cons <| by simp [pathGraph_adj]
  | n + 1, ⟨i + 1, _⟩, ⟨j + 1, _⟩ =>
    ofPathGraphBetween ⟨i, by lia⟩ ⟨j, by lia⟩ |>.map <| Embedding.toHom <|
