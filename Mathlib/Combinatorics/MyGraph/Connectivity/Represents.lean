...
* `MyGraph.ConnectedComponent.Represents` says that a set of vertices represents a set of
...
namespace MyGraph.ConnectedComponent
...
end MyGraph.ConnectedComponent.Represents
