...
@[deprecated (since := "2026-06-03")] alias diff_subset_ground := private sdiff_subset_ground

@[aesop unsafe 10% (rule_sets := [Matroid])]
private theorem ground_sdiff_subset_ground : M.E \ X ⊆ M.E :=
  sdiff_subset_ground rfl.subset

@[deprecated (since := "2026-06-03")] alias ground_diff_subset_ground := private ground_sdiff_subset_ground
