...
theorem empty_isBase_iff : M.IsBase ∅ ↔ M = loopyOn M.E := by
  simp only [isBase_iff_maximal_indep, Maximal, empty_indep, empty_subset, subset_empty_iff,
    true_implies, true_and, ext_iff_indep, loopyOn_ground, loopyOn_indep_iff]
