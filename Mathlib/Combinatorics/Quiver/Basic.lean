...
instance (priority := 10000) (V : Type*) [Quiver V] : Inhabited (Prefunctor V V) :=
  ⟨id V⟩
...
instance (priority := 10000) opposite {V} [Quiver V] : Quiver Vᵒᵖ :=
...
instance (priority := 10000) emptyQuiver (V : Type u) : Quiver.{u} (Empty V) := ⟨fun _ _ => PEmpty⟩
