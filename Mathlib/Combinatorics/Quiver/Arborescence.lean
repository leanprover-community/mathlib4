...
instance (priority := 10000) {V : Type u} [Quiver V] [Arborescence V] (b : V) : Unique (Path (root V) b) :=
...
noncomputable instance (priority := 10000) geodesicArborescence : Arborescence (geodesicSubtree r) :=
