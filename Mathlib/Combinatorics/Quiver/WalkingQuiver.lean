...
Here we define the 'walking quiver', a category whose category of presheaves is equivalent to
**Quiv**, and provide some basic API and notation for working with it.

## Implementation details
This category is essentially identical to `CategoryTheory.Limits.WalkingParallelPair`, but given
names more intuitive when working with presheaves on `WalkingQuiver`.
-/
