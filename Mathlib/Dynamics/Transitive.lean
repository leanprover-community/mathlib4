...
/-- Deprecated alias for `AddMonoidAction.IsTopologicallyTransitive`. -/
@[deprecated AddMonoidAction.IsTopologicallyTransitive (since := "2026-09-02")]
abbrev AddAction.IsTopologicallyTransitive := @AddMonoidAction.IsTopologicallyTransitive
@[deprecated (since := "2026-09-02")]
alias AddAction.IsTopologicallyTransitive.exists_vadd_inter :=
  AddMonoidAction.IsTopologicallyTransitive.exists_vadd_inter
...
/-- Deprecated alias for `MonoidAction.IsTopologicallyTransitive`. -/
@[deprecated MonoidAction.IsTopologicallyTransitive (since := "2026-09-02")]
abbrev MulAction.IsTopologicallyTransitive := @MonoidAction.IsTopologicallyTransitive
@[deprecated (since := "2026-09-02")]
