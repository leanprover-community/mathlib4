...
/-- The (extended complex-valued) variation of a function `f` on a set `s` inside a linear order is
...
/-- If a complex-valued function has bounded variation on a set, then it is a difference of monotone
functions there. -/
