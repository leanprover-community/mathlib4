...
instance (priority := 10000) instPreorder : Preorder (Specialization α) := specializationPreorder α
instance (priority := 10000) instPartialOrder [T0Space α] : PartialOrder (Specialization α) := specializationOrder α
