...
theorem closure_eq_uniformity (s : Set <| α × α) :
  ...
  simp +contextual only
    [mem_closure_iff_nhds_basis (UniformSpace.hasBasis_nhds_prod x y), mem_iInter, mem_ofPred,
...
theorem ball_entourageProd (u : SetRel α α) (v : SetRel β β) (x : α × β) :
  ...
  ext p; simp only [ball, entourageProd, Set.mem_ofPred, Set.mem_prod, Set.mem_preimage]
