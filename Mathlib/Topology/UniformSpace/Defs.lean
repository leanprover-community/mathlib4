...
@[deprecated SetRel.id (since := "2025-08-28")]
def idRel {α : Type*} :=
  { p : α × α | p.1 = p.2 }

set_option linter.deprecated false in
@[deprecated SetRel.mem_id (since := "2025-08-28")]
theorem mem_idRel {a b : α} : (a, b) ∈ @idRel α ↔ a = b :=
  Iff.rfl

set_option linter.deprecated false in
@[deprecated SetRel.id_subset_iff (since := "2025-08-28")]
theorem idRel_subset {s : SetRel α α} : idRel ⊆ s ↔ ∀ a, (a, a) ∈ s := by
  simp [subset_def, mem_idRel]

set_option linter.deprecated false in
@[deprecated SetRel.exists_eq_singleton_of_prod_subset_id (since := "2025-08-28")]
...
@[deprecated SetRel.comp (since := "2025-08-28")]
...
@[deprecated (since := "2025-08-28")] alias compRel_mono := SetRel.comp_subset_comp
@[deprecated (since := "2025-08-28")] alias compRel_left_mono := SetRel.comp_subset_comp_left
@[deprecated (since := "2025-08-28")] alias compRel_right_mono := SetRel.comp_subset_comp_right
@[deprecated (since := "2025-08-28")] alias prodMk_mem_compRel := SetRel.prodMk_mem_comp
@[deprecated (since := "2025-03-10")] alias prod_mk_mem_compRel := SetRel.prodMk_mem_comp

set_option linter.deprecated false in
@[deprecated SetRel.id_comp (since := "2025-08-28")]
theorem id_compRel {r : SetRel α α} : idRel ○ r = r :=
  SetRel.id_comp _

set_option linter.deprecated false in
@[deprecated SetRel.comp_assoc (since := "2025-08-28")]
theorem compRel_assoc {r s t : SetRel α α} : r ○ s ○ t = r ○ (s ○ t) := by
  apply SetRel.comp_assoc

set_option linter.deprecated false in
@[deprecated SetRel.left_subset_comp (since := "2025-08-28")]
theorem left_subset_compRel {s t : SetRel α α} (h : idRel ⊆ t) : s ⊆ s ○ t := fun ⟨_x, y⟩ xy_in =>
  ⟨y, xy_in, h <| rfl⟩

set_option linter.deprecated false in
@[deprecated SetRel.right_subset_comp (since := "2025-08-28")]
...
set_option linter.deprecated false in
@[deprecated SetRel.subset_iterate_comp (since := "2025-08-28")]
...
@[deprecated SetRel.IsSymm (since := "2025-08-28")]
