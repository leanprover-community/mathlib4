...
theorem uniformInducing_pureCauchy : UniformInducing (pureCauchy : α → CauchyCat α) :=
...
theorem uniformEmbedding_pureCauchy : UniformEmbedding (pureCauchy : α → CauchyCat α) :=
