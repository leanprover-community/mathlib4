...
lemma UniformEmbedding.toClosedEmbedding [UniformSpace α] [UniformSpace β] [CompleteSpace α]
...
lemma continuous_extend_of_cauchy {e : α → β} {f : α → γ} (de : DenseInducing e)
