...
group with the order topology. This weakens the assumptions of the norm and commutativity, in
exchange for strengthening to a linear order. This separate generality is not included in this file,
but that generality was included in initial drafts of the original
