...
instance ULift.completeSpace [h : CompleteSpace α] : CompleteSpace (ULift α) := fast_instance%
...
instance CompleteSpace.sum [CompleteSpace α] [CompleteSpace β] : CompleteSpace (Sum α β) := fast_instance% by
