...
@[deprecated (since := "2026-04-01")] alias LocPathConnectedSpace :=
...
@[deprecated (since := "2026-04-01")] alias LocPathConnectedSpace.of_bases :=
...
@[deprecated (since := "2026-04-01")] alias PathConnectedSpace.of_locPathConnectedSpace :=
...
@[deprecated (since := "2026-04-01")] alias Topology.IsOpenEmbedding.locPathConnectedSpace :=
...
@[deprecated (since := "2026-04-01")] alias IsOpen.locPathConnectedSpace :=
...
@[deprecated (since := "2026-04-01")] alias locPathConnectedSpace_iff_isOpen_pathComponentIn :=
...
@[deprecated (since := "2026-04-01")] alias locPathConnectedSpace_iff_pathComponentIn_mem_nhds :=
...
@[deprecated (since := "2026-04-01")] alias LocPathConnectedSpace.coinduced :=
...
@[deprecated (since := "2026-04-01")] alias Quot.locPathConnectedSpace :=
...
instance Sum.locallyPathConnectedSpace.{u} {X Y : Type u} [TopologicalSpace X] [TopologicalSpace Y]
...
@[deprecated (since := "2026-04-01")] alias Sum.locPathConnectedSpace :=
...
@[deprecated (since := "2026-04-01")] alias Sigma.locPathConnectedSpace :=
...
@[deprecated (since := "2026-04-01")] alias AlexandrovDiscrete.locPathConnectedSpace :=
