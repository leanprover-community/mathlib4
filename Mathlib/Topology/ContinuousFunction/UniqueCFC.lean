...
variable {𝕜 A : Type*} [ROrCLike 𝕜]

theorem ROrCLike.uniqueContinuousFunctionalCalculus_of_compactSpace_spectrum [TopologicalSpace A]
...
instance ROrCLike.instUniqueContinuousFunctionalCalculus [NormedRing A] [StarRing A]
    [NormedAlgebra 𝕜 A] [CompleteSpace A] : UniqueContinuousFunctionalCalculus 𝕜 A :=
  ROrCLike.uniqueContinuousFunctionalCalculus_of_compactSpace_spectrum
