...
lemma continuous_eraseIdx {n : ℕ} : Continuous fun l : List α => eraseIdx l n :=
...
lemma continuousAt_eraseIdx {n : ℕ} {i : Fin (n + 1)} :
...
lemma continuous_eraseIdx {n : ℕ} {i : Fin (n + 1)} :
