...
- `t2Space_withConstructibleTopology`: If `X` is T0, quasi-compact, quasi-separated and prespectral,
  then `X` is T2 in the constructible topology.
...
/-- If `X` is T0, quasi-compact, quasi-separated and prespectral, then `X` is T2 in the
