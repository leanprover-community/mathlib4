...
lemma continuousAt_sign_of_pos {a : α} (h : 0 < a) : ContinuousAt SignType.sign a := by
...
lemma continuousAt_sign_of_neg {a : α} (h : a < 0) : ContinuousAt SignType.sign a := by
...
lemma continuousAt_sign_of_ne_zero {a : α} (h : a ≠ 0) : ContinuousAt SignType.sign a := by
