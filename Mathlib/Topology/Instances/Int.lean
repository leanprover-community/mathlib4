...
instance (priority := 10000) : Dist ℤ :=
  ⟨fun x y => dist (x : ℝ) y⟩
...
instance (priority := 10000) : MetricSpace ℤ := Int.uniformEmbedding_coe_real.comapMetricSpace _
...
instance (priority := 10000) : ProperSpace ℤ :=
  ⟨fun x r => by
