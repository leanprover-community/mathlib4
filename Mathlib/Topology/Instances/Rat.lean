...
instance (priority := 10000) : MetricSpace ℚ :=
...
instance (priority := 10000) : NoncompactSpace ℚ := Int.closedEmbedding_coe_rat.noncompactSpace
...
instance (priority := 10000) : UniformAddGroup ℚ :=
  UniformAddGroup.mk' Rat.uniformContinuous_add Rat.uniformContinuous_neg

instance (priority := 10000) : TopologicalAddGroup ℚ := inferInstance

instance (priority := 10000) : OrderTopology ℚ := induced_orderTopology _ Rat.cast_lt exists_rat_btwn
...
instance (priority := 10000) : TopologicalRing ℚ := inferInstance
