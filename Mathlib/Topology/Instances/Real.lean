...
@[deprecated (since := "2024-06-12")] alias Real.cocompact_eq := cocompact_eq_atBot_atTop
...
@[deprecated continuousAt_inv₀ (since := "2024-06-12")]
...
@[deprecated Continuous.inv₀ (since := "2024-06-12")]
...
@[deprecated continuous_mul (since := "2024-06-12")]
...
@[deprecated Function.Periodic.compact_of_continuous (since := "2024-06-12")]
theorem Periodic.compact_of_continuous' [TopologicalSpace α] {f : ℝ → α} {c : ℝ} (hp : Periodic f c)
