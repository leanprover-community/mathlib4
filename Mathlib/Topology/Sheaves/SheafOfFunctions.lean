...
We show that
* `TopCat.Presheaf.toType_isSheaf`: not-necessarily-continuous functions into a type form a sheaf
* `TopCat.Presheaf.toTypes_isSheaf`: in fact, these may be dependent functions into a type family
