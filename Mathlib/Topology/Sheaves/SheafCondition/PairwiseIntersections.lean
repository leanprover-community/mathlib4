...
instance (priority := 10000) (V : OpensLeCover U) : Nonempty (StructuredArrow V (pairwiseToOpensLeCover U)) :=
...
-/
instance (priority := 10000) : Functor.Final (pairwiseToOpensLeCover U) :=
  ⟨fun V =>
