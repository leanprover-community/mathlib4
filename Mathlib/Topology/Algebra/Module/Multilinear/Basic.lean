...
variable (R ι) (A : Type*) [Fintype ι] [CommSemiring R] [CommSemiring A] [SMul R A] [Algebra R A]
...
variable (R n) (A : Type*) [CommSemiring R] [Semiring A] [SMul R A] [Algebra R A] [TopologicalSpace A]
  [ContinuousMul A]
