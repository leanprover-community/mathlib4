...
`𝕜` (i.e we have `[AddCommGroupCat E] [ModuleCat 𝕜 E] [TopologicalSpace E] [TopologicalAddGroup E]`
...
@[simp]
theorem coe_to_continuous_linear_map' (f : E →ₗ[𝕜] F') : ⇑(LinearMap.toContinuousLinearMap f) = f :=
  rfl
