...
variable {𝕜 : Type u} [hnorm : NormMetric 𝕜] [Field 𝕜] [IsNontriviallyNormedField 𝕜] {E : Type v} [AddCommGroup E] [Module 𝕜 E]
...
theorem unique_topology_of_t2 {t : TopologicalSpace 𝕜} (h₁ : @IsTopologicalAddGroup 𝕜 t _)
  ...
  · -- To show `𝓣 ≤ 𝓣₀`, we have to show that closed balls are `𝓣`-neighborhoods of 0.
    ...
    intro ε hε
    rcases IsNormedField.exists_norm_lt 𝕜 hε with ⟨ξ₀, hξ₀, hξ₀ε⟩
...
space. -/
def _root_.Module.End.toContinuousLinearMap (E : Type v) [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E]
