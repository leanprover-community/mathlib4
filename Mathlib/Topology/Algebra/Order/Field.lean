...
ring. -/
theorem TopologicalRing.of_norm {R 𝕜 : Type*} [NonUnitalNonAssocRing R]
...
instance (priority := 100) IsStrictOrderedRing.topologicalRing : TopologicalRing 𝕜 :=
...
instance (priority := 100) IsStrictOrderedRing.toTopologicalDivisionRing :
