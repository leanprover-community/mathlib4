...
theorem Rat.denseRange_cast {𝕜}
    [Field 𝕜] [LinearOrderedField 𝕜] [TopologicalSpace 𝕜] [OrderTopology 𝕜] [Archimedean 𝕜] :
    DenseRange ((↑) : ℚ → 𝕜) :=
...
variable {G : Type*} [AddCommGroup G] [LinearOrderedAddCommGroup G]
