...
lemma cocompact_le_atBot_atTop [CompactIccSpace α] :
...
lemma cocompact_le_atBot [OrderTop α] [CompactIccSpace α] :
...
lemma cocompact_le_atTop [OrderBot α] [CompactIccSpace α] :
    cocompact α ≤ atTop :=
  cocompact_le_atBot (α := αᵒᵈ)

lemma atBot_le_cocompact [NoMinOrder α] [ClosedIicTopology α] :
...
lemma atTop_le_cocompact [NoMaxOrder α] [ClosedIciTopology α] :
    atTop ≤ cocompact α :=
  atBot_le_cocompact (α := αᵒᵈ)

lemma atBot_atTop_le_cocompact [NoMinOrder α] [NoMaxOrder α]
    [OrderClosedTopology α] : atBot ⊔ atTop ≤ cocompact α :=
  sup_le atBot_le_cocompact atTop_le_cocompact

@[simp 900]
lemma cocompact_eq_atBot_atTop [NoMaxOrder α] [NoMinOrder α]
