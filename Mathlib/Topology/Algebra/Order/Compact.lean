...
theorem IsCompact.exists_isLeast [LowerClosedTopology α] {s : Set α} (hs : IsCompact s)
...
theorem IsCompact.exists_isGreatest [UpperClosedTopology α] {s : Set α} (hs : IsCompact s)
...
theorem IsCompact.exists_isGLB [LowerClosedTopology α] {s : Set α} (hs : IsCompact s)
...
theorem IsCompact.exists_isLUB [UpperClosedTopology α] {s : Set α} (hs : IsCompact s)
...
theorem IsCompact.exists_isMinOn [LowerClosedTopology α] {s : Set β} (hs : IsCompact s)
...
theorem IsCompact.exists_forall_le [LowerClosedTopology α] {s : Set β} (hs : IsCompact s)
...
theorem IsCompact.exists_isMaxOn [UpperClosedTopology α] {s : Set β} (hs : IsCompact s)
...
theorem IsCompact.exists_forall_ge [UpperClosedTopology α] {s : Set β} (hs : IsCompact s)
...
theorem ContinuousOn.exists_isMinOn' [LowerClosedTopology α] {s : Set β} {f : β → α}
...
theorem ContinuousOn.exists_forall_le' [LowerClosedTopology α] {s : Set β} {f : β → α}
    (hf : ContinuousOn f s) (hsc : IsClosed s) {x₀ : β} (h₀ : x₀ ∈ s)
...
theorem ContinuousOn.exists_isMaxOn' [UpperClosedTopology α] {s : Set β} {f : β → α}
    (hf : ContinuousOn f s) (hsc : IsClosed s) {x₀ : β} (h₀ : x₀ ∈ s)
...
theorem ContinuousOn.exists_forall_ge' [UpperClosedTopology α] {s : Set β} {f : β → α}
    (hf : ContinuousOn f s) (hsc : IsClosed s) {x₀ : β} (h₀ : x₀ ∈ s)
...
theorem Continuous.exists_forall_le' [LowerClosedTopology α] {f : β → α} (hf : Continuous f)
...
theorem Continuous.exists_forall_ge' [UpperClosedTopology α] {f : β → α} (hf : Continuous f)
...
theorem Continuous.exists_forall_le [LowerClosedTopology α] [Nonempty β] {f : β → α}
...
theorem Continuous.exists_forall_ge [UpperClosedTopology α] [Nonempty β] {f : β → α}
...
theorem Continuous.exists_forall_le_of_hasCompactMulSupport [LowerClosedTopology α] [Nonempty β]
...
theorem Continuous.exists_forall_ge_of_hasCompactMulSupport [UpperClosedTopology α] [Nonempty β]
    [One α] {f : β → α} (hf : Continuous f) (h : HasCompactMulSupport f) :
    ∃ x : β, ∀ y : β, f y ≤ f x :=
...
theorem IsCompact.bddBelow [LowerClosedTopology α] [Nonempty α] {s : Set α} (hs : IsCompact s) :
    BddBelow s := by
...
theorem IsCompact.bddAbove [UpperClosedTopology α] [Nonempty α] {s : Set α} (hs : IsCompact s) :
    BddAbove s :=
  IsCompact.bddBelow (α := αᵒᵈ) hs
#align is_compact.bdd_above IsCompact.bddAbove

/-- A continuous function is bounded below on a compact set. -/
theorem IsCompact.bddBelow_image [LowerClosedTopology α] [Nonempty α] {f : β → α} {K : Set β}
...
theorem IsCompact.bddAbove_image [UpperClosedTopology α] [Nonempty α] {f : β → α} {K : Set β}
...
theorem Continuous.bddBelow_range_of_hasCompactMulSupport [LowerClosedTopology α] [One α]
...
theorem Continuous.bddAbove_range_of_hasCompactMulSupport [UpperClosedTopology α] [One α]
...
theorem IsCompact.sSup_lt_iff_of_continuous [UpperClosedTopology α] {f : β → α} {K : Set β}
...
theorem IsCompact.lt_sInf_iff_of_continuous [LowerClosedTopology α] {f : β → α} {K : Set β}
    (hK : IsCompact K) (h0K : K.Nonempty) (hf : ContinuousOn f K) (y : α) :
...
theorem IsCompact.isGreatest_sSup [UpperClosedTopology α] {s : Set α} (hs : IsCompact s)
...
theorem IsCompact.exists_sInf_image_eq_and_le [LowerClosedTopology α] {s : Set β}
...
theorem IsCompact.exists_sSup_image_eq_and_ge [UpperClosedTopology α] {s : Set β}
    (hs : IsCompact s) (ne_s : s.Nonempty) {f : β → α} (hf : ContinuousOn f s) :
...
theorem IsCompact.exists_sInf_image_eq [LowerClosedTopology α] {s : Set β} (hs : IsCompact s)
...
theorem IsCompact.exists_sSup_image_eq [UpperClosedTopology α] {s : Set β} (hs : IsCompact s)
...
theorem IsCompact.exists_isMinOn_mem_subset [LowerClosedTopology α] {f : β → α} {s t : Set β}
...
theorem IsCompact.exists_isLocalMinOn_mem_subset [LowerClosedTopology α] {f : β → α} {s t : Set β}
    {z : β} (ht : IsCompact t) (hf : ContinuousOn f t) (hz : z ∈ t)
...
-- `IsOpen s`?
theorem IsCompact.exists_isLocalMin_mem_open [LowerClosedTopology α] {f : β → α} {s t : Set β}
