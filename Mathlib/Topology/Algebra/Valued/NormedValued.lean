...
variable {K : Type*} [Field K] [hK : WithNormMulClassNormedRing K] [IsUltrametricDist K]
...
def toNormedField : WithNormMulClassNormedRing L where
  norm := norm
...
-/
def toNontriviallyNormedField : WithNontrivialNormMulClassNormedRing L := {
