...
In this file we set up the theory of non-Archimedean topological groups and rings.

A non-Archimedean group is a topological group whose topology admits a basis of
open neighborhoods of the identity element in the group consisting of open subgroups.
A non-Archimedean ring is a topological ring whose underlying topological (additive)
group is non-Archimedean.

## Definitions

- `NonarchimedeanAddGroup`: non-Archimedean additive group.
- `NonarchimedeanGroup`: non-Archimedean multiplicative group.
- `NonarchimedeanRing`: non-Archimedean ring.
...
/-- A topological additive group is non-Archimedean if every neighborhood of 0
...
/-- A topological ring is non-Archimedean if its underlying topological additive
  group is non-Archimedean. -/
...
/-- Every non-Archimedean ring is naturally a non-Archimedean additive group. -/
...
/-- If a topological group embeds into a non-Archimedean group, then it is non-Archimedean. -/
@[to_additive]
...
/-- An open neighborhood of the identity in the Cartesian product of two non-Archimedean groups
...
the Cartesian product of two non-Archimedean groups contains the Cartesian product of
...
/-- An open neighborhood of the identity in the Cartesian square of a non-Archimedean group
...
the Cartesian square of a non-Archimedean group contains the Cartesian square of
...
/-- The Cartesian product of two non-Archimedean groups is non-Archimedean. -/
@[to_additive /-- The Cartesian product of two non-Archimedean groups is non-Archimedean. -/]
...
/-- The Cartesian product of two non-Archimedean rings is non-Archimedean. -/
instance : NonarchimedeanRing (R × S) where
  is_nonarchimedean := NonarchimedeanAddGroup.is_nonarchimedean

/-- Given an open subgroup `U` and an element `r` of a non-Archimedean ring, there is an open
...
/-- An open subgroup of a non-Archimedean ring contains the square of another one. -/
