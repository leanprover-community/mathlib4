...
@[to_additive] instance instR0Space [R0Space M] : R0Space Mᵈᵐᵃ := mkHomeomorph.r0Space
@[to_additive] instance instR1Space [R1Space M] : R1Space Mᵈᵐᵃ := mkHomeomorph.r1Space

@[to_additive]
instance instRegularSpace [RegularSpace M] : RegularSpace Mᵈᵐᵃ := mkHomeomorph.regularSpace
