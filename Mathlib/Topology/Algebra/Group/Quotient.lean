...
@[to_additive (attr := deprecated "Deprecated without replacement." (since := "2024-10-05"))]
...
@[to_additive (attr := deprecated "Deprecated without replacement." (since := "2024-08-05"))]
