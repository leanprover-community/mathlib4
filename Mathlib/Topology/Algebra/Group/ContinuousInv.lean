...
attribute [to_additive (attr := simp)]
  continuous_inv_iff continuous_fun_inv_iff
  continuousAt_inv_iff continuousAt_fun_inv_iff
  continuousOn_inv_iff continuousOn_fun_inv_iff
