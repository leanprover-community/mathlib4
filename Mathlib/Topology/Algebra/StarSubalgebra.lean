...
instance [TopologicalSemiring A] (s : StarSubalgebra R A) : TopologicalSemiring s := fast_instance%
...
instance [T2Space A] {x : A} [IsStarNormal x] : CommSemiring (elementalStarAlgebra R x) := fast_instance%
