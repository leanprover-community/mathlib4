...
variable [TopologicalSpace A] [Semiring A] [SMul R A] [Algebra R A] [StarRing A] [StarModule R A]
...
variable [TopologicalSpace B] [Semiring B] [SMul R B] [Algebra R B] [StarRing B]
...
instance {A : Type*} [UniformSpace A] [CompleteSpace A] [Semiring A] [StarRing A]
    [TopologicalSemiring A] [ContinuousStar A] [SMul R A] [Algebra R A] [StarModule R A]
...
abbrev commRingTopologicalClosure {R A} [CommRing R] [StarRing R] [TopologicalSpace A] [Ring A]
    [SMul R A] [Algebra R A] [StarRing A] [StarModule R A] [TopologicalRing A] [ContinuousStar A] [T2Space A]
...
variable [ContinuousStar A] [SMul R A] [Algebra R A] [StarModule R A]
variable [TopologicalSpace B] [Semiring B] [StarRing B] [SMul R B] [Algebra R B]
...
/-- The `elementalStarAlgebra` generated by a normal element is commutative. -/
instance {R A} [CommRing R] [StarRing R] [TopologicalSpace A] [Ring A] [SMul R A] [Algebra R A] [StarRing A]
...
instance {A : Type*} [UniformSpace A] [CompleteSpace A] [Semiring A] [StarRing A]
    [TopologicalSemiring A] [ContinuousStar A] [SMul R A] [Algebra R A] [StarModule R A] (x : A) :
