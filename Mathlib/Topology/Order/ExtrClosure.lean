...
protected lemma IsMaxOn.closure (h : IsMaxOn f s a) (hc : ContinuousOn f (closure s)) :
...
protected lemma IsMinOn.closure (h : IsMinOn f s a) (hc : ContinuousOn f (closure s)) :
    IsMinOn f (closure s) a :=
  h.dual.closure hc
#align is_min_on.closure IsMinOn.closure

protected lemma IsExtrOn.closure (h : IsExtrOn f s a) (hc : ContinuousOn f (closure s)) :
...
protected lemma IsLocalMaxOn.closure (h : IsLocalMaxOn f s a) (hc : ContinuousOn f (closure s)) :
...
protected lemma IsLocalMinOn.closure (h : IsLocalMinOn f s a) (hc : ContinuousOn f (closure s)) :
    IsLocalMinOn f (closure s) a :=
  IsLocalMaxOn.closure h.dual hc
#align is_local_min_on.closure IsLocalMinOn.closure

protected lemma IsLocalExtrOn.closure (h : IsLocalExtrOn f s a)
