...
/-
lemma isOpen_iff_Lower_and_Scott_Open  (u : Set α) : IsOpen (WithLawsonTopology.toLawson u ) ↔
  IsOpen (WithLowerTopology.toLower u) ∧  IsOpen (WithScottTopology.toScott u) := sorry
-/
