...
instance [Preorder α] : UpperTopology (Topology.WithUpper α) :=
  ⟨rfl⟩
...
instance instUpperTopologyDual [Preorder α] [TopologicalSpace α] [Topology.IsLower α] :
...
instance instTopology.IsLowerDual [Preorder α] [TopologicalSpace α] [UpperTopology α] :
...
lemma upper_dual_iff_lower [Preorder α] [TopologicalSpace α] :
    UpperTopology αᵒᵈ ↔ Topology.IsLower α := by
  constructor
  · apply UpperTopology.instTopology.IsLowerDual
  · apply Topology.IsLower.instUpperTopologyDual

lemma lower_dual_iff_upper [Preorder α] [TopologicalSpace α] :
    Topology.IsLower αᵒᵈ ↔ UpperTopology α := by
  constructor
  · apply Topology.IsLower.instUpperTopologyDual
  · apply UpperTopology.instTopology.IsLowerDual
