...
@[deprecated (since := "2024-10-10")] alias to_WithLower_symm_eq := toLower_symm

@[simp] lemma ofLower_symm : (@ofLower α).symm = toLower := rfl
@[deprecated (since := "2024-10-10")] alias of_WithLower_symm_eq := ofLower_symm
...
@[deprecated (since := "2024-10-10")] alias to_WithUpper_symm_eq := toUpper_symm
@[simp] lemma ofUpper_symm : (@ofUpper α).symm = toUpper := rfl
@[deprecated (since := "2024-10-10")] alias of_WithUpper_symm_eq := ofUpper_symm
