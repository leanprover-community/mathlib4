...
It is shown that `Topology.WithLower α` is an instance of `LowerTopology`.
...
instance [Preorder α] : LowerTopology (Topology.WithLower α) :=
  ⟨rfl⟩
...
#align lower_topology.with_lower_topology_homeomorph LowerTopology.Topology.WithLowerHomeomorph
