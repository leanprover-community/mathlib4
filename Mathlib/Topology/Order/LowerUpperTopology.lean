...
class IsLower (α : Type*) [t : TopologicalSpace α] [Preorder α] : Prop where
  topology_eq_lowerTopology (α) : t = lower α
...
class IsUpper (α : Type*) [t : TopologicalSpace α] [Preorder α] : Prop where
  topology_eq_upperTopology (α) : t = upper α
...
lemma topology_eq : ‹_› = lower α := topology_eq_lowerTopology α
...
instance _root_.OrderDual.instIsUpper [Preorder α] [TopologicalSpace α] [IsLower α] :
    IsUpper αᵒᵈ where
  topology_eq_upperTopology := topology_eq_lowerTopology α
...
lemma topology_eq : ‹_› = upper α := topology_eq_upperTopology α
...
instance _root_.OrderDual.instIsLower [Preorder α] [TopologicalSpace α] [IsUpper α] :
    IsLower αᵒᵈ where
  topology_eq_lowerTopology := topology_eq_upperTopology α
...
instance instIsUpperProd [Preorder α] [TopologicalSpace α] [IsUpper α]
  ...
  topology_eq_upperTopology := by
    suffices IsLower (α × β)ᵒᵈ from IsLower.topology_eq_lowerTopology (α × β)ᵒᵈ
