...
variable [TopologicalSpace α] [AddCommGroup α] [LinearOrderedAddCommGroup α] [OrderTopology α]
...
theorem orderTopology_of_nhds_abs {α : Type*}
    [TopologicalSpace α] [AddCommGroup α] [LinearOrderedAddCommGroup α]
