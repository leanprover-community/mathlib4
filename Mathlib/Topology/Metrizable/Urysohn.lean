...
instance PseudoMetrizableSpace.of_regularSpace_secondCountableTopology : PseudoMetrizableSpace X :=
...
same topology. -/
instance metrizableSpace_of_t3_second_countable : MetrizableSpace X :=
