...
(`t` is finer than `s`). -/
instance (priority := 10000) : PartialOrder (TopologicalSpace α) :=
...
instance (priority := 10000) : CompleteLattice (TopologicalSpace α) := (gciGenerateFrom α).liftCompleteLattice
...
instance (priority := 10000) inhabitedTopologicalSpace {α : Type u} : Inhabited (TopologicalSpace α) :=
  ⟨⊥⟩
...
instance (priority := 10000) : TopologicalSpace Empty := ⊥
instance (priority := 10000) : DiscreteTopology Empty := ⟨rfl⟩

instance (priority := 10000) : TopologicalSpace PEmpty := ⊥
instance (priority := 10000) : DiscreteTopology PEmpty := ⟨rfl⟩

instance (priority := 10000) : TopologicalSpace PUnit := ⊥
instance (priority := 10000) : DiscreteTopology PUnit := ⟨rfl⟩

instance (priority := 10000) : TopologicalSpace Bool := ⊥
instance (priority := 10000) : DiscreteTopology Bool := ⟨rfl⟩

instance (priority := 10000) : TopologicalSpace ℕ := ⊥
instance (priority := 10000) : DiscreteTopology ℕ := ⟨rfl⟩

instance (priority := 10000) : TopologicalSpace ℤ := ⊥
instance (priority := 10000) : DiscreteTopology ℤ := ⟨rfl⟩

instance (priority := 10000) {n} : TopologicalSpace (Fin n) := ⊥
instance (priority := 10000) {n} : DiscreteTopology (Fin n) := ⟨rfl⟩

instance (priority := 10000) sierpinskiSpace : TopologicalSpace Prop :=
  generateFrom {{True}}
