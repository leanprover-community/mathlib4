...
instance (priority := 10000) NoetherianSpace.set [NoetherianSpace α] (s : Set α) : NoetherianSpace s :=
...
instance (priority := 10000) {α} : NoetherianSpace (CofiniteTopology α) := by
