...
instance : TopologicalSpace (Filter α) := fast_instance%
...
instance {l : Filter α} [IsCountablyGenerated l] : IsCountablyGenerated (𝓝 l) := fast_instance%
...
instance : T0Space (Filter α) := fast_instance%
