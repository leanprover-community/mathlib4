...
instance (priority := 10000) : TopologicalSpace (Filter α) :=
...
instance (priority := 10000) {l : Filter α} [IsCountablyGenerated l] : IsCountablyGenerated (𝓝 l) :=
...
instance (priority := 10000) : T0Space (Filter α) :=
