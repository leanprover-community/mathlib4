...
epi. The theorem `TopCat.effectiveEpi_iff_quotientMap` should be used instead.
-/
noncomputable
def struct {B X : TopCat.{u}} (π : X ⟶ B) (hπ : QuotientMap π) :
...
/-- The effective epimorphisms in `TopCat` are precisely the quotient maps. -/
theorem effectiveEpi_iff_quotientMap
    {B X : TopCat.{u}} (π : X ⟶ B) :
