...
/-- If the space is (pseudo)metrizable, then any sequentially compact set is compact. -/
...
/-- A version of Bolzano-Weierstrass: in a (pseudo)metrizable space, a set is compact if and only if
