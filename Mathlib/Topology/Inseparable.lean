...
theorem isQuotientMap_mk : IsQuotientMap (mkQ : X → SeparationQuotient X) :=
...
theorem isOpenQuotientMap_mk : IsOpenQuotientMap (mkQ : X → SeparationQuotient X) :=
...
theorem isInducing_mk : IsInducing (mkQ : X → SeparationQuotient X) :=
...
theorem isQuotientMap_prodMap_mk : IsQuotientMap (Prod.map mkQ' mkQ' : X × Y → _) :=
