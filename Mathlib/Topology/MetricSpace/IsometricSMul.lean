...
@[to_additive]
lemma isometry_smul {M : Type u} (X : Type w) [PseudoEMetricSpace X] [SMul M X]
...
lemma edist_smul_left [SMul M X] [IsometricSMul M X] (c : M) (x y : X) :
...
@[to_additive (attr := simp)]
lemma ediam_smul [SMul M X] [IsometricSMul M X] (c : M) (s : Set X) :
...
@[to_additive]
lemma isometry_mul_left [Mul M] [PseudoEMetricSpace M] [IsometricSMul M M] (a : M) :
    Isometry ((· * ·) a) :=
  isometry_smul M a
...
@[to_additive (attr := simp)]
lemma edist_mul_left [Mul M] [PseudoEMetricSpace M] [IsometricSMul M M] (a b c : M) :
...
@[to_additive]
lemma isometry_mul_right [Mul M] [PseudoEMetricSpace M] [IsometricSMul Mᵐᵒᵖ M] (a : M) :
    Isometry fun x => x * a :=
...
@[to_additive (attr := simp)]
lemma edist_mul_right [Mul M] [PseudoEMetricSpace M] [IsometricSMul Mᵐᵒᵖ M] (a b c : M) :
...
@[to_additive (attr := simp)]
lemma edist_div_right [DivInvMonoid M] [PseudoEMetricSpace M] [IsometricSMul Mᵐᵒᵖ M]
...
@[to_additive (attr := simp)]
lemma edist_inv_inv [PseudoEMetricSpace G] [IsometricSMul G G] [IsometricSMul Gᵐᵒᵖ G]
...
@[to_additive]
lemma isometry_inv [PseudoEMetricSpace G] [IsometricSMul G G] [IsometricSMul Gᵐᵒᵖ G] :
...
@[to_additive]
lemma edist_inv [PseudoEMetricSpace G] [IsometricSMul G G] [IsometricSMul Gᵐᵒᵖ G]
    (x y : G) : edist x⁻¹ y = edist x y⁻¹ := by rw [← edist_inv_inv, inv_inv]
#align edist_inv edist_inv
#align edist_neg edist_neg

@[to_additive (attr := simp)]
lemma edist_div_left [PseudoEMetricSpace G] [IsometricSMul G G] [IsometricSMul Gᵐᵒᵖ G]
...
@[to_additive (attr := simp)]
lemma mulLeft_symm [IsometricSMul G G] (x : G) :
...
@[to_additive (attr := simp)]
lemma mulRight_symm [IsometricSMul Gᵐᵒᵖ G] (x : G) : (mulRight x).symm = mulRight x⁻¹ :=
  ext fun _ => rfl
...
@[to_additive (attr := simp)]
lemma divRight_symm [IsometricSMul Gᵐᵒᵖ G] (c : G) : (divRight c).symm = mulRight c :=
  ext fun _ => rfl
...
@[to_additive (attr := simp)] lemma inv_symm : (inv G).symm = inv G := rfl
...
@[to_additive (attr := simp)]
lemma preimage_mul_left_ball [IsometricSMul G G] (a b : G) (r : ℝ≥0∞) :
...
@[to_additive (attr := simp)]
lemma preimage_mul_right_ball [IsometricSMul Gᵐᵒᵖ G] (a b : G) (r : ℝ≥0∞) :
...
@[to_additive (attr := simp)]
lemma preimage_mul_left_closedBall [IsometricSMul G G] (a b : G) (r : ℝ≥0∞) :
...
@[to_additive (attr := simp)]
lemma preimage_mul_right_closedBall [IsometricSMul Gᵐᵒᵖ G] (a b : G) (r : ℝ≥0∞) :
...
@[to_additive (attr := simp)]
lemma dist_smul [PseudoMetricSpace X] [SMul M X] [IsometricSMul M X] (c : M) (x y : X) :
...
@[to_additive (attr := simp)]
lemma nndist_smul [PseudoMetricSpace X] [SMul M X] [IsometricSMul M X] (c : M) (x y : X) :
...
@[to_additive (attr := simp)]
lemma diam_smul [PseudoMetricSpace X] [SMul M X] [IsometricSMul M X] (c : M) (s : Set X) :
...
@[to_additive (attr := simp)]
lemma dist_mul_left [PseudoMetricSpace M] [Mul M] [IsometricSMul M M] (a b c : M) :
...
@[to_additive (attr := simp)]
lemma nndist_mul_left [PseudoMetricSpace M] [Mul M] [IsometricSMul M M] (a b c : M) :
...
@[to_additive (attr := simp)]
lemma dist_mul_right [Mul M] [PseudoMetricSpace M] [IsometricSMul Mᵐᵒᵖ M] (a b c : M) :
...
@[to_additive (attr := simp)]
lemma nndist_mul_right [PseudoMetricSpace M] [Mul M] [IsometricSMul Mᵐᵒᵖ M] (a b c : M) :
...
@[to_additive (attr := simp)]
lemma dist_div_right [DivInvMonoid M] [PseudoMetricSpace M] [IsometricSMul Mᵐᵒᵖ M]
...
@[to_additive (attr := simp)]
lemma nndist_div_right [DivInvMonoid M] [PseudoMetricSpace M] [IsometricSMul Mᵐᵒᵖ M]
...
@[to_additive (attr := simp)]
lemma dist_inv_inv [Group G] [PseudoMetricSpace G] [IsometricSMul G G]
...
@[to_additive (attr := simp)]
lemma nndist_inv_inv [Group G] [PseudoMetricSpace G] [IsometricSMul G G]
...
@[to_additive (attr := simp)]
lemma dist_div_left [Group G] [PseudoMetricSpace G] [IsometricSMul G G]
...
@[to_additive (attr := simp)]
lemma nndist_div_left [Group G] [PseudoMetricSpace G] [IsometricSMul G G]
...
lemma Bounded.smul [PseudoMetricSpace X] [SMul G X] [IsometricSMul G X] {s : Set X}
...
@[to_additive (attr := simp)]
lemma preimage_mul_left_ball [IsometricSMul G G] (a b : G) (r : ℝ) :
    (· * ·) a ⁻¹' ball b r = ball (a⁻¹ * b) r :=
  preimage_smul_ball a b r
...
@[to_additive (attr := simp)]
lemma preimage_mul_right_ball [IsometricSMul Gᵐᵒᵖ G] (a b : G) (r : ℝ) :
    (fun x => x * a) ⁻¹' ball b r = ball (b / a) r := by
  rw [div_eq_mul_inv]
  exact preimage_smul_ball (MulOpposite.op a) b r
...
@[to_additive (attr := simp)]
lemma preimage_mul_left_closedBall [IsometricSMul G G] (a b : G) (r : ℝ) :
    (· * ·) a ⁻¹' closedBall b r = closedBall (a⁻¹ * b) r :=
  preimage_smul_closedBall a b r
...
@[to_additive (attr := simp)]
lemma preimage_mul_right_closedBall [IsometricSMul Gᵐᵒᵖ G] (a b : G) (r : ℝ) :
    (fun x => x * a) ⁻¹' closedBall b r = closedBall (b / a) r := by
  rw [div_eq_mul_inv]
  exact preimage_smul_closedBall (MulOpposite.op a) b r
