...
/-!
# Pseudo metric space instances

Instance for `ℝ≥0`, and derived instances for `UList`, product, and pi types.

Also basic consequences, such as the distance function itself being continuous, and hence
closed balls and spheres being closed.
-/

open Set Filter TopologicalSpace Bornology Metric
