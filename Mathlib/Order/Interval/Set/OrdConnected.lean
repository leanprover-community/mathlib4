...
lemma image_Icc (e : α ↪o β) (he : OrdConnected (range e)) (x y : α) :
    e '' Icc x y = Icc (e x) (e y) := by
  rw [← e.preimage_Icc, image_preimage_eq_inter_range, inter_eq_left.2 (he.out ⟨_, rfl⟩ ⟨_, rfl⟩)]

lemma image_Ico (e : α ↪o β) (he : OrdConnected (range e)) (x y : α) :
...
lemma image_Ioc (e : α ↪o β) (he : OrdConnected (range e)) (x y : α) :
...
lemma image_Ioo (e : α ↪o β) (he : OrdConnected (range e)) (x y : α) :
...
lemma ordConnected_biInter {ι : Sort*} {p : ι → Prop} {s : ∀ i, p i → Set α}
...
@[instance]
lemma ordConnected_preimage {F : Type*} [FunLike F α β] [OrderHomClass F α β] (f : F)
...
@[instance]
lemma ordConnected_image {E : Type*} [EquivLike E α β] [OrderIsoClass E α β] (e : E) {s : Set α}
...
@[instance]
lemma ordConnected_range {E : Type*} [EquivLike E α β] [OrderIsoClass E α β] (e : E) :
