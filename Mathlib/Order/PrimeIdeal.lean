...
- `Order.Ideal.PrimePair`: A pair of an `Mathlib/Order/Ideal.lean` and an `Mathlib/Order/PFilter.lean` which form a partition
...
/-- A pair of an `Mathlib/Order/Ideal.lean` and an `Mathlib/Order/PFilter.lean` which form a partition of `P`.
-/
