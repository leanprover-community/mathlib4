...
instance [i : Decidable (∀ a b, a ≤ b → f a ≤ f b)] : Decidable (Monotone f) := fast_instance% i
instance [i : Decidable (∀ a b, a ≤ b → f b ≤ f a)] : Decidable (Antitone f) := fast_instance% i
...
instance [i : Decidable (∀ a b, a < b → f a < f b)] : Decidable (StrictMono f) := fast_instance% i
instance [i : Decidable (∀ a b, a < b → f b < f a)] : Decidable (StrictAnti f) := fast_instance% i
