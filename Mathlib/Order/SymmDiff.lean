...
instance (priority := 10000) symmDiff_isCommutative : Std.Commutative (α := α) (· ∆ ·) :=
  ⟨symmDiff_comm⟩
...
instance (priority := 10000) bihimp_isCommutative : Std.Commutative (α := α) (· ⇔ ·) :=
  ⟨bihimp_comm⟩
...
instance (priority := 10000) symmDiff_isAssociative : Std.Associative (α := α)  (· ∆ ·) :=
  ⟨symmDiff_assoc⟩
...
instance (priority := 10000) bihimp_isAssociative : Std.Associative (α := α) (· ⇔ ·) :=
  ⟨bihimp_assoc⟩
