...
instance symmDiff_isCommutative : Std.Commutative (α := fast_instance% α) (· ∆ ·) :=
  ⟨symmDiff_comm⟩
...
instance bihimp_isCommutative : Std.Commutative (α := fast_instance% α) (· ⇔ ·) :=
  ⟨bihimp_comm⟩
...
instance symmDiff_isAssociative : Std.Associative (α := fast_instance% α)  (· ∆ ·) :=
  ⟨symmDiff_assoc⟩
...
instance bihimp_isAssociative : Std.Associative (α := fast_instance% α) (· ⇔ ·) :=
  ⟨bihimp_assoc⟩
