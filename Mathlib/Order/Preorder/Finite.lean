...
This file shows that nonempty finite sets in a preorder have minimal/maximal elements, and
contrapositively that nonempty sets without minimal or maximal elements are infinite.
-/
