...
This file sets up the complement equivalence between filters and order filters on a type.

## Main definitions

* `Filter.toPFilter`
* `Order.PFilter.toFilter`
* `Filter.orderIsoPFilter`
...
def Filter.orderIsoPFilter : Filter α ≃o (PFilter (Set α))ᵒᵈ :=
  OrderIso.ofHomInv
