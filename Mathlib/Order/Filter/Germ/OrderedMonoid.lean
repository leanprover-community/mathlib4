...
@[to_additive]
instance instIsOrderedMonoid [CommSemigroup β] [Preorder β] [IsOrderedMonoid β] :
...
@[to_additive]
instance instIsOrderedCancelMonoid [CommSemigroup β] [Preorder β] [IsOrderedCancelMonoid β] :
