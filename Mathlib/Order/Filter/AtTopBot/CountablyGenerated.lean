...
lemma atTop_countable_basis [Preorder α] [IsPredirectedOrder α] [Nonempty α] [Countable α] :
    HasCountableBasis (atTop : Filter α) (fun _ => True) Ici :=
  { atTop_basis with countable := to_countable _ }

lemma atBot_countable_basis [Preorder α] [IsPrecodirectedOrder α] [Nonempty α] [Countable α] :
...
theorem exists_seq_monotone_tendsto_atTop_atTop (α : Type*) [Preorder α] [Nonempty α]
    [IsPredirectedOrder α] [(atTop : Filter α).IsCountablyGenerated] :
...
theorem exists_seq_antitone_tendsto_atTop_atBot (α : Type*) [Preorder α] [Nonempty α]
    [IsPrecodirectedOrder α] [(atBot : Filter α).IsCountablyGenerated] :
