...
variable [AddCommMonoid β] [OrderedAddCommMonoid β] {f g : α → β} {a : α} {s : Set α} {l : Filter α}
...
variable [AddCommGroup β] [OrderedAddCommGroup β] {f g : α → β} {a : α} {s : Set α} {l : Filter α}
