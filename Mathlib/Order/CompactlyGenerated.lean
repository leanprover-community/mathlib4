...
theorem isCompactElement_finset_sup {α β : Type*} [CompleteLattice α] {f : β → α} (s : Finset β)
...
#align complete_lattice.finset_sup_compact_of_compact CompleteLattice.isCompactElement_finset_sup
