...
@[simp]
lemma coe_forget_to_partOrd (X : SemilatSupCat) :
...
@[simp]
lemma coe_forget_to_partOrd (X : SemilatInfCat) :
...
lemma SemilatSupCat_dual_comp_forget_to_partOrd :
...
lemma SemilatInfCat_dual_comp_forget_to_partOrd :
