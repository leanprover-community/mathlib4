...
@[deprecated (since := "2025-02-14")] alias atom_le_iSup := IsAtom.le_iSup
...
@[deprecated (since := "2025-02-14")] alias iInf_le_coatom := IsCoatom.iInf_le
...
@[deprecated disjoint_of_ne (since := "2025-02-14")]
