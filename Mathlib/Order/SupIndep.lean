...
@[simp]
lemma independent_ne_bot_iff_independent :
...
lemma Independent.injOn (ht : Independent t) : InjOn t {i | t i ≠ ⊥} := by
...
lemma CompleteLattice.Independent.supIndep' [CompleteLattice α] {f : ι → α} (s : Finset ι)
