...
@[to_additive]
theorem le_mul_ciInf [CovariantClass α α HMul.hMul LE.le] {a : α} {g : α} {h : ι → α}
...
@[to_additive]
theorem mul_ciSup_le [CovariantClass α α HMul.hMul LE.le] {a : α} {g : α} {h : ι → α}
...
@[to_additive]
theorem le_ciInf_mul [CovariantClass α α (Function.swap HMul.hMul) LE.le] {a : α} {g : ι → α}
...
@[to_additive]
theorem ciSup_mul_le [CovariantClass α α (Function.swap HMul.hMul) LE.le] {a : α} {g : ι → α}
...
@[to_additive]
theorem le_ciInf_mul_ciInf [CovariantClass α α HMul.hMul LE.le]
    [CovariantClass α α (Function.swap HMul.hMul) LE.le] {a : α} {g : ι → α} {h : ι' → α}
...
@[to_additive]
theorem ciSup_mul_ciSup_le [CovariantClass α α HMul.hMul LE.le]
    [CovariantClass α α (Function.swap HMul.hMul) LE.le] {a : α} {g : ι → α} {h : ι' → α}
