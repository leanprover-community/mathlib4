...
theorem inter_nonempty [IsDirectedGE P] (I J : Ideal P) : (I ∩ J : Set P).Nonempty := by
...
variable [IsDirectedLE P] [Nonempty P] {I : Ideal P}
...
variable [SemilatticeSup P] [IsDirectedGE P] {x : P} {I J s t : Ideal P}
