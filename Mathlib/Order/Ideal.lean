...
- `Mathlib/Order/Ideal.lean P`: the type of nonempty, upward directed, and downward closed subsets of `P`.
...
- `Mathlib/Order/Cofinal.lean P`: the type of subsets of `P` containing arbitrarily large elements.
