...
theorem BddAbove.union [IsDirectedLE α] {s t : Set α} :
...
theorem bddAbove_union [IsDirectedLE α] {s t : Set α} :
...
theorem BddBelow.union [IsDirectedGE α] {s t : Set α} :
...
theorem bddBelow_union [IsDirectedGE α] {s t : Set α} :
