...
theorem withTopCongr_apply_some (e : α ≃o β) (a : α) :
    withTopCongr e (WithTop.some a) = WithTop.some (e a) := rfl
...
theorem withBotCongr_apply_some (e : α ≃o β) (a : α) :
    withBotCongr e (WithBot.some a) = WithBot.some (e a) := rfl
