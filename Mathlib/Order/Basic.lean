...
theorem Preorder.dual_dual (α : Type*) [H : Preorder α] : OrderDual.preorder αᵒᵈ = H :=
  Preorder.ext fun _ _ ↦ Iff.rfl
#align order_dual.preorder.dual_dual OrderDual.Preorder.dual_dual

theorem partialOrder.dual_dual (α : Type*) [H : PartialOrder α] : OrderDual.partialOrder αᵒᵈ = H :=
  PartialOrder.ext fun _ _ ↦ Iff.rfl
#align order_dual.partial_order.dual_dual OrderDual.partialOrder.dual_dual

theorem linearOrder.dual_dual (α : Type*) [H : LinearOrder α] : OrderDual.linearOrder αᵒᵈ = H :=
