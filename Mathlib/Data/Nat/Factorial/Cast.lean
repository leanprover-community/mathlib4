...
lemma cast_ascFactorial : (a.ascFactorial b : S) = (pochhammer S b).eval (a + 1 : S) := by
...
lemma cast_descFactorial : (a.descFactorial b : S) = (pochhammer S b).eval (a - (b - 1) : S) := by
...
lemma cast_factorial : (a ! : S) = (pochhammer S a).eval 1 := by
