...
instance (priority := 10000) Primes.infinite : Infinite Primes := infinite_setOf_prime.to_subtype

instance (priority := 10000) Primes.countable : Countable Primes := ⟨⟨coeNat.coe, coe_nat_injective⟩⟩
