...
theorem commute_add_cast [NonAssocSemiring α] (r s : α) (n : ℕ) (h: Commute r s) :
  Commute r (s + n) := h.add_right (commute_cast r n)

theorem add_cast_commute [NonAssocSemiring α] (r s : α) (n : ℕ) (h : Commute r s) :
  Commute (r + n) s := h.add_left (cast_commute n s)

theorem add_cast_commute_add_cast [NonAssocSemiring α] (r s : α) (k n : ℕ) (h : Commute r s):
  Commute (r + k) (s + n) :=
