...
lemma exp_one_near_10 : |exp 1 - 2244083 / 825552| ≤ 1 / 10 ^ 10 := by
...
lemma exp_one_near_20 : |exp 1 - 363916618873 / 133877442384| ≤ 1 / 10 ^ 20 := by
  apply exp_approx_start
...
lemma exp_neg_one_gt_d9 : 0.36787944116 < exp (-1) := by
...
lemma exp_neg_one_lt_d9 : exp (-1) < 0.3678794412 := by
...
lemma log_two_near_10 : |log 2 - 287209 / 414355| ≤ 1 / 10 ^ 10 := by
