...
instance (priority := 10000) : LocallyFiniteOrder (∀ i, α i) :=
...
instance (priority := 10000) : LocallyFiniteOrderBot (∀ i, α i) :=
...
instance (priority := 10000) : LocallyFiniteOrderTop (∀ i, α i) :=
