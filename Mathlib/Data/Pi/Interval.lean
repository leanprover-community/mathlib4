...
instance instLocallyFiniteOrder : LocallyFiniteOrder (∀ i, α i) := fast_instance%
...
instance instLocallyFiniteOrderBot : LocallyFiniteOrderBot (∀ i, α i) := fast_instance%
...
instance instLocallyFiniteOrderTop : LocallyFiniteOrderTop (∀ i, α i) := fast_instance%
