...
instance (priority := 10000) : OrOp PosNum where or := PosNum.lor
...
instance (priority := 10000) : HAnd PosNum PosNum Num where hAnd := PosNum.land
...
instance (priority := 10000) : HXor PosNum PosNum Num where hXor := PosNum.lxor
...
instance (priority := 10000) : HShiftLeft PosNum Nat PosNum where hShiftLeft := PosNum.shiftl
...
instance (priority := 10000) : HShiftRight PosNum Nat Num where hShiftRight := PosNum.shiftr
...
instance (priority := 10000) : OrOp Num where or := Num.lor
...
instance (priority := 10000) : AndOp Num where and := Num.land
...
instance (priority := 10000) : Xor Num where xor := Num.lxor
...
instance (priority := 10000) : HShiftLeft Num Nat Num where hShiftLeft := Num.shiftl
...
instance (priority := 10000) : HShiftRight Num Nat Num where hShiftRight := Num.shiftr
...
instance (priority := 10000) : Coe NzsNum SNum :=
  ⟨SNum.nz⟩

instance (priority := 10000) : Zero SNum :=
  ⟨SNum.zero false⟩

instance (priority := 10000) : One NzsNum :=
  ⟨NzsNum.msb true⟩

instance (priority := 10000) : One SNum :=
  ⟨SNum.nz 1⟩

instance (priority := 10000) : Inhabited NzsNum :=
  ⟨1⟩

instance (priority := 10000) : Inhabited SNum :=
  ⟨0⟩
...
instance (priority := 10000) : Neg SNum :=
  ⟨SNum.neg⟩
...
instance (priority := 10000) : Add SNum :=
  ⟨SNum.add⟩
...
instance (priority := 10000) : Sub SNum :=
  ⟨SNum.sub⟩
...
instance (priority := 10000) : Mul SNum :=
  ⟨SNum.mul⟩
