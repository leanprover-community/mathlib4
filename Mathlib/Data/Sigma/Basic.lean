...
@[ext]
lemma ext {x₀ x₁ : Sigma β} (h₀ : x₀.1 = x₁.1) (h₁ : HEq x₀.2 x₁.2) : x₀ = x₁ := by
...
lemma _root_.Function.eq_of_sigmaMk_comp {γ : Type*} [Nonempty γ]
...
@[ext]
lemma ext {x₀ x₁ : PSigma β} (h₀ : x₀.1 = x₁.1) (h₁ : HEq x₀.2 x₁.2) : x₀ = x₁ := by
  cases x₀; cases x₁; cases h₀; cases h₁; rfl
