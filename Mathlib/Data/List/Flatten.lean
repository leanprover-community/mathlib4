...
/-- See also `head_flatten_eq_head_head`, which removes `hl'` as a proof obligation. -/
...
/-- See also `head_head_eq_head_flatten`, which removes `hl'` as a proof obligation. -/
...
/-- See also `getLast_flatten_of_flatten_ne_nil`, which removes `hl'` as a proof obligation. -/
...
/-- See also `getLast_flatten_of_getLast_ne_nil`, which removes `hl'` as a proof obligation. -/
