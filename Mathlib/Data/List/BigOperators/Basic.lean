...
@[to_additive]
theorem monotone_prod_take [Monoid M] [PartialOrder M] [CanonicallyOrderedMul M] (L : List M) :
...
@[simp] lemma _root_.CanonicallyOrderedAdd.list_prod_pos
    {α : Type*} [OrderedSemiring α] [CanonicallyOrderedAdd α] [NoZeroDivisors α] [Nontrivial α] :
