...
lemma triplewise_iff_getElem : l.Triplewise p ↔ ∀ i j k (hij : i < j) (hjk : j < k)
  ...
  | cons head tail ih =>
    ...
    · rcases i with - | i <;> rcases j with - | j
      ...
      · rcases k with - | k
        · grind
        · simpa using hh j k (by grind) (by grind) (by grind)
      · simp at hij
      · rcases k with - | k
        · grind
        · simpa using ht i j k (by grind) (by grind) (by grind)
    · simpa using h 0 (i + 1) (j + 1) (by grind) (by grind) (by grind)
    · simpa using h (i + 1) (j + 1) (k + 1) (by grind) (by grind) (by grind)
