...
@[simp]
lemma forall₂_cons {a b l₁ l₂} : Forall₂ R (a :: l₁) (b :: l₂) ↔ R a b ∧ Forall₂ R l₁ l₂ :=
...
lemma forall₂_of_length_eq_of_nthLe :
    ∀ {x : List α} {y : List β},
...
lemma forall₂_iff_nthLe {l₁ : List α} {l₂ : List β} :
...
@[to_additive]
lemma rel_prod [Monoid α] [Monoid β] (h : R 1 1) (hf : (R ⇒ R ⇒ R) (· * ·) (· * ·)) :
