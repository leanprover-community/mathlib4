...
protected instance semigroup [Semigroup β] [IsMulApply F α β] : Semigroup F :=
...
protected instance commSemigroup [CommSemigroup β] [IsMulApply F α β] :
    CommSemigroup F :=
...
protected instance isLeftCancelMul [Mul β] [IsLeftCancelMul β] [IsMulApply F α β] :
    IsLeftCancelMul F :=
...
protected instance isRightCancelMul [Mul β] [IsRightCancelMul β] [IsMulApply F α β] :
    IsRightCancelMul F :=
...
protected instance isCancelMul [Mul β] [IsCancelMul β] [IsMulApply F α β] :
    IsCancelMul F :=
...
protected instance leftCancelSemigroup [LeftCancelSemigroup β] [IsMulApply F α β] :
...
protected instance rightCancelSemigroup [RightCancelSemigroup β] [IsMulApply F α β] :
...
`AddZeroClass`. -/]
protected instance mulOneClass [MulOneClass β] [IsOneApply F α β] [IsMulApply F α β] :
    MulOneClass F :=
...
protected instance monoid [Monoid β] [IsOneApply F α β] [IsMulApply F α β] [IsPowApply ℕ F α β] :
    Monoid F :=
...
protected instance leftCancelMonoid [LeftCancelMonoid β] [IsOneApply F α β] [IsMulApply F α β]
...
additive monoid. -/]
protected instance rightCancelMonoid [RightCancelMonoid β] [IsOneApply F α β] [IsMulApply F α β]
...
protected instance cancelMonoid [CancelMonoid β] [IsOneApply F α β] [IsMulApply F α β]
...
protected instance commMonoid [CommMonoid β] [IsOneApply F α β] [IsMulApply F α β]
...
additive monoid. -/]
protected instance cancelCommMonoid [CancelCommMonoid β] [IsOneApply F α β] [IsMulApply F α β]
...
protected instance involutiveInv [InvolutiveInv β] [IsInvApply F α β] : InvolutiveInv F :=
...
`NegZeroClass`. -/]
protected instance invOneClass [InvOneClass β] [IsOneApply F α β] [IsInvApply F α β] :
    InvOneClass F :=
...
protected instance divInvMonoid [DivInvMonoid β] [IsOneApply F α β] [IsMulApply F α β]
...
protected instance divInvOneMonoid [DivInvOneMonoid β] [IsOneApply F α β] [IsMulApply F α β]
    [IsInvApply F α β] [IsDivApply F α β] [IsPowApply ℕ F α β] [IsPowApply ℤ F α β] :
    DivInvOneMonoid F :=
...
protected instance divisionMonoid [DivisionMonoid β] [IsOneApply F α β] [IsMulApply F α β]
    [IsInvApply F α β] [IsDivApply F α β] [IsPowApply ℕ F α β] [IsPowApply ℤ F α β] :
    DivisionMonoid F :=
...
protected instance divisionCommMonoid [DivisionCommMonoid β] [IsOneApply F α β] [IsMulApply F α β]
    [IsInvApply F α β] [IsDivApply F α β] [IsPowApply ℕ F α β] [IsPowApply ℤ F α β] :
...
protected instance group [Group β] [IsOneApply F α β] [IsMulApply F α β] [IsInvApply F α β]
...
commutative group. -/]
protected instance commGroup [CommGroup β] [IsOneApply F α β] [IsMulApply F α β] [IsInvApply F α β]
    [IsDivApply F α β] [IsPowApply ℕ F α β] [IsPowApply ℤ F α β] :
    CommGroup F :=
...
torsion-free. -/]
protected instance isMulTorsionFree [Monoid β] [Monoid F] [IsOneApply F α β] [IsMulApply F α β]
