...
instance covariant_add : AddLeftMono ℝ≥0 := inferInstance
#align nnreal.covariant_add NNReal.covariant_add

instance contravariant_add : AddLeftReflectLT ℝ≥0 := inferInstance
#align nnreal.contravariant_add NNReal.contravariant_add

instance covariant_mul : MulLeftMono ℝ≥0 := inferInstance
