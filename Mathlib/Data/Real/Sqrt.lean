...
-- 2024-02-14
@[deprecated (since := "2024-06-12")] alias sqrt_le_sqrt_iff := sqrt_le_sqrt
@[deprecated (since := "2024-06-12")] alias sqrt_lt_sqrt_iff := sqrt_lt_sqrt
@[deprecated (since := "2024-06-12")] alias sqrt_le_iff := sqrt_le_iff_le_sq
@[deprecated (since := "2024-06-12")] alias le_sqrt_iff := le_sqrt_iff_sq_le
@[deprecated (since := "2024-06-12")] alias sqrt_eq_iff_sq_eq := sqrt_eq_iff_eq_sq
