...
-- 2024-05-11
@[deprecated (since := "2024-06-12")] alias den_div_cast_eq_one_iff := den_div_intCast_eq_one_iff
...
-- 2024-04-05
@[deprecated (since := "2024-06-12")] alias coe_int_div_self := intCast_div_self
@[deprecated (since := "2024-06-12")] alias coe_nat_div_self := natCast_div_self
@[deprecated (since := "2024-06-12")] alias coe_int_div := intCast_div
@[deprecated (since := "2024-06-12")] alias coe_nat_div := natCast_div
@[deprecated (since := "2024-06-12")] alias inv_coe_int_num_of_pos := inv_intCast_num_of_pos
@[deprecated (since := "2024-06-12")] alias inv_coe_nat_num_of_pos := inv_natCast_num_of_pos
@[deprecated (since := "2024-06-12")] alias inv_coe_int_den_of_pos := inv_intCast_den_of_pos
@[deprecated (since := "2024-06-12")] alias inv_coe_nat_den_of_pos := inv_natCast_den_of_pos
@[deprecated (since := "2024-06-12")] alias inv_coe_int_num := inv_intCast_num
@[deprecated (since := "2024-06-12")] alias inv_coe_nat_num := inv_natCast_num
@[deprecated (since := "2024-06-12")] alias inv_coe_int_den := inv_intCast_den
@[deprecated (since := "2024-06-12")] alias inv_coe_nat_den := inv_natCast_den
