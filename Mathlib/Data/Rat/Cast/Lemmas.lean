...
@[simp, norm_cast]
lemma cast_nnratCast {K} [DivisionRing K] (q : ℚ≥0) :
    ((q : ℚ) : K) = (q : K) := by
...
@[simp, norm_cast]
lemma cast_pow {K} [DivisionSemiring K] (q : ℚ≥0) (n : ℕ) :
...
lemma cast_zpow_of_ne_zero {K} [DivisionSemiring K] (q : ℚ≥0) (z : ℤ) (hq : (q.num : K) ≠ 0) :
