...
lemma iSup_add_iSup_of_monotone {ι : Type*} [Preorder ι] [IsPredirectedOrder ι] {f g : ι → ℕ∞}
...
lemma iInf_add_iInf_of_monotone {ι : Type*} [Preorder ι] [IsPrecodirectedOrder ι] {f g : ι → ℕ∞}
