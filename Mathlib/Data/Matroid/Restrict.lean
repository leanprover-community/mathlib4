...
theorem Basis.basis_restriction (hI : M.Basis I X) (hNM : N ≤r M) (hX : X ⊆ N.E) : N.Basis I X := by
  obtain ⟨R, hR, rfl⟩ := hNM
  rwa [basis_restrict_iff .., and_iff_left (show X ⊆ R from hX)]
