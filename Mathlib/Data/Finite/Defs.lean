...
instance (priority := 10000) [Finite α] : Finite (PLift α) :=
  Finite.of_equiv α Equiv.plift.symm

instance (priority := 10000) {α : Type v} [Finite α] : Finite (ULift.{u} α) :=
...
instance (priority := 10000) [Infinite α] : Infinite (PLift α) :=
  Equiv.plift.infinite_iff.2 ‹_›

instance (priority := 10000) {α : Type v} [Infinite α] : Infinite (ULift.{u} α) :=
