...
lemma center {R n : Type*} [CommSemiring R] [Fintype n] [DecidableEq n] :
  ...
  rw [SetLike.mem_coe, Submodule.mem_span_singleton, ← this,
    mem_range_scalar_iff_commute_single', Semigroup.mem_center_iff]
