...
@[simp]
lemma row_empty : row (vecEmpty : Fin 0 → α) = fun _ => vecEmpty := by
  ext
  rfl
...
@[simp]
lemma vecMul_empty [Fintype n'] (v : n' → α) (B : Matrix n' (Fin 0) α) : vecMul v B = ![] :=
  empty_eq _
...
@[simp]
lemma empty_mulVec [Fintype n'] (A : Matrix (Fin 0) n' α) (v : n' → α) : mulVec A v = ![] :=
  empty_eq _
