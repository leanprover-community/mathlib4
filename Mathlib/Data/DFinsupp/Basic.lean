...
@[to_additive]
theorem prod_comm {ι₁ ι₂ : Sort*} {β₁ : ι₁ → Type*} {β₂ : ι₂ → Type*} [DecidableEq ι₁]
...
theorem sumAddHom_comm {ι₁ ι₂ : Sort*} {β₁ : ι₁ → Type*} {β₂ : ι₂ → Type*} {γ : Type*}
...
instance DFinsupp.fintype {ι : Sort*} {π : ι → Sort*} [DecidableEq ι] [∀ i, Zero (π i)]
...
instance DFinsupp.infinite_of_left {ι : Sort*} {π : ι → Sort*} [∀ i, Nontrivial (π i)]
...
theorem DFinsupp.infinite_of_exists_right {ι : Sort*} {π : ι → Sort*} (i : ι) [Infinite (π i)]
...
instance DFinsupp.infinite_of_right {ι : Sort*} {π : ι → Sort*} [∀ i, Infinite (π i)]
