...
theorem recF_eq {α : TypeVec n} {β : Type*} (g : F (α.append1 β) → β) (a : q.P.A)
...
theorem recF_eq' {α : TypeVec n} {β : Type*} (g : F (α.append1 β) → β) (x : q.P.W α) :
...
theorem recF_eq_of_wEquiv (α : TypeVec n) {β : Type*} (u : F (α.append1 β) → β) (x y : q.P.W α) :
