...
instance (priority := 10000) Finset.fintype [Fintype α] : Fintype (Finset α) :=
...
instance (priority := 10000) Set.fintype [Fintype α] : Fintype (Set α) :=
...
instance (priority := 10000) Set.finite' [Finite α] : Finite (Set α) := by
