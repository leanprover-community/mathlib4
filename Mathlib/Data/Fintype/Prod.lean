...
instance Pi.infinite_of_right {ι : Type*} {π : ι → Type*} [∀ i, Infinite <| π i] [Nonempty ι] :
    Infinite (∀ i : ι, π i) :=
...
instance Function.infinite_of_left {ι : Sort*} {π : Type*} [Nontrivial π] [Infinite ι] :
    Infinite (ι → π) := Pi.infinite_of_left
...
instance Function.infinite_of_right {ι π : Type*} [Infinite π] [Nonempty ι] : Infinite (ι → π) :=
