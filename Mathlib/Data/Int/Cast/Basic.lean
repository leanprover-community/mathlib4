...
lemma cast_natCast (n : ℕ) : ((n : ℤ) : R) = n :=
...
@[simp, norm_cast]
lemma cast_ofNat (n : ℕ) [n.AtLeastTwo] :
...
lemma cast_two : ((2 : ℤ) : R) = 2 := cast_ofNat _
#align int.cast_two Int.cast_two

lemma cast_three : ((3 : ℤ) : R) = 3 := cast_ofNat _
#align int.cast_three Int.cast_three

lemma cast_four : ((4 : ℤ) : R) = 4 := cast_ofNat _
