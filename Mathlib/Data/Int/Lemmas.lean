...
-- 2024-04-02
@[deprecated (since := "2024-06-12")] alias le_coe_nat_sub := le_natCast_sub
@[deprecated (since := "2024-06-12")] alias succ_coe_nat_pos := succ_natCast_pos
@[deprecated (since := "2024-06-12")] alias coe_natAbs := natCast_natAbs
@[deprecated (since := "2024-06-12")] alias coe_nat_eq_zero := natCast_eq_zero
@[deprecated (since := "2024-06-12")] alias coe_nat_ne_zero := natCast_ne_zero
@[deprecated (since := "2024-06-12")] alias coe_nat_ne_zero_iff_pos := natCast_ne_zero_iff_pos
@[deprecated (since := "2024-06-12")] alias abs_coe_nat := abs_natCast
@[deprecated (since := "2024-06-12")] alias coe_nat_nonpos_iff := natCast_nonpos_iff
