...
instance (priority := 10000) decidableExistsOfDecidableSubsets {s : Finset α} {p : ∀ t ⊆ s, Prop}
...
instance (priority := 10000) decidableForallOfDecidableSubsets {s : Finset α} {p : ∀ t ⊆ s, Prop}
...
instance (priority := 10000) decidableExistsOfDecidableSSubsets {s : Finset α} {p : ∀ t ⊂ s, Prop}
...
instance (priority := 10000) decidableForallOfDecidableSSubsets {s : Finset α} {p : ∀ t ⊂ s, Prop}
    [∀ t h, Decidable (p t h)] : Decidable (∀ t h, p t h) :=
