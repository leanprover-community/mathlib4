...
theorem sup_product_left (s : Finset β) (t : Finset γ) (f : β × γ → α) :
    (s ×ᶠˢ t).sup f = s.sup fun i => t.sup fun i' => f ⟨i, i'⟩ := by
...
theorem sup_product_right (s : Finset β) (t : Finset γ) (f : β × γ → α) :
    (s ×ᶠˢ t).sup f = t.sup fun i' => s.sup fun i => f ⟨i, i'⟩ := by
...
theorem inf_product_left (s : Finset β) (t : Finset γ) (f : β × γ → α) :
    (s ×ᶠˢ t).inf f = s.inf fun i => t.inf fun i' => f ⟨i, i'⟩ :=
...
theorem inf_product_right (s : Finset β) (t : Finset γ) (f : β × γ → α) :
    (s ×ᶠˢ t).inf f = t.inf fun i' => s.inf fun i => f ⟨i, i'⟩ :=
...
theorem sup_inf_sup (s : Finset ι) (t : Finset κ) (f : ι → α) (g : κ → α) :
    s.sup f ⊓ t.sup g = (s ×ᶠˢ t).sup fun i => f i.1 ⊓ g i.2 := by
...
theorem inf_sup_inf (s : Finset ι) (t : Finset κ) (f : ι → α) (g : κ → α) :
    s.inf f ⊔ t.inf g = (s ×ᶠˢ t).inf fun i => f i.1 ⊔ g i.2 :=
...
--TODO: Extract out the obvious isomorphism `(insert i s).pi t ≃ t i ×ᶠˢ s.pi t` from this proof
