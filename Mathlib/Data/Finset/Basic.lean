...
-- 2024-03-22
@[deprecated (since := "2024-06-12")] alias inter_distrib_left := inter_union_distrib_left
@[deprecated (since := "2024-06-12")] alias inter_distrib_right := union_inter_distrib_right
@[deprecated (since := "2024-06-12")] alias union_distrib_left := union_inter_distrib_left
@[deprecated (since := "2024-06-12")] alias union_distrib_right := inter_union_distrib_right
