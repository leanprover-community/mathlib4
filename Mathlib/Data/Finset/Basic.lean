...
theorem Nonempty.exists {s : Finset α} (h : s.Nonempty) : ∃ x : α, x ∈ s :=
  h
#align finset.nonempty.bex Finset.Nonempty.exists
@[deprecated] alias Nonempty.bex := Nonempty.exists -- 2024-03-23
