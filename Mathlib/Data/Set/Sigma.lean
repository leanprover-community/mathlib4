...
theorem _root_.biSup_sigma [CompleteLattice ι'] (s : Set ι) (t : ∀ i, Set (α i))
    (f : Sigma α → ι') : ⨆ ij ∈ s.sigma t, f ij = ⨆ (i ∈ s) (j ∈ t i), f ⟨i, j⟩ :=
...
theorem _root_.biInf_sigma [CompleteLattice ι'] (s : Set ι) (t : ∀ i, Set (α i))
    (f : Sigma α → ι') : ⨅ ij ∈ s.sigma t, f ij = ⨅ (i ∈ s) (j ∈ t i), f ⟨i, j⟩ :=
