...
lemma Ici_add_bij : BijOn (· + d) (Ici a) (Ici (a + d)) := by
  refine'
...
lemma Ioi_add_bij : BijOn (· + d) (Ioi a) (Ioi (a + d)) := by
  refine'
...
lemma Icc_add_bij : BijOn (· + d) (Icc a b) (Icc (a + d) (b + d)) := by
...
lemma Ioo_add_bij : BijOn (· + d) (Ioo a b) (Ioo (a + d) (b + d)) := by
...
lemma Ioc_add_bij : BijOn (· + d) (Ioc a b) (Ioc (a + d) (b + d)) := by
...
lemma Ico_add_bij : BijOn (· + d) (Ico a b) (Ico (a + d) (b + d)) := by
