...
instance (priority := 10000) [NoMinOrder α] {a : α} : Infinite (Iio a) :=
  NoMinOrder.infinite
...
instance (priority := 10000) [NoMinOrder α] {a : α} : Infinite (Iic a) :=
  NoMinOrder.infinite
...
instance (priority := 10000) [NoMaxOrder α] {a : α} : Infinite (Ioi a) :=
  NoMaxOrder.infinite
...
instance (priority := 10000) [NoMaxOrder α] {a : α} : Infinite (Ici a) :=
  NoMaxOrder.infinite
