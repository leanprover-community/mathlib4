...
instance Lex.wellFoundedLT {α N} [LT α] [IsTrichotomous α (· < ·)] [hα : WellFoundedGT α]
    [AddCommMonoid N] [CanonicallyOrderedAddCommMonoid N] [hN : WellFoundedLT N] :
    WellFoundedLT (Lex (α →₀ N)) :=
...
instance wellFoundedLT'
    {N} [AddCommMonoid N] [CanonicallyOrderedAddCommMonoid N] [WellFoundedLT N] :
    WellFoundedLT (α →₀ N) :=
