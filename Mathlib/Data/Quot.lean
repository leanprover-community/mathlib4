...
-- We have not yet decided which one works best, since the setoid instance cannot always be
-- reliably found but it cannot always be inferred from the expected type either.
