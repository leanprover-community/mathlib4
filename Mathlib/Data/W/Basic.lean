...
instance (priority := 10000) : Inhabited (WType fun _ : Unit => Empty) :=
...
instance (priority := 10000) [hα : IsEmpty α] : IsEmpty (WType β) :=
...
encodable. -/
instance (priority := 10000) : Encodable (WType β) := by
