...
Given bicategories `B` and `C`, we give a bicategory structure on `B ⥤ᴼ C` whose
...
@[simps!]
scoped instance OplaxFunctor.bicategory : Bicategory (B ⥤ᴼ C) where
