    ...
    _ =
        𝟙 _ ⊗≫
          g ◁ (η.hom ▷ 𝟙 a ≫ (f ≫ g) ◁ η.hom) ⊗≫
            ε.hom ▷ (g ≫ f ≫ g) ⊗≫ ε.hom ▷ g ⊗≫ ε.inv ▷ g ⊗≫ g ◁ η.inv ⊗≫ 𝟙 _ := ?_
    _ =
        𝟙 _ ⊗≫
          g ◁ η.hom ⊗≫
            g ◁ η.hom ▷ f ▷ g ⊗≫
              (ε.hom ▷ (g ≫ f) ≫ 𝟙 b ◁ ε.hom) ▷ g ⊗≫ ε.inv ▷ g ⊗≫ g ◁ η.inv ⊗≫ 𝟙 _ := ?_
    _ =
        𝟙 _ ⊗≫
          g ◁ η.hom ⊗≫
            g ◁ (η.hom ▷ f ⊗≫ f ◁ ε.hom) ▷ g ⊗≫
...
theorem adjointifyCounit_symm (η : 𝟙 a ≅ f ≫ g) (ε : g ≫ f ≅ 𝟙 b) :
  ...
  calc
    ...
    _ =
        𝟙 _ ⊗≫
          ε.inv ▷ g ▷ f ⊗≫
            g ◁ ((f ≫ g) ◁ η.hom ≫ η.inv ▷ (f ≫ g)) ▷ f ⊗≫ g ◁ f ◁ ε.hom ⊗≫ 𝟙 _ := ?_
