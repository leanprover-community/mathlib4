...
* `PseudoNatTrans F G` : oplax natural transformations between oplax functors `F` and `G`
* `PseudoNatTrans.vcomp η θ` : the vertical composition of oplax natural transformations `η`
  and `θ`
* `PseudoNatTrans.category F G` : the category structure on the oplax natural transformations
  between `F` and `G`
-/
...
-/
structure PseudoNatTrans (F G : OplaxFunctor B C) where
...
attribute [nolint docBlame] CategoryTheory.PseudoNatTrans.app
  CategoryTheory.PseudoNatTrans.naturality
  CategoryTheory.PseudoNatTrans.naturality_naturality
  CategoryTheory.PseudoNatTrans.naturality_id
  CategoryTheory.PseudoNatTrans.naturality_comp

attribute [reassoc (attr := simp)] PseudoNatTrans.naturality_naturality PseudoNatTrans.naturality_id
  PseudoNatTrans.naturality_comp
...
@[simps]
def id : PseudoNatTrans F F where
  app a := 𝟙 (F.obj a)
  naturality {a b} f := (ρ_ (F.map f)).hom ≫ (λ_ (F.map f)).inv
#align category_theory.oplax_nat_trans.id CategoryTheory.PseudoNatTrans.id

instance : Inhabited (PseudoNatTrans F F) :=
  ⟨id F⟩

variable {F} {G H : OplaxFunctor B C} (η : PseudoNatTrans F G) (θ : PseudoNatTrans G H)
...
#align category_theory.oplax_nat_trans.whisker_left_naturality_naturality CategoryTheory.PseudoNatTrans.whiskerLeft_naturality_naturality
...
#align category_theory.oplax_nat_trans.whisker_right_naturality_naturality CategoryTheory.PseudoNatTrans.whiskerRight_naturality_naturality
...
#align category_theory.oplax_nat_trans.whisker_left_naturality_comp CategoryTheory.PseudoNatTrans.whiskerLeft_naturality_comp
...
#align category_theory.oplax_nat_trans.whisker_right_naturality_comp CategoryTheory.PseudoNatTrans.whiskerRight_naturality_comp
...
#align category_theory.oplax_nat_trans.whisker_left_naturality_id CategoryTheory.PseudoNatTrans.whiskerLeft_naturality_id
...
#align category_theory.oplax_nat_trans.whisker_right_naturality_id CategoryTheory.PseudoNatTrans.whiskerRight_naturality_id

end

/-- Vertical composition of oplax natural transformations. -/
@[simps]
def vcomp (η : PseudoNatTrans F G) (θ : PseudoNatTrans G H) : PseudoNatTrans F H where
  ...
  naturality_comp {a b c} f g := by
    ...
    · rw [whisker_exchange_assoc]
      simp
    · simp
#align category_theory.oplax_nat_trans.vcomp CategoryTheory.PseudoNatTrans.vcomp
...
instance : CategoryStruct (PseudoFunctor B C) where
  Hom := PseudoNatTrans
  id := PseudoNatTrans.id
  comp := PseudoNatTrans.vcomp
...
structure Modification (η θ : F ⟶ G) where
  ...
  naturality :
    ...
    aesop_cat
#align category_theory.oplax_nat_trans.modification CategoryTheory.PseudoNatTrans.Modification
#align category_theory.oplax_nat_trans.modification.app CategoryTheory.PseudoNatTrans.Modification
#align category_theory.oplax_nat_trans.modification.naturality' CategoryTheory.PseudoNatTrans.Modification.naturality
#align category_theory.oplax_nat_trans.modification.naturality CategoryTheory.PseudoNatTrans.Modification.naturality

attribute [nolint docBlame] CategoryTheory.PseudoNatTrans.Modification.app
  CategoryTheory.PseudoNatTrans.Modification.naturality
...
#align category_theory.oplax_nat_trans.modification.id CategoryTheory.PseudoNatTrans.Modification.id
...
#align category_theory.oplax_nat_trans.modification.whisker_left_naturality CategoryTheory.PseudoNatTrans.Modification.whiskerLeft_naturality
...
#align category_theory.oplax_nat_trans.modification.whisker_right_naturality CategoryTheory.PseudoNatTrans.Modification.whiskerRight_naturality
...
#align category_theory.oplax_nat_trans.modification.vcomp CategoryTheory.PseudoNatTrans.Modification.vcomp
...
#align category_theory.oplax_nat_trans.category CategoryTheory.PseudoNatTrans.category
...
#align category_theory.oplax_nat_trans.modification_iso.of_components CategoryTheory.PseudoNatTrans.ModificationIso.ofComponents
