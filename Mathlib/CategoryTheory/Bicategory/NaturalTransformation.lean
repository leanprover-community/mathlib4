...
@[reassoc (attr := simp)]
lemma whiskerLeft_naturality_naturality (f : a' ⟶ G.obj a) {g h : a ⟶ b} (β : g ⟶ h) :
...
@[reassoc (attr := simp)]
lemma whiskerRight_naturality_naturality {f g : a ⟶ b} (β : f ⟶ g) (h : G.obj b ⟶ a') :
...
@[reassoc (attr := simp)]
lemma whiskerLeft_naturality_comp (f : a' ⟶ G.obj a) (g : a ⟶ b) (h : b ⟶ c) :
...
@[reassoc (attr := simp)]
lemma whiskerRight_naturality_comp (f : a ⟶ b) (g : b ⟶ c) (h : G.obj c ⟶ a') :
...
@[reassoc (attr := simp)]
lemma whiskerLeft_naturality_id (f : a' ⟶ G.obj a) :
...
@[reassoc (attr := simp)]
lemma whiskerRight_naturality_id (f : G.obj a ⟶ a') :
...
@[reassoc (attr := simp)]
lemma whiskerLeft_naturality (f : a' ⟶ F.obj b) (g : b ⟶ c) :
...
@[reassoc (attr := simp)]
lemma whiskerRight_naturality (f : a ⟶ b) (g : G.obj b ⟶ a') :
