...
lemma Concrete.to_product_injective_of_isLimit {D : Cone F} (hD : IsLimit D) :
...
lemma Concrete.isLimit_ext {D : Cone F} (hD : IsLimit D) (x y : D.pt) :
...
lemma Concrete.limit_ext [HasLimit F] (x y : ↑(limit F)) :
...
lemma Concrete.widePullback_ext {B : C} {ι : Type w} {X : ι → C} (f : ∀ j : ι, X j ⟶ B)
...
lemma Concrete.widePullback_ext' {B : C} {ι : Type w} [Nonempty ι] {X : ι → C}
...
lemma Concrete.multiequalizer_ext {I : MulticospanIndex.{w} C} [HasMultiequalizer I]
...
@[simp]
lemma Concrete.multiequalizerEquiv_apply (I : MulticospanIndex.{w} C) [HasMultiequalizer I]
...
lemma cokernel_funext {C : Type*} [Category C] [HasZeroMorphisms C] [ConcreteCategory C]
...
lemma Concrete.from_union_surjective_of_isColimit {D : Cocone F} (hD : IsColimit D) :
...
lemma Concrete.isColimit_exists_rep {D : Cocone F} (hD : IsColimit D) (x : D.pt) :
...
lemma Concrete.colimit_exists_rep [HasColimit F] (x : ↑(colimit F)) :
...
lemma Concrete.isColimit_rep_eq_of_exists {D : Cocone F} {i j : J} (hD : IsColimit D)
...
lemma Concrete.colimit_rep_eq_of_exists [HasColimit F] {i j : J} (x : F.obj i) (y : F.obj j)
...
lemma Concrete.isColimit_exists_of_rep_eq {D : Cocone F} {i j : J} (hD : IsColimit D)
...
lemma Concrete.isColimit_rep_eq_iff_exists {D : Cocone F} {i j : J} (hD : IsColimit D)
    (x : F.obj i) (y : F.obj j) :
...
lemma Concrete.colimit_exists_of_rep_eq [HasColimit F] {i j : J} (x : F.obj i) (y : F.obj j)
...
lemma Concrete.colimit_rep_eq_iff_exists [HasColimit F] {i j : J} (x : F.obj i) (y : F.obj j) :
...
lemma Concrete.widePushout_exists_rep {B : C} {α : Type _} {X : α → C} (f : ∀ j : α, B ⟶ X j)
...
lemma Concrete.widePushout_exists_rep' {B : C} {α : Type _} [Nonempty α] {X : α → C}
