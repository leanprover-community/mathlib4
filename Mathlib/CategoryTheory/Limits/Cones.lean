...
namespace Cones
run_meta
  Mathlib.Tactic.ToDual.translations.add `CategoryTheory.Limits.Cones
    { translation := `CategoryTheory.Limits.Cocones }
  Mathlib.Tactic.ToDual.translations.add `CategoryTheory.Limits.Cocones
