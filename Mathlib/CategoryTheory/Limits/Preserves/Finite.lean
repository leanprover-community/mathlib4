...
noncomputable instance idPreservesFiniteLimits : PreservesFiniteLimits (𝟭 C) := fast_instance%
...
-- of some instances?
noncomputable instance idPreservesFiniteColimits : PreservesFiniteColimits (𝟭 C) := fast_instance%
