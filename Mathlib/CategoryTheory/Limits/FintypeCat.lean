...
instance (priority := 10000) {J : Type} [SmallCategory J] (K : J ⥤ FintypeCat.{u}) (j : J) :
...
has a finite limit. -/
noncomputable instance (priority := 10000) finiteLimitOfFiniteDiagram {J : Type} [SmallCategory J] [FinCategory J]
...
noncomputable instance (priority := 10000) inclusionCreatesFiniteLimits {J : Type} [SmallCategory J] [FinCategory J] :
...
instance (priority := 10000) {J : Type} [SmallCategory J] [FinCategory J] : HasLimitsOfShape J FintypeCat.{u} where
  has_limit F := hasLimit_of_created F FintypeCat.incl

instance (priority := 10000) hasFiniteLimits : HasFiniteLimits FintypeCat.{u} where
  out _ := inferInstance

noncomputable instance (priority := 10000) inclusionPreservesFiniteLimits :
...
noncomputable instance (priority := 10000) finiteColimitOfFiniteDiagram {J : Type} [SmallCategory J] [FinCategory J]
...
noncomputable instance (priority := 10000) inclusionCreatesFiniteColimits {J : Type} [SmallCategory J] [FinCategory J] :
...
instance (priority := 10000) {J : Type} [SmallCategory J] [FinCategory J] : HasColimitsOfShape J FintypeCat.{u} where
  has_colimit F := hasColimit_of_created F FintypeCat.incl

instance (priority := 10000) hasFiniteColimits : HasFiniteColimits FintypeCat.{u} where
  out _ := inferInstance

noncomputable instance (priority := 10000) inclusionPreservesFiniteColimits :
