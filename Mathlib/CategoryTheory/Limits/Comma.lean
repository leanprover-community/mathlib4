...
instance (priority := 10000) hasLimit (F : J ⥤ Comma L R) [HasLimit (F ⋙ fst L R)] [HasLimit (F ⋙ snd L R)]
...
instance (priority := 10000) hasLimitsOfShape [HasLimitsOfShape J A] [HasLimitsOfShape J B]
...
instance (priority := 10000) hasLimitsOfSize [HasLimitsOfSize.{w, w'} A] [HasLimitsOfSize.{w, w'} B]
...
instance (priority := 10000) hasColimit (F : J ⥤ Comma L R) [HasColimit (F ⋙ fst L R)] [HasColimit (F ⋙ snd L R)]
...
instance (priority := 10000) hasColimitsOfShape [HasColimitsOfShape J A] [HasColimitsOfShape J B]
...
instance (priority := 10000) hasColimitsOfSize [HasColimitsOfSize.{w, w'} A] [HasColimitsOfSize.{w, w'} B]
...
instance (priority := 10000) hasLimit (F : J ⥤ Arrow T) [i₁ : HasLimit (F ⋙ leftFunc)] [i₂ : HasLimit (F ⋙ rightFunc)] :
    HasLimit F := by
...
instance (priority := 10000) hasLimitsOfShape [HasLimitsOfShape J T] : HasLimitsOfShape J (Arrow T) where
#align category_theory.arrow.has_limits_of_shape CategoryTheory.Arrow.hasLimitsOfShape

instance (priority := 10000) hasLimits [HasLimits T] : HasLimits (Arrow T) :=
  ⟨fun _ _ => inferInstance⟩
#align category_theory.arrow.has_limits CategoryTheory.Arrow.hasLimits

instance (priority := 10000) hasColimit (F : J ⥤ Arrow T) [i₁ : HasColimit (F ⋙ leftFunc)]
...
instance (priority := 10000) hasColimitsOfShape [HasColimitsOfShape J T] : HasColimitsOfShape J (Arrow T) where
#align category_theory.arrow.has_colimits_of_shape CategoryTheory.Arrow.hasColimitsOfShape

instance (priority := 10000) hasColimits [HasColimits T] : HasColimits (Arrow T) :=
  ⟨fun _ _ => inferInstance⟩
...
instance (priority := 10000) hasLimit [i₁ : HasLimit (F ⋙ proj X G)] [i₂ : PreservesLimit (F ⋙ proj X G) G] :
    HasLimit F := by
...
instance (priority := 10000) hasLimitsOfShape [HasLimitsOfShape J A] [PreservesLimitsOfShape J G] :
...
instance (priority := 10000) hasLimitsOfSize [HasLimitsOfSize.{w, w'} A] [PreservesLimitsOfSize.{w, w'} G] :
...
noncomputable instance (priority := 10000) createsLimit [i : PreservesLimit (F ⋙ proj X G) G] :
...
noncomputable instance (priority := 10000) createsLimitsOfShape [PreservesLimitsOfShape J G] :
...
noncomputable instance (priority := 10000) createsLimitsOfSize [PreservesLimitsOfSize.{w, w'} G] :
...
instance (priority := 10000) mono_right_of_mono [HasPullbacks A] [PreservesLimitsOfShape WalkingCospan G]
...
instance (priority := 10000) hasColimit [i₁ : HasColimit (F ⋙ proj G X)] [i₂ : PreservesColimit (F ⋙ proj G X) G] :
    HasColimit F := by
...
instance (priority := 10000) hasColimitsOfShape [HasColimitsOfShape J A] [PreservesColimitsOfShape J G] :
...
instance (priority := 10000) hasColimitsOfSize [HasColimitsOfSize.{w, w'} A] [PreservesColimitsOfSize.{w, w'} G] :
...
noncomputable instance (priority := 10000) createsColimit [i : PreservesColimit (F ⋙ proj G X) G] :
...
noncomputable instance (priority := 10000) createsColimitsOfShape [PreservesColimitsOfShape J G] :
...
noncomputable instance (priority := 10000) createsColimitsOfSize [PreservesColimitsOfSize.{w, w'} G] :
...
instance (priority := 10000) epi_left_of_epi [HasPushouts A] [PreservesColimitsOfShape WalkingSpan G]
