...
@[implicit_reducible]
noncomputable def createsLimitFullSubcategoryInclusion' (F : J ⥤ P.FullSubcategory)
...
@[implicit_reducible]
noncomputable def createsColimitFullSubcategoryInclusion' (F : J ⥤ P.FullSubcategory)
...
@[implicit_reducible]
noncomputable def createsLimitFullSubcategoryInclusionOfClosed [P.IsClosedUnderLimitsOfShape J]
    (F : J ⥤ P.FullSubcategory) [HasLimit (F ⋙ P.ι)] :
    CreatesLimit F P.ι :=
  createsLimitFullSubcategoryInclusion F (P.prop_limit _ fun j => (F.obj j).property)

/-- If `P` is closed under limits of shape `J`, then the inclusion creates such limits. -/
noncomputable instance createsLimitsOfShapeFullSubcategoryInclusion [P.IsClosedUnderLimitsOfShape J]
...
@[implicit_reducible]
noncomputable def createsColimitFullSubcategoryInclusionOfClosed [P.IsClosedUnderColimitsOfShape J]
