...
lemma ClosedUnderLimitsOfShape.limit (h : ClosedUnderLimitsOfShape J P) {F : J ⥤ C} [HasLimit F] :
...
lemma ClosedUnderColimitsOfShape.colimit (h : ClosedUnderColimitsOfShape J P) {F : J ⥤ C}
...
lemma hasLimit_of_closed_under_limits (h : ClosedUnderLimitsOfShape J P)
...
lemma hasLimitsOfShape_of_closed_under_limits (h : ClosedUnderLimitsOfShape J P)
...
lemma hasColimit_of_closed_under_colimits (h : ClosedUnderColimitsOfShape J P)
...
lemma hasColimitsOfShape_of_closed_under_colimits (h : ClosedUnderColimitsOfShape J P)
