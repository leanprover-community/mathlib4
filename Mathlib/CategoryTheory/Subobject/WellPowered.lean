...
instance (priority := 10000) small_subobject [WellPowered C] (X : C) : Small.{v} (Subobject X) :=
...
instance (priority := 10000) essentiallySmall_monoOver (X : C) : EssentiallySmall.{v} (MonoOver X) :=
