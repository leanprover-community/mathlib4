...
for any `i₁` and `i₂`. -/
@[reducible, inline]
def HasPullbacks := ∀ (i₁ i₂ : E.I₀), HasPullback (E.f i₁) (E.f i₂)

/-- The presieve of `S` that is generated by the morphisms `f i : X i ⟶ S`. -/
@[reducible, inline]
def presieve₀ : Presieve S := .ofArrows _ E.f
...
@[reducible, inline]
def sieve₀ : Sieve S := .ofArrows _ E.f
...
@[reducible, inline]
def Hom (E : ZeroHypercover.{w} J S) (F : ZeroHypercover.{w'} J S) :=
