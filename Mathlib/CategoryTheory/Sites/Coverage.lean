...
-/
theorem isSheaf_coverage (K : Coverage C) (P : Cᵒᵖ ⥤ TypeCat) :
...
-/
theorem isSheaf_sup (K L : Coverage C) (P : Cᵒᵖ ⥤ TypeCat) :
...
lemma Precoverage.isSheaf_toGrothendieck_iff_of_isStableUnderBaseChange
    {J : Precoverage C} [J.HasPullbacks] [J.IsStableUnderBaseChange] (P : Cᵒᵖ ⥤ TypeCat) :
...
lemma Precoverage.isSheaf_toGrothendieck_iff_of_isStableUnderBaseChange_of_small {J : Precoverage C}
    [J.IsStableUnderBaseChange] [J.HasPullbacks] [Small.{w} J] (P : Cᵒᵖ ⥤ TypeCat) :
