...
elements satisfy `P`. -/
def pretopology (P : MorphismProperty C) [P.IsMultiplicative] [P.StableUnderBaseChange] :
    Pretopology C where
...
abbrev grothendieckTopology (P : MorphismProperty C) [P.IsMultiplicative]
    [P.StableUnderBaseChange] : GrothendieckTopology C :=
  P.pretopology.toGrothendieck

variable {P Q : MorphismProperty C}
  [P.IsMultiplicative] [P.StableUnderBaseChange]
  [Q.IsMultiplicative] [Q.StableUnderBaseChange]
