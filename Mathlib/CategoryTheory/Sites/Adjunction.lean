...
instance [IsRightAdjoint F] : IsRightAdjoint (sheafCompose J F) := fast_instance%
...
instance [IsRightAdjoint (forget D)] : IsRightAdjoint (sheafForget J : Sheaf J D ⥤ _) := fast_instance%
