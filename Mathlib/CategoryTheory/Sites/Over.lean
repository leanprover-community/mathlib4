...
lemma overMapPullback_comp_id {X Y : C} (f : X ⟶ Y) :
  ...
  ext
  dsimp
  simp only [overMapPullbackComp_inv_app_hom_app, overMapPullbackId_hom_app_hom_app, comp_id,
...
lemma overMapPullback_id_comp {X Y : C} (f : X ⟶ Y) :
  ...
  simp only [overMapPullbackComp_inv_app_hom_app, overMapPullbackId_hom_app_hom_app,
    Functor.sheafPushforwardContinuous_obj_obj_map, Quiver.Hom.unop_op, comp_id,
    ← Functor.map_comp, ← op_comp]
  congr
  cat_disch
...
lemma overMapPullback_assoc {X Y Z T : C} (f : X ⟶ Y) (g : Y ⟶ Z) (h : Z ⟶ T) :
  ...
  ext
  dsimp
  simp only [overMapPullbackComp_inv_app_hom_app, overMapPullbackComp_hom_app_hom_app,
