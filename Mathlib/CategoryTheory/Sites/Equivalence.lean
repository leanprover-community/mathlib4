...
def sheafCongr.functor : Sheaf J A ⥤ Sheaf K A where
  obj F := ⟨e.inverse.op ⋙ F.obj, e.inverse.op_comp_isSheaf _ _ _⟩
  map f := ObjectProperty.homMk (whiskerLeft e.inverse.op f.hom)

/-- The inverse in the equivalence of sheaf categories. -/
@[simps!]
def sheafCongr.inverse : Sheaf K A ⥤ Sheaf J A where
  obj F := ⟨e.functor.op ⋙ F.obj, e.functor.op_comp_isSheaf _ _ _⟩
  map f := ObjectProperty.homMk (whiskerLeft e.functor.op f.hom)

/-- The unit iso in the equivalence of sheaf categories. -/
@[simps!]
def sheafCongr.unitIso : 𝟭 (Sheaf J A) ≅ functor J K e A ⋙ inverse J K e A :=
  NatIso.ofComponents (fun F ↦ ⟨ObjectProperty.homMk (isoWhiskerRight e.op.unitIso F.obj).hom,
    ObjectProperty.homMk (isoWhiskerRight e.op.unitIso F.obj).inv,
    InducedCategory.hom_ext (isoWhiskerRight e.op.unitIso F.obj).hom_inv_id,
    InducedCategory.hom_ext (isoWhiskerRight e.op.unitIso F.obj).inv_hom_id⟩ ) (by aesop)
...
def sheafCongr.counitIso : inverse J K e A ⋙ functor J K e A ≅ 𝟭 (Sheaf _ A) :=
  NatIso.ofComponents (fun F ↦ ⟨ObjectProperty.homMk (isoWhiskerRight e.op.counitIso F.obj).hom,
    ObjectProperty.homMk (isoWhiskerRight e.op.counitIso F.obj).inv,
    InducedCategory.hom_ext (isoWhiskerRight e.op.counitIso F.obj).hom_inv_id,
    InducedCategory.hom_ext (isoWhiskerRight e.op.counitIso F.obj).inv_hom_id⟩ ) (by aesop)
...
def sheafCongr : Sheaf J A ≌ Sheaf K A where
  ...
  functor_unitIso_comp X := by
    ext
    simp only [id_obj, sheafCongr.functor_obj_obj_obj, comp_obj]
