...
attribute [local instance] Functor.OplaxMonoidal.ofChosenFiniteProducts
  Functor.Monoidal.ofChosenFiniteProducts Functor.Braided.ofChosenFiniteProducts in
