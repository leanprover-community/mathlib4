...
instance (priority := 10000) mono_factorThruImage [Mono f] : Mono (Abelian.factorThruImage f) :=
...
instance (priority := 10000) epi_factorThruCoimage [Epi f] : Epi (Abelian.factorThruCoimage f) :=
