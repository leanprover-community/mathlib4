...
instance (priority := 10000) : Epi (Abelian.factorThruImage f) :=
...
instance (priority := 10000) isIso_factorThruImage [Mono f] : IsIso (Abelian.factorThruImage f) :=
...
instance (priority := 10000) : Mono (Abelian.factorThruCoimage f) :=
...
instance (priority := 10000) isIso_factorThruCoimage [Epi f] : IsIso (Abelian.factorThruCoimage f) :=
...
instance (priority := 10000) epi_r {A : C} : Epi (r A) := by
...
instance (priority := 10000) isIso_r {A : C} : IsIso (r A) :=
  isIso_of_mono_of_epi _
