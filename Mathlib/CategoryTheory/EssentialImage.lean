...
/-- Lift a functor `G : J ⥤ D` to the essential image of a fully faithful functor `F : C ⥤ D` to a functor
...
/-- A functor `G : J ⥤ D` to the essential image of a fully faithful functor `F : C ⥤ D` does factor through
