...
instance (priority := 10000) associatorIsEquivalence : IsEquivalence (associator C D E) :=
...
instance (priority := 10000) inverseAssociatorIsEquivalence : IsEquivalence (inverseAssociator C D E) :=
