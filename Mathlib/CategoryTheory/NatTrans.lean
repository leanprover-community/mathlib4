...
-/
@[ext, order_dual self (reorder := 5 6)]
...
attribute [order_dual self (reorder := 5 6)] NatTrans.app

@[order_dual existing NatTrans.naturality]
...
-- attribute [order_dual NatTrans.assoc_naturality] NatTrans.naturality_assoc
...
@[order_dual self (reorder := 5 7, 8 9)]
