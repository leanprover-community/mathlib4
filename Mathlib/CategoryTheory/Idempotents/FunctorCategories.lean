...
@[reassoc (attr := simp)]
lemma app_idem : P.p.app X ≫ P.p.app X = P.p.app X :=
  congr_app P.idem X
...
lemma toKaroubi_comp_karoubiFunctorCategoryEmbedding :
