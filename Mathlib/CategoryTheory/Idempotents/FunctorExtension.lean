...
noncomputable instance (priority := 10000) : IsEquivalence (toKaroubi D) :=
...
noncomputable instance (priority := 10000) : IsEquivalence (functorExtension₂ C D) := by
...
noncomputable instance (priority := 10000) : IsEquivalence ((whiskeringLeft C (Karoubi C) D).obj (toKaroubi C)) :=
