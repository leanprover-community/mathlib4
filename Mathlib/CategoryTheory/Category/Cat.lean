...
def ofCatHom {C D : Type u} [Category C] [Category D] (F : Cat.of C ⟶ Cat.of D) : C ⥤ D := F

@[simp] theorem to_ofCatHom {C D : Type u} [Category C] [Category D] (F : Cat.of C ⟶ Cat.of D) :
    (ofCatHom F).toCatHom = F := rfl

@[simp] theorem of_toCatHom {C D : Type u} [Category C] [Category D] (F : C ⥤ D) :
    ofCatHom (F.toCatHom) = F := rfl
