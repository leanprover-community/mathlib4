...
instance (priority := 10000) : CoeSort TwoP (Type*) :=
  ⟨TwoP.X⟩
...
instance (priority := 10000) : Inhabited TwoP :=
  ⟨of TwoPointing.bool⟩
...
noncomputable instance (priority := 10000) largeCategory : LargeCategory TwoP :=
  InducedCategory.category toBipointed
#align Twop.large_category TwoP.largeCategory

noncomputable instance (priority := 10000) concreteCategory : ConcreteCategory TwoP :=
  InducedCategory.concreteCategory toBipointed
#align Twop.concrete_category TwoP.concreteCategory

noncomputable instance (priority := 10000) hasForgetToBipointed : HasForget₂ TwoP Bipointed :=
