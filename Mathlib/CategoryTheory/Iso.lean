...
@[stacks 0017, to_dual self (reorder := 3 4)]
...
@[simp, to_dual self (reorder := 3 4, 7 8)]
...
@[simps, to_dual self (reorder := 3 5, 6 7)]
...
@[simp, to_dual self (reorder := 3 5, 6 10, 7 11, 8 13, 9 12, 14 15)]
...
@[simp, to_dual self (reorder := 3 5, 6 7)]
...
@[to_dual (attr := simp) self_symm_id]
