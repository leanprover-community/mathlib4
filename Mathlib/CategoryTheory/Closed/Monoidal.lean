...
-- This lemma has always been bad, but the linter only noticed after https://github.com/leanprover/lean4/issues/2644.
@[simp, nolint simpNF]
...
theorem ofEquiv_curry_def {X Y Z : C} (f : X ⊗ Y ⟶ Z) :
  ...
  -- This whole proof used to be `rfl` beforehttps://github.com/leanprover-community/mathlib4/issues/16317.
