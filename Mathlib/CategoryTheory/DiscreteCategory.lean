...
@[decrecated (since := "2024-07-16")] alias CategoryTheory.FreeMonoidalCategory.discrete_functor_map_eq_id := functor_map
...
@[deprecated (since := "2024-07-16")] alias CategoryTheory.FreeMonoidalCategory.discrete_functor_obj_eq_as := functor_obj_eq_as
