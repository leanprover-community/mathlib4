...
lemma ιTensorObj₃_tensorHom (f₁ : X₁ ⟶ Y₁) (f₂ : X₂ ⟶ Y₂) (f₃ : X₃ ⟶ Y₃)
  ...
  rw [ιTensorObj₃_eq _ _ _ i₁ i₂ i₃ j h _ rfl, ιTensorObj₃_eq _ _ _ i₁ i₂ i₃ j h _ rfl, assoc,
    ι_tensorHom, ← id_tensorHom, ← id_tensorHom, MonoidalCategory.tensorHom_comp_tensorHom_assoc,
    ι_tensorHom, MonoidalCategory.tensorHom_comp_tensorHom_assoc, id_comp, comp_id]
...
lemma ιTensorObj₃'_tensorHom (f₁ : X₁ ⟶ Y₁) (f₂ : X₂ ⟶ Y₂) (f₃ : X₃ ⟶ Y₃)
    ...
    ιTensorObj₃' X₁ X₂ X₃ i₁ i₂ i₃ j h ≫ tensorHom (tensorHom f₁ f₂) f₃ j =
      ((f₁ i₁ ⊗ₘ f₂ i₂) ⊗ₘ f₃ i₃) ≫ ιTensorObj₃' Y₁ Y₂ Y₃ i₁ i₂ i₃ j h := by
  rw [ιTensorObj₃'_eq _ _ _ i₁ i₂ i₃ j h _ rfl, ιTensorObj₃'_eq _ _ _ i₁ i₂ i₃ j h _ rfl, assoc,
    ι_tensorHom, ← tensorHom_id, ← tensorHom_id, MonoidalCategory.tensorHom_comp_tensorHom_assoc,
    id_comp, ι_tensorHom, MonoidalCategory.tensorHom_comp_tensorHom_assoc, comp_id]
