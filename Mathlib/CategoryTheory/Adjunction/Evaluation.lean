...
instance evaluationIsRightAdjoint (c : C) : IsRightAdjoint ((evaluation _ D).obj c) := fast_instance%
...
instance evaluationIsLeftAdjoint (c : C) : IsLeftAdjoint ((evaluation _ D).obj c) := fast_instance%
