...
variable (T : Triangle C) (hT : T ∈ Pretriangulated.distinguishedTriangles)
include hT

omit hT in
lemma shift_distinguished_iff (n : ℤ) :
    (CategoryTheory.shiftFunctor (Triangle C) n).obj T ∈ distinguishedTriangles ↔
    T ∈ distinguishedTriangles := by
  constructor
  · intro hT
...
@[simps! hom_hom₁ hom_hom₃ inv_hom₁ inv_hom₃]
def isoTriangleOfIso₁₃ (T₁ T₂ : Triangle C) (hT₁ : T₁ ∈ distinguishedTriangles)
    (hT₂ : T₂ ∈ distinguishedTriangles) (e₁ : T₁.obj₁ ≅ T₂.obj₁) (e₃ : T₁.obj₃ ≅ T₂.obj₃)
