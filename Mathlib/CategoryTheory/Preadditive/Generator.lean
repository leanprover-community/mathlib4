...
lemma Preadditive.isSeparating_iff (𝒢 : Set C) :
...
lemma Preadditive.isCoseparating_iff (𝒢 : Set C) :
...
lemma Preadditive.isSeparator_iff (G : C) :
...
lemma Preadditive.isCoseparator_iff (G : C) :
...
lemma isSeparator_iff_faithful_preadditiveCoyoneda (G : C) :
...
lemma isSeparator_iff_faithful_preadditiveCoyonedaObj (G : C) :
...
lemma isCoseparator_iff_faithful_preadditiveYoneda (G : C) :
...
lemma isCoseparator_iff_faithful_preadditiveYonedaObj (G : C) :
