...
lemma hasEqualizer_of_hasKernel [HasKernel (f - g)] : HasEqualizer f g :=
  HasLimit.mk
...
lemma hasKernel_of_hasEqualizer [HasEqualizer f g] : HasKernel (f - g) :=
  HasLimit.mk
...
lemma hasCoequalizer_of_hasCokernel [HasCokernel (f - g)] : HasCoequalizer f g :=
  HasColimit.mk
...
lemma hasCokernel_of_hasCoequalizer [HasCoequalizer f g] : HasCokernel (f - g) :=
  HasColimit.mk
...
lemma hasEqualizers_of_hasKernels [HasKernels C] : HasEqualizers C :=
...
lemma hasCoequalizers_of_hasCokernels [HasCokernels C] : HasCoequalizers C :=
