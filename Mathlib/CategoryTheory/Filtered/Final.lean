...
* Under categories of objects of filtered categories are filtered.
...
/-- The forget functor of the under category on any filtered or empty category is final. -/
instance Under.forget_final [IsFilteredOrEmpty C] (c : C) : Final (Under.forget c) :=
...
/-- The forget functor of the ov category on any filtered or empty category is initial. -/
instance Over.forget_initial [IsCofilteredOrEmpty C] (c : C) : Initial (Over.forget c) :=
