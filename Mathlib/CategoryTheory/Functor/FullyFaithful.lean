...
@[deprecated (since := "2024-06-12")] alias Full := Functor.Full
@[deprecated (since := "2024-06-12")] alias Faithful := Functor.Faithful
@[deprecated (since := "2024-06-12")] alias preimage_id := Functor.preimage_id
@[deprecated (since := "2024-06-12")] alias preimage_comp := Functor.preimage_comp
@[deprecated (since := "2024-06-12")] alias preimage_map := Functor.preimage_map
@[deprecated (since := "2024-06-12")] alias Faithful.of_comp := Functor.Faithful.of_comp
@[deprecated (since := "2024-06-12")] alias Full.ofIso := Functor.Full.of_iso
@[deprecated (since := "2024-06-12")] alias Faithful.of_iso := Functor.Faithful.of_iso
@[deprecated (since := "2024-06-12")] alias Faithful.of_comp_iso := Functor.Faithful.of_comp_iso
@[deprecated (since := "2024-06-12")] alias Faithful.of_comp_eq := Functor.Faithful.of_comp_eq
@[deprecated (since := "2024-06-12")] alias Faithful.div := Functor.Faithful.div
