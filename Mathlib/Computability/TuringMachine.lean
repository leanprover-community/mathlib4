...
import Mathlib.Computability.TuringMachine0

/-!
# Turing machines

This file and `TuringMachine0.lean`
...
theorem tr_respects : Respects (TM0.step M) (TM1.step (tr M)) fun a b ↦ trCfg M a = b :=
  fun_respects.2 fun ⟨q, T⟩ ↦ by
    ...
    · apply ReflTransGen.single
      ...
      split
      next s d => simp_all only [Option.isNone_none, cond_true]
      next s a => simp_all only [Option.isNone_none, cond_true]
    · rfl
