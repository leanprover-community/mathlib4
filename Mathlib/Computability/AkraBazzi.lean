...
For the Akra-Bazzi theorem to hold, the function `g` must satisfy a polynomial growth condition,
namely that c₁ g(n) ≤ g(u) ≤ c₂ g(n), for u between b*n and n for any constant b ∈ (0,1).

This section defines this notion and proves several basic facts about it.
-/
