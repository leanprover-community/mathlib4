...
/--
Get the the `ConstantVal`s of declarations elaborated in the infotree `t`.
-/
def getDeclVals (t : InfoTree) (env : Environment) : List ConstantVal :=
  t.getDeclsByBody.filterMap env.findConstVal?
