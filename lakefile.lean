...
require "leanprover" / "sos" @ git "v0.2.1"
...
lean_exe «check-yaml» where
  ...
  -- The executable imports these modules dynamically; make their `.olean`
  -- artifacts explicit Lake dependencies without statically linking them.
