...
require "leanprover-community" / "proofwidgets" @ git "v0.0.75-pre" -- ProofWidgets should always be pinned to a specific version
...
abbrev mathlibLeanOptions := #[
    ...
    ⟨`backward.grind.checkInferPatternDiscrepancy, true⟩,
    ⟨`backward.grind.inferPattern, true⟩
