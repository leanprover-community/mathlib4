...
nonrec lemma m_le_n {m n : ℕ} (h1 : NatPredicate N m n) : m ≤ n := by exact_mod_cast h1.m_le_n
#align imo1981_q3.nat_predicate.m_le_n Imo1981Q3.NatPredicate.m_le_n

nonrec lemma eq_imp_1 {n : ℕ} (h1 : NatPredicate N n n) : n = 1 := by exact_mod_cast h1.eq_imp_1
...
lemma n_pos {m n : ℕ} (h1 : NatPredicate N m n) : 0 < n := by exact_mod_cast h1.n_range.left
#align imo1981_q3.nat_predicate.n_pos Imo1981Q3.NatPredicate.n_pos

lemma m_pos {m n : ℕ} (h1 : NatPredicate N m n) : 0 < m := by exact_mod_cast h1.m_range.left
#align imo1981_q3.nat_predicate.m_pos Imo1981Q3.NatPredicate.m_pos

lemma n_le_N {m n : ℕ} (h1 : NatPredicate N m n) : n ≤ N := by exact_mod_cast h1.n_range.right
