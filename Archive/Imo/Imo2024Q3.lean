...
lemma nth_ne_zero_of_M_le_of_lt {i k : ℕ} (hi : M a N ≤ a i) (hk : k < a (i + 1)) :
    Nat.nth (a · = a i) k ≠ 0 :=
  Nat.nth_ne_zero_anti (apply_ne_of_M_le_apply hi (Nat.zero_le _)) (by grind)
...
lemma apply_add_one_lt_of_apply_eq {i j : ℕ} (hi : N ≤ i) (hij : i < j) (ha : a i = a j) :
    a (i + 1) < a (j + 1) := by
  rw [hc.apply_add_one_eq_card hi, hc.apply_add_one_eq_card (by grind), ha]
...
lemma empty_consecutive_apply_ge_M : {i | M a N ≤ a i ∧ M a N ≤ a (i + 1)} = ∅ := by
  ...
  have N_le_i : N ≤ i := by
    unfold M at hi1
    by_contra! HH
    have i_in_range : i ∈ Finset.range (N + 1) := by rw [Finset.mem_range]; grind
...
lemma infinite_setOf_apply_eq_anti {j k : ℕ} (hj : 0 < j) (hk : {i | a i = k}.Infinite)
  ...
  have hk' : {i | a (i + 1) = k}.Infinite := by
    ...
    · rintro ⟨j, rfl, rfl⟩
      simp
    · rintro ⟨rfl, h⟩
      exact ⟨i - 1, by simp [(by grind : i - 1 + 1 = i)]⟩
  ...
  rw [Set.mem_setOf_eq, hc.apply_nth_add_one_eq_of_lt (by grind), Nat.sub_add_cancel hj]
...
lemma finite_setOf_apply_eq_k_add_one : {i | a i = k a + 1}.Finite := by
  rw [hc.finite_setOf_apply_eq_iff_not_small (by grind), Small]
  grind
...
lemma finite_setOf_k_lt_card : {m | ∀ hf : {i | a i = m}.Finite, k a < #hf.toFinset}.Finite := by
  ...
  · refine Set.Finite.of_diff (hc.finite_setOf_apply_eq_k_add_one.subset fun i hi ↦ ?_)
    ...
    rw [Set.mem_setOf_eq, hc.apply_nth_add_one_eq hjf (by grind)]
  · intro i hi j hj hij
...
lemma not_medium_of_N'aux_lt {j : ℕ} (h : N'aux a N < j) : ¬Medium a (a j) := by
  ...
  have hf : s.Finite := by
    ...
    rintro i ⟨hk, -⟩
    rwa [hc.finite_setOf_apply_eq_iff_not_small (by grind), Small, not_le]
...
lemma small_apply_N' : Small a (a (N' a N)) := by
  ...
  · have hb : Big a (a (N'aux a N + 1)) := by
    ...
    exact hc.apply_add_one_small_of_apply_big_of_N'aux_le hb (by grind)
...
lemma small_apply_N'_add_iff_even {n : ℕ} : Small a (a (N' a N + n)) ↔ Even n := by
  ...
  | succ n ih =>
    ...
    · have hb : Big a (a (N' a N + n)) := by
        simpa [ih] using hc.small_or_big_of_N'_le (j := N' a N + n) (by grind)
      simp [hc.apply_add_one_small_of_apply_big_of_N'_le hb (by grind), Nat.not_even_iff_odd.mp he]

lemma small_apply_add_two_mul_iff_small {n : ℕ} (m : ℕ) (hN' : N' a N ≤ n) :
    Small a (a (n + 2 * m)) ↔ Small a (a n) := by
  rw [show n = N' a N + (n - N' a N) by grind, add_assoc, hc.small_apply_N'_add_iff_even,
...
lemma apply_sub_one_big_of_apply_small_of_N'_lt {i : ℕ} (h : Small a (a i)) (hN' : N' a N < i) :
    Big a (a (i - 1)) := by
  have h0i : 1 ≤ i := by grind
  have h' : N' a N ≤ i - 1 := by grind
...
lemma apply_sub_two_small_of_apply_small_of_N'_lt {i : ℕ} (h : Small a (a i)) (hN' : N' a N < i) :
  ...
  convert hc.apply_sub_one_small_of_apply_big_of_N'_le
    (hc.apply_sub_one_big_of_apply_small_of_N'_lt h hN') (by grind) using 1
...
lemma N_add_one_lt_apply_of_apply_big_of_N'_le {i : ℕ} (h : Big a (a i)) (hN' : N' a N ≤ i) :
  ...
  by_contra
  exact hc.not_small_of_big ((by grind : i = N' a N) ▸ h) hc.small_apply_N'
...
lemma setOf_apply_eq_of_apply_big_of_N'_le {i : ℕ} (h : Big a (a i)) (hN' : N' a N ≤ i) :
  ...
  have hs : #((Finset.Icc 1 (k a)).image (fun t ↦ Nat.nth (a · = t) (a i - 1) + 1)) = k a := by
    ...
    · simp only [add_left_inj] at htu
      ...
      rw [← Small, ← hc.infinite_setOf_apply_eq_iff_small (by grind)] at ht hu
      apply_fun a at htu
  ...
  rw [← Small] at htk
  have htki := htk
  rw [← hc.infinite_setOf_apply_eq_iff_small (by grind)] at htki
  ...
  · congr
    ...
    · have hjN : N < j := hc.N_lt_of_apply_eq_of_apply_big_of_N'_le hji hib hi.le
      ...
      · rw [hc.apply_eq_card hjN]
        have : j ≤ i := by grind
        gcongr
      · have hj1 : j = j - 1 + 1 := by grind
        nth_rw 2 [hj1]
        rw [hc.nth_apply_add_one_eq (by grind), hj1.symm]
    · subst ht
...
lemma apply_eq_card_small_le_card_eq_of_small {i : ℕ} (hi : N' a N + 1 < i)
  ...
  have hib : Big a (a (i - 1)) := hc.apply_sub_one_big_of_apply_small_of_N'_lt his (by grind)
  nth_rw 1 [show i = i - 1 + 1 by grind]
  rw [hc.apply_add_one_eq_card_small_le_card_eq (by grind) hib]
  congr 1
  ext j
  ...
  refine ⟨fun ⟨hti, rfl⟩ ↦ ⟨?_, rfl⟩, fun ⟨_, rfl⟩ ↦ ⟨by grind, rfl⟩⟩
  by_contra hti1
  have htieq : t = i - 1 := by grind
  subst htieq
...
lemma exists_apply_sub_two_eq_of_apply_eq {i j : ℕ} (hi : N' a N + 2 < i) (hijlt : i < j)
  ...
  have hIc : a i = #I := hc.apply_eq_card_small_le_card_eq_of_small (by grind) his
  have hJc : a j = #J := hc.apply_eq_card_small_le_card_eq_of_small (by grind) (hijeq ▸ his)
  have hIJc : #I = #J := hIc ▸ hJc ▸ hijeq
  have := hc.N_lt_N'
  have hiju : Finset.range i ∪ Finset.Ico i j = Finset.range j := by
    rw [Finset.range_eq_Ico, Finset.Ico_union_Ico' (by grind) (by grind)]
    simp [hijlt.le]
  have hi2s : a (i - 2) < k a + 1 :=
    Nat.lt_add_one_iff.mpr (hc.apply_sub_two_small_of_apply_small_of_N'_lt his (by grind))
  have hiI : a (i - 2) ∈ I := by
    simp only [I, Finset.mem_filter, Finset.mem_range, hi2s, true_and]
    rw [hc.apply_eq_card (by grind), show i - 1 - 1 = i - 2 by grind]
    exact Finset.card_le_card (Finset.filter_subset_filter _  (by simp))
  have hj2s : a (j - 2) < k a + 1 :=
    Nat.lt_add_one_iff.mpr (hc.apply_sub_two_small_of_apply_small_of_N'_lt (hijeq ▸ his) (by grind))
  have hjJ : a (j - 2) ∈ J := by
    simp only [J, Finset.mem_filter, Finset.mem_range, hj2s, true_and]
    rw [hc.apply_eq_card (by grind), show j - 1 - 1 = j - 2 by grind]
    exact Finset.card_le_card (Finset.filter_subset_filter _  (by simp))
  have hjI : a (j - 2) ∈ I := by
    by_contra hjI
    have hjIf := hjI
  ...
  have hi1j1 : a (i - 1) + 1 ≤ a (j - 1) := by
    calc a (i - 1) + 1 ≤ #{u ∈ Finset.range i | a u = a (j - 2)} + 1 := by grind
      _ ≤ #{u ∈ Finset.range i | a u = a (j - 2)} + #{u ∈ Finset.Ico i j | a u = a (j - 2)} := by
          ...
          refine ⟨?_, by grind⟩
          by_contra hj
          have hj' : j = i + 1 := by grind
          subst hj'
          exact hc.not_small_of_big (hc.apply_add_one_big_of_apply_small_of_N'_le his (by grind))
            (hijeq ▸ his)
      _ = #({u ∈ Finset.range i | a u = a (j - 2)} ∪ {u ∈ Finset.Ico i j | a u = a (j - 2)}) := by
      ...
      _ = a (j - 1) := by
          rw [hc.apply_eq_card (show N < j - 1 by grind)]
          congr 1
          ext t
          simp only [Finset.mem_filter, Finset.mem_range]
          refine ⟨fun ⟨htj, htj'⟩ ↦ ⟨?_, by convert htj' using 1⟩,
            fun ⟨htj, htj'⟩ ↦ ⟨by grind, by convert htj' using 1⟩⟩
          by_contra htj''
          have ht1 : t = j - 1 := by grind
          subst ht1
          exact hc.not_small_of_big (htj' ▸ hc.apply_sub_one_big_of_apply_small_of_N'_lt
            (hijeq ▸ his) (by grind)) (hc.apply_sub_two_small_of_apply_small_of_N'_lt
            (hijeq ▸ his) (by grind))
  have hIJ : I = J := by
  ...
  rw [hc.apply_eq_card (by grind), show i - 1 - 1 = i - 2 by grind, Nat.add_one_le_iff,
     ← not_le] at hiI'
  ...
  by_contra
  have hti' : t = i - 1 := by grind
  subst hti'
  exact hc.not_small_of_big (hc.apply_sub_one_big_of_apply_small_of_N'_lt his (by grind)) (htj.2 ▸
    (hc.apply_sub_two_small_of_apply_small_of_N'_lt his (by grind)))
...
lemma nonempty_pSet (n : ℕ) : (pSet a n).Nonempty := by
  ...
  exact ⟨i, ⟨hni.le, by grind⟩, hi1 ▸ ⟨hc.small_one, hj1 ▸ (by congr; grind)⟩⟩
...
lemma card_filter_apply_eq_Ico_add_p_le_one (n : ℕ) {j : ℕ} (hjs : Small a j) :
  ...
  · replace h := h.2 (y - n) x hx.1.1 (by grind) (hx.2 ▸ hjs)
    rw [show n + (y - n) = y by grind, hx.2, hy.2] at h
    grind
  · rfl
  · replace h := h.2 (x - n) y hy.1.1 (by grind) (hy.2 ▸ hjs)
    rw [show n + (x - n) = x by grind, hx.2, hy.2] at h
    grind
...
lemma apply_add_p_eq {n : ℕ} (hn : N' a N + 2 < n) (hs : Small a (a n)) : a (n + p a n) = a n := by
  ...
  obtain ⟨t, hti, hi2t⟩ := hc.exists_apply_sub_two_eq_of_apply_eq (j := n + p a n) (by grind)
    (by grind) his hin.symm hf
  have h1 := hc.card_filter_apply_eq_Ico_add_p_le_one n
    (hi2t ▸ hc.apply_sub_two_small_of_apply_small_of_N'_lt his (by grind))
  revert h1
  simp only [imp_false, not_le, Finset.one_lt_card_iff, Finset.mem_filter, Finset.mem_Ico, ne_eq,
    exists_and_left]
  simp only [Finset.mem_Ico] at hti
  refine ⟨i - 2, ⟨⟨?_, by grind⟩, hi2t⟩, t, by grind⟩
  by_contra hi2
  have hi1 : n = i - 1 := by grind
  subst hi1
  exact hc.not_small_of_big (hc.apply_sub_one_big_of_apply_small_of_N'_lt his (by grind)) hs

lemma even_p {n : ℕ} (hn : N' a N + 2 < n) (hs : Small a (a n)) : Even (p a n) := by
  have hna : n = N' a N + (n - (N' a N)) := by grind
...
lemma p_le_two_mul_k {n : ℕ} (hn : N' a N + 2 < n) (hs : Small a (a n)) : p a n ≤ 2 * k a := by
  ...
  obtain ⟨x, hx, y, hy, hxyne, hxy⟩ : ∃ x ∈ Finset.range (k a + 1), ∃ y ∈ Finset.range (k a + 1),
    ...
    · rintro i -
      ...
      rw [← Small, hc.small_apply_add_two_mul_iff_small i (by grind)]
      simp [hs, hc.one_le_apply]
  have hs' : Small a (a (n + 2 * x)) := by rwa [hc.small_apply_add_two_mul_iff_small x (by grind)]
  have hj := hc.card_filter_apply_eq_Ico_add_p_le_one n hs'
  revert hj
  simp only [imp_false, not_le, Finset.one_lt_card_iff, Finset.mem_filter, Finset.mem_Ico, ne_eq,
    exists_and_left]
  simp only [Finset.mem_range] at hx hy
  exact ⟨n + 2 * x, by grind, n + 2 * y, by grind⟩

lemma p_apply_sub_two_le_p_apply {n : ℕ} (hn : N' a N + 4 < n) (hs : Small a (a n)) :
    p a (n - 2) ≤ p a n := by
  obtain ⟨t, hti, _⟩ := hc.exists_apply_sub_two_eq_of_apply_eq (j := n + p a n) (by grind)
    ((lt_add_iff_pos_right n).mpr (hc.p_pos n)) hs
    (hc.apply_add_p_eq (by grind) hs).symm (fun _ ↦ hc.card_filter_apply_eq_Ico_add_p_le_one _)
  by_contra
  have hn2 := (hc.apply_sub_two_small_of_apply_small_of_N'_lt hs (by grind))
  have : p a n ≤ p a (n - 2) - 2 := by
    obtain ⟨_, _⟩ := hc.even_p (by grind) hs
    obtain ⟨_, _⟩ := hc.even_p (by grind) hn2
    grind
  ...
  simp only [Finset.mem_Ico] at hti
  exact ⟨n - 2, ⟨⟨le_rfl, by grind⟩, rfl⟩, t, by grind⟩

lemma p_apply_le_p_apply_add_two {n : ℕ} (hn : N' a N + 2 < n) (hs : Small a (a n)) :
    p a n ≤ p a (n + 2) :=
  hc.p_apply_sub_two_le_p_apply (n := n + 2) (by grind)
    (hc.apply_add_two_small_of_apply_small_of_N'_le hs (by grind))
...
lemma exists_p_eq : ∃ b c, ∀ n, b < n → p a (N' a N + 2 * n) = c := by
  ...
  have hk : 2 * k a ∈ upperBounds (Set.range (fun i ↦ p a (N' a N + 2 * (2 + i)))) := by
    ...
    exact fun i ↦ hc.p_le_two_mul_k (by grind) (hc.small_apply_N'_add_iff_even.mpr (by simp))
  ...
  have heqc (u : ℕ) : p a (N' a N + 2 * (2 + t + u)) = c := by
    ...
    | succ u ih =>
      ...
      · have hs : Small a (a (N' a N + 2 * (2 + t + u))) := by
          ...
          simp
        convert hc.p_apply_le_p_apply_add_two (by grind) hs using 1
  refine ⟨1 + t, c, fun n hn ↦ ?_⟩
  rw [show n = 2 + t + (n - (2 + t)) by grind]
  exact heqc _
...
lemma exists_a_apply_add_eq : ∃ b c, 0 < c ∧ ∀ n, b < n →
  ...
  refine ⟨b + 2, c' / 2, ?_, fun n hbn ↦ hbc' n (by grind) ▸ ?_⟩
  · have := hbc' (b + 2) (by grind)
    have := hc.p_pos (N' a N + 2 * (b + 2))
    rcases hc.even_p (by grind) (hs (b + 2)) with ⟨_, _⟩
    grind
  · convert hc.apply_add_p_eq (by grind) (hs n) using 3
    rcases hc.even_p (by grind) (hs n) with ⟨_, ht⟩
    simp [ht, ← two_mul]
...
theorem result {a : ℕ → ℕ} {N : ℕ} (h : Condition a N) :
  ...
  · refine .inl ⟨c, Condition.N' a N / 2 + b + 1, hc, fun m hm ↦ ?_⟩
    convert hbc (m - t) (by grind) using 1 <;> dsimp only <;> congr <;> grind
  · refine .inr ⟨c, Condition.N' a N / 2 + b + 1, hc, fun m hm ↦ ?_⟩
    convert hbc (m - t) (by grind) using 1 <;> dsimp only <;> congr 1 <;> grind
