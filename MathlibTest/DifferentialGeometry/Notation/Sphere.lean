...
variable
  {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E] {H : Type*}
  ...
  {E'' : Type*} [NormMetric E''] [AddCommGroup E''] [IsNormedAddGroup E''] [InnerProductSpace ℝ E''] {n : ℕ}
...
variable {G : Type*} [NormMetric G] [AddCommGroup G] [IsNormedAddGroup G] [InnerProductSpace ℝ G]
