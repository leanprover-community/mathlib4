...
example [Infinite α] : Infinite (Option α) := derive_infinite%
...
instance [Nonempty α] : Infinite (List' α) := derive_infinite%
...
example : Infinite (Indexed 0) := derive_infinite%
example : Infinite (Indexed 1) :=
  let _ : Infinite (Indexed 0) := derive_infinite%
  derive_infinite%
...
instance [Inhabited α] [Infinite α] : Infinite (Vector' α (n + 1)) := derive_infinite%
