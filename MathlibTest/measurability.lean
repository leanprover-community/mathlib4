...
example [TopologicalSpace α] [BorelSpace α] [NormMetric β] [AddCommGroup β] [IsNormedAddGroup β] [BorelSpace β]
...
simplification. -/
variable {E : Type*} (v : E) [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [InnerProductSpace ℝ E] [MeasurableSpace E]
