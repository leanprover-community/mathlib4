...
example [NormMetric E] [Group E] [IsNormedGroup E] {a : E} : 0 ≤ ‖a‖ := by positivity
example [NormMetric E] [Group E] [IsNormedGroup E] {a : E} (ha : a ≠ 1) : 0 < ‖a‖ := by positivity

example [NormPseudoMetric E] [AddGroup E] [IsNormedAddGroup E] {a : E} (_ha : a ≠ 0) : 0 ≤ ‖a‖ := by positivity
example [NormMetric E] [AddGroup E] [IsNormedAddGroup E] {a : E} : 0 ≤ ‖a‖ := by positivity
example [NormMetric E] [AddGroup E] [IsNormedAddGroup E] {a : E} (ha : a ≠ 0) : 0 < ‖a‖ := by positivity
...
variable {D : Type*} [NormMetric D] [AddCommGroup D] [IsNormedAddGroup D] [NormedSpace ℝ D]
  {E : Type*} [NormMetric E] [AddCommGroup E] [IsNormedAddGroup E] [NormedSpace ℝ E] [MeasurableSpace D] [BorelSpace D]
  (μ : Measure D)
