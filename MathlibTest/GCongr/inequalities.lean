...
/- Test for `gcongr` efficiency on problems with many hypotheses. Heartbeat count is 12561 as of
November 2024 (#19425). -/
set_option linter.unusedVariables false in
set_option maxHeartbeats 15000 in
example
    {a00000 a00001 a00010 a00011 a00100 a00101 a00110 a00111
    a01000 a01001 a01010 a01011 a01100 a01101 a01110 a01111
    a10000 a10001 a10010 a10011 a10100 a10101 a10110 a10111
    a11000 a11001 a11010 a11011 a11100 a11101 a11110 a11111  : ℝ}
    (h0 : 0 ≤ a00000 + 1)
    (h0 : 0 ≤ a00010 + 1)
    (h00000 : a00000 ≤ b00000)
    (h00001 : a00001 ≤ b00001)
    (h00010 : a00010 ≤ b00010)
    (h00011 : a00011 ≤ b00011)
    (h00100 : a00100 ≤ b00100)
    (h00101 : a00101 ≤ b00101)
    (h00110 : a00110 ≤ b00110)
    (h00111 : a00111 ≤ b00111)
    (h01000 : a01000 ≤ b01000)
    (h01001 : a01001 ≤ b01001)
    (h01010 : a01010 ≤ b01010)
    (h01011 : a01011 ≤ b01011)
    (h01100 : a01100 ≤ b01100)
    (h01101 : a01101 ≤ b01101)
    (h01110 : a01110 ≤ b01110)
    (h01111 : a01111 ≤ b01111)
    (h10000 : a10000 ≤ b10000)
    (h10001 : a10001 ≤ b10001)
    (h10010 : a10010 ≤ b10010)
    (h10011 : a10011 ≤ b10011)
    (h10100 : a10100 ≤ b10100)
    (h10101 : a10101 ≤ b10101)
    (h10110 : a10110 ≤ b10110)
    (h10111 : a10111 ≤ b10111)
    (h11000 : a11000 ≤ b11000)
    (h11001 : a11001 ≤ b11001)
    (h11010 : a11010 ≤ b11010)
    (h11011 : a11011 ≤ b11011)
    (h11100 : a11100 ≤ b11100)
    (h11101 : a11101 ≤ b11101)
    (h11110 : a11110 ≤ b11110)
    (h11111 : a11111 ≤ b11111) :
    3 * (a00000 + 1) ^ 2 + 3 * (a00010 + 1) ^ 2 ≤ 3 * (b00000 + 1) ^ 2 + 3 * (b00010 + 1) ^ 2  := by
  gcongr
